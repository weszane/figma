...
export function $$b0({ handleClosePanel: e }) {
  let [t, l] = useState([]);
  let [c, d] = useState("");
  let m = useRef(null);
  let f = useCallback(() => {
    let e = UN()
      ?.getInternalCanvas()
      ?.childrenNodes.find((e) => "CODE_LIBRARY" === e.type);
    e &&
      (l(
        e.chatMessages.map((t, l) => {
  ...
  return jsxs("div", {
    ...
    children: [
      ...
      jsxs("div", {
        className:
          "x98rzlu x78zum5 xdt5ytf x2lwn1j x5yr21d x1odjw0f x1mh6rdz xg2d0mh",
        children: [
          jsxs(_$$t.TabStrip, {
            manager: E,
            children: [
...
function N({ messages: e, parentRef: t }) {
  let l = Te({
    count: e.length,
    ...
    jsxs(
      E,
      {
        children: [
          ...
          " ",
          e.result
            ? _$$t2("figmake.scope.tool_success")
            : _$$t2("figmake.scope.tool_failure"),
        ],
      },
      e.toolName,
    ),
      ...
      children: [
        jsx(Y9, {
          ...
          children: jsx(JU, {
            ...
            children: jsxs("span", {
              className:
                "x78zum5 x1q0g3np xg2d0mh xlyipyv xb3r6kr xuxw1ft x193iq5w",
        ...
        jsx(UC, {
          children: jsx("pre", {
            className:
              "xclx6tv x17akokd x1qxcl5b x1betce5 xno9bf3 x1akne3o x126k92a x1yn0g08 xysyzu8 x1phlbz0 x1hx0egp",
            children: t,
          }),
        }),
      ],
