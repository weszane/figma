...
let $$R0 = connect(e => ({
  ...
  let j = useMemo(() => e.includeCopyLinkButton ? jsx(Button, {
    onClick: x,
    disabled: !u,
...
function B(e) {
  ...
  return jsxs(EventShield, {
    ...
    children: [jsx("div", {
      ...
      children: jsx(DialogTriggerButton, {
        ...
        onClick: () => {
          ...
          l() ? n(hideDropdownAction()) : e && n(showDropdownThunk({
            type: t,
            data: {
              targetRect: e
            }
    ...
    }), l() && jsxs(ConnectedPointingDropdown, {
  ...
  let s = jsxs("div", {
    ...
    children: [jsxs("span", {
      ...
      children: [jsxs(ButtonPrimitive, {
        onClick: i => {
          i.stopPropagation();
          e.url && (e.dropdownShown ? n(hideDropdownAction()) : n(showDropdownThunk({
            type: t
          })));
        },
