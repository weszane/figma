...
class J {
  constructor(e, t, n, o) {
    if (e.pins.length > 1 && (this.showClusterCount = !0), !n)
      return
    let a = eo(e, n)
    if (!a) {
    ...
    if (d.current) {
      if (i instanceof J) {
        ...
        if (d.current.style.opacity = '1.0', showClusterCount && c.current) {
          let e;
          (e = c.current)
            ? (e.style.transition = 'none', e.style.opacity = '1', _$$G(e, [], {
                duration: 1e3,
              }).then(() => {
...
let eN = memo(({
  ...
  let {
    ...
    let v = useCallback((t) => {
      r === 'dragging'
        ? (e.current?.releasePointerCapture(t.pointerId), t.stopPropagation(), o(h), f({
            x: 0,
            y: 0,
          }))
        : d || s()
...
let eU = memo((e) => {
  ...
  useEffect(() => {
    if (zoomScale === K.viewport.zoomScale)
      return
    let {
      width,
      height,
...
function tV(e) {
  ...
  let f = GH()
  let v = useMemo(() => f && f.status === 'loaded' && f.data && f?.feedApi?.reactionsApi
    ? f.feedApi.reactionsApi.getReactionsForPost(e.feedPost.feedPostPublicUuid)
    : {
        postReactions: [],
        commentReactions: {},
...
function nr(e) {
  ...
  let A = useCallback((n) => {
    ...
    if (t === 'fullscreen' && !n.page)
      return new Point(x, y)
    if (!n.threadPosition)
      return
    if (e.useAbsolutePositioning)
      return new Point(n.threadPosition.x, n.threadPosition.y)
      ...
      children: [Y && jsx(ue, {
        ...
        children: [eS && eA && jsx(th, {
          ...
          'children': [jsx(t8, {
            ...
            thread: t,
          }), thread.sidebarItemType === ThreadType.COMMENT_THREAD
            ? jsxs(_$$P, {
                'ref': ep,
                'maxHeight': c,
                'onMouseDown': no,
            ...
            : thread.sidebarItemType === ThreadType.FEED_POST
              ? jsx(tV, {
                  comments: e.comments,
                  dispatch,
                  editorOnClear: e.editorOnClear,
...
function nO(e) {
  ...
  let L = useCallback((e) => {
    if (u) {
      ...
      if (!l.comments[0].client_meta?.selection_box_anchor)
        return
      let n = {
  ...
  let z = !!useSubscription(FileCanEdit(u
    ? null
    : {
        key: e.thread.key,
      })).unwrapOr(!1)
    ...
    : jsxs(Fragment, {
        children: [jsx('div', {
          ...
          children: [l.canvasPosition && q && jsx(nS, {
            ...
            : l.sidebarItemType === ThreadType.COMMENT_THREAD || l.sidebarItemType === ThreadType.FEED_POST && _$$y()
              ? jsx(nr, {
...
function nG(e) {
  ...
  let x = (function (e, t, n, o, s) {
    ...
    let x = useCallback((o, a) => {
      if (e && (allowCompose || !t))
        return _requestToDeselectCommentPin ? !0 !== a && (_requestToDeselectCommentPin(), !0) : (n && n(!1), !f(UU()) || !0 !== a)
    ...
    return (function (e, t, n, o, i, s) {
      ...
      useEffect(() => {
        touchEvents && i && s?.current
          ? (i.updateTapGestureRecognizer(s.current, (e) => {
              t(e)
          ...
          : (c.onCanvasPositionClick = e, c.onViewportPositionClick = t)
...
// todo: refactor this giant component
function n0(e) {
  let t
  let {
    activeId,
  ...
  let q = nJ(S?.id)
  return jsxs(Fragment, {
    children: [getFeatureFlags().comments_react
      ? jsx(eH, {
          activeThread: S,
          dragDisabledOverride: e.dragDisabledOverride,
          isCommunity: l,
...
function n2(e) {
  ...
  if (isDevModeFocusViewActive() || k && (I || isLoading) || M === null || j)
    return null
