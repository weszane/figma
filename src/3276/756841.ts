...
import { hB, Lc, lM, Qj, Ue, Yo } from "../905/301347"
import { VisualBellActions } from "../905/302958"
import { getI18nString, renderI18nText } from "../905/303541"
import { P as _$$P } from "../905/347284"
import { createOptimistThunk } from "../905/350402"
import { getUserId, selectCurrentUser } from "../905/372672"
import { isCommentStateActive, isCommentStatePostable, isCommentStateUpdatable, ThreadType } from "../905/380385"
...
import { bL, HG, O6 } from "../905/598775"
...
import { $Q, a2, CU, H_, z6 } from "../905/963340"
...
import { ek as _$$ek, hh, L9, oS, T4, vO } from "../figma_app/42945"
...
import { cU, wY } from "../figma_app/708845"
...
import { activateCommentThreadInternal, addEmphasizedPin, deactivateActiveComment, deleteComment, markAllCommentsAsRead, markCommentAsUnread, markThreadAsRead, removeEmphasizedPin, resolveCommentThread, setActiveComment, switchOrDeactivateCommentThread } from "../figma_app/770088"
...
import { MenuContainerComp, MenuHiddenTitleComp, MenuItemComp, MenuItemTrail, MenuRootComp, MenuSeparator, MenuShortcut, MenuSubText, MenuTitleComp, setupMenu } from "../figma_app/860955"
...
function el(e) {
  return jsxs("span", {
    ...
    children: [jsx("div", {
      ...
      children: e.isPendingFromSinatra
        ? renderI18nText("comments.in_a_moment")
...
function ed(e) {
  ...
  return e.hideParentName || !e.parentName
    ? e.orderId
      ? renderI18nText("comments.number_only", {
          commentNumber: e.orderId,
        })
      : null
    : e.orderId
      ? renderI18nText("comments.parent_name_and_number", {
...
function ex(e) {
  ...
  let y = useMemo(() => {
    if (_ === thread.comments[0].user_id && !thread.isCanvasMention && isCommentStateUpdatable(thread.sidebarItemType)) {
  ...
  let C = useMemo(() => {
    let e = []
    m && f && thread.isCanvasMention
      ? e.push(jsx(MenuItemComp, {
          onClick: v,
          children: isUnread ? renderI18nText("comments.mark_as_read") : renderI18nText("comments.mark_as_unread"),
        }, "toggleUnreadCanvasMention"))
      : commentReceipts && f && !thread.isCanvasMention && isCommentStateActive(thread.sidebarItemType) && e.push(jsx(MenuItemComp, {
        onClick: g,
        children: isUnread ? renderI18nText("comments.mark_as_read") : renderI18nText("comments.mark_as_unread"),
      }, "toggleUnreadComment"))
    e.push(jsx(MenuItemComp, {
...
let eM = memo((e) => {
  return jsxs("div", {
    ...
    children: [e.replyCount !== 0 && jsxs(Fragment, {
      children: [jsx("div", {
        className: eC,
        children: renderI18nText("comments.reply_count", {
          replyCount: e.replyCount,
        }),
      }), e.attachmentCount !== 0 && jsx("div", {
...
let eS = memo((e) => {
  ...
  let L = jsxs(Fragment, {
    children: [!isPendingFromSinatra && !P && (y
      ? jsx(HG, {
          className: ey,
          ref: optionsMenuRef,
          children: S,
      ...
      : jsx("div", {
          ...
          ref: optionsMenuRef,
          children: S,
        })), e.thread.sidebarItemType === ThreadType.FEED_POST && (y
      ? jsx(HG, {
          className: ey,
          ref: optionsMenuRef,
          children: A,
...
function eJ(e) {
  ...
  return e.page === null || getNodeStatus(t, e.page) === DataLoadStatus.LOADED
}
let e0 = memo((e) => {
  let {
    element,
  ...
  let {
    ...
    let U = useCallback(() => {
      ...
      if (o(k
        ? activateCommentThreadInternal(a)
        : switchOrDeactivateCommentThread({
            ...a,
  ...
  let er = m
    ? getI18nString("comments.aria_label_select_comment_descriptive_unread", {
  ...
  return jsx(Fragment, {
    children: getFeatureFlags().fpl_card_primitive_migration
      ? jsxs(bL, {
...
function e2(e) {
  ...
  let m = useCallback(e => elements.length === 0 ? 0 : c.current.get(e) || estimatedSize, [elements, estimatedSize])
...
let tt = forwardRef((e, t) => {
  ...
  let f = useCallback((e) => {
    e.key === "Enter" && onClearSearchKeyDown(e)
    e.stopPropagation()
  }, [onClearSearchKeyDown])
  return jsx("div", {
    className: "sidebar_search--searchContainer--eU94N",
    children: getFeatureFlags().a11y_comments_search
      ? jsx(_$$D, {
          "ref": searchInputRef,
...
let tl = createOptimistThunk((e, t) => {
  ...
  t.id
    ...
    : o && getCurrentLiveGraphClient()?.optimisticallyCreate({
      FileFollower: {
        [`optimistic-id-${t.key}`]: {
          key: t.key,
          userId: o,
...
function tp() {
  ...
  let C = (o) => {
    ...
    n?.data?.id
      ...
      : t?.id && getCurrentLiveGraphClient()?.optimisticallyCreate({
        FileFollower: {
          [`optimistic-id-${e}`]: {
            key: e,
            userId: t.id,
...
function tg(e) {
  ...
  return (useEffect(() => {
    if (d !== manager.isOpen) {
      if (r)
        return l("SELECT_COMMENT_SIDEBAR")
      t(deactivateActiveComment())
    }
  }, [t, r, manager.isOpen, d, l]), e.hideSettingsDropdown)
    ? null
    : jsxs(MenuRootComp, {
        manager,
        children: [jsx(DialogTriggerButton, {
...
function tj(e) {
  return e.hasActiveQuery
    ? jsx(tw, {
        message: getFeatureFlags().a11y_comments_search
...
export function $$tT0(e) {
  ...
  return disableSidebar
    ...
    : jsxs("div", {
        ...
        "onKeyDown": (e) => {
          fullscreenValue.isReady() && e.key === "Escape" && fullscreenValue.triggerAction("set-tool-default")
          tP(e)
        },
        "onMouseDown": tP,
        "ref": U,
        ...
        "children": [jsx(ty, {
          ...
          isLoading: filteredSidebarItems.status === "loading",
          children: () => jsx(tk, {
