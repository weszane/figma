...
function R(e) {
  let t = useRef(null);
  let n = useResizeObserverRef(t) ?? initialSize;
  let i = function (e) {
    switch (e.display) {
      case "inline-flex":
...
let e0 = memo(e => {
  ...
  let {
    ...
    let b = _$$s3();
    let w = Kq(e);
    let j = useNavigateToViewport("comments_navigate");
    ...
    let U = useCallback(() => {
      ...
      if (o(k ? activateCommentThreadInternal(a) : switchOrDeactivateCommentThread({
        ...a,
