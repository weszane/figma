...
import { usePublishedPlugins, usePluginAllowlistValidation } from "../figma_app/844435";
...
export function $$y0(e) {
  ...
  } = usePluginAllowlistValidation(e.resource.plugin_id);
  return _$$t2(e, {
    insertAction: t => {
    ...
    onPointerDownCallback: () => {
      e.showRequestFlow || hasLocalFileId(e.resource) || M || setupPluginCodeCache.getAndCache(e.resource, n);
    },
