...
import { iZ as _$$iZ, ux, Zb } from '../905/29425'
...
let er = memo((e) => {
  ...
  let eV = useCallback((e, t) => ev
    ? () => Promise.resolve(ex('COMMENT_PIN_CLICK'))
    : async () => {
  ...
  let tc = useCallback((e) => {
    ...
    !e9 && e.key === 'Escape' && _$$iZ?.getFocusedClusterId() && td.current?.focus()
  }, [tl, tr, ts, e9])
  return jsxs(_$$p, {
    children: [
      ej && !!to && jsx(ue, {
