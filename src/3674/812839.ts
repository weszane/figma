...
let I = ex("hub_file_in_review", function (e) {
  let {
    url
  } = e;
  let n = Gc(e => {
...
let E = ex("hub_file_info", function (e) {
  let {
    lastPublishedAt,
    url
  } = e;
...
let C = ex("hub_file_info_unverified", function (e) {
  let {
    verificationStatus
  } = e;
  return jsx("div", {
...
export function $$G0() {
  ...
  let t = aV();
  let n = d4(e => e.mirror.appModel.showUi);
