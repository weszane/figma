...
export function $$_0(e) {
  ...
  return jsx("div", {
    style: t,
    className: l()("nav_container--flexContainer--3Us-2 nav_container--baseContainer--QideS overflow--overflowYAuto--nfK38 overflow--momentumScroll--qtsu7", jsFullscreenPreventEventCapture, e.className),
    children: e.children
  });
}
export const K = $$_0;