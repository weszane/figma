...
let $$el0 = forwardRef(({
  ...
  let eV = e !== 'buzz' && getFeatureFlags().slides_editor_a11y ? eO ? getI18nString('slides.carousel.item_aria_label_slides_skipped') : getI18nString('slides.carousel.item_aria_label_slides', {
    number: number ?? ''
