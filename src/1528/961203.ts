...
import { AnimationEventType, AppStateTsApi, InteractionCpp, SlideConstantsCppBindings, SlideTransitionType } from '../figma_app/763686'
import { useIsSelectedViewFullscreenCooper } from '../figma_app/828186'
import { generateRecordingKey, useHandleChangeEvent, useHandleKeyboardEvent } from '../figma_app/878298'
...
function U(e) {
  ...
  if (!r && !carouselSlide.isCollapsed)
    return null
    ...
    children: [e
      ? jsx(ButtonPrimitive, {
        ...
        'style': {
          ...
          transform: e === 'EXPANDED' ? `rotate(0deg) translateX(${s && s > 9 ? '2px' : '0'})` : 'rotate(-90deg) translateX(0)',
...
let $$el0 = forwardRef(({
  ...
  let eI = (function (e) {
    ...
    let n = t != null && (t.type !== SlideTransitionType.NONE || t.trigger.type === AnimationEventType.AFTER_DELAY)
  ...
  let eV = e !== 'buzz' && getFeatureFlags().slides_editor_a11y
    ? eO
      ? getI18nString('slides.carousel.item_aria_label_slides_skipped')
      : getI18nString('slides.carousel.item_aria_label_slides', {
        number: number ?? '',
      })
    : getI18nString('cooper.carousel.item_aria_label')
  let e$ = eA && g > 0 && !X
  return jsxs(Fragment, {
    children: [eA && (!eg || g <= 0 || J)
      ? jsx('div', {
      ...
      : null, jsxs(_$$_2.Item, {
        ...
        'children': [J && isCollapsed && children.length > 0 && jsx('div', {
          ...
          'recordingKey': M,
          'style': J
            ? styleBuilderInstance.relative.add({
            ...
            : styleBuilderInstance.relative.if(eP, {
              ...
              borderTopLeftRadius: eH,
              borderTopRightRadius: eH,
            }).if(_ || Y && eD || (eK === 'COLLAPSED' || void 0 === eK) && eb && b === 1, {
              borderBottomLeftRadius: eH,
              borderBottomRightRadius: eH,
            }).if(e === 'buzz' && !J && !u && c && !eR, {
              borderTopLeftRadius: eH,
          ...
          : jsx(RecordableButton, {
            ...
            style: {
              justifySelf: 'center',
              transition: 'transform 0.25s',
              transform: eK === 'EXPANDED' ? `rotate(0deg) translateX(${number && number > 9 ? '2px' : '0'})` : 'rotate(-90deg) translateX(0)',
              top: '28px',
              left: '0',
            },
...
function ec({
  ...
  let r = e === 1 ? ['var(--elevation-100-canvas)'] : ['var(--elevation-200-canvas)', 'var(--elevation-100-canvas)']
