import { hasCommandModifier, isCtrlKeyCommand } from "../vendor/317994";
import { RETURN, DELETE, BACKSPACE, LEFT, RIGHT } from "../vendor/685920";
import { isPlatform, isBrowser } from "../vendor/42266";
var a = isPlatform("Mac OS X");
var s = a && isBrowser("Firefox < 29");
var u = hasCommandModifier;
var c = isCtrlKeyCommand;
function l(t) {
