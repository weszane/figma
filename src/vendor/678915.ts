...
export function $$k0(e) {
  ...
  if (r[0] !== O[0] || r[1] !== O[1] || r[2] !== O[2] || r[3] !== O[3] || r[4] !== O[4] || r[5] !== O[5] || r[6] !== O[6] || r[7] !== O[7] || r[8] !== O[8] || r[9] !== O[9] || r[10] !== O[10] || r[11] !== O[11]) throw Error("Missing KTX 2.0 identifier.");
  let n = new y();
  ...
  for (let r = 0; r < o; r++) n.levels.push({
