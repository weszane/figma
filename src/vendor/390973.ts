...
let O = {
  ...
  set: (e, r, n) => (e[r] = n, !0),
  has: (e, r) => e instanceof IDBTransaction && (r === 'done' || r === 'store') || r in e,
}
function x(e) {
  O = e(O)
}
...
function k(e) {
  return typeof e == 'function' ? w(e) : (e instanceof IDBTransaction && b(e), o(e, a())) ? new Proxy(e, O) : e
}
function _(e) {
...
let I = new Map()
function P(e, r) {
  if (!(e instanceof IDBDatabase && !(r in e) && typeof r == 'string'))
    return
  if (I.get(r))
    return I.get(r)
...
export const MR = deleteDB
export const P2 = openDB
