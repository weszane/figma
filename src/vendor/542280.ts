import r, { TV, Dz, sq, C0, Sg, _3, nI, B1, LI, Jx, T9, jk, RI, PG, qE, bV, WJ, lP, w7 } from "../vendor/759447";
import { L9, sb, vq, zk, Tc, _m, CP, ep, Tf, $4, eu, Lv, sQ, gJ, mq, ZU, v9 } from "../vendor/535641";
function i(e, t, n) {
  let i;
  let {
    reference,
...
let A = async (e, t, n) => {
  ...
  for (let n = 0; n < a.length; n++) {
    ...
    reset && h <= 50 && (h++, "object" == typeof reset && (reset.placement && (f = reset.placement), reset.rects && (u = !0 === reset.rects ? await platform.getElementRects({
      reference: e,
      floating: t,
      strategy
    }) : reset.rects), {
...
async function o(e, t) {
  ...
  let h = nI(padding);
  let p = elements[altBoundary ? "floating" === elementContext ? "reference" : "floating" : elementContext];
  let C = B1(await platform.getClippingRect({
    element: null == (n = await platform.isElement?.(p)) || n ? p : p.contextElement || (await platform.getDocumentElement?.(elements.floating)),
    boundary,
    rootBoundary,
    strategy
  }));
  let I = "floating" === elementContext ? {
    ...rects.floating,
    x,
    y
  } : rects.reference;
  ...
  let m = B1(platform.convertOffsetParentRelativeRectToViewportRelativeRect ? await platform.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements,
    rect: I,
    offsetParent: E,
    strategy
...
async function s(e, t) {
  ...
  a && "number" == typeof alignmentAxis && (d = "end" === a ? -1 * alignmentAxis : alignmentAxis);
  return l ? {
    x: crossAxis * g,
    y: mainAxis * u
  } : {
...
function C(e, t, n) {
  ...
  if ("viewport" === t) i = function (e, t) {
  ...
  }(e, n);else if ("document" === t) i = function (e) {
    let t = ep(e);
    let n = CP(e);
    ...
    let l = -n.scrollTop;
    "rtl" === L9(i).direction && (s += T9(t.clientWidth, i.clientWidth) - A);
    return {
      width: A,
      height: o,
      x: s,
  ...
  }(ep(e));else if (vq(t)) i = function (e, t) {
    let n = d(e, !0, "fixed" === t);
...
function I(e) {
  return "static" === L9(e).position;
}
function E(e, t) {
  if (!sb(e) || "fixed" === L9(e).position) return null;
  if (t) return t(e);
...
let y = {
  convertOffsetParentRelativeRectToViewportRelativeRect: function (e) {
    ...
    if ((h || !h && !o) && (("body" !== mq(offsetParent) || ZU(s)) && (u = CP(offsetParent)), sb(offsetParent))) {
  ...
  getClippingRect: function (e) {
    ...
    let o = [...("clippingAncestors" === boundary ? Tf(element) ? [] : function (e, t) {
      let n = t.get(e);
      if (n) return n;
      let r = v9(e, [], !1).filter(e => vq(e) && "body" !== mq(e));
      let i = null;
      let A = "fixed" === L9(e).position;
      let o = A ? $4(e) : e;
      for (; vq(o) && !eu(o);) {
        let t = L9(o);
        let n = sQ(o);
        n || "fixed" !== t.position || (i = null);
        (A ? !n && !i : !n && "static" === t.position && !!i && ["absolute", "fixed"].includes(i.position) || ZU(o) && !n && function e(t, n) {
          let r = $4(t);
          return !(r === n || !vq(r) || eu(r)) && ("fixed" === L9(r).position || e(r, n));
        }(e, o)) ? r = r.filter(e => e !== o) : i = t;
        o = $4(o);
      }
      t.set(e, r);
      return r;
    }(element, this._c) : [].concat(boundary)), rootBoundary];
    let s = o[0];
    let l = o.reduce((e, n) => {
  ...
  isElement: vq,
  isRTL: function (e) {
    return "rtl" === L9(e).direction;
  }
};
export function $$_1(e, t, n, i) {
  let A;
  void 0 === i && (i = {});
  let {
    ancestorScroll = !0,
  ...
  let p = f && layoutShift ? function (e, t) {
    let n;
    let i = null;
    let A = ep(e);
    function o() {
...
let $$D5 = function (e) {
  ...
  return {
    ...
    async fn(t) {
      ...
      let l = await s(t, e);
      return placement === (null == (n = middlewareData.offset) ? void 0 : n.placement) && null != (r = middlewareData.arrow) && r.alignmentOffset ? {} : {
        x: x + l.x,
        y: y + l.y,
        data: {
          ...l,
...
let $$b4 = function (e) {
  ...
  return {
    ...
    async fn(t) {
      ...
      if (null != (n = middlewareData.arrow) && n.alignmentOffset) return {};
      let y = C0(placement);
      ...
      fallbackPlacements || "none" === fallbackAxisSideDirection || D.push(...lP(initialPlacement, flipAlignment, fallbackAxisSideDirection, Q));
      let w = [initialPlacement, ...D];
      let b = await o(t, m);
      let v = [];
      let k = (null == (i = middlewareData.flip) ? void 0 : i.overflows) || [];
      ...
      if (k = [...k, {
        ...
        let e = ((null == (A = middlewareData.flip) ? void 0 : A.index) || 0) + 1;
        let t = w[e];
        if (t) return {
          data: {
            index: e,
        ...
        let n = null == (s = k.filter(e => e.overflows[0] <= 0).sort((e, t) => e.overflows[1] - t.overflows[1])[0]) ? void 0 : s.placement;
        if (!n) switch (fallbackStrategy) {
          case "bestFit":
            {
...
let $$v7 = function (e) {
  ...
  return {
    ...
    async fn(t) {
      ...
      let f = C0(placement);
      let d = Sg(placement);
      let h = "y" === TV(placement);
      let {
        width,
        height
      } = rects.floating;
      "top" === f || "bottom" === f ? (n = f, i = d === ((await platform.isRTL?.(elements.floating)) ? "start" : "end") ? "left" : "right") : (i = f, n = "end" === d ? "top" : "bottom");
      let I = height - c[n];
      let E = width - c[i];
      ...
      if (B && !d) {
        ...
        let n = T9(c.top, 0);
        let i = T9(c.bottom, 0);
        h ? y = width - 2 * (0 !== e || 0 !== t ? e + t : T9(c.left, c.right)) : m = height - 2 * (0 !== n || 0 !== i ? n + i : T9(c.top, c.bottom));
      }
      await apply({
        ...t,
        availableWidth: y,
...
let $$k0 = e => ({
  ...
  async fn(t) {
    ...
    let v = qE(Q, b, w);
    let k = !middlewareData.arrow && null != Sg(placement) && b !== v && rects.reference[h] / 2 - (b < Q ? Q : D) - p[h] / 2 < 0;
