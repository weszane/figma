...
let d = {}
let s = []
let c = /acit|ex(?:[sgnp]|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i
function h(e, n) {
...
function g(e, n, i) {
  ...
  let a
  let o = {}
  for (a in n) a == 'key' ? t = n[a] : a == 'ref' ? r = n[a] : o[a] = n[a]
  if ($$arguments.length > 2 && (o.children = $$arguments.length > 3 ? f.call(arguments, 2) : i), typeof e == 'function' && e.defaultProps != null) {
...
function w() {
  for (var e; w.__r = o.length;) {
    ...
    e.some((e) => {
      ...
      let f
      let r
      e.__d && (f = (t = e.__v).__e, (r = e.__P) && (n = [], (i = h({}, t)).__v = t.__v + 1, L(r, t, i, e.__n, void 0 !== r.ownerSVGElement, t.__h != null ? [f] : null, n, f, t.__h), N(n, t), t.__e != f && (function e(n) {
        let i
        let t
        if ((n = n.__) != null && n.__c != null) {
          for (n.__e = n.__c.base = null, i = 0; i < n.__k.length; i++) {
            if ((t = n.__k[i]) != null && t.__e != null) {
...
function k(e, n, i, t, f, a, o, u, l, c) {
  ...
  let x = t && t.__k || s
  let C = x.length
  for (i.__k = [], h = 0; h < n.length; h++) {
    if ((v = i.__k[h] = n[h] || typeof v == 'boolean'
      ? null
      : typeof v == 'string' || typeof v == 'number' || typeof v == 'bigint'
        ...
        : Array.isArray(v)
          ...
          : v.__b > 0 ? m(v.type, v.props, v.key, null, v.__v) : v) != null) {
      if (v.__ = i, v.__b = i.__b + 1, x[h] || b && v.key == b.key && v.type === b.type) {
        x[h] = void 0
      }
      else {
        for (g = 0; g < C; g++) {
      ...
      w != null
        ? (k == null && (k = w), typeof v.type == 'function' && v.__k === b.__k
            ? v.__d = l = (function e(n, i, t) {
              for (r = n.__k, a = 0, void 0; r && a < r.length; a++) {
                var f
                var r
                var a;
                (f = r[a]) && (f.__ = n, i = typeof f.type == 'function' ? e(f, i, t) : E(t, f, f, r, f.__e, i))
              }
              return i
            }(v, l, e))
            : l = E(e, v, b, x, w, l), typeof i.type == 'function' && (i.__d = l))
        : l && b.__e == l && l.parentNode != e && (l = y(b))
    }
  }
  for (i.__e = k, h = C; h--;) {
    x[h] != null && (typeof i.type == 'function' && x[h].__e != null && x[h].__e == i.__d && (i.__d = y(t, h + 1)), (function e(n, i, t) {
      let f
      let a
      if (r.unmount && r.unmount(n), (f = n.ref) && (f.current && f.current !== n.__e || O(f, null, i)), (f = n.__c) != null) {
      ...
      if (f = n.__k) {
        for (a = 0; a < f.length; a++) f[a] && e(f[a], i, typeof n.type != 'function')
      }
      t || n.__e == null || p(n.__e)
      n.__e = n.__d = void 0
    }(x[h], x[h])))
  }
  if (S) {
...
function S(e, n) {
  n = n || []
  e == null || typeof e == 'boolean' || (Array.isArray(e)
    ? e.some((e) => {
        S(e, n)
      })
    : n.push(e))
...
function E(e, n, i, t, f, r) {
  ...
  else if (i == null || f != r || f.parentNode == null) {
    i: if (r == null || r.parentNode !== e) {
      e.appendChild(f)
      a = null
    }
    else {
      for (o = r, u = 0; (o = o.nextSibling) && u < t.length; u += 2) {
        if (o == f)
          break i
      }
      e.insertBefore(f, r)
...
function x(e, n, i) {
  n[0] === '-' ? e.setProperty(n, i) : e[n] = i == null ? '' : typeof i != 'number' || c.test(n) ? i : `${i}px`
}
  ...
  i: if (n === 'style') {
    if (typeof i == 'string') {
      ...
      if (typeof t == 'string' && (e.style.cssText = t = ''), t) {
        for (n in t) i && n in i || x(e.style, n, '')
      }
      if (i) {
        for (n in i) t && i[n] === t[n] || x(e.style, n, i[n])
      }
    }
  }
  else if (n[0] === 'o' && n[1] === 'n') {
    ...
    typeof i == 'function' || (i != null && (!1 !== i || n[0] === 'a' && n[1] === 'r') ? e.setAttribute(n, i) : e.removeAttribute(n))
  }
}
function T(e) {
...
function L(e, n, i, t, a, o, u, l, s) {
  ...
  if (void 0 !== n.constructor)
    return null
  i.__h != null && (s = i.__h, l = n.__e = i.__e, n.__h = null, o = [l]);
  (c = r.__b) && c(n)
  try {
    i: if (typeof N == 'function') {
      if (x = n.props, T = (c = N.contextType) && t[c.__c], P = c ? T ? T.props.value : c.__ : t, i.__c ? E = (g = n.__c = i.__c).__ = g.__E : ('prototype' in N && N.prototype.render ? n.__c = g = new N(x, P) : (n.__c = g = new b(x, P), g.constructor = N, g.render = A), T && T.sub(g), g.props = x, g.state || (g.state = {}), g.context = P, g.__n = t, m = g.__d = !0, g.__h = []), g.__s == null && (g.__s = g.state), N.getDerivedStateFromProps != null && (g.__s == g.state && (g.__s = h({}, g.__s)), h(g.__s, N.getDerivedStateFromProps(x, g.__s))), v = g.props, w = g.state, m) {
        N.getDerivedStateFromProps == null && g.componentWillMount != null && g.componentWillMount()
        g.componentDidMount != null && g.__h.push(g.componentDidMount)
      }
      else {
        if (N.getDerivedStateFromProps == null && x !== v && g.componentWillReceiveProps != null && g.componentWillReceiveProps(x, P), !g.__e && g.shouldComponentUpdate != null && !1 === g.shouldComponentUpdate(x, g.__s, P) || n.__v === i.__v) {
          g.props = x
          g.state = g.__s
          n.__v !== i.__v && (g.__d = !1)
          g.__v = n
        ...
        g.componentWillUpdate != null && g.componentWillUpdate(x, g.__s, P)
        g.componentDidUpdate != null && g.__h.push(() => {
      ...
      g.state = g.__s
      g.getChildContext != null && (t = h(h({}, t), g.getChildContext()))
      m || g.getSnapshotBeforeUpdate == null || (S = g.getSnapshotBeforeUpdate(v, w))
      L = c != null && c.type === _ && c.key == null ? c.props.children : c
      ...
      o == null && n.__v === i.__v
        ...
        : n.__e = (function (e, n, i, t, r, a, o, u) {
          let l
          let s
          let c
          let h = i.props
          ...
          if (m === 'svg' && (r = !0), a != null) {
            for (; _ < a.length; _++) {
              if ((l = a[_]) && 'setAttribute' in l == !!m && (m ? l.localName === m : l.nodeType === 3)) {
                e = l
                a[_] = null
                break
              }
          ...
          if (m === null) {
            ...
            if ((function (e, n, i, t, f) {
              let r
              for (r in i) r === 'children' || r === 'key' || r in n || C(e, r, null, i[r], t)
              for (r in n) f && typeof n[r] != 'function' || r === 'children' || r === 'key' || r === 'value' || r === 'checked' || i[r] === n[r] || C(e, r, n[r], i[r], t)
            }(e, g, h, r, u)), c) {
              n.__k = []
            }
            else if (_ = n.props.children, k(e, Array.isArray(_) ? _ : [_], n, i, t, r && m !== 'foreignObject', a, o, a ? a[0] : i.__k && y(i, 0), u), a != null) {
              for (_ = a.length; _--;) a[_] != null && p(a[_])
            }
            u || ('value' in g && void 0 !== (_ = g.value) && (_ !== h.value || _ !== e.value || m === 'progress' && !_) && C(e, 'value', _, h.value, !1), 'checked' in g && void 0 !== (_ = g.checked) && _ !== e.checked && C(e, 'checked', _, h.checked, !1))
          }
          return e
        }(i.__e, n, i, t, a, o, u, s))
    }
    ...
    n.__v = null;
    (s || o != null) && (n.__e = l, n.__h = !!s, o[o.indexOf(l)] = null)
    r.__e(e, n, i)
  }
}
function N(e, n) {
...
function M(e, n, i) {
  ...
  let o
  r.__ && r.__(e, n)
  a = (t = typeof i == 'function') ? null : i && i.__k || n.__k
  o = []
...
r = {
  __e(e, n) {
    for (void 0; n = n.__;) {
      ...
      if ((i = n.__c) && !i.__) {
        try {
          if ((t = i.constructor) && t.getDerivedStateFromError != null && (i.setState(t.getDerivedStateFromError(e)), f = i.__d), i.componentDidCatch != null && (i.componentDidCatch(e), f = i.__d), f)
            return i.__E = i
        }
        catch (n) {
          e = n
...
b.prototype.setState = function (e, n) {
  let i
  i = this.__s != null && this.__s !== this.state ? this.__s : this.__s = h({}, this.state)
  typeof e == 'function' && (e = e(h({}, i), this.props))
  e && h(i, e)
  e != null && this.__v && (n && this.__h.push(n), v(this))
}
...
o = []
u = typeof Promise == 'function' ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout
w.__r = 0
let R = 0
function j(e, n, i, t, f) {
  ...
  let o
  let u = {}
  for (o in n) o == 'ref' ? a = n[o] : u[o] = n[o]
  let l = {
    type: e,
    props: u,
    key: i,
  ...
  if (typeof e == 'function' && (a = e.defaultProps)) {
    for (o in a) void 0 === u[o] && (u[o] = a[o])
  }
  r.vnode && r.vnode(l)
  return l
}
async function I(e = 1) {
  for (let n in [...new Array(e).keys()]) await new Promise(requestAnimationFrame)
}
function get(e) {
  try {
...
let F = {
  add(e) {
    U || (U = Store.get('frequently') || {})
    let n = e.id || e
    n && (U[n] || (U[n] = 0), U[n] += 1, Store.set('last', n), Store.set('frequently', U))
  },
  get({
    maxFrequentRows: e,
    perLine: n,
    ...
    if (i.sort((e, n) => {
      ...
      f && !i.includes(f) && (delete U[i[i.length - 1]], i.splice(-1, 1, f))
      Store.set('frequently', U)
    }
    return i
  },
}
...
function q(e, {
  ...
  for (let e of i) {
    ...
    for (let n of (t = [], f = {}, r)) {
      ...
      i != -1 && (t.push(n), f[n.id] || (f[n.id] = 0), f[n.id] += n.id == e ? 0 : i + 1)
    }
    r = t
  }
...
let SearchIndex = {
  async search(e, {
    ...
    return e && e.trim().length
      ? (n || (n = 90), await init(), q(e, {
          maxResults: n,
        }))
      : null
  },
  searchSynchronized(e, {
    maxResults: n,
  } = {}) {
    return e && e.trim().length
      ? (n || (n = 90), init(), q(e, {
    ...
    let t = (function (e, n) {
      ...
      for (let t in X) {
        i[t] = (function (i) {
          ...
          f != null && t.value && typeof t.value != typeof f && (f = typeof t.value == 'boolean' ? f != 'false' : t.value.constructor(f));
          (f == null || t.choices && !t.choices.includes(f)) && (f = t.value)
          return f
        }(t))
      }
      return i
...
function en(e) {
  ...
  if (!emoji && !id && shortcodes) {
    let e = shortcodes.match(SearchIndex.SHORTCODES_REGEX)
    e && (n = e[1], e[2] && (i = e[2]))
  }
  if (emoji || (f = SearchIndex.get(id)), !emoji || emoji.id === 'female_sign' || emoji.id === 'male_sign')
    return e.fallback
...
r.diffed = function (e) {
  es && es(e)
  let n = e.__c
  n && n.__H && n.__H.__h.length && (eu.push(n) !== 1 && eo === r.requestAnimationFrame || ((eo = r.requestAnimationFrame) || function (e) {
    let n
    let i = function () {
      clearTimeout(t)
...
r.__e = function (e, n, i) {
  if (e.then) {
    for (f = n, void 0; f = f.__;) {
      ...
      var f
      if ((t = f.__c) && t.__c) {
        n.__e == null && (n.__e = i.__e, n.__k = i.__k)
        return t.__c(e, n)
      }
    }
  }
    ...
    if (!--t.__u) {
      if (t.state.__e) {
        ...
        t.__v.__k[0] = (function e(n, i, t) {
          n && (n.__v = null, n.__k = n.__k && n.__k.map((n) => {
            return e(n, i, t)
...
eS.prototype.render = function (e, n) {
  if (this.__b) {
    if (this.__v.__k) {
      ...
      let t = this.__v.__k[0].__c
      this.__v.__k[0] = (function e(n, i, t) {
        n && (n.__c && n.__c.__H && (n.__c.__H.__.forEach((e) => {
          typeof e.__c == 'function' && e.__c()
        }), n.__c.__H = null), (n = (function (e, n) {
          for (let i in n) e[i] = n[i]
          return e
        }({}, n))).__c != null && (n.__c.__P === t && (n.__c.__P = i), n.__c = null), n.__k = n.__k && n.__k.map((n) => {
          return e(n, i, t)
        }))
        return n
  ...
  let f = n.__e && g(_, null, e.fallback)
  f && (f.__h = null)
  return [g(_, null, n.__e ? null : e.children), f]
}
let eC = function (e, n, i) {
  if (++i[1] === i[0] && e.o.$$delete(n), e.props.revealOrder && (e.props.revealOrder[0] !== 't' || !e.o.size)) {
    for (i = e.u; i;) {
...
ex.prototype.render = function (e) {
  ...
  for (let i = n.length; i--;) this.o.set(n[i], this.u = [1, 0, this.u])
  return e.children
}
...
let eT = typeof Symbol != 'undefined' && Symbol.$$for && Symbol.$$for('react.element') || 60103
let eP = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?![HWU])|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/
let eL = typeof document != 'undefined'
b.prototype.isReactComponent = {};
['componentWillMount', 'componentWillReceiveProps', 'componentWillUpdate'].forEach((e) => {
...
r.vnode = function (e) {
  ...
  if (typeof i == 'string') {
    ...
    for (let a in f = {}, t) {
      let o = t[a]
      eL && a === 'children' && i === 'noscript' || a === 'value' && 'defaultValue' in t && o == null || (a === 'defaultValue' && 'value' in t && t.value == null ? a = 'value' : a === 'download' && !0 === o ? o = '' : /ondoubleclick/i.test(a) ? a = 'ondblclick' : /^onchange(textarea|input)/i.test(a + i) && (n = t.type, !(typeof Symbol != 'undefined' && typeof Symbol() == 'symbol' ? /fil|che|rad/i : /fil|che|ra/i).test(n)) ? a = 'oninput' : /^onfocus$/i.test(a) ? a = 'onfocusin' : /^onblur$/i.test(a) ? a = 'onfocusout' : /^on(Ani|Tra|Tou|BeforeInp)/.test(a) ? a = a.toLowerCase() : r && eP.test(a) ? a = a.replace(/[A-Z0-9]/, '-$&').toLowerCase() : o === null && (o = void 0), f[a] = o)
    }
    i == 'select' && f.multiple && Array.isArray(f.value) && (f.value = S(t.children).forEach((e) => {
      e.props.selected = f.value.includes(e.props.value)
    }))
    i == 'select' && f.defaultValue != null && (f.value = S(t.children).forEach((e) => {
      e.props.selected = f.multiple ? f.defaultValue.includes(e.props.value) : f.defaultValue == e.props.value
    }))
    e.props = f
    t.$$class != t.className && (eR.enumerable = 'className' in t, t.className != null && (f.$$class = t.className), Object.defineProperty(f, 'className', eR))
  }
  e.$$typeof = eT
  ej && ej(e)
}
...
class Picker extends b {
  constructor(e) {
    super()
    this.state = {
      pos: [-1, -1],
      skin: Store.get('skin') || e.skin,
  ...
  handleBaseKeydown = (e) => {
    this.state.showSkins && e.key == 'Escape' && (e.preventDefault(), e.stopImmediatePropagation(), this.closeSkins(), this.refs.skinToneButton.current.focus())
  }
  ...
  observeRows() {
    ...
    for (let {
      ...
      for (let i of rows) i.current && n.observe(i.current)
    }
  }
  ...
  handleSearchInput = async () => {
    ...
    let i = await SearchIndex.search(value)
    let t = () => {
  ...
  handleKeyDown = (e) => {
    e.stopImmediatePropagation()
    e.key === 'Escape' && this.props.onEscapeKeydown && this.props.onEscapeKeydown()
  }

  handleSearchKeyDown = (e) => {
    if (e.stopImmediatePropagation(), e.key === 'Enter') {
  ...
  scrollTo({
    ...
    if (n >= 0 && (e = i[n].__categoryId), e && (r = (this.refs[e] || this.refs.categories.get(e).root).current.getBoundingClientRect().top - (f.top - t.scrollTop) + 1), n >= 0) {
      if (n) {
        ...
        let a = e + this.props.emojiButtonSize + 0.88 * this.props.emojiButtonSize
        if (e < t.scrollTop) {
          r = e
        }
        else {
  ...
  renderEmojiButton(e, {
    ...
    return j(eB, {
      ...
      children: j('button', {
        ...
        'title': this.props.previewPosition == 'none' ? e.id : void 0,
        'type': 'button',
  ...
  renderSkins() {
    ...
    this.props.previewPosition == 'bottom' ? i.bottom = n.bottom - e.top + 4 : (i.top = e.bottom - n.top + 3, i.bottom = 'auto')
    return j('div', {
      'ref': this.refs.menu,
      'role': 'radiogroup',
      ...
      'style': i,
      'children': [...Array.from({ length: 6 }).keys()].map((e) => {
        let n = e + 1
        ...
        return j('div', {
          children: [j('input', {
            ...
            'onKeyDown': (e) => {
              e.code != 'Enter' && e.code != 'Space' && e.code != 'Tab' || (e.preventDefault(), this.handleSkinClick(n), this.refs.skinToneButton.current.focus())
            },
          }), j('button', {
            'aria-hidden': 'true',
            'tabindex': '-1',
  ...
  render() {
    return j('section', {
      ...
      'onKeyDown': this.handleKeyDown,
      'children': [this.props.previewPosition == 'top' && this.renderPreview(), this.props.navPosition == 'top' && this.renderNav(), this.props.stickySearch && j('div', {
        class: 'padding-lr',
...
export class EmojiElement extends et {
  constructor(e) {
    super(e, {
      styles: t(eU),
    })
...
'customElements' in window && !customElements.get('em-emoji-picker-15') && customElements.define('em-emoji-picker-15', EmojiElement)
var eU = {}
...
export const LC = EmojiElement
export const dN = SearchIndex
export const il = Store
