...
import { td as _$$td, Rq } from '../figma_app/181241'
...
import { i as _$$i, tJ as _$$tJ, NT } from '../figma_app/741237'
...
import { Egt, Ez5, FAf, fZl, glU, ibQ, IPu, kul, lyf, m1T, NLJ, nQ7, nzw, Oin, rrT, ruz, rXF, t2E, Z64 } from '../figma_app/763686'
import { wV } from '../figma_app/779965'
import { parsePxInt, parsePxNumber } from '../figma_app/783094'
import { aH as _$$aH, Pt } from '../figma_app/806412'
...
function X({
  ...
  return DD(n, {
    ...
    : jsx('div', {
        style: d,
        onMouseEnter: s,
        children: l || isInteractionPathCheck()
          ? jsx(Y, {
              viewportInfo: t,
              buzzFrameId: n,
    ...
    let v = useCallback(({
      ...
      function n() {
        b.forEach((e) => {
          ...
          t && e.paintIndex != null && (Ez5?.markContainingIndependentLayerNodesDirty(t.guid) || Ez5?.invalidateCanvas(), Ez5?.moveFromIndependentRenderLayer(t.guid), t.invalidateCanvasSpaceBoundsForSelfAndParents())
        })
      }
...
let eo = (e, t, n, l) => {
  if (e.length > 0) {
    ...
    let o = (e) => {
      CZ(e, 'EXPORT_PROGRESS')
        ? void 0 !== e.data.data.progressPercent && n(1)
        : CZ(e, 'EXPORT_COMPLETED') && (l('video_export_finished', {
...
function tz({
  ...
  let h = useMemo(() => x || u
    ? [{
        ...
        loading: u,
        text: c
          ? getI18nString('cooper.templates.from_plan_name', {
              planName: c,
            })
...
function tG({
  ...
  return t === J_.NO_QUERY_RESULTS
    ? renderI18nText('slides.templates.file_picker.no_files_match', {
        searchQuery: jsx('p', {
          className: _$$s.colorText.textBodyLargeStrong.$,
          children: e,
        }),
      })
    : t === J_.NO_RECENT_FILES
      ? jsx('h1', {
...
function nB() {
  ...
  return n?.status !== 'loaded' || n?.status === 'loaded' && n?.data
    ? null
    : jsx('div', {
...
function nX({
  ...
  let v = useCallback(() => {
    j && y.length === 0 && r(ky())
    n(t.type === mF.TEMPLATES
      ? t.parentView
      : {
          type: mF.ALL,
        })
  }, [j, y, r, n, t])
  if (x.status !== 'loaded' || u)
    return jsx(_$$ah, {})
  ...
  return jsxs(Fragment, {
    children: [jsx(tQ, {
      ...
      className: ns,
      children: [jsx(nB, {}), E.length === 1 && E[0]
        ? jsx('div', {
            className: 'xyamay9',
            children: jsx(nq, {
              library: T,
...
function nQ({
  ...
  let {
    ...
    insertionCallback: (n, l, r) => {
      let o
      n.length === 1 && (o = fZl?.getCooperTemplateType(n[0]), i && _$$l2.user('set-community-asset-name-untitled', () => _$$i(n[0], getI18nString('cooper.templates.new_asset'))))
      y(n, l, r)
...
function n8({
  ...
  return (r?.status !== 'loaded' || r?.status === 'loaded' && r?.data) && n
    ? null
    : t
      ? jsx('div', {
          className: 'x2iayur',
...
function le({
  ...
  return jsx(EI, {
    name,
    label: d
      ? getI18nString('cooper.templates.by_author', {
          author: d,
        })
      : void 0,
...
function lj({
  ...
  let t = e
    ? renderI18nText('cooper.templates.couldnt_find_templates_error', {
        searchTerm: jsx('span', {
      ...
      ? jsx(Fragment, {
          children: e.data.map(e => jsx('div', {
            ...
            children: jsx(lK, {
              ...
              teamId: e.teamId,
              onSeeAllClick: e.totalTemplatesByTeam > YS
                ? () => a({
                    type: mF.TEAM,
                    teamId: e.teamId,
...
function iS() {
  let e = (function () {
    let e = ik()
    return e ? e.type === 'MIXED_PAINT' ? _$$oV : e.paint.type === 'IMAGE' ? [e.paint, e.index] : void 0 : e
  }())
...
function ik() {
  ...
  return (function (e, t, n) {
    ...
    for (let e = t.length - 1; e >= 0; e--) {
      let l = t[e]
      if ((!(n && hS(n)) || n.opacity === 1 || n.id !== l.id) && i_.includes(l.type) && l.visible && l.opacity === 1) {
        return {
          type: 'SINGLE_PAINT',
          paint: l,
          index: e,
...
let oO = memo(({
  ...
  useEffect(() => {
    !E && (ea.current
      ? (q.scrollToOffset(ea.current.scrollTop), ea.current.fauxFocusIndex && eo({
          id: ea.current.fauxFocusIndex,
        }))
      : (er(Math.max(Q, 0)), eo({
          id: Q,
  ...
  let eu = useCallback(async (t, n = !0, i = !0) => {
    if (getFeatureFlags().dse_sf_pro_font && !(await Cj(t, ec, r, e, 'font_picker')))
      return
    ...
    children: [jsxs('div', {
      ...
      children: V.length > 0
        ...
        : (() => {
            ...
            let e = X ? _$$A0 : _$$A10
            let t = X
              ? renderI18nText('fullscreen.properties_panel.font_picker.org_upsell')
              : G
                ? renderI18nText('fullscreen.properties_panel.font_picker.no_shared_fonts_orgname', {
                    orgName: G.name,
                  })
...
let oF = memo(({
  ...
  return jsxs(_$$S2.recordableButton, {
    ...
    'children': [n
    ...
    }), getFeatureFlags().ce_show_gf_new_badge && Uw.has(e.previewPath) && g !== _$$O3.IS_LOADING
      ? jsx('div', {
          className: oC,
          children: jsx('div', {
            className: oA,
      ...
      : '', e.recentlyInstalled && g !== _$$O3.IS_LOADING
      ? jsx('div', {
          className: oC,
          children: jsx('div', {
            className: oA,
...
function an({
  ...
  let {
    ...
    return useMemo(() => {
      let e = {
        fontFamily: gl(l) ? getI18nString('common.mixed') : E7(l),
        isMixed: gl(l),
      }
      return styleIdForText
        ? gl(styleIdForText)
          ? {
...
function aN({
  ...
  let c = kl('locked')
  let u = !!(gl(c) || c)
  return topLevelActions || l || remainingSections || u
    ? jsxs(Fragment, {
        children: [l && jsx(aL, {
          aiActionSections: l,
...
function aw({
  ...
  return jsx(Fragment, {
    children: e.map((e, t) => e.type === 1 && e.asTopLevelAction
      ? e.asTopLevelAction()
      : jsx(_$$R4, {
          children: jsx(_$$E2, {
            name: e.trackingId,
...
function sc() {
  ...
  return useMemo(() => e.map((e) => {
    if (e.type === 'paint' && e.stylePaint.paint.color)
      return e.stylePaint.paint
...
function su() {
  ...
  return useCallback(() => {
    if (!e)
      return 'NONE'
    if (e.type === 'MIXED_PAINT')
      return e.fillsType === 'SOLID' ? 'SOLID' : 'MIXED'
    let t = e.paint.type
    if (!t)
      return 'NONE'
    switch (t) {
  ...
  return jsxs('div', {
    ...
    children: [ih.map((t, n) => jsx(sy, {
      children: jsx(sl, {
        ...
        opacity: 1,
        isSelected: !!(e && hS(e) && Vm(t, e?.color) && e.opacity === 1),
      }, n),
...
function sP() {
  ...
  return !(function () {
    let e = (function () {
      let e = ik()
      return e ? e.type === 'MIXED_PAINT' ? _$$oV : e.paint.type === 'VIDEO' ? [e.paint, e.index] : void 0 : e
    }())
    return !e || gl(e) ? null : e[0]
  }())
    ? null
...
function s6({
  ...
  !(function (e, t, n) {
    ...
    useEffect(() => {
      ...
      else if (gl(e) && p.current && Array.isArray(p.current) && p.current.length > 1) {
...
function ds({
  ...
  let r = useCallback(() => {
    e === m1T.RASTER
      ? (n(Lt(t, 90), zk.YES), _$$l2.user('image-rotate-clockwise', () => {
...
function dI() {
  ...
  return !onlyCooperFrames && e?.allStates && e?.selectedStates
    ? jsx(_$$R4, {
        children: jsx(_$$E2, {
...
function dw({
  ...
  useEffect(() => {
    let t = p.activeTab
    m !== t && t !== 'MIXED' && (t === 'NONE' && Y5.triggerActionInUserEditScope('remove-stroke'), r(e[t].dashPattern), m && m !== 'NONE' && m !== 'MIXED' || t === 'NONE' || n && i || Y5.triggerActionInUserEditScope('add-stroke-to-selection'))
...
function d$({
  ...
  return getFeatureFlags().buzz_video_export
    ? jsx(_$$R4, {
        children: jsx(_$$A7, {
          positionY: _$$j5,
          target: jsx(_$$E2, {
  ...
  return jsx(_$$k5, {
    ...
    children: jsxs(IA, {
      children: [jsx(dK, {}), jsxs('span', {
        ...
        'children': [m && jsx(dW, {}), !m && (hasInstanceSelected
          ? jsx(dX, {
              shownPanels: t,
...
function u4({
  ...
  let {
    ...
    let r = mediaPaint != null && hS(mediaPaint)
...
function xe({
  ...
  let s = gl(t) ? getI18nString('design_systems.component_properties.mixed') : t
  let d = useRef(null)
...
function xl() {
  ...
  let z = k !== m1T.TEXT || A.length === 0 ? void 0 : A
  let {
    mediaFieldsToShow,
    showAllMediaFields,
            ...
            children: [m && jsx(ug, {
              ...
              children: [jsxs('div', {
                ...
                : jsx(xr, {
                    ...
                    setShowAll: y,
                    text: j
                      ? getI18nString('cooper.properties_panel.fields.hide_text_fields', {
                          count: E - 4,
                        })
              ...
              children: [jsx(xi, {
                icon: jsx(_$$_5, {}),
                title: i
                  ? getI18nString('cooper.properties_panel.fields.media', {
                      numMedia: u.length,
                    })
                ...
                guid: e,
              }, e)), shouldNeverTruncateMediaFields
                ? null
                : jsx(xr, {
                    ...
                    text: i
                      ? showAllMediaFields
                        ? getI18nString('cooper.properties_panel.fields.hide_media_fields', {
                            count: u.length - 2,
                          })
                      ...
                      : showAllMediaFields
                        ? getI18nString('cooper.properties_panel.fields.hide_image_fields', {
                            count: u.length - 2,
                          })
...
function xx({
  ...
  let t = (function (e) {
    ...
    switch (e) {
      ...
      case _$$x.MEDIA:
        if (getFeatureFlags().buzz_unsplash)
          return l ? getI18nString('buzz.left_rail.image') : getI18nString('buzz.left_rail.media')
        if (getFeatureFlags().buzz_video_export)
          return getI18nString('cooper.left_rail.images_videos')
      ...
      case _$$x.BULK_CREATE:
        if (t === uO.MAP_DATA)
          return getI18nString('buzz.bulk_create.connect_data')
      ...
      if (s) {
        ...
        !(function (e, t, n, l) {
          ...
          if (o) {
            ...
            if (!t)
              throw new Error('No page found to append the image node.')
            t.appendChild(a)
          }
        }(r, l, p, n))
      }
...
function xH() {
  ...
  let {
    ...
    let u = !!d
    let x = u
      ? cm.UnsplashPaginatedSearchQuery({
          fileKey: e,
          query: d,
          per_page: 30,
        })
    ...
    (function (e, t, n, l) {
      ...
      let o = (function () {
        let e = useContext(ch)
        if (!e)
          throw new Error('useBuzzStockPhotosViewType must be used within a BuzzStockPhotosViewTypeContext')
        return e
      }())
...
function xY({
  ...
  return getFeatureFlags().buzz_unsplash
    ? jsx('div', {
...
function x4() {
  ...
  let [l, r] = (function (e) {
    ...
    useEffect(() => {
      ...
      i && i !== e
        ? t
          ? (n(i), r(!0), o.current = window.setTimeout(() => {
              n(_$$x.ASSETS)
              r(!1)
            }, 350))
          : (n(e), r(!1))
...
function x6({
  ...
  return jsxs(Fragment, {
    children: [jsx(VF, {
      ...
      children: () => getFeatureFlags().buzz_plugins
        ? jsx(cH, {
            positionerRef: t,
          })
        : jsx(cL, {
...
function pd() {
  ...
  return shouldShow
    ? jsx(_$$A16.IconButton, {
        ...
        badge,
      }, getI18nString('cooper.inserts.review_library_updates'))
    : null
}
...
function pI() {
  ...
  return (useEffect(() => {
    ...
    l !== FAf.COMMENT || UK().propertiesPanelSplitPosition.getCopy() !== 0 || u || UK().propertiesPanelSplitPosition.set(p.current?.offsetWidth || _$$R8.propertiesPanelSplitPosition)
  }, [l, x, i, u]), u)
    ? jsxs(noop, {
...
function pW({
  ...
  if (!e || gl(e))
    return renderI18nText('cooper.inline_menu.fill_panel.title')
  let t = bn(e.type)
  let n = _$$x$(e)
...
function p8({
  ...
  return jsx(_$$bL, {
    ...
    width: 240,
    ref: n,
    children: 'entireContentsOverride' in t
      ? t.entireContentsOverride
      : jsxs(vo, {
          children: [jsxs(Y9, {
            children: [jsx(hE, {
...
let mI = memo(({
  ...
  }, [d, c, l, x, s, m]), l !== _$$u.HIDDEN && l !== _$$u.SHOWN)
    ? null
    : jsx(_$$tH, {
...
let mS = memo(({
  ...
  let s = _$$tS()
  let d = r === _$$u.HIDDEN
  let c = useMemo(() => n?.initialViewerSize
    ? n.initialViewerSize
    : {
        x: 400,
        y: 400,
...
let mw = memo(({
  ...
  useEffect(() => {
    x && n && n.length === 1 && n[0] && !l && (IPu?.detachAndReplaceSymbolOnCommunityLoad(n[0]), r(!0))
  }, [x, n, l])
