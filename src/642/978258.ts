...
export function $$_0({
  ...
  let L = useSelectionPropertyValue("isTableSublayerSelected");
  f = Positioning.ABOVE;
...
function b({
  ...
  let K = useCallback((e, t, s) => {
    let [r, n] = B(e, t, s);
    return Rectangle.fromOriginAndSize(r, n, t.width, t.height);
  }, [B]);
  ...
  let H = useCallback((e, s, r, n) => {
    let i = Rectangle.fromOriginAndSize(t.x, t.y, t.width, t.height);
    let l = K(e, s, g);
    let a = R(l, i, n);
    let d = G(e, s, g, a, l);
    d === a || v || (a = R(d, i, n));
