...
import { bo, fg, Bs, ko } from "../figma_app/73698";
...
import { wV, S5, _m, RR, xc, W9, G3, aK, Cg, t6 as _$$t2, sH as _$$sH } from "../figma_app/647246";
import { F_ } from "../905/858282";
import { QI3 } from "../figma_app/6204";
import { j as _$$j } from "../642/323508";
import { T as _$$T } from "../642/794951";
import { CK, NB, r6 as _$$r } from "../figma_app/517115";
import { m as _$$m, w as _$$w } from "../642/720139";
import { JA, Ev } from "../figma_app/608944";
...
import { Nz, gO, dS } from "../figma_app/915774";
import { rp as _$$rp, PI } from "../figma_app/703988";
import { M3, q_ } from "../figma_app/119475";
import { ON, lM as _$$lM, tM as _$$tM, nE as _$$nE, c_, JS, Mk, yW, AZ, o8, Yv, gP, Wy, my } from "../figma_app/644808";
...
import { CT, $c, d5, H0, Mj, _K, HE, _q, RQ, ce, Sx, T5, RU, nT as _$$nT, YJ, Kv, PK, vr, Kd, y4, Gd, xP, GH, RX } from "../figma_app/540964";
import { sN as _$$sN, ht, h as _$$h2, zf, uo, LH, R2, hB } from "../figma_app/188908";
import { rl as _$$rl, C0, MB, pg, NR, tM as _$$tM2 } from "../figma_app/525558";
import { MA, ye, $H } from "../figma_app/134428";
...
import { kH, ke } from "../905/309735";
import { I as _$$I } from "../905/342732";
import { Cn } from "../905/225265";
import { F9, e_ as _$$e_, MH, dM, fA } from "../figma_app/803787";
import { dK, vD } from "../figma_app/889655";
import { $z } from "../figma_app/297733";
import { tM as _$$tM3, gb, O as _$$O } from "../figma_app/984498";
...
import { mZ, _9, Bk, Sg, $1, oV } from "../figma_app/76115";
import { n as _$$n2 } from "../905/186638";
import { F as _$$F } from "../905/84606";
import { Y as _$$Y2 } from "../905/411989";
import { MT, lX as _$$lX, $A } from "../figma_app/588397";
import { K as _$$K2, h as _$$h3 } from "../905/275787";
...
import { sortByWithOptions, sortBy } from "../figma_app/656233";
...
import { pJ, Mw, pW } from "../figma_app/663669";
...
import { WS, jp, qF } from "../905/370597";
...
import { kL, b3, Nb } from "../figma_app/547952";
var l = i;
function M() {
  let e = aV();
  let t = q5()?.canEdit;
  ...
  let c = !!_$$f(bo);
  let u = "no_figma_basics_onboarding_was_shown_in_current_session" === zl(_$$j).currentState;
  useEffect(() => {
...
let el = forwardRef(function ({
  ...
  let f = jsxs(Fragment, {
    children: ["preview" === c || "preview-no-padding" === c ? jsx("div", {
      className: "asset_panel_folder--folderPreview--0ezgC",
      children: i ? jsx(_$$V2, {
        keyPrefix: e,
        previewAssetOrUrl: i,
        type: "preview-no-padding" === c ? "no-padding" : void 0,
        customThumbnailData: u,
        ...ei,
        pageInfo: p
      }) : jsx("div", {
      ...
      className: l()("asset_panel_folder--folderNextIcon--ZYH9z", {
        "asset_panel_folder--adjustMargin--uitBT": "icon" === c
      }),
      children: jsx(_$$n, {})
    })]
  });
...
function ec({
  ...
  C0(keyboardNavigationItem, 0 === t && i === (folderPath?.length ?? 0) && currentView === S5.Assets);
  let y = MB({
    onBoth: p,
  ...
  return jsx(el, {
    ...
    disabled: _,
    variant: "list" === d ? "icon" : "preview",
    role: "list" === d ? "listitem" : "gridcell"
  });
}
...
function tu(e, t, s, n, i, l, a) {
  let o = [];
  let d = "list" === n.displayType ? "listitem" : "gridcell";
  for (let c = 0; c < e.length; c += t) {
      ...
      if (e) {
        ...
        p.push(jsx("div", {
          ...
          children: jsx(e3, {
            ...
            isFirstTile: a?.includesFirstTile && 0 === u,
    ...
    o.push({
      element: jsx("div", {
        className: "list" === n.displayType ? ts : 0 === c ? tt : te,
        children: p
      }),
      key: `${s}:row-${c / t}`,
      keys: u.map(e => _$$V3(e)),
...
function tH(e, t) {
  let [s] = MA();
  let r = useMemo(() => t && "grid" === s ? t : [], [s, t]);
  let i = useMemo(() => r.every(e => e.fullPage) ? .85 : Math.max(r.map(e => e.mainThumbnailInfo.width / e.mainThumbnailInfo.height).reduce((e, t) => Math.abs(t - 1) < Math.abs(e - 1) ? t : e), .7), [r]);
  let l = e - tO;
  let a = useMemo(() => tA({
    elementMinSize: 144,
    gap: tR,
  ...
  for (let u = 0; u < e.length; u += t) {
    ...
    p.forEach((e, i) => {
      ...
      sv(e) ? h.push(jsx(t1, {
        asset: e,
        hideName: d.hideName,
        isFirstTile: d?.includesFirstTile && 0 === c,
...
function sF({
  ...
  return jsx(xU, {
    children: jsx("div", {
      className: "grid" === t ? "asset_panel_assets--embeds--kl79b" : _$$s.flex.flexColumn.itemsCenter.$,
      children: jsx(sd, {
        embeds: e.embeds
      })
    })
...
let sQ = Pt("assetsLibrary", "contextMenu");
let s0 = ms;
let s1 = c$;
let s3 = memo(({
  dropdownShown: e,
...
let s5 = Pt("assetsLibrary", "contextMenu");
let s6 = ms;
let s8 = c$;
let s7 = memo(({
  dropdownShown: e,
...
async function rv({
  ...
  if (!r) {
    ...
    if (0 === n.length) throw Error("MOCK: COULD NOT FIND ANY ASSETS - maybe they are still loading?");
    r = n.sort(() => Math.random() - .5).map(e => ({
      ...e,
    ...
    let t = function (e) {
      ...
      return function ({
        ...
        targetNodeGuid: function ({
          ...
          let d = !!e && b4.includes(e.type) && Mw(e, debouncedViewportInfo, .4);
...
function r9({
  ...
  return jsxs("div", {
    ...
    children: [jsx(nr, {
      ...
      name: lastStub,
      firstSlash: 0 === collapsibleStubs.length,
      shouldEllipsize: c
    }) : null]
  });
}
...
function nr({
  ...
  let _ = function () {
    ...
    let l = useMemo(() => {
      ...
      return s || n || "disabled" !== siteLibraries.status;
  ...
  let w = useMemo(() => !!v || !!isCurrentlySkippingPage && (!folderPath || !!isCurrentlySkippingFirstFolder && 1 === folderPath.length), [folderPath, isCurrentlySkippingFirstFolder, isCurrentlySkippingPage, v]);
  let N = useCallback(e => {
...
function nd() {
  ...
  let o = useMemo(() => !a || (a.type === yW.DESIGN ? 0 === a.numComponents && 0 === a.numTemplates : 0 === a.numResponsiveSets), [a]);
  let d = 0 === libraries.length;
...
function nv({
  ...
  let i = function (e) {
    ...
    return useMemo(() => data ? function (e) {
      ...
      let i = t.find(e => "image" === e.fieldType);
      return {
    ...
    asset: function (e, t) {
      ...
      return useMemo(() => {
        ...
        let s = function (e, t) {
          ...
          let i = null !== primaryTextFieldId;
          let l = null !== secondaryTextFieldId;
          let a = i || l;
          let o = null !== imageFieldId;
...
function nN() {
  let e = useContext(nT);
  if (void 0 === e) throw Error("useFlyoutContext must be used within a FlyoutProvider");
  return e;
}
function nI({
  page: e,
...
function nP() {
  ...
  return "loading" === status || null == data ? jsx(nR, {
    styleXStyle: nO.justifyCenter,
    children: jsx(nS, {})
  }) : 0 === data.length ? jsx(nR, {
    styleXStyle: nO.justifyCenter,
    children: jsx(n_, {})
  }) : jsx(nL, {
    children: jsx(nR, {
...
let nO = {
  ...
  flyoutPosition: e => [{
    ...
    "--left": (e => "number" == typeof e ? e + "px" : null != e ? e : void 0)(`calc(var(--left-panel-width) + ${e ? _$$_ + 1 : 0}px)`)
  }],
  hidden: {
    display: "x1s85apg",
    $$css: !0
...
function ie({
  ...
  let v = "grid" === f ? n3 + previewHeight + 2 : n5;
  let S = t.length > 0;
...
function ir({
  ...
  let {
    ...
    let x = useCallback((e, t) => {
      ...
      } else i.current && (clearTimeout(i.current), i.current = null);
    }, [d, setSafePolygon]);
    let y = useCallback(() => {
      i.current && (clearTimeout(i.current), i.current = null);
    }, []);
    let _ = useCallback(() => setSafePolygon(null), [setSafePolygon]);
    let b = useCallback(() => null !== a && (f(), !0), [a, f]);
    O1(b, KD.OVERLAY);
...
function ii({
  ...
  C0(keyboardNavigationItem, currentView === S5.Pages && 0 === t);
  let y = MB({
    onBoth: c,
    onKeyDown: focusFirstItem,
    onClick: focusSearchBar
  ...
  let b = useMemo(() => "list" === i ? "icon" : "preview", [i]);
  let C = {
    pageId: e.id,
...
function ib({
  ...
  C0(keyboardNavigationItem, currentView === S5.Pages && 0 === i && 0 === l);
  let x = MB({
    onBoth: c,
    onKeyDown: focusFirstItem,
    onClick: focusSearchBar
  ...
  let m = useMemo(() => {
    if (e?.type === yW.SITE && "grid" === l) return function (e, t, s, n) {
      ...
      for (let e = 0; e < i.length; e += n) {
        let o = 0 === e ? "site_kit_pages--virtualRowFirst--pNAgS site_kit_pages--virtualRow--F7pf9" : "site_kit_pages--virtualRow--F7pf9";
        let d = i.slice(e, e + n);
        let c = [];
        let u = d.map(([e]) => e);
        d.forEach(([n, i], l) => {
...
function iQ({
  ...
  let _ = iZ({
    moreResults: o,
    query: i,
    showMoreDefault: 0 === a.length && o.length > 0
  });
  let [b, C] = useState(!1);
  let [j, v] = useState(!1);
  let S = _$$r4(s);
...
function i7({
  ...
  if (d?.[0]?.components && a?.libraryKey) {
    ...
    } else c = tw(d[0].components).slice(0, 11);
  }
  let u = PI(c, !0);
  let p = (width - 24 - 24) / 4;
  let h = {
  ...
  return c.length ? jsx("div", {
    ...
    children: [0, 1, 2].map(s => jsxs("div", {
      ...
      children: [c.slice(4 * s, (s + 1) * 4).map((e, n) => jsx(e3, {
        ...
        thumbWidth: p,
        viewMode: Bk.Grid
      }, `$visualAssetsPanel:component:${_$$V3(e)}`)), 2 === s && jsx(i8, {
        libraryKey: e,
        numComponents: o,
        size: p
      })]
...
function lR({
  ...
  let d = R2("number" == typeof e?.top ? e.top : void 0);
  let {
    productComponents
  } = g5(_$$$A.Design);
  let u = iE();
...
function lQ({
  ...
  let c = "component_filter" === getConfig().get("variant", "control");
  let u = useCallback(() => {
    a && ($I({
      moduleToOpen: {
        type: "custom",
  ...
  let f = useCallback(e => (!!e.metaKey || !!e.ctrlKey) && "Enter" === e.key && (e.preventDefault(), e.stopPropagation(), u(), !0), [u]);
...
function l4({
  ...
  let o = !_$$cJ() && n && "control" !== getConfig().get("variant", "control");
  return jsxs("div", {
