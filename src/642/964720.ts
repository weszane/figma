...
import { Zk, jT } from "../figma_app/626177";
...
export function $$A0({
  ...
  let [ee, et] = useState({
    ...{
      ...Object.fromEntries(Object.entries(UD()).map(([e, t]) => [e, !1])),
      ...KQ
    },
    ...M
  });
  ...
  let er = useCallback(async e => {
    if (ee) try {
      ...
      if (e instanceof LV && "Focus node is not a descendant of the node" === e.message) {
        U("");
        W(0);
        return;
      }
  ...
  async function ei(e) {
    ...
    try {
      ...
      } else if (!(await LZ(e, t)).node) throw Error("Couldn't parse JSX");
    } catch (e) {
      console.error(e);
...
function P({
  ...
  let u = [...Object.entries(s ?? {}).map(([e, t]) => jsx(MM, {
    ...
    onClick: () => d(e),
    children: E[e]
  }, e)), ...(s ? [jsx(wv, {}, "separator")] : []), ...Object.entries(e).filter(([e, t]) => "boolean" == typeof t).map(([e, t]) => jsx(MM, {
    checked: !!t,
    onClick: () => c(e),
    children: a[e] || e
  }, e))];
