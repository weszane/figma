...
import { MAX_DESCRIPTION_LENGTH2 } from "../figma_app/350203";
...
export function $$h2(e, t, n, a = MAX_DESCRIPTION_LENGTH2) {
  let {
    templatesByTeam,
    isLoading
  } = li({
...
export function $$b1(e, t, n, a = MAX_DESCRIPTION_LENGTH2) {
