...
function y(e) {
  switch (e) {
    case "developer":
      return {
        title: tx("whiteboard.whats_new.diagram.title"),
        ...
        body: tx("whiteboard.whats_new.engineer.control.body")
      };
    case "researcher":
      return {
        title: tx("whiteboard.whats_new.workshop.title"),
        ...
        body: tx("whiteboard.whats_new.research.control.body")
      };
    case "designer":
      return {
        title: tx("whiteboard.whats_new.brainstorm.title"),
        ...
        body: tx("whiteboard.whats_new.design.control.body")
      };
    case "marketer":
      return {
        title: tx("whiteboard.whats_new.workshop.title"),
        ...
        body: tx("whiteboard.whats_new.marketing.control.body")
      };
    case "product-manager":
      return {
        title: tx("whiteboard.whats_new.meeting.title"),
        ...
        body: tx("whiteboard.whats_new.product.control.body")
      };
    default:
      return {
        title: tx("whiteboard.whats_new.diagram.title"),
        ...
        body: tx("whiteboard.whats_new.other.control.body")
      };
  }
}
function v() {
    ...
    overrideFooter: jsxs("div", {
      ...
      children: [jsx(_$$J, {
        ...
        children: jsx($z, {
          ...
          children: tx("rcs.whats_new_in_figjam.try_fig_jam")
        })
...
function k({
  ...
  return jsx(S, {
    label: jsx(J, {
      children: _$$t("rcs.whats_new_in_figjam.show_fig_jam_updates")
    }),
    checked: e,
    onChange: t
  });
