...
let d = {
  ...
  renderTitle: () => t("dev_handoff.codebase_suggestions.snippet"),
  renderDescription: () => t("dev_handoff.codebase_suggestions.add_a_script_tag_to_your_application_to_automatically_collect_components")
};
let c = {
  installMethod: "npm",
  thumbnailUrls: {
  ...
  thumbnailAlignment: "centered",
  renderTitle: () => t("dev_handoff.codebase_suggestions.npm"),
  renderDescription: () => t("dev_handoff.codebase_suggestions.install_an_npm_package_that_scans_your_local_dev_environment")
};
let _ = {
  ...
  renderTitle: () => t("dev_handoff.codebase_suggestions.bookmarklet"),
  renderDescription: () => t("dev_handoff.codebase_suggestions.add_a_bookmarklet_to_your_browser_bar_to_collect_components")
};
