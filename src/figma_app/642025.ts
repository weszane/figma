...
export function $$V4(e, t, r) {
  return e.org_access !== FAccessLevelType.SECRET && (function (e, t, r) {
    if (!(r = r || t.user?.id) || !e || !t.currentUserOrgId)
      return !1
    ...
    let i = _$$_(e, t)
    if (!i || !n || t.currentUserOrgId !== i.org_id)
      return !1
    if ($$M17(e, t))
      return !0
...
export function $$W12(e, t) {
  if (e.level !== e6.VIEWER && e.level !== e6.VIEW_PROTOTYPES)
    return null
