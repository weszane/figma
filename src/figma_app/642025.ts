...
import { FResourceCategoryType, FAccessLevelType, FBasicPermissionType, FPermissionLevelType, FOrganizationRoleType } from "../figma_app/191312";
import { _ as _$$_ } from "../905/613917";
import { jh } from "../figma_app/35887";
import { e6 } from "../905/557142";
import { Ay, R$ } from "../figma_app/12796";
...
export function $$y20(e, t) {
  for (let r of e) if (r.level >= t) return !0;
  return !1;
}
...
function x(e, t, r) {
  ...
  if (s) {
    let n = !o && t <= e6.EDITOR && $$U5(s, r) && i.org_access === FAccessLevelType.PUBLIC && i.default_permission === FBasicPermissionType.EDIT;
    let c = $$y20($$b15(e, r), t);
    let u = t <= e6.ADMIN && (c || $$V4(i, r, a));
    let _ = !o && t <= e6.VIEWER && $$U5(s, r) && i.org_access === FAccessLevelType.PUBLIC;
    let h = $$U5(s, r) && (t <= e6.VIEWER && l === FPermissionLevelType.ORG_VIEW || t <= e6.EDITOR && l === FPermissionLevelType.ORG_EDIT);
...
export function $$C7(e, t) {
  return function (e, t, r) {
    ...
    if (!u && o && $$U5(o, r) && t <= e6.VIEWER && c && c.org_access === FAccessLevelType.PUBLIC && !s.is_invite_only || !u && o && $$U5(o, r) && t <= e6.EDITOR && c && c.org_access === FAccessLevelType.PUBLIC && !s.is_invite_only && !s.is_view_only && c.default_permission === FBasicPermissionType.EDIT || o && $$U5(o, r) && (t <= e6.EDITOR && _ === FPermissionLevelType.ORG_EDIT || t <= e6.VIEWER && _ === FPermissionLevelType.ORG_VIEW)) return !0;
    let h = T(e, r);
    return (h.forEach(e => {
      e.resource_type === FResourceCategoryType.FOLDER && (i = e);
    }), !s.team_id || s.is_invite_only || s.is_view_only && t >= e6.EDITOR) ? !!i && i.level >= t : $$y20(h, t);
  }(e, e6.VIEWER, t);
}
export function $$w8(e, t) {
  return x(e, e6.VIEWER, t);
}
export function $$O2(e, t) {
  return x(e, e6.EDITOR, t);
}
export function $$R1(e, t) {
  return x(e, e6.ADMIN, t);
}
export function $$L6(e, t) {
  return x(e, e6.OWNER, t);
}
export function $$P22(e, t) {
  return N(e, e6.VIEWER, t);
}
export function $$D19(e, t) {
  return N(e, e6.EDITOR, t);
}
...
export function $$j3(e, t) {
  ...
  return $$G21(F(t, e, r.id), n, jh.GUEST);
}
export function $$U5(e, t, r) {
  if (!e) return !1;
  r = r || t.user?.id;
  let n = t.orgById[e] ?? J(t, "org", e);
  return $$G21(F(t, e, r), n, jh.MEMBER);
}
export function $$B0(e, t, r) {
  if (!e) return !1;
  let n = t.orgById[e] ?? J(t, "org", e);
  r = r || t.user?.id;
  return $$G21(F(t, e, r), n, jh.ADMIN);
}
export function $$G21(e, t, r) {
  return !!t && !!e && Ay(e.permission) >= r;
}
export function $$V4(e, t, r) {
  return e.org_access !== FAccessLevelType.SECRET && function (e, t, r) {
    ...
    null === n && (n = J(t, "org_user", t.currentUserOrgId));
    let i = _$$_(e, t);
...
export function $$H23(e) {
  return R$(e.user, e.currentUserOrgId);
}
export function $$z16(e, t) {
  return !!t && null != Object.entries(e.teamUserByTeamId ?? {}).find(([r, n]) => {
    let i = e.teams[r];
    return !!i?.student_team_at && null != n[t];
  });
}
export function $$W12(e, t) {
  ...
  return n && n.level > e6.VIEWER && i ? _$$t("permissions.can_still_edit_team_project_is_in") : null;
}
