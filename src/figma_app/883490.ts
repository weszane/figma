...
let $$m7 = eU(!1);
let $$g3 = eU({});
export function $$f8({ type: e }) {
  return e & PW.ASSET_GIF;
}
export function $$E5({ type: e }) {
  return e & PW.ASSET_VIDEO;
}
export function $$y4(e) {
  return e & PW.ASSET_ICON
    ? "icon"
    : e & PW.ASSET_ILLUSTRATION
      ? "illustration"
      : e & PW.ASSET_IMAGE
        ? "img"
        : e & PW.ASSET_VIDEO
          ...
          : e & PW.ASSET_GIF
            ? "gif"
            : e & PW.ASSET_COMPONENT
              ? "component"
              : void 0;
}
export function $$b10({ pxWidth: e, pxHeight: t, dataTestId: r }) {
  let { unit } = gc();
  let s = unit === tKW.SCALED;
  let o = (e) =>
    (e ?? 0).toLocaleString("en", {
...
export function $$I1({
  ...
  let l =
    e & PW.ASSET_VIDEO
      ? _$$t("dev_handoff.assets.video")
      : e & PW.ASSET_GIF
        ? _$$t("dev_handoff.assets.gif")
        : e & PW.ASSET_IMAGE
          ? _$$t("dev_handoff.assets.image")
          : e & PW.ASSET_ICON
            ? _$$t("dev_handoff.assets.icon")
            : e & PW.ASSET_COMPONENT
              ? _$$t("dev_handoff.assets.instance")
              : e & PW.ASSET_ILLUSTRATION
                ? _$$t("dev_handoff.assets.asset")
                : void 0;
  return jsxs("span", {
    children: [
      s && l,
...
let $$C9 = nF((e, t) => {
  t &&
    (A = {
      guidsToReturnTo: Object.keys(
        e.getState().mirror.sceneGraphSelection,
      ).sort(),
      selectedGUID: t,
    });
});
let $$w2 = nF((e) => {
  ...
  let r = A && 1 === t.length && A.selectedGUID === t[0];
  r && !x
    ? (document.addEventListener("keydown", O),
      e.dispatch(
        F.enqueue({
          ...
          button: {
            text: _$$t("dev_handoff.assets.return_to_previous"),
            action: R,
          },
          onDismiss: () => {
            A = null;
