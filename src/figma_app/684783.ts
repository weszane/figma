...
import { _Q, fz, Hs, Jr, qb, RL, UG } from "../figma_app/2590"
...
import { Ac, GP, IK, Pz, Qd, Ti, Xl, Yu } from "../figma_app/292324"
...
((e) => {
  ...
  e.HubFileZoomButtonDropdown = function ({
    ...
    if (U3("keydown", h), !useSelector(e => e.dropdownShown?.type === s))
      return null
    let m = (t) => {
...
function eN(e) {
  ...
  return jsxs(Fragment, {
    children: [e.isFreemiumPreview
      ? jsx(n.BottomLeftContainer, {
...
export class $$eJ0 extends Component {
    ...
    this.handleFullscreenTransition = (e, t) => {
      if (e !== t) {
        if (t0(e) !== t0(t)) {
          ...
          t === PreviewMode.FULLSCREEN_WITH_COMMENTS
            ? this.setState({
                showFullscreenComments: !0,
              })
  ...
  getViewer() {
    return this.props.disableViewerForTest
      ? null
      : this.props.hubFile.viewer_mode === FTemplateCategoryType.PROTOTYPE
        ? jsx(eW, {
            hubFile: this.props.hubFile,
