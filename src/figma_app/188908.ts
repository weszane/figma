...
import { selectCurrentFile, useCurrentFileKey, useOpenFileLibraryKey } from "../figma_app/516028"
import { getUUID, useUUIDSubscription } from "../figma_app/517115"
import { ModeType, PRIVATE_TYPE } from "../figma_app/644808"
...
export function $$b9() {
  ...
  return useCallback((t, r) => {
    !(function (e, t, r) {
      ...
      libraryKey && l.length > 0 && l.includes(libraryKey) && view === "Library" && ["libraryCard", "settingsMenu"].includes(e) && analyticsEventManager.trackDefinedEvent("assets_panel.view_site_kit", {
        fileKey: r?.key,
        fileTeamId: r?.teamId ?? void 0,
        fileOrgId: r?.parentOrgId ?? void 0,
        entrypoint: e,
...
export function $$I12({
  ...
  return useMemo(() => {
    switch (currentView) {
      case S5.Search:
        if (isNavigatingVisualAssets && visualAssetsType) {
          return {
...
export function $$C2(e) {
  return (e instanceof HTMLInputElement || e instanceof HTMLTextAreaElement || e instanceof HTMLSelectElement) && e.role !== "application"
}
