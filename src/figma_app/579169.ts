...
let $$_9 = J9([UserForRcs.Query({}), ZS], ([e, t]) => null != e.currentUser.id && t?.canRead ? qo.ORG : qo.PERSONAL);
let $$h11 = Z1(UserForRcs.Query({}), e => e.currentUser.createdAt);
let $$m0 = Z1($$h11, e => e.getTime() <= Date.now() - 12096e5);
let $$g1 = J9([rg, UserForRcs.Query({})], ([e, t], r) => {
  let n = r(_s);
...
Z1(UserForRcs.Query({}), e => {
  let t = e.currentUser.email;
  return jm(t) || !!t?.endsWith("@dev.figma.com");
});
let $$f15 = Z1(UserForRcs.Query({}), e => null != e.currentUser.studentValidatedAt);
let $$E6 = Z1(EduOffboardingData.Query({}), e => e.currentUser.eduPeriodEnd);
...
let $$x12 = Z1(UserForRcs.Query({}), e => {
  let t = e.currentUser.email;
  return null != t ? qe(t) : void 0;
});
let $$N4 = Z1(UserForRcs.Query({}), e => e.currentUser.profile?.jobTitle);
Z1($$N4, e => {
  let t = HB(e);
  return "designer" !== t && "other" !== t && "unknown" !== t;
});
Z1(UserForRcs.Query({}), e => e.currentUser.profile?.usagePurpose);
let C = createReduxSubscriptionAtomWithState(e => e.authedProfilesById);
atom(e => Object.values(e(C)).some(e => !!e.org_id || !!e.team_id));
Z1(UserForRcs.Query({}), e => e.currentUser.email);
let $$w10 = Z1(UserForRcs.Query({}), e => e.currentUser.emailValidatedAt);
...
let $$L5 = J9([UserForRcs.Query({}), ZS], ([e, t]) => {
