...
import { jsFullscreenPreventEventCapture, jsFullscreenWheelEventCapture } from "../figma_app/8833";
...
interface DropdownProps {
  ...
  dropdownButton?: React.ComponentType<{
    onClick: () => void;
  }>;
...
export function DropdownComponent(props: DropdownProps) {
  ...
  return jsxs("div", {
    ...
    children: [hasLabel && jsxs("div", {
      ...
      children: [jsxs("div", {
        className: ep,
        children: [!!props.iconLabel && jsx("div", {
          className: Vi,
...
export function useDropdownFocus(props: DropdownHookProps) {
  ...
  const childrenComponents = useMemo(() => Children.toArray(props.children || props.options).filter(child => typeof child !== "boolean"), [props.children, props.options]);
  const childRefs = useRef<Array<HTMLElement | null>>(Array.from({
    length: childrenComponents.length
  }));
  ...
  const getSetChildRef = (index: number) => {
    ...
    if (typeof child !== "boolean" && "type" in child && (child.type === OptionComponent || child.type === CheckableOptionComponent)) {
...
export function DropdownOptions(props: any) {
  ...
  return jsx(DropdownContainer, {
    ...
    onKeyDown,
    tabIndex: -1,
    children: Children.map(childrenComponents, (child, index) => cloneElement(child as React.ReactElement, {
...
export class DropdownContainer extends RecordingPureComponent<any> {
  ...
  render() {
    return jsx("div", {
      ...
      "className": classNames(Wm, this.props.className, {
        [DY]: this.props.positionAbsolute,
        [_S]: this.props.positionFixed,
        [rU]: this.props.shouldRenderAutocompleteStyles,
        [jsFullscreenWheelEventCapture]: this.props.preventZoom,
        [jsFullscreenPreventEventCapture]: this.props.preventEventCapture
      }),
...
export class OptionComponent extends RecordingPureComponent<any> {
  ...
  render() {
    ...
    const className = classNames(isDisabledOrHeader ? IZ : {
...
export class CheckableOptionComponent extends RecordingPureComponent<any> {
  ...
  render() {
    return jsxs(OptionComponent, {
      ...this.props,
      "className": classNames(_$$o, this.props.displayType === CheckDisplayType.Checkbox && this.props.nested && cY, this.props.className),
      "aria-checked": this.props.checked,
      "role": "role" in this.props ? this.props.role : undefined,
      "children": [this.props.displayType === CheckDisplayType.Checkbox ? jsx(setupThemeContext, {
        mode: "dark",
        children: jsx("span", {
          className: z6,
  ...
  render() {
    return jsxs(Fragment, {
      children: [jsx(DropdownContainer, {
        ...this.props
      }), this.hasCloseDropdown(this.props) ? jsx(DropdownScrim, {
...
export class DropdownScrim extends RecordingPureComponent<any> {
  ...
  render() {
    return jsx("div", {
      "className": classNames(bv, this.props.preventEventCapture && jsFullscreenPreventEventCapture),
