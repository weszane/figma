...
import { Dm, GT, U$, vt } from '../figma_app/306946'
import { Gl, XW } from '../figma_app/427318'
...
export function $$y6(e, t) {
  switch (e) {
    ...
    case vt.PLUGIN:
      if (t)
        return renderI18nText('community.using.try_in')
...
function b(e) {
  ...
  t.innerHTML = dompurify.sanitize(e)
  return t.innerText
}
...
export function $$O11(e) {
  return e.community_publishers.accepted.some(e => e.profile_handle.toLowerCase() === 'apple')
}
export function $$R14(e) {
  return e.community_publishers.accepted.some(e => e.profile_handle.toLowerCase() === 'figma')
}
...
export function $$D15(e, t) {
  if (t === editorUtilities.Editors.PROTOTYPE)
    return [vt.PROTOTYPE]
  let r = Array.from(U$)
  isMakeDiscoveryEnabled() && r.push(vt.FIGMAKE_TEMPLATE)
  let i = Dm
  let a = GT
  switch (e) {
    case void 0:
