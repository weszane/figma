...
export function $$d0() {
  ...
  let t = useSelector(e => valueOrFallback(b(e.mirror.selectionProperties, "inheritEffectStyleKey"), void 0));
  let r = useSelector(e => valueOrFallback(e.mirror.selectionProperties.inheritEffectStyleKey, void 0));
  let d = uQ();
  return useMemo(() => !d || isInvalidValue(e) ? [] : [{
