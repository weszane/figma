...
export function $$d0() {
  let e = d4(e => e.mirror.selectionProperties.effects);
  let t = d4(e => _W(b(e.mirror.selectionProperties, "inheritEffectStyleKey"), void 0));
  let r = d4(e => _W(e.mirror.selectionProperties.inheritEffectStyleKey, void 0));
  let d = uQ();
