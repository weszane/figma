...
function j(e) {
  "BACK" === e ? atomStoreManager.set(pD, renderI18nText("magic_link.running_and_adding_back_interactions")) : "OPEN_POPUP" === e ? atomStoreManager.set(pD, renderI18nText("magic_link.running_and_adding_overlay_interactions")) : atomStoreManager.set(pD, renderI18nText("magic_link.running_and_adding_navigate_interactions"));
}
export function $$U6() {
