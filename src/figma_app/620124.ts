...
let $$o1 = () => ({
  BACKGROUND_COLOR: {
    id: "BACKGROUND_COLOR",
    getLabel: () => t("design_linter.suggestion_block.fill_colors.background"),
    priority: 0
  },
  STROKE_COLOR: {
    id: "STROKE_COLOR",
    getLabel: () => t("design_linter.suggestion_block.stroke_colors.stroke"),
    priority: 1
  },
  SHAPE_COLOR: {
    id: "SHAPE_COLOR",
    getLabel: () => t("design_linter.suggestion_block.fill_colors.shape"),
    priority: 2
  },
  SHAPE_STROKE_COLOR: {
    id: "SHAPE_STROKE_COLOR",
    getLabel: () => t("design_linter.suggestion_block.stroke_colors.shape_stroke"),
    priority: 3
  },
  TEXT_COLOR: {
    id: "TEXT_COLOR",
    getLabel: () => t("design_linter.suggestion_block.text"),
    priority: 4
  },
  TEXT_STROKE_COLOR: {
    id: "TEXT_STROKE_COLOR",
    getLabel: () => t("design_linter.suggestion_block.stroke_colors.text_stroke"),
    priority: 5
  },
  TEXT_STYLE: {
    id: "TEXT_STYLE",
    getLabel: () => t("design_linter.suggestion_block.text_style"),
    priority: 6
  },
  CORNER_RADIUS: {
    id: "CORNER_RADIUS",
    getLabel: () => t("design_linter.suggestion_block.corner_radius"),
    priority: 7
  },
  HORIZONTAL_SPACING: {
    id: "HORIZONTAL_SPACING",
    getLabel: () => t("design_linter.suggestion_block.horizontal_spacing"),
    priority: 8
  },
  VERTICAL_SPACING: {
    id: "VERTICAL_SPACING",
    getLabel: () => t("design_linter.suggestion_block.vertical_spacing"),
    priority: 9
  },
  PADDING: {
    id: "PADDING",
    getLabel: () => t("design_linter.suggestion_block.padding"),
    priority: 10
  },
