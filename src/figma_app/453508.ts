...
export function $$C2(e) {
  ...
  let O = r || w ? "showReload" : _$$Ay2.isWasm4gbSupported ? "showRecoveryMode" : "showBrowserUpgradeAndDesktop";
  let R = jsx(_$$N, {
    href: _$$Ay2.mac ? "/download/desktop/mac" : "/download/desktop/win",
    newTab: !0,
    children: tx("memory_warning_modal.desktop_app_download_link")
  });
  let L = "showReload" === O ? {
    title: _$$t("memory_warning_modal.reload_modal_title"),
    content: _$$t("memory_warning_modal.reload_modal_content"),
    contentCTA: _$$t("memory_warning_modal.reload_modal_content_cta"),
    buttonCTA: _$$t("memory_warning_modal.reload_page_button"),
    secondaryButtonCTA: _$$t("memory_warning_modal.learn_more"),
    ...
    title: _$$t("memory_warning_modal.recovery_mode_modal_title"),
    content: _$$t("memory_warning_modal.recovery_mode_modal_out_of_memory"),
    contentCTA: _$$t("memory_warning_modal.recovery_mode_modal_content"),
    buttonCTA: _$$t("memory_warning_modal.recovery_mode_button"),
    secondaryButtonCTA: _$$t("memory_warning_modal.learn_more"),
    buttonExternalLink: null,
    secondaryButtonExternalLink: "https://help.figma.com/hc/articles/360040528173-Reduce-memory-usage-in-files/"
  } : {
    title: _$$t("memory_warning_modal.old_browser_out_of_memory_modal_title"),
    content: _$$t("memory_warning_modal.old_browser_out_of_memory_modal_content"),
    contentCTA: null,
    buttonCTA: _$$t("memory_warning_modal.old_browser_primary_button_cta"),
    secondaryButtonCTA: null,
    buttonExternalLink: _$$Ay2.browserType && {
    ...
    children: jsxs(vo, {
      children: [jsx(Y9, {
        ...
        children: [jsxs("div", {
          ...
          }), "showBrowserUpgradeAndDesktop" === O ? tx("memory_warning_modal.old_browser_out_of_memory_modal_content_cta_and_download_desktop", {
            desktopAppLink: R
          }) : L.contentCTA, jsx("br", {})]
        }), jsxs("div", {
          className: v0,
          children: [L.secondaryButtonCTA && L.secondaryButtonExternalLink && jsx(_$$N.Button, {
            onClick: () => {
              L.secondaryButtonCTA === _$$t("memory_warning_modal.learn_more") && $$A0({
            ...
            children: L.buttonExternalLink ? jsx(_$$N.Button, {
              ...
              recordingKey: Pt(e, "crash"),
              onClick: () => {
                L.buttonCTA === _$$t("memory_warning_modal.recovery_mode_button") && $$A0({
