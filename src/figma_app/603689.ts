...
import { browserCapabilities as PlatformInfo } from '../905/409121'
...
import { BF as AssetConsumptionMirrorBindings, fh } from '../figma_app/98072'
import { Cg as _$$Cg } from '../figma_app/99436'
import { xo as EditScopeWebBindings } from '../figma_app/106634'
...
import { Zc as ExperimentBuildersTsBindings } from '../figma_app/171569'
...
import { initializeFullscreenPreloading, isUsingLocalBuild, loadWasmBinaryByType } from '../figma_app/298277'
...
import { wV as undoRedoEventsBindings } from '../figma_app/462456'
...
import { WH as VariablesBindingsWeb } from '../figma_app/485258'
import { nz as WhiteboardTsBindings } from '../figma_app/492354'
...
import { yu as WhiteboardDltConstantBindings } from '../figma_app/533986'
...
import { st as userActionTimingBindings } from '../figma_app/578011'
...
import { Gm as KeyboardShortcutBindings } from '../figma_app/675605'
...
import { fm as VideoTsBindings } from '../figma_app/723183'
import { x as _$$x5 } from '../figma_app/731109'
import { YN as MentionsTsBindings } from '../figma_app/738358'
...
import { ip as FrameDistributionTrackerBindings } from '../figma_app/857454'
import { LoadingSpinner } from '../figma_app/858013'
import { w as _$$w2 } from '../figma_app/859828'
import { r as CanvasSearchBindings } from '../figma_app/860474'
...
import { t7 as WhiteboardTemplatePreviewTsBindings } from '../figma_app/880974'
import { ld as HandoffScenegraphBindings } from '../figma_app/881578'
import { selectLocalStylesWithUsagesOnLoadedPages, selectPublishableStyleNodeIds } from '../figma_app/889655'
import { S as TsFontManualLoader } from '../figma_app/894185'
...
import { PluginSandbox } from '../figma_app/911344'
import { Dt as InteractionBindings } from '../figma_app/912411'
...
import { mn as slotsBindingsWeb } from '../figma_app/968938'
    ...
    ? jsx('div', {
        ...
        children: jsxs('div', {
          ...
          children: [jsxs('div', {
            ...
            children: a && a.threadId && a.fileKey
              ? jsx(_$$d3, {
                  quickReplyInfo: a,
                  onClose: () => {
                    e(selectViewAction({
...
let SlidesTsBindings = new class {
...
let CodeBlockBindings = new class {
...
let JsBindingsTestHelpers = new class {
  constructor() {
  ...
  jsEchoUintValue(e) {
    if (e < 0)
      throw new Error('Unsigned value was negative')
    return e
  }
...
let RichTextBindings = new class {
...
let ns = {
  ...
  WhiteboardTsBindings: () => WhiteboardTsBindings,
  CodeBlockBindings: () => CodeBlockBindings,
  ColorRampBindings: () => ColorRampBindings,
  WhiteboardAnalyticsTsBindings: () => WhiteboardAnalyticsTsBindings,
...
let nV = memo(() => {
  ...
  return !e || t
    ? null
    : getInitialOptions().consent_region === 'implicit'
      ? jsx(C$, {
      ...
      : getInitialOptions().consent_region === 'explicit'
        ? jsx(ZQ, {
            variant: _$$a3.FILE_VIEWER,
            dismissIcon: _$$A,
            verticalPadding: 32,
...
function iW() {
  ...
  if (!isMonetizationRedirectView(i))
    return null
  let {
    redirectUrl,
    interstitialType,
...
class ac extends _$$$ {
  ...
  getAdditionalProperties(e) {
    if (!this.sceneGraphValidationInfo)
      return []
...
async function a$(e) {
  ...
  if (!t.ok)
    throw new Error(`invalid response: ${t.status}`)
  let r = await t.blob()
...
async function aZ(e, t, r, n) {
  ...
  let [l, d] = await Promise.all([a, o, FigmaApp.loadAndStartFullscreenIfNecessary()])
...
async function a1(e, t) {
  ...
  if (r.length !== 0)
    return r.reduce((e, r) => r.sequenceNumber <= Number(t) && r.sequenceNumber > e.sequenceNumber ? r : e)
}
...
async function a5(e) {
  if (isServerSideJournalRedactionEnabled())
    return aB(e)
  let {
    entry,
...
async function a6(e) {
  let t = yH(e)
  if (!t)
    throw new Error('Unable to parse clipboard data')
  if (t = await BX(t), _$$l3(t) === Eo)
    throw new Error('Unexpected figd data in clipboard')
  return {
...
async function a7(e, t) {
  if (t == null) {
    let t = await a8(e)
    return _$$l3(t) === Eo
      ? await a4(t, `Local figd file ${e.name}`, 'show')
      : {
  ...
  }
  {
    ...
    if (i === Eo || a === Eo)
      throw new Error('Diffing diff files is not supported')
    {
...
function si() {
  ...
  return s
    ? jsx('div', {
        ...
        children: o
          ? 'backend' in o && o.backend === 'fullscreen'
            ? jsx(ss, {
                urlParams: o,
                onClose: n,
              })
    ...
    let t = async (t) => {
      ...
      try {
        if (t.clipboardData?.files.length) {
          ...
          if (!i || !i[1])
            throw new Error('Unable to parse file key from URL')
          e(i[1])
        }
      }
      catch (e) {
...
function oL({
  ...
  useEffect(() => {
    isShowing && t.data?.status !== _$$Q4.EXPIRED
      ? complete()
      : show({
...
function oj(e) {
  ...
  if (orgTrial.status !== _$$Q4.PENDING || o.status !== 'loaded')
    return null
  let d = o.data
...
function oG({
  ...
  useEffect(() => {
    isShowing && t.data?.status !== _$$Q4.PENDING
      ? complete()
      : show({
...
let oK = createRemovableAtomFamily(e => transformAtom(ProductTrialsView.Query({
  orgId: e,
}), e => e?.org?.canAdmin && e.org.billingTrials?.length
  ? (function (e) {
...
function o1({
  ...
  }, [show, complete, isShowing, t]), getFeatureFlags().product_trials_lg)
    ? jsx(OnboardingSequence, {
        isShowing,
...
function l2(e) {
  ...
  useEffect(() => {
    e
      ? (r(1), n.current = setTimeout(() => {
          r(2)
          n.current = null
        }, 2e3))
      : (r(0), n.current && clearTimeout(n.current))
  }, [e, n])
  return t
}
function l5({
...
function dE({
  ...
  let i = useMemo(() => ({
    ...
    handleDiffReport: (e, t, i) => (r.current[e] = !0, t.hasDiffs)
      ? (n(e, t, i), {
          didDiff: !0,
          report: t,
          args: i,
...
let dP = atom(new Set())
let dD = atom((e) => {
  if (!e(figmaLibrariesEnabledAtom))
    return {}
...
function dH() {
  !(function () {
    ...
    useEffect(() => {
      if (r.state !== LibraryPublishStatusEnum.UPLOADING || p.status === 'loading' || p.status === 'disabled' || !c || p.status === 'errors')
        return
    ...
    useEffect(() => {
      if (r.state !== LibraryPublishStatusEnum.UPLOADING || p.status === 'loading' || p.status === 'disabled')
        return
      if (!c) {
...
function ue({
  ...
  return (newModeWhenLoaded !== 'design' || isDesignViewLoaded) && (newModeWhenLoaded !== 'handoff' || isDevHandoffViewLoaded)
    ? jsx('div', {
        ...m,
...
function uO() {
  ...
  useEffect(() => {
    if (!i || !i.billableProductKey || getProductAccessTypeByKey(i.billableProductKey) !== ProductAccessTypeEnum.DEVELOPER)
      return
    let {
...
function pm(e) {
  ...
  return hoistedToolbeltItems.length
    ? jsx(_$$k6, {
        ...
        children: jsxs(_$$a0, {
          ...
          children: [jsx('div', {
            ...
            children: hoistedToolbeltItems.map(e => e.type === ZU.FLYOUT
...
function pP({
  ...
  let t = (function () {
    ...
    useFullscreenViewportUpdates({
      ...
      if (!n || a.isPanning || a.isZooming || e)
        return
      let o = i.get(t)
      ...
      s(function (e, t) {
        let r = 0
        let n = 0
        if (t.width / e.width > t.height / e.height ? (r = t.width, n = e.width) : (r = t.height, n = e.height), e.zoomScale < 0.5 && r / n < 0.25)
          return !0
...
function pV(e) {
  ...
  return (useEffect(() => {
  ...
  }, [h, activeToolId, a, s, editModeType, setActiveSecondaryToolbeltId, g, _]), activeSecondaryToolbeltId === _$$R6.PenTool && (editModeType === LayoutTabType.VECTOR || g))
    ? jsx(_$$A1, {
        activeToolId: h,
        activateTool,
    ...
    : activeSecondaryToolbeltId === _$$R6.DevModeInspectTool
      ? jsx(pP, {
          handleAction: $v,
        })
      : activeSecondaryToolbeltId === _$$R6.ImageOrVideoTool
        ? jsx(_$$O3, {
            handleAction: $v,
          })
        : activeSecondaryToolbeltId === _$$R6.BrushTool && _
          ? jsx(_$$a0, {
          ...
          : activeSecondaryToolbeltId === _$$R6.PencilTool && _
            ? jsx(_$$a0, {
            ...
            : activeSecondaryToolbeltId === _$$R6.SimplifyVectorTool
              ? jsx(_$$a0, {
                  ariaLabel: getI18nString('fullscreen.toolbar.simplify_vector.aria-label'),
                  children: jsx(pb, {}),
                })
              : _ && !u && activeSecondaryToolbeltId === _$$R6.SecondaryToolbeltForSelectionActions
                ? jsx(p_, {
                    activeToolId,
                    activateTool,
                    getShortcutTextForTool: p,
...
function pz() {
  ...
  }, [s, n, activateTool, activeToolId, close, g, h?.showBanner]), i || a || getFilteredFeatureFlags().ce_il_root && c === _$$n5.LOADING)
    ? jsx(Fragment, {})
    : jsx(TrackingProvider, {
        ...
        children: jsxs(XS, {
          ...
          'children': [jsxs(Iy, {
            children: [jsx('div', {
              ...
              children: [getFilteredFeatureFlags().ce_il_root && c === _$$n5.HAS_ACCESS
                ? jsx(uA, {})
                : jsx(ui, {
...
class _p extends _a {
  constructor() {
    ...
    this.position = () => {
      ...
      if (this.props.hasMobileNativeToolbar)
        return _i.TOP_CENTER
      let t = e.type
      switch (t) {
        case NotificationCategory.COMPONENT_PUBLISH_ERROR:
        case NotificationCategory.DOWNTIME:
      ...
      'children': jsx('div', {
        ...
        children: s.length > 0
          ? jsx(UserAuthList, {
              dispatch: e,
              header: o(() => a
                ? renderI18nText('locked_org.description_no_other_accounts', {
                    orgName: a.name,
                  })
          ...
          : jsxs('div', {
              ...
              children: [o(() => a
                ? renderI18nText('locked_org.description', {
                    orgName: a.name,
                  })
...
function _S({
  ...
  switch (useRequireOpenFileOrSuspend(t), yB(t), e) {
    ...
    case FEditorType.Illustration:
      return jsx(p$, {
        children: getFilteredFeatureFlags().ce_il_root
          ? jsx(_$$C, {
              fallback: NONE_SYMBOL.NONE,
            })
          : jsx(_$$a5, {
...
let _x = memo(() => {
  ...
  if (e.view === 'figmascope')
    return jsx(si, {})
  if (e.view === 'figjamTry')
    return jsx(iq, {})
  if (e.view === 'desktopNewTab')
    return jsx(dr, {})
  if (e.view === 'prototype')
    throw new Error('Unexpected prototype view')
  if (e === _$$o3) {
    return jsx(Fragment, {})
  }
...
function _N(e) {
  ...
  if (t.view === 'fullscreen' && r !== 'ok') {
    ...
    return type === 'oom'
      ? jsx(ConnectedAppModal, {})
      : jsx(RootErrorBoundaryFallback, {
          sentryId,
        })
  }
  return jsx(Fragment, {
...
let _C = memo(() => {
  ...
  (function () {
    ...
    useEffect(() => {
      t.shouldReload && (t.reason === 'mfa_required'
        ? e(flashMfaAndRedirect({
            reason: t.reason,
  ...
  return _$$d8()
    ? jsx(_$$O, {})
    : isHubFileEmbedView(r)
      ? jsx(sN, {
          hubFileId: r.hubFileId,
        })
      : isMonetizationRedirectView(r)
        ? jsx(iW, {})
        : jsx(_$$K3, {
                      ...
                      children: jsx(_$$ds, {
                        children: jsxs(FplStringsProvider, {
                          ...
                          children: [!1, jsx(ErrorBoundaryCrash, {
                            ...
                            children: jsx(_x, {}),
                          }), getFeatureFlags().fpl_flash_view_migration
                            ? jsx(_$$J, {
                                flashes: t,
                              })
                            : jsx(_$$a4, {
...
(function (e) {
  if (!getFeatureFlags().web_vitals_report)
    return
