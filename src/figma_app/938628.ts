...
import { c$ as _$$c$2, sK, tV as _$$tV, l6 } from "../905/794875";
import { XO, zn, jw, mw, QG, aj, Zg, rX as _$$rX, Ng, qU, wV, SC, zg, jQ, Kl, Md, wf, Fp, qi, dr, G7, hl, p3 } from "../figma_app/409807";
...
import { Vk, II } from "../figma_app/200284";
...
import { v as _$$v2, q as _$$q2 } from "../905/476456";
import { M9, KG, Df, Jo, AY, Xs } from "../figma_app/98483";
...
function W() {
  return selectWithShallowEqual(e => {
    ...
    return {
      ...
      hasMinOrMaxWidth: null != t.minWidth || null != t.maxWidth,
      hasMinOrMaxHeight: null != t.minHeight || null != t.maxHeight
    };
  });
}
class X {
  constructor(e, t) {
    this.isHorizontal = "HORIZONTAL" === e;
...
function Q(e) {
  ...
  let y = "MAX" === u.horizontalConstraint || "STRETCH" === u.horizontalConstraint;
  let b = "MIN" === u.verticalConstraint || "STRETCH" === u.verticalConstraint;
  let I = "MAX" === u.verticalConstraint || "STRETCH" === u.verticalConstraint;
  let S = "CENTER" === u.horizontalConstraint;
  let v = "CENTER" === u.verticalConstraint;
  let x = (e, t) => {
  ...
  let R = (e, t) => {
    ...
    let r = "horizontal" === t ? f : b;
    let n = "horizontal" === t ? y : I;
...
function el(e) {
  ...
  return jsxs(Fragment, {
    children: [jsxs(_$$bL, {
      onChange: t ? lQ : t => {
        let r = "HORIZONTAL" === e.axis ? "horizontalConstraint" : "verticalConstraint";
        e.updateConstraints({
          [r]: t
        }, !0);
      },
...
function e_(e) {
  ...
  let _ = (t, r) => n => {
    ...
    if (p(n) || e.isCompact) {
      let n = "MIN" === r ? "MAX" : "MIN";
      let a = u(t);
      let s = "VERTICAL" === t ? !e.disableVerticalStretchScaleConstraints : !e.disableHorizontalStretchScaleConstraints;
      a === r && s ? i = "SCALE" : a === n && s ? i = "STRETCH" : "STRETCH" === a && (i = n);
    }
    "VERTICAL" === t ? e.updateConstraints({
  ...
  let E = t => {
    if (!e.readOnly) {
      if ("CENTER" !== d || p(t)) {
        if ("CENTER" !== l || p(t)) {
          if ("VERTICAL" === g(t)) {
            let r = p(t) && "CENTER" === d ? "SCALE" : "CENTER";
            e.updateConstraints({
              verticalConstraint: r
            });
          } else {
            let r = p(t) && "CENTER" === l ? "SCALE" : "CENTER";
            e.updateConstraints({
              horizontalConstraint: r
            });
          }
        } else e.updateConstraints({
  ...
  let y = t => {
    e.readOnly || ("CENTER" === d ? s("HORIZONTAL") : "CENTER" === l ? s("VERTICAL") : s(g(t)));
  };
  let b = () => {
    s(null);
  };
  ...
  let S = (r, n) => {
    let i = "HORIZONTAL" === c(r) ? e.isCompact ? "constraint_selector--compactOuterHorizontalHandle--LVIo0 constraint_selector--outerHorizontalHandle--5Riwa constraint_selector--_handle--LH-q2" : "constraint_selector--outerHorizontalHandle--5Riwa constraint_selector--_handle--LH-q2" : e.isCompact ? "constraint_selector--compactOuterVerticalHandle--bF8mY constraint_selector--outerVerticalHandle--SrFsJ constraint_selector--_handle--LH-q2" : "constraint_selector--outerVerticalHandle--SrFsJ constraint_selector--_handle--LH-q2";
    return f()(i, I(n), {
      [ep]: t === r && !o
    });
  };
  let v = (t, r) => {
    let n = "HORIZONTAL" === t ? e.isCompact ? "constraint_selector--compactInnerHorizontalHandle--voVqQ constraint_selector--_compactInnerHandle--gqwrT constraint_selector--_handle--LH-q2" : "constraint_selector--innerHorizontalHandle--Zfxr0 constraint_selector--_innerHandle--UA2jx constraint_selector--_handle--LH-q2" : e.isCompact ? "constraint_selector--compactInnerVerticalHandle--UTZB- constraint_selector--_compactInnerHandle--gqwrT constraint_selector--_handle--LH-q2" : "constraint_selector--innerVerticalHandle--slyp1 constraint_selector--_innerHandle--UA2jx constraint_selector--_handle--LH-q2";
    return f()(n, I(r), {
      [ep]: a === t && !o
    });
  };
    ...
    children: [jsx("div", {
      ...
      children: [A("left"), (() => {
        ...
        return jsx("div", {
          ...
          children: "CENTER" === l ? jsxs(Fragment, {
            children: [r, t]
          }) : jsxs(Fragment, {
            children: [t, r]
          })
...
function eg(e) {
  ...
  let _ = t => {
    if (!e.readOnly) {
      if ("CENTER" !== o || c(t)) {
        if ("CENTER" !== s || c(t)) {
          if ("VERTICAL" === p(t)) {
            let r = c(t) && "CENTER" === o ? "SCALE" : "CENTER";
            e.updateConstraints({
              verticalConstraint: r
            });
          } else {
            let r = c(t) && "CENTER" === s ? "SCALE" : "CENTER";
            e.updateConstraints({
              horizontalConstraint: r
            });
          }
  ...
  let h = t => {
    e.readOnly || ("CENTER" === o ? r("HORIZONTAL") : "CENTER" === s ? r("VERTICAL") : r(p(t)));
  };
  let m = () => {
    r(null);
  };
  let g = t => {
    ...
    return jsx(D8, {
      ...
      children: c ? jsx("div", {
        ...
        ...Ay.props(eb.baseHandle, "HORIZONTAL" === r && eb.horizontalHandle, o && ("HORIZONTAL" === r ? eb.horizontalHandleSelected : eb.verticalHandleSelected), a && eb.handleDisabled)
      })
    });
  };
  let f = r => {
    ...
    return jsx(D8, {
      ...
      onMouseLeave: m,
      children: jsx("div", {
        ...Ay.props(ey.baseInnerTarget, "HORIZONTAL" === i ? ey.horizontalInnerConstraintHandle : ey.verticalInnerConstraintHandle, a && ("HORIZONTAL" === i ? eb.horizontalHandleSelected : eb.verticalHandleSelected))
      })
    });
  };
  return jsxs("div", {
    ...
    children: [jsx("div", {
      ...
      children: (() => {
        ...
        return jsx("div", {
          ...
          children: "CENTER" === s ? jsxs(Fragment, {
            children: [t, e]
          }) : jsxs(Fragment, {
            children: [e, t]
          })
...
function td({
  ...
  !function (e) {
    ...
    show({
      canShow: (e, t) => e && null != t && _$$A3(t).isBefore("2025-02-04")
    });
  }, [show]));
...
function tc() {
  let {
    ...
    let e = useContext(tl);
    if (!e) throw Error("Tried to use `useAspectRatioLockOverlay` outside of provider!");
    return e;
  }();
  return jsx(_$$rq, {
    arrowPadding: 4,
...
function tz({
  ...
  let l = {
    ...
    setMinValue: a,
    setMaxValue: o,
    stackSize: kl("stackVerticalSize"),
    isAuto: M9().heightIsAuto,
...
function tW({
  ...
  let l = {
    ...
    setMinValue: a,
    setMaxValue: o,
    stackSize: kl("stackHorizontalSize"),
    isAuto: M9().widthIsAuto,
    variableField: "WIDTH",
    minMaxOptions: [mw, QG],
    strings: {
...
function tK() {
  let e = useContext(tH);
  if (!e) throw Error("DimensionInputConfigContext not initialized!");
  return e;
}
function tY() {
  return {
...
function t5({
  ...
  let u = function (e) {
    ...
    return useCallback(n => {
      ...
      return a ? (!function e(t, r) {
        ...
        for (let n of Object.values(t.next)) if (!e(n, r)) return !1;
        return !0;
      }(a, r => {
        let n = t[r];
  ...
  let g = useMemo(() => function (e, t, r) {
    ...
    n.format = e => "number" == typeof r ? t1(String(r)) : i(e);
    n.incrementBy = (e, t, n) => "number" == typeof r ? r + t : e;
    let a = n.parse.bind(n);
    n.parse = (e, r) => {
      let n = t(e);
      return null != n ? n : a(e, r);
    };
    n.incrementBy = (e, t, n) => "number" == typeof r ? r + t : e;
  ...
  return jsxs("div", {
    ...
    children: [jsx(e, {
      ...
      onChange: e => {
        let t = "string" == typeof e ? tZ(e) : null;
        if (t) {
          d(t, axis);
          c(t, axis);
          return;
      ...
      forwardedRef: useCallback(e => {
        h.current = e;
        "function" == typeof forwardedRef ? forwardedRef(e) : forwardedRef && (forwardedRef.current = e);
      }, [forwardedRef])
    }), b && jsx("span", {
...
function t3() {
  let e = kl("nodesAreAllStacksOrInStacks");
  let t = _$$rX();
...
function re(e) {
  ...
  let v = function (e) {
    ...
    let _ = kl("isNonEditableInstanceSublayerSelected");
    let m = kl("isBreakpointFrameSelected");
    let g = t3();
    let f = Tv();
    return useMemo(() => {
      let r = [];
  ...
  let K = strings.dim;
  null != minValue && null != maxValue ? K = strings.dimWithMinMax : null != minValue ? K = strings.dimWithMin : null != maxValue && (K = strings.dimWithMax);
...
function rE() {
  let e = W();
  return !(dr() && "AUTO" === e.stackPositioning);
}
function ry(e) {
  let t = W();
...
export let $$r24 = memo(function (e) {
  let t = Df();
  let r = Jo();
  let {
    hasSelectedText,
...
export function $$r51(e) {
  let t = kl("width");
  let r = kl("height");
  let i = kl("isInstanceSelected");
  let s = kl("isNonEditableInstanceSublayerSelected");
  let o = kl("resizeToFit");
  let l = kl("canBecomeFrame");
  let d = kl("canBecomeGroup");
  let c = kl("canBecomeSection");
  let u = kl("isSection");
  let p = !!(i || s);
...
export function $$r87(e) {
  ...
  let f = kl("isNonEditableInstanceSublayerSelected");
  let E = useCallback(e => {
    g({
      widthOrHeight: "width",
      minOrMax: e,
...
export let $$r70 = memo(function (e) {
  let [t, r] = lJ("arcStart");
  let [i, s] = lJ("arcSweep");
  let [o, l] = lJ("arcRadius");
  let {
    smallNudgeAmount,
    bigNudgeAmount,
    wheelMultiplier,
...
export function $$r96(e) {
  ...
  kl("x");
  let [a, s] = Xw();
  let [o] = lJ("hasPartialRadiusSelection");
  let l = jsx($$r48, {
    transformDisabled: !r.transform,
    recordingKey: e.recordingKey,
...
function ne(e) {
  let t = (e ? pw : zj)("x", "y", "cornerRadius", "handleMirroring");
  return {
    ...t,
    handleMirroring: t.handleMirroring
  };
