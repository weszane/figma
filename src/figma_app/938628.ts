...
class X {
  ...
  getUI3DropdownOverride(e) {
    if (e === 'STRETCH')
      return this.isHorizontal ? getI18nString('fullscreen.properties_panel.constraints_panel.select.left_and_right_truncated') : getI18nString('fullscreen.properties_panel.constraints_panel.select.top_and_bottom_truncated')
  }
}
function q(e, t, r) {
  switch (e) {
  ...
  let R = (e, t) => {
    ...
    i && void 0 !== e[0]
      ? (function (e, t, r, n, i) {
        ...
        }(e[0], t, u.verticalConstraint, u.horizontalConstraint, g))
      : e.length === 2 || r && n ? (r && n && void 0 !== e[0] && e.push(e[0]), void 0 !== e[0] && J(e[0], a[0], u.verticalConstraint, u.horizontalConstraint, g), void 0 !== e[1] && J(e[1], a[1], u.verticalConstraint, u.horizontalConstraint, g)) : void 0 !== e[0] && (n ? J(e[0], a[1], u.verticalConstraint, u.horizontalConstraint, g) : J(e[0], a[0], u.verticalConstraint, u.horizontalConstraint, g))
  }
  let L = (e, t) => {
    let r = e === 'MIN' || e === 'STRETCH'
    let n = e === 'MAX' || e === 'STRETCH'
...
let eo = new class {
  format(e) {
    if (e === 'AUTO')
      return getI18nString('fullscreen.auto')
  }
}()
function el(e) {
  let t = z()
...
function eh(e, t = !1) {
  let r = W()
  if ((e === 'HORIZONTAL' ? r.stackHorizontalSize : r.stackVerticalSize) === LayoutSizingMode.FILL_CONTAINER || r.stackMode !== 'NONE' && (e === 'HORIZONTAL' ? r.hasMinOrMaxWidth : r.hasMinOrMaxHeight))
    return !0
  if (r.scrollBehavior !== MIXED_MARKER && (t || r.scrollBehavior !== 'FIXED_WHEN_CHILD_OF_SCROLLING_FRAME'))
    return !1
...
function eA(e) {
  ...
  let [x, R] = useState(!1)
  let L = (e) => {
    if ((e === 'HORIZONTAL' ? u.stackHorizontalSize : u.stackVerticalSize) === LayoutSizingMode.FILL_CONTAINER || u.stackMode !== 'NONE' && (e === 'HORIZONTAL' ? u.hasMinOrMaxWidth : u.hasMinOrMaxHeight))
      return !0
    if (u.scrollBehavior !== MIXED_MARKER)
      return !1
...
function eH(e) {
  ...
  let C = isInvalidValue(width) || isInvalidValue(height)
    ? null
    : fS({
        width,
        height,
...
function td({
  ...
  !(function (e) {
    ...
    show({
      canShow: (e, t) => e && t != null && _$$A3(t).isBefore('2025-02-04'),
    })
  }, [show])))
...
function tc() {
  let {
    ...
    let e = useContext(tl)
    if (!e)
      throw new Error('Tried to use `useAspectRatioLockOverlay` outside of provider!')
    return e
  }())
  return jsx(_$$rq, {
    arrowPadding: 4,
...
function tK() {
  let e = useContext(tH)
  if (!e)
    throw new Error('DimensionInputConfigContext not initialized!')
  return e
}
function tY() {
  return {
    ...
    return useCallback((n) => {
      ...
      return a
        ? (!(function e(t, r) {
          ...
          })), i.size === 1 ? LayoutSizingMode[Array.from(i)[0]] : null)
        : null
    }, [r, e, t])
  }(function () {
...
function t4(e) {
  ...
  let E = useSelector<AppState>((e) => {
    if (isInvalidValue(e.mirror.selectionProperties.cooperTemplateData))
      return MIXED_MARKER
    if (!e.mirror.selectionProperties.cooperTemplateData)
      return SocialMediaFormats.CUSTOM
    ...
    return {
      text: (function (e, t, r) {
        switch (t) {
          case LayoutSizingMode.FIXED:
            return e === Axis.X
              ? getI18nString('fullscreen.properties_panel.stack_panel.al.fixed.width', {
                  value: r_(r),
                })
  ...
  return jsx(setupToggleButton, {
    ...
    'onChange': () => {
      permissionScopeHandler.user('set-stack-position', () => {
        i === 'ABSOLUTE'
          ? (s('AUTO'), o('Remove Absolute Position'))
          : (s('ABSOLUTE', yesNoTrackingEnum.NO), Fullscreen.bringSelectionToFrontVisually(), Fullscreen.triggerAction('commit', {}), _$$F.trackFromFullscreen('add_absolute_position', {
...
let rH = memo(e => o3(nt.fplScrubbableInput)
  ? jsx(rW, {
      ...e,
    })
  : jsx(rz, {
...
let rY = memo(e => o3(nt.fplScrubbableInput)
  ? jsx(rX, {
      ...e,
    })
  : jsx(r$, {
...
export function $$r51(e) {
  ...
  let T = useDispatch()
  return getFeatureFlags().eu_fpl_frame_preset_menu
    ? jsx(eH, {
        canBecomeFrame: !!l,
        canBecomeGroup: !!d,
        canBecomeSection: !!c,
...
export function $$r96(e) {
  ...
  let u = c.showIllustrationSliderInputs
    ? jsx(_$$U, {
        disabled: !1,
  ...
  let p = jsx(Fragment, {
    children: c.showIllustrationSliderInputs
      ? jsx(DE, {
          input: u,
          icon: null,
