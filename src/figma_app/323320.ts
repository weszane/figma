...
import { getSlotPropTypes, findCommonSymbolId, computeBackingGUID, getComponentPropDisplayName, findCommonValue, findCommonStateGroupId, intersectHiddenProps } from '../figma_app/164212';
import { EM_DASH } from '../figma_app/264776';
import { createBackingSymbolSelector, selectStateOrInstanceNode, createContainingInstanceBackingSymbolSelector, createContainingStateOrSymbolSelector, createSymbolNodesWithBackingSymbolSelector, getComponentProps, selectContainingStateOrSymbolId, selectResettableComponentPropAssignments } from '../figma_app/505098';
...
let E = () => createDeepEqualSelector([getComponentProps, selectStateOrInstanceNode(), createSymbolNodesWithBackingSymbolSelector()], (e, t, r) => {
  let n = r ?? t;
...
export function $$b7() {
  return createDeepEqualSelector([h, (e, t, r) => r], (e, t) => {
    let r = getSlotPropTypes(t).types;
...
let A = () => createDeepEqualSelector([getComponentProps, selectSceneGraph, (e, t) => t], (e, t, r) => {
  ...
  let n = findCommonSymbolId(r, t);
  let i = findCommonStateGroupId(r, t) ?? n;
  if (!i) return {};
...
let $$x8 = createSelector([(e, t) => t, (e, t, r) => r, f, selectSingleSelectedNode], (e, t, r, i) => {
  ...
  {
    let t = e === ComponentPropType.INSTANCE_SWAP ? getI18nString('design_systems.component_properties.instance_swap_property_default_name') : getComponentPropDisplayName(e);
    return generateUniqueName(t, r);
  }
});
export function $$N1() {
  return createDeepEqualSelector([selectSceneGraph, E(), A(), getComponentProps, (e, t) => t], (e, t, r, i, a) => {
    if (!i) return [];
    let s = intersectHiddenProps(a, i);
    return t.filter(e => !s.has(e.explicitDefID)).map(t => {
      let i = t.defaultValue;
      if (r[t.explicitDefID] != null) {
        let e = r[t.explicitDefID];
        i = e ? e.isMixed ? MIXED_MARKER : e.value : EM_DASH;
      }
      if (t.type === ComponentPropType.INSTANCE_SWAP && i !== EM_DASH && i !== MIXED_MARKER) {
        let t = computeBackingGUID([i], e);
        i = t && isValidValue(t) ? t.name : EM_DASH;
      }
      return {
        name: t.name,
        value: i,
  ...
  for (let a of n) {
    for (let n in t[a]) {
      ...
      for (let e in i[o] || (i[o] = {}), t[a][n]) {
        i[o][e] ? i[o][e].instanceGUIDs.push(n) : i[o][e] = {
          name: t[a][n][e],
          instanceGUIDs: [n]
        };
      }
