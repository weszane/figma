...
import { J7, SN, G_ as _$$G_, _d, M7 } from "../figma_app/650409";
import { oU, J0, Od } from "../figma_app/967319";
...
import { Ft, jX, SC, Sc, ck, bb } from "../figma_app/707808";
import { Iv, A$, F9, pu } from "../905/548208";
import { o as _$$o } from "../905/895626";
import { V0, m2, rj, dN, Fi } from "../figma_app/858344";
...
export function $$V0({
  ...
  let n = wA(t);
  let i = xw(t);
  return !n || !i || !n.bigma_enabled || r.subView === GN.ADMIN && !e && !i.license_admin;
}
export function $$H4({
  isAdminOrg: e,
  permissions: t,
  ...
  return !(i && a && (r !== J7.WORKSPACES && n !== SN.WORKSPACES || !t.currentUserOrgId || s) && (e || a.license_admin || a.workspace_users?.some(e => "admin" === e.permission))) || r === J7.BILLING && n === _$$G_.BILLING_GROUPS && !s;
}
export function $$z3({
  isAdminTeam: e,
  ...
  return (t === Iv.BILLING || t === Iv.DASHBOARD) && (!e || !n[r] || n[r].student_team || !w5(n[r]));
}
let W = {
  feed: {
    slug: "feed",
    i18nName: () => _$$t("view_selectors.file_browser.feed"),
    hasMissingResource: () => !1
  },
  resourceUnavailable: {
    slug: "resourceUnavailable",
    i18nName: () => _$$t("view_selectors.file_browser.resource_unavailable"),
    hasMissingResource: () => !1,
    isNonUrlAddressable: !0
  },
  deletedFiles: {
    slug: "trashed",
    i18nName: () => _$$t("view_selectors.file_browser.trash"),
    hasMissingResource: () => !1
  },
  trashedFolders: {
  ...
  teamCreation: {
    slug: "create-team",
    i18nName: () => _$$t("view_selectors.file_browser.create_new_team"),
    hasMissingResource: () => !1,
  ...
  team: {
    ...
    hasMissingResource: (e, t) => {
      ...
      let n = t.teamViewTab === A$.BILLING && (!canAdminTeam(teamId, e) || !e.teams[teamId] || !e.teams[teamId].pro_team);
      return HZ({
  ...
  limitedTeamSharedProjects: {
    ...
    i18nName: () => _$$t("sidebar.all_shared_projects"),
    hasMissingResource: () => !1
  },
  teamAdminConsole: {
  ...
  addCollaborators: {
    ...
    i18nName: () => _$$t("view_selectors.file_browser.add_collaborators"),
    hasMissingResource: () => !1
  },
  teamUpgrade: {
    slug: "upgrade-team",
    hasMissingResource: (e, t) => !getFeatureFlags().redirect_starter_team_loophole && null === t.teamId && jX(t.teamFlowType) || !!t.teamId && !(t.teamId in e.teams),
    missingResourceType: Ft.TEAM,
  ...
  seatRequests: {
    slug: "seat-requests",
    i18nName: () => _$$t("admin_dashboard.requests.seat_title"),
    hasMissingResource: () => !1
  },
  workspace: {
    slug: "workspace",
  ...
  orgDomainManagement: {
    slug: "domains",
    i18nName: () => _$$t("view_selectors.file_browser.org_domain_management"),
    hasMissingResource: () => !1
  },
  orgIdpManagement: {
    slug: "idps",
    i18nName: () => _$$t("view_selectors.file_browser.org_idp_management"),
    hasMissingResource: () => !1
  },
  abandonedDraftFiles: {
    slug: "abandoned_draft_files",
    i18nName: () => _$$t("org_admin_tab.abandoned_drafts"),
    hasMissingResource: () => !1
  },
  orgAdminSettings: {
    slug: "admin",
    i18nName: () => _$$t("view_selectors.file_browser.org_admin"),
    hasMissingResource: () => !1,
    areDifferent: (e, t) => e.orgAdminSettingsViewTab !== t.orgAdminSettingsViewTab || e.orgAdminSettingsViewSecondaryTab !== t.orgAdminSettingsViewSecondaryTab || !l()(e.orgAdminMembersTabFilters, t.orgAdminMembersTabFilters) || !l()(e.orgAdminMembersTabSort, t.orgAdminMembersTabSort)
  },
  search: {
    slug: "search",
    hasMissingResource: () => !1,
    areDifferent: (e, t) => e.entryPoint !== t.entryPoint,
    stripFuidParam: e => "community" === e.entryPoint
  },
  user: {
    slug: "user",
    i18nName: () => _$$t("view_selectors.file_browser.user"),
    hasMissingResource: () => !1,
    areDifferent: (e, t) => e.userViewTab !== t.userViewTab || e.userId !== t.userId
  },
  recentsAndSharing: {
    slug: "recents-and-sharing",
    i18nName: () => _$$t("view_selectors.file_browser.recents_and_sharing"),
    hasMissingResource: () => !1
  },
  draftsToMove: {
    slug: "drafts-to-move",
    i18nName: () => _$$t("view_selectors.file_browser.drafts_to_move"),
    hasMissingResource: () => !1
  },
  resourceHub: {
    slug: "resources",
    i18nName: () => _$$t("view_selectors.file_browser.templates_and_tools"),
    hasMissingResource: () => !1
  }
};
...
function X({
  ...
  $D(_$$e.WAYFINDING, Error(`Invalid ${e} ID while parsing selected view ${t} from path`), {
    extra: {
      matchingViewName: t,
      ...r
    }
...
export class $$q1 {
  pathToSelectedView(e, t, r, n) {
    if ("my_plugins" === t[1] && e.user) return {
      view: "user",
      userId: e.user.id,
      userViewTab: _$$o.PLUGINS
    };
    if ("files" !== t[1]) return null;
    if ("drafts" === t[2]) return {
      view: "folder",
      folderId: e.user?.drafts_folder_id
    };
    if ("recent" === t[2]) return {
    ...
    switch (o) {
      case "folder":
        {
          ...
          let n = !1;
          r && null != parseQuery(r).renameProject && (n = "true" === parseQuery(r).renameProject);
          return {
            view: o,
            folderId: e,
      ...
      case "team":
        {
          ...
          let c = A$.HOME;
          if (4 === t.length) {
            let e = K(A$, t[t.length - 1]);
            e && e !== A$.PROFILE && (c = e);
          }
          if (5 === t.length || 6 === t.length) {
            if ("restore" === t[5]) return null;
            let e = K(A$, t[t.length - 1]);
            e && e !== A$.PROFILE && (c = e);
          }
          ...
          r && null != parseQuerySimple(r).rciid && (n = parseQuerySimple(r).rciid);
          p && r && null != parseQuery(r).proUpgrade && (a = "true" === parseQuery(r).proUpgrade);
          r && null != parseQuery(r).assetTransferRequest && (s = parseQuery(r).assetTransferRequest);
          return {
            view: "team",
            teamId: d,
            teamViewTab: c,
      ...
      case "teamAdminConsole":
        {
          ...
          s || (s = d ? Iv.DASHBOARD : Iv.MEMBERS);
          let c = "";
          d && r && parseQuery(r).dashEntryPoint && (s = Iv.DASHBOARD, c = parseQuery(r).dashEntryPoint);
          s === Iv.CONTENT && n === F9.CONNECTED_PROJECTS && r && null != parseQuerySimple(r).rciid && (a = parseQuerySimple(r).rciid);
          return {
            view: o,
            teamId: l,
      ...
      case "teamUpgrade":
        {
          ...
          if (n && i !== SC.UPGRADE_EXISTING_TEAM) {
            $D(_$$e.MONETIZATION_UPGRADES, Error("Invalid team flow type while parsing selected view from path"), {
              extra: {
                matchingViewName: o,
                parts: t
              }
          ...
          if ("n" === _) {
            if (_ = null, n) {
              $D(_$$e.MONETIZATION_UPGRADES, Error("Null team ID while parsing selected view from path"), {
                extra: {
                  matchingViewName: o,
                  parts: t
                }
      ...
      case "billingGroupDashboard":
        return {
          view: o,
          selectedTab: K(_$$D, t[3] ?? "") ?? _$$D.REQUESTS
        };
      case "seatRequests":
        if (null === e.currentUserOrgId) return {
          view: o,
      ...
      case "orgAdminSettings":
        {
          ...
          n === J7.DASHBOARD && r && null != parseQuery(r).dashEntryPoint && (s.dashDeepLinkEntryPoint = parseQuery(r).dashEntryPoint);
          let o = rT(r, e.licenseGroups);
          n === J7.MEMBERS && o && (s.orgAdminMembersTabFilters = o);
          let l = _$$E(r);
          if (n === J7.MEMBERS && r && "date-upgraded" === parseQuery(r).initialSort ? s.orgAdminMembersTabSort = {
            columnName: Od.DESIGN_ROLE,
            isReversed: !0
          } : n === J7.MEMBERS && l && (s.orgAdminMembersTabSort = l), n === J7.MEMBERS && r && null != parseQuery(r).orgJoinRequest && (s.membersTabOrgJoinRequest = parseQuery(r).orgJoinRequest), r && null != parseQuery(r).assetTransferRequest && (s.teamsTabAssetTransferRequest = parseQuery(r).assetTransferRequest), n === J7.RESOURCES && r && (a === _d.APPROVED_PLUGINS || a === _d.APPROVED_WIDGETS)) {
            let e = parseQuery(r).eid;
            s.selectedExtensionId = e;
          }
          n === J7.CONTENT && a === SN.CONNECTED_PROJECTS && r && null != parseQuerySimple(r).rciid && (s.showResourceConnectionInviteModal = parseQuerySimple(r).rciid);
          return s;
        }
      case "search":
        return {
      ...
      case "user":
        {
          ...
          if ("settings" === t[t.length - 1] && i === e.user.id) {
          ...
          if ("plugins" === t[t.length - 1]) return {
            view: "recentsAndSharing",
            accountModalTab: bb.PLUGINS
          };
          if ("email_unsubscribe" === t[t.length - 1] && i === e.user.id) {
          ...
          getFeatureFlags().xr_debounce_threshold && "posts" === t[t.length - 1] && (a = _$$o.INTERNAL_PROFILE_POSTS);
          return {
            view: "user",
            userId: i,
            userViewTab: a
      ...
      case "feed":
        if (r) {
          let e = parseQuery(r);
          if (e.quickReplyFileKey && e.quickReplyThreadId) return {
            view: "feed",
            quickReplyInfo: {
      ...
      case "teamFeed":
        {
          if (null === e.currentUserOrgId || !getFeatureFlags().xr_debounce_threshold) return null;
      ...
      case "recentsAndSharing":
        {
          let e;
          if (t.length >= 4 && (e = K(G, t[t.length - 1])), !e) return {
            view: "recentsAndSharing"
          };
          return {
            view: "recentsAndSharing",
  ...
  selectedViewToPath(e, t) {
    ...
    let a = {};
    let o = i.slug;
    "folder" === e.view && t.user?.drafts_folder_id === e.folderId && (o = "drafts");
    let l = "";
    l = _$$i(t);
    let p = `/files${l}/${o}`;
    switch (e.view) {
      ...
      case "abandonedDraftFiles":
        ...
        break;
      case "orgAdminSettings":
        e.orgAdminSettingsViewTab && (p += `/${e.orgAdminSettingsViewTab}`, "members" === e.orgAdminSettingsViewTab && (e.orgAdminMembersTabFilters && (a = {
          ...a,
      ...
      case "licenseGroup":
        ...
        e.selectedTab === RM.MEMBERS && e.orgAdminMembersTabSort && (a = {
          ...a,
          ..._$$n(e.orgAdminMembersTabSort)
        });
        ...
        break;
      case "billingGroupDashboard":
        e.selectedTab === _$$D.ALL_REQUESTS && (p += `/${e.selectedTab}`);
        break;
      case "workspace":
        switch (e.subView) {
          case V0.ADMIN:
            ...
            break;
          case V0.DIRECTORY:
            p += `/${e.workspaceId ?? _$$O3}/${e.subView}/${e.selectedTab}`;
        }
        break;
      case "search":
      ...
      case "resourceHub":
        ...
        break;
      case "litmus":
        "feed" === e.subView && (p += `/${e.projectId}`);
    }
    let A = !i.stripFuidParam || !i.stripFuidParam(e);
    return (t.user && A && (a.fuid = t.user.id), _$$O() && (a._app_shell = "1"), 0 !== Object.keys(a).length) ? `${p}?${serializeQuery(a)}` : p;
  }
  selectedViewName(e, t) {
    ...
    switch (e.view) {
      case "folder":
        if (getFeatureFlags().folder_page_fix_tab_titles && t.user?.drafts_folder_id === e.folderId) return _$$t("sidebar.drafts");
        let n = t.folders[e.folderId];
        if (!n) return null;
        return CI(n);
      case "team":
        return t.teams[e.teamId]?.name ?? _$$t("view_selectors.file_browser.team");
      case "teamAdminConsole":
        let i = t.teams[e.teamId]?.name;
        return _$$t("view_selectors.file_browser.team_admin_console_with_name", {
          adminTeamName: i
        }) ?? _$$t("view_selectors.file_browser.team_admin_console_generic");
      case "teamUpgrade":
        if (e.teamFlowType === SC.CREATE_AND_UPGRADE || null === e.teamId) return _$$t("view_selectors.file_browser.create_new_team");
        let a = t.teams[e.teamId]?.name;
        if (a) return _$$t("view_selectors.file_browser.team_upgrade_with_name", {
          teamName: a
        });
        return _$$t("view_selectors.file_browser.team_upgrade_generic");
      case "search":
        let {
          query
        } = t.search.parameters;
        return query ? _$$t("view_selectors.file_browser.search_results_with_query", {
          query
        }) : _$$t("view_selectors.file_browser.search_results_generic");
      case "user":
        let {
          orgUsersByOrgId,
          currentUserOrgId
        ...
        if (e.userViewTab === _$$o.PLUGINS) return _$$t("view_selectors.file_browser.plugins");
        return "User";
      case "licenseGroup":
        return _$$t("view_selectors.file_browser.billing_admin");
      case "workspace":
        if (e.subView === V0.ADMIN) return _$$t("view_selectors.file_browser.workspace_admin");
        if (!e.workspaceId) return _$$t("view_selectors.file_browser.other_teams");
        return _$$t("view_selectors.file_browser.workspace");
      default:
