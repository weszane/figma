...
export function $$d6(e, t, r, s, o, d, c, u, p, _, h) {
  ...
  qV(s).then(a => {
    sx("ai_prompt_builder_output_requested", {
      fileKey: e,
      variantIndex: t,
      numVariants: r,
      promptId: a,
...
export function $$c1(e, t, r, s, o) {
  qV(r).then(r => {
    sx("ai_prompt_builder_output_streaming", {
      fileKey: e,
      variantIndex: t,
      promptId: r,
      outputType: l(s),
...
export function $$u8(e, t, r, s, o) {
  qV(r).then(r => {
    sx("ai_prompt_builder_output_created", {
      fileKey: e,
      variantIndex: t,
      promptId: r,
      outputType: l(s),
...
export function $$g2(e) {
  ...
  sx("ai_prompt_suggestions_viewed", {
