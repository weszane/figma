...
import { atom, atomStoreManager, setupAtomWithInitialValue, setupAtomWithMount, atomWithReducer } from '../figma_app/27355';
...
let m = setupAtomWithMount(atomWithReducer({
  mallocLevelBytes: 0,
  heapMemoryLimit: 1 / 0
}, () => ({
