...
import { keyboardLayoutEnumToNameMap, getCurrentKeyboardLayout } from "../figma_app/475303";
...
export function $$p1(e, t, r) {
  ...
  let d = h();
  let p = keyboardLayoutEnumToNameMap.get(getCurrentKeyboardLayout()) || "UNKNOWN";
...
export function $$_0(e, t) {
  if (!getFeatureFlags().ce_custom_keyboard_shortcuts) return;
  let r = h();
  let d = keyboardLayoutEnumToNameMap.get(getCurrentKeyboardLayout()) || "UNKNOWN";
...
export function $$m2() {
  let e = keyboardLayoutEnumToNameMap.get(getCurrentKeyboardLayout()) || "UNKNOWN";
