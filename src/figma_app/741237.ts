...
export function $$T30(e, t = !0) {
  Egt.replaceSelection(e, t);
}
export function $$I33() {
  Egt.clearSelection();
}
export function $$S5(e, t) {
  Egt.selectNodesInRange(e, t);
}
export function $$v13(e, t, r = KjJ.SCROLLS) {
  Egt.transferSelection(e, t, r);
}
export function $$A25(e, t, r = KjJ.SCROLLS) {
  Egt.duplicateSelection(e, t, r);
}
...
export function $$L22(e) {
  Egt.expandUpToRoot(e);
}
export function $$P28(e, t) {
  Egt.setExpandedRecursive(e, t);
}
export function $$D34(e, t) {
  Egt.setSelectionExpanded(e, t);
}
export function $$k21(e) {
  glU?.updateAppModel(e);
}
...
export function $$F19(e) {
  Ez5.uiState().hoveredComponentPropDef.set(e);
}
...
export function $$G15() {
  return Ez5?.propertiesPanelState()?.propertiesPanelTab;
}
export function $$V9(e) {
  return $$G15()?.set(e);
}
export function $$H8() {
  return Ez5?.devModePropertiesPanelState()?.getEnabledTabs() ?? [];
}
export function $$z32() {
  return Ez5?.devModePropertiesPanelState()?.selectedTab;
}
...
export function $$Y31(e, t, r) {
  Egt.setNodeLocked(e, t, r);
}
export function $$$27(e, t, r) {
  Egt.setNodeVisible(e, t, r);
}
  ...
  try {
    !function (e, t, r, a, o) {
      ...
      if (a = $$J20(a), t?.guid) {
        ...
        Egt.updateSelectionProperties(d, r, o, a === zk.YES, e);
      }
    }(e, t, r, a, o);
  } catch (e) {
    throw e;
...
export function $$er26(e = et) {
  e.has(0) && Y5.fromFullscreen.on("sceneGraphMirrorUpdate", ei);
  e.has(2) && (Y5.fromFullscreen.on("selection:addSelectors", es), Y5.fromFullscreen.on("selection:removeSelectors", eo), Y5.fromFullscreen.on("selection:replaceSelectors", el));
  e.has(1) && Y5.fromFullscreen.on("updateAppModel", ed);
  e.has(3) && Y5.fromFullscreen.on("selectionPropertiesUpdate", ec);
}
...
function es(e) {
  ...
  let t = e.buffer;
  if (t) for (let e = 0; e < t.length; e += 8) {
    let r = ea(t, e);
    let n = ea(t, e + 4);
    let i = dI({
      sessionID: r,
...
function ed({
  ...
  if (eD) {
    ...
    for (let t of Object.keys(e)) if (t.startsWith(i)) r[t.substr(i.length)] = e[t].value;else {
      let r = _$$m(t);
      if (void 0 !== r) {
        let i = e[t].value;
        for (let {
    ...
    e.keyboardShortcuts && (t = K(e.keyboardShortcuts.value));
