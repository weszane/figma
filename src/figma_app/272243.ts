...
import { G } from "src/905/289770";
import { DP } from "src/905/158740";
import { A } from "src/vendor/723372";
import { K } from "src/905/443068";
import { J } from "src/905/799737";
import { S as _$$S } from "src/905/823680";
import { L } from "src/905/704296";
import { C } from "src/905/520159";
import { P } from "src/905/143421";
import { Lh } from "src/figma_app/415899";
import { r } from "src/905/840133";
import { M8 } from "src/905/893109";
import { Q } from "src/905/586361";
import { g as _$$g } from "src/905/749786";
import { C as _$$C } from "src/905/780985";
import { Q as _$$Q } from "src/905/737752";
import { gy } from "src/905/183218";
import { s as _$$s } from "src/905/536340";
import { contents, allowOverflow, customContents, arrow, e as _$$e, header, close, closeButtonLight, closeButtonDark, title, tabStripRoot, tabStripScroll, tabStripContent, body, bodyNoScroll, bodyScrollContainer, bodyInner, scroller, footer, customFooter, actionStrip } from "src/905/511376";
