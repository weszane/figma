...
export function $$u0(e) {
  ...
  let t = e.displayForQuickCommand ? e.displayForQuickCommand : getActionOrName(e);
...
export function $$_2(e, t) {
  switch (e) {
    case JT.MAGIC_LINK:
      return renderI18nText("magic_link.qa_suggestion_toast");
    case JT.UPSCALE_IMAGE:
      let r = t.nodeImagePairs.length;
      return getFeatureFlags().aip_batch_image_modify ? renderI18nText("image_ai.upscale_image.qa_suggestion_toast.multiple_images", {
        num: r
      }) : renderI18nText("image_ai.upscale_image.qa_suggestion_toast");
    default:
      return renderI18nText("qa.toast.suggestion");
  }
}
