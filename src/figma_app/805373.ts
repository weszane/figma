...
import { getColorForMultiplayer, getMultiplayerTextColor, multiplayerColors, selectColorByString } from '../figma_app/136698'
...
export class $$Q2 extends Component {
  render() {
    let e = {
      ...
      color: this.props.tint || getMultiplayerTextColor(this.props.color),
    ...
    return jsx('span', {
      ...
      'className': l()(a, this.props.className || '', {
        [f]: !t,
        [y]: this.props.borderStyle === 'outward',
        [b]: this.props.borderStyle === 'inward',
      }),
      'aria-hidden': 'true',
...
export function $$et8(e) {
  ...
  if (!e.removeCustomFill) {
    let r = getMultiplayerTextColor(e.color)
    t.fill = r
  }
  return jsx($$Q2, {
    ...e,
...
class en extends Component {
  ...
  render() {
    ...
    let a = this.state.loadError || !this.props.imgUrl
      ? this.props.children
      : jsx(WAFImage, {
...
let eo = (e, t = ea) => class extends Component {
  constructor() {
    ...
    this.computeFallbackInitial = () => {
      ...
      return e && typeof e == 'string' ? t.getInitial(e) : null
    }
    this.computeFallbackColor = () => getColorForMultiplayer(this.props.entity.id, t.colors)
  }
...
class el extends Component {
  renderFallback() {
    ...
    if (this.props.hideFallbackInitial) {
      return jsx($$Q2, {
        size: $(size)?.fallbackSize,
        fontSize,
    ...
    return o
      ...
      : this.props.defaultFallbackAvatarSvg
        ? jsx(er, {
            className: this.props.className,
            size: $(size)?.fallbackSize,
  ...
  render() {
    return !this.props.imgUrl || $$W12(this.props.imgUrl)
      ? this.renderFallback()
      : jsx(en, {
...
export function $$eu10({
  ...
  let i = selectColorByString(e?.id, z)
  return jsx(er, {
    src: i.svgSrc,
    size: t,
    shape: r,
...
class eb extends Component {
  render() {
    ...
    let t = ey[labelSize]
    let r = this.props.showTruncatedTextTooltip
