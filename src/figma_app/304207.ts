...
let $$v0 = (createOptimistAction("SAVE_EXTENSION", (e, {
  ...
  N.then(({
    ...
    if (e.dispatch(Qi({
      ...
      let t = (() => {
        if (T === "inserts_modal")
          return r === ResourceTypeNoComment.PLUGIN ? getI18nString("community.saves.plugin_saved") : getI18nString("community.saves.widget_saved")
        if (p) {
    ...
    t.data.status === 403
      ? e.dispatch(VisualBellActions.enqueue({
          message: r === ResourceTypeNoComment.PLUGIN
            ? getI18nString("community.actions.unable_to_save_plugin_error", {
  ...
  b.then(({
    ...
    if (e.dispatch(Qi({
      ...
      let n = {
        message: (() => {
          if (c === "inserts_modal")
            return r === ResourceTypeNoComment.PLUGIN ? getI18nString("community.saves.plugin_removed_from_your_account") : getI18nString("community.saves.widget_removed_from_your_account")
          if (i) {
...
let N = createOptimistThunk((e, t) => {
  ...
  n && n(t.orgId).then(({
    ...
    e.dispatch(VisualBellActions.enqueue({
      ...
      message: t.resourceType === ResourceTypeNoComment.PLUGIN
        ? getI18nString("community.actions.unable_to_save_plugin_error", {
