...
export function $$v5(e, t = 'fragment-search') {
  ...
  let n = generateExportThumbnail(r, e.guid, !1, void 0, !1, !0);
  return n && n.pixels && n.pixelSize && n.displaySize && convertImageDataToURL(n.pixels, n.pixelSize).split(';base64,').pop() || null;
}
