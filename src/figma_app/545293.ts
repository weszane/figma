...
export function $$E9(e, t, r, n, a, s, o) {
  return n ? {
    ...
    query_node_id: "input-selection" === n.type ? n.node.guid : void 0,
...
export function $$v5(e, t = "fragment-search") {
  let r;
  r = "fragment-search" === t ? $$I16(new Point(e.size.x, e.size.y)) : $$I16(function (e, t) {
...
export async function $$A11(e, t, r) {
  return t.x !== e.width || t.y !== e.height ? {
    ...
    value: function (e, t) {
      ...
      throw Error("Invalid data URL format");
    }(e, t)
  } : {
    type: "image",
    value: await _$$t(r)
...
export async function $$N7(e, t, r, l, c, u, p, _) {
  ...
  let b = {
    session_id: g,
    search_id: h,
    node_id: "input-selection" === e.type ? e.node.guid : ""
  };
  try {
    let a = [];
    switch (e.type) {
...
export async function $$C17(e, t, r, n, i) {
  ...
  let o = $$v5(node);
  if (!o) throw Error("Failed to export thumbnail");
