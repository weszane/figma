...
import { vn, Em, ow } from "../figma_app/976749";
...
import { LB, JQ } from "../figma_app/29089";
import { QE } from "../figma_app/914216";
import { F as _$$F2 } from "../figma_app/127204";
import { e as _$$e } from "../figma_app/630744";
import { gc, jw, Xl, bw } from "../figma_app/781981";
import { m9, dP } from "../figma_app/947348";
...
import { ah, fP, tx as _$$tx } from "../figma_app/240115";
import { RW, ay } from "../figma_app/17220";
import { aC, bX, RK, NV } from "../figma_app/193101";
...
import { Zp, yc, T0, gv, XS as _$$XS, sE, aj, rq, $L, aT, TQ, mp, gF, ek as _$$ek, zU } from "../figma_app/386160";
...
import { bh, X9, VE } from "../figma_app/730706";
var p = u;
...
function F() {
  ...
  let E = useCallback(e => {
    e && (t && "RESPONSIVE_SET" === t.type ? l7.user("dakota-set-text-binding", () => {
      t.setDakotaSelectorCollection(e, TsU.CMS_PROPERTIES_PANEL);
    }) : f(e, () => {
      o(_$$F.enqueue({
        button: {
          text: _$$t("dakota.fullscreen_actions.visual_bell.go_to_component"),
          action: () => {
            Y5.triggerActionEnum(rcl.GO_TO_REPEATER_COMPONENT);
          }
        },
        message: _$$t("dakota.fullscreen_actions.visual_bell.repeater_created"),
        onDismiss: () => {}
      }));
    }));
  }, [t, f, o]);
  if (!_$$U2() || !_ || 0 === (p ?? []).length || m) return;
  if (!getFeatureFlags().dakota_grid_repeaters && t?.stackMode === "GRID") return {
    type: ZU.CUSTOM_ACTION,
    customActionType: Wg.STANDARD_BUTTON,
    onClick: lQ,
    icon: jsx(_$$T, {}),
    getTitle: () => _$$t("dakota.collection_selector.connect_submenu_title"),
  ...
  return {
    ...
    getTitle: () => getFeatureFlags().cms_bindings_ux_improvements ? _$$t("dakota.collection_selector.connect_list_to_cms_title") : _$$t("dakota.collection_selector.connect_submenu_title"),
    items: P,
...
function j() {
  ...
  if (t && r) return {
    ...
    icon: jsx(_$$U, {}),
    getTitle: () => _$$t("dakota.collection_selector.disconnect_submenu_title"),
    recordingKey: "removeCmsCollectionAction",
    customActionType: Wg.STANDARD_BUTTON
  };
}
let U = e => !!e && "RESPONSIVE_SET" === e.type && "/" !== e.name;
let ea = {
  type: ZU.ACTION,
...
let ed = {
  ...
  getTooltip: () => _$$t("fullscreen_actions.more-transform-modifier-options"),
  actions: [es, eo, el],
  ...
  return e ? jsx(_$$E, {
    ...
    children: jsx("div", {
      ...
      children: jsx(_$$z, {
        ...
        children: _$$t("figmake.toolbar.goToSource")
      })
    })
  }) : null;
}
function ek() {
  let e = function () {
    ...
    return {
      ...
      recordingKey: M,
      icon: jsx(_$$i, {}),
      getTitle: () => _$$t("dakota.collection_selector.connect_page_to_cms_title"),
      items: c,
      preventSingleItemSubmenuFlattening: !0,
      preventHoisting: !1
    };
...
let ez = memo(function ({
  ...
  switch (g) {
    ...
    case "REPEATER":
    case "FRAME":
      if (t && t.getDakotaSelector()?.collectionId) return jsxs("div", {
        className: _$$s.flex.wFull.justifyBetween.$,
        children: [jsx(eK, {
          node: t,
          nodeTypeStringToDisplay: tx("dakota.properties_panel.repeater_header"),
          panelTitleRef: c
        }), m && jsx(_$$S, {
      ...
      if (t && t.isBreakpointFrame) return jsx(eK, {
        node: t,
        panelTitleRef: c
      });
      if (u || p) {
        if ("MIXED_FRAME_SECTION_GROUP" === g) return f;
        return t ? jsx(eK, {
          node: t,
          panelTitleRef: c
        }) : null;
    ...
    case "WEBPAGE":
      return t ? jsxs("div", {
        ...
        children: [jsx(eK, {
          node: t,
          nodeTypeStringToDisplay: getFeatureFlags().cms_bindings_ux_improvements && t.getDakotaSelectorCollectionId() ? tx("sites.panel.toolbar_header.webpage_bound_to_cms") : tx("sites.panel.toolbar_header.webpage"),
          panelTitleRef: c
        }), jsxs("div", {
...
function eW({
  ...
  let r = useMemo(() => {
    ...
    return 1 === new Set(e.map(e => e?.guid)).size ? e[0] : null;
  }, [t]);
  return r ? jsx(eK, {
    node: r,
    panelTitleRef: e
...
function eK({
  ...
  let u = t || function (e, t, r, n) {
    if (function (e, t) {
      ...
      if (r) return _$$t("fullscreen.properties_panel.layer_header.node_type_video");
      if (n) return _$$t("fullscreen.properties_panel.layer_header.node_type_image");
    }
    ...
    switch (e.type) {
      ...
      case "SLIDE":
        return _$$Y(e) && e.isSkippedSlide ? _$$t("fullscreen.properties_panel.layer_header.node_type_slide_skipped") : _$$t("fullscreen.properties_panel.layer_header.node_type_slide", {
          slideNumber: e.name
        });
      ...
      case "TRANSFORM":
        return _$$t("fullscreen.properties_panel.layer_header.node_type_transform_group");
      case "FRAME":
        if (n) {
    ...
    children: jsx("div", {
      ...
      children: jsxs("div", {
        ...
        children: [jsx(_$$d2, {
          ...
          label: jsx(_$$J3, {
            children: _$$t("fullscreen.properties_panel.video_controls.autoplay")
          })
        }), jsx(_$$d2, {
          id: "mediaLoop",
          checked: !0 === e,
          ...
          label: jsx(_$$J3, {
            children: _$$t("fullscreen.properties_panel.video_controls.loop")
          })
        }), jsx(_$$d2, {
          id: "showControls",
          checked: !0 === i,
          ...
          label: jsx(_$$J3, {
            children: _$$t("fullscreen.properties_panel.video_controls.show_playback_controls")
          })
        }), jsx(_$$d2, {
          id: "muted",
          checked: !0 === r,
          ...
          label: jsx(_$$J3, {
            children: _$$t("fullscreen.properties_panel.video_controls.mute")
          })
        })]
      })
    })
...
function tr({
  ...
  return jsx(_$$k2, {
    ...
    children: jsxs(Zk, {
      ...
      className: p()(rq, {
        [$L]: "INSTANCE" === F || "SLOT" === F || "SYMBOL" === F || u || y || o,
        [aT]: eN && ex,
...
export function $$ti7(e, t) {
  ...
  let h = function () {
    ...
    if (cJ() && e) return {
      ...
      disabled: !0,
      getTitle: () => _$$t("sites.toolbar_item.cannot-create-component"),
      recordingKey: e5,
      dataTestId: e5
    };
  }();
...
export function $$ta8(e, t) {
  return useMemo(() => e.map(e => e.reduce((e, r) => t.includes(r) ? e : r.type === ZU.CUSTOM_ACTION && r.dataTestId === e5 ? (r.getTitle = () => _$$t("fullscreen_actions.create-symbol"), e.concat(r)) : r.type === ZU.FLYOUT ? e.concat(r.actions) : e.concat(r), [])), [e, t]);
}
