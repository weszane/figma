...
export function $$M28(e) {
  return e.content.hub_file
    ? e.content.hub_file
    : e.content.plugin
      ? e.content.plugin
      : e.content.widget
        ? e.content.widget
        : void reportError(_$$e.COMMUNITY, new Error('Resource has no content'), {
          extra: {
            resourceId: e.id,
          },
        })
...
export function $$F23(e) {
  return e == null ? void 0 : $$D16(e) ? e.content.hub_file : hasClientMeta(e) ? e : void 0
}
...
export function $$X33() {
  return (function () {
    ...
    isMakeDiscoveryEnabled() && e.push(vt.FIGMAKE_TEMPLATE)
    return e
