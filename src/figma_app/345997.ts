...
export function $$O29(e) {
  return !!e && e.subscription != null && e.subscription !== FPaymentHealthStatusType.INCOMPLETE
}
...
export function $$B20(e, t, r) {
  ...
  return (!!e.team_id || e.sharing_audience_control !== 'org_edit') && !!(!e.team_id && !Gi(e) || e.team_id && (!r && H(n, i, a) || !$$L32(n) && (e.is_invite_only || e.is_view_only)))
}
...
export function $$J30(e) {
  switch (e) {
    ...
    default:
      reportError(_$$e.MONETIZATION_UPGRADES, new Error(`Attempted to get BillingInterval from invalid BillingPeriod: ${e}`))
      return null
  }
}
export function $$Z3(e) {
  switch (e) {
    ...
    default:
      reportError(_$$e.MONETIZATION_UPGRADES, new Error(`Attempted to get BillingPeriod from invalid BillingInterval: ${e}`))
      return null
  }
}
export function $$Q6(e, t, r) {
  let n = r === 'whiteboard' ? 'whiteboard_paid_status' : 'design_paid_status'
