...
import { DEFAULT_ZERO, PRIMARY_LIMIT, STANDARD_LIMIT, ZERO_VALUE } from "../figma_app/345997";
...
function x(e) {
  ...
  if (y.status !== "loaded" || y.data.team?.stripeCustomerId.status !== "loaded") return null;
  ...
  let j = e => {
    switch (e.limitExceededType) {
      ...
      default:
        throw new Error("Not a valid starter plan limit");
    }
  };
