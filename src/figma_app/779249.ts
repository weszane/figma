...
export function $$l1(e) {
  atomStoreManager.get(s0) === PanelType.CODE ? AppStateTsApi?.codeSelection().fullscreenCodeFileNodeId.set(e.guid) : AppStateTsApi?.codeSelection().selectedCodeFileNodeId.set(e.guid);
}
