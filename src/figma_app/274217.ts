...
function v(e, t) {
  ...
  return {
    ...
    isTwitterLinkPreview: "Twitter" === o || "X (formerly Twitter)" === o
  };
}
export function $$A1({
  figma: e
  ...
  widget.register(function () {
    ...
    let D = _$$l(e, widget, "faviconImageHash");
    let k = 480 - (hasThumbnail ? 112 : 8) - 32 - 16;
    let [M, F] = widget.useSyncedState("orientation", hasUrlOnly ? "horizontal" : "vertical");
    let {
      title,
      description,
      fullUrlProvider
      ...
      titleFontSize: r,
      titleLineHeight: n,
      descriptionFontSizeWithTitle: i,
      descriptionFontSizeWithoutTitle: a,
      descriptionLineHeight: s,
      verticalTextWidth: o,
      horizontalTextWidth: l,
      faviconDimension: d,
      hasTitleXorDescription: c,
      orientation: u
    }) {
      let {
        hasTitleOrDescription: _hasTitleOrDescription,
      ...
      let m = _$$H(t, "title", {
        ...
        size: r,
        lineHeight: n
      }, "vertical" === u ? o : l, ("vertical" === u ? 2 : 1) + (c ? 1 : 0) + (isTwitterLinkPreview ? 4 : 0), !1);
      let g = _$$H(t, "description", {
        name: "Inter",
        size: m ? i : a,
        lineHeight: s
      }, "vertical" === u ? o : l, ("vertical" === u ? 2 : 1) + (c ? 1 : 0), !1);
      return {
        title: m,
        description: g,
        fullUrlProvider: _$$H(t, "url", {
          name: "Inter",
          size: r,
          lineHeight: n
        }, ("vertical" === u ? o : l) - (d + 8), 1 + (_hasTitleOrDescription ? 0 : 1), !0)
      };
    }({
      figma: e,
      widget,
    ...
    widget.usePropertyMenu([{
      ...
      switch (e) {
        ...
        case "horizontal":
          ...
          break;
        default:
          console.error("Unhandled property name for LinkPreview widget: %s", e);
      }
    });
    let H = {
      fontFamily: "Inter",
    ...
    return "vertical" === M ? function (...t) {
    ...
    }(!hasThumbnail && e.widget.h(Frame, {
      width: 304,
      height: .01
    }), hasThumbnail && W(304, thumbnailAspectRatio ? Math.max(Math.min(304 / thumbnailAspectRatio, 608), 160) : 160, thumbnailImageHash), hasTitleOrDescription && ((t, ...r) => e.widget.h(AutoLayout, {
      direction: "vertical",
      horizontalAlignItems: "start",
      verticalAlignItems: "start",
      width: "fill-parent",
    ...
    }, ...r))(hasThumbnail, K(title), Y(hasTitle, description)), ((t, ...r) => e.widget.h(AutoLayout, {
      name: "service-name-autolayout",
      direction: "horizontal",
      verticalAlignItems: t ? "center" : "start",
      horizontalAlignItems: "start",
      width: "fill-parent",
      spacing: 8,
      padding: t ? {
    ...
    }, ...r))(hasTitleOrDescription, z(D), $(hasTitleOrDescription, G))) : "horizontal" === M ? function (t, ...r) {
      return e.widget.h(AutoLayout, {
        direction: "horizontal",
    ...
    }(hasThumbnail, !hasThumbnail && e.widget.h(Frame, {
      width: .01,
      height: .01
    }), hasThumbnail && W(112, 112, thumbnailImageHash), ((t, ...r) => e.widget.h(AutoLayout, {
      direction: "vertical",
      horizontalAlignItems: "center",
      verticalAlignItems: "start",
      width: "fill-parent",
    ...
    }, ...r))(hasThumbnail, hasTitleOrDescription && ((...t) => e.widget.h(AutoLayout, {
      direction: "vertical",
      horizontalAlignItems: "start",
      verticalAlignItems: "start",
      width: "fill-parent",
      ...
      spacing: 4,
      padding: 0
    }, ...t))(K(title), Y(hasTitle, description)), ((...t) => e.widget.h(AutoLayout, {
      name: "service-name-autolayout",
      direction: "horizontal",
      ...
      width: "fill-parent",
      spacing: 8
    }, ...t))(z(D), $(hasTitleOrDescription, G)))) : void 0;
  });
}
export const HP = $$m0;
export const Nd = $$A1;
