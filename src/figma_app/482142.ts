...
export const restoreSavedCartAction = createActionCreator('PAYMENT_RESTORE_SAVED_CART')
export const setCurrencyAction = createActionCreator('PAYMENT_SET_CURRENCY')
export const setTokenAction = createActionCreator('PAYMENT_SET_TOKEN')
export const setTaxesAction = createActionCreator('PAYMENT_SET_TAXES')
export const setPromoAction = createActionCreator('PAYMENT_SET_PROMO')
export const setVatGstIdAction = createActionCreator('PAYMENT_SET_VAT_GST_ID')
export const setRegionalVatGstIdAction = createActionCreator('PAYMENT_SET_REGIONAL_VAT_GST_ID')
export const makeStudentTeamAction = createActionCreator('PAYMENT_MAKE_STUDENT_TEAM')
export const showErrorAction = createActionCreator('PAYMENT_SHOW_ERROR')
export const setCompanyDetailsAction = createActionCreator('PAYMENT_SET_COMPANY_DETAILS')
export const setSubmitPendingAction = createActionCreator('PAYMENT_SET_SUBMIT_PENDING')
export const setEditorStatusChangesAction = createActionCreator('PAYMENT_SET_EDITOR_STATUS_CHANGES')
export const setNumFigmaEmailTeamUsersAction = createActionCreator('PAYMENT_SET_NUM_FIGMA_EMAIL_TEAM_USERS')
