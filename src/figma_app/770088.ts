...
createOptimistThunk((e, t) => {
  ...
  let s = reactionsApi.addReaction(id, emoji, {
    prototype_mode: "prototype" === r.selectedView.view,
...
let $$W58 = createOptimistThunk((e, t) => {
  ...
  let a = e.getState();
  uD(emoji) && null !== $f() && (i = Kh(emoji)[0] + $f());
  let s = reactionsApi.toggleReaction(id, emoji, {
    prototype_mode: "prototype" === a.selectedView.view,
...
let $$K10 = createOptimistThunk((e, t) => {
  ...
  _$$O.remove(id);
  r = uuid ? WB().optimisticallyDeleteWithUUID({
    Comment: {
      [uuid]: null
    }
  }, d) : WB().optimisticallyDelete({
    Comment: {
      [id]: null
    }
  }, d);
...
let $$Y34 = createOptimistThunk((e, {
  ...
  if (n && L4(r)) {
    ...
    n ? WB().optimisticallyUpdateWithUUID({
      Comment: {
        [n]: {
          uuid: n,
          resolvedAt: i ? new Date() : null
...
let $$q27 = createOptimistThunk((e, t) => {
  ...
  if (s ? WB().optimisticallyUpdateWithUUID({
    Comment: {
      [s]: {
        uuid: s,
        messageMeta: o,
...
let $$Z38 = createOptimistThunk((e, t) => {
  ...
  if (!viewport.getViewportInfo()) return null;
...
let $$er40 = createOptimistThunk((e, t) => {
  ...
  let [l, d] = commentsWriteApi.reply({
    ...
    prototypeMode: "prototype" === r.selectedView.view,
...
let $$ei26 = createOptimistThunk((e, t) => {
  ...
  let [I, S] = t.commentsWriteApi.create({
    ...
    onValidationError: async (t, r, n) => {
      if (await G(o.messageMeta, e.dispatch, t, r, n)) return {
        forceMentions: !0,
        forceWithInvite: !0
      };
      if (0 !== e.getState().comments.newComment.messageMeta.length) {
        e.dispatch($$ew1({
          resetStatusOnly: !0
        }));
        let t = {
...
let $$ea23 = createOptimistThunk((e, t) => {
  ...
  let d = Kx(newComment.messageMeta) && 0 === Object.keys(newComment.attachments).length;
  if (!a && !d && !H3(r.comments)) {
    e.dispatch(eA());
    return !1;
  }
  let c = l && r.comments.threads[l];
  let p = c && Kx(c.reply.messageMeta) && 0 === Object.keys(c.reply.attachments || {}).length;
      ...
      if (e && e.state === BusyReadyState.BUSY) {
        let n = !function (e, t) {
          ...
          for (var r = 0; r < e.length; r++) {
            ...
            let s = Object.keys(i);
            if (a.size !== s.length || !s.every(e => !!a.has(e) && n[e] === i[e])) return !1;
          }
          return !0;
