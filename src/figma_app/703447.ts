...
let $$d1 = {
  ...
  INOUT_CUBIC: [.645, .045, .355, 1],
  LINEAR: [0, 0, 1, 1],
  IN_BACK_CUBIC: [.3, -.05, .7, -.5],
  OUT_BACK_CUBIC: [.45, 1.45, .8, 1],
  INOUT_BACK_CUBIC: [.7, -.4, .4, 1.4],
...
class E {
  ...
  transformRect(e) {
    ...
    if (0 === this.axisX().y && 0 === this.axisY().x) return r.computeBounds(this.transformPoint(e.topLeft()), this.transformPoint(e.bottomRight()));
...
function I(e, t) {
  ...
  n.multiply(Array.isArray(r = e.transform) ? E.fromNumbers(r[0][0], r[0][1], r[0][2], r[1][0], r[1][1], r[1][2]) : "object" == typeof r ? E.fromNumbers(r.m00, r.m01, r.m02, r.m10, r.m11, r.m12) : E.identity());
  let i = n.toScale();
  let a = n.offset();
  let s = n.toDegrees();
  return {
  ...
  for (let s of (a.hasBehaviors = !0, a.variants = {
    ...
    switch (e) {
      ...
      case Xc.ScrollTransform:
        {
          if (!s || r?.[Xc.ScrollTransform]) break;
