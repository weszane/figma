...
import { $E, cL, G, is, p2, QF, Wv } from "../905/452765"
...
export function $$k1({
  ...
  if (!e)
    return null
  let n = $E
  if (t ? n = cL : r && (n = is), !(Array.isArray(e)))
    return M(e, n, t)
  if (e.includes(ManifestEditorType.FIGMA) && e.includes(ManifestEditorType.FIGJAM) && isDevOrInspect(e)) {
  ...
  if (e.includes(ManifestEditorType.FIGMA) && e.includes(ManifestEditorType.FIGJAM)) {
    return jsx(SvgComponent, {
      "svg": t ? _$$A5 : _$$A6,
      "className": n,
      "useOriginalSrcFills_DEPRECATED": !0,
  ...
  if (e.includes(ManifestEditorType.FIGMA) && isDevOrInspect(e)) {
    return jsx(SvgComponent, {
      "svg": t ? _$$A3 : _$$A4,
      "className": n,
      "useOriginalSrcFills_DEPRECATED": !0,
  ...
  if (e.includes(ManifestEditorType.FIGJAM) && isDevOrInspect(e)) {
    return jsx(SvgComponent, {
      "svg": t ? _$$A : _$$A2,
      "className": n,
      "useOriginalSrcFills_DEPRECATED": !0,
...
((e) => {
  ...
  e.BadgeContainer = function ({
    ...
    let n = Wv
    t && r === "plugin" ? n = p2 : t && r === "widget" && (n = QF)
    return jsx("div", {
      className: n,
      children: e,
    })
