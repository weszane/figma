...
function UserProfilePreview({
  ...
  return jsxs(Fragment, {
    ...
    jsxs("h3", {
      className: N4,
      children: [renderI18nText("community.onboarding.change_your_photo_or_name_in_your_settings"), hasVariation(variations, CommunityOnboardingVariation.COMMENTS) && jsxs(Fragment, {
...
registerModal(({
  ...
  const containerClass = hasVariation(variations, CommunityOnboardingVariation.COMMENTS) ? variations.length === 1 ? aq : Qc : FT;
  return jsx(ModalContainer, {
    ...
    children: jsxs(TrackingProvider, {
      ...
      hasVariation(variations, CommunityOnboardingVariation.OPT_IN) && user ? jsx(UserProfilePreview, {
        user,
        variations
      ...
      jsx(TrackedButton, {
        ...
        children: hasVariation(variations, CommunityOnboardingVariation.COMMENTS) ? renderI18nText("community.onboarding.got_it") : renderI18nText("community.onboarding.looks_good")
      }),
