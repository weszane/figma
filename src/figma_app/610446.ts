...
function o() {
  return jsxs("svg", {
    ...
    children: [jsx("rect", {
      ...
      fill: "#D5EB97",
      stroke: "#9CB74F",
      d: "M16.5 20.5a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z",
    }), jsx("path", {
      stroke: "#AFBCCF",
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M18.572 10.857h5.142m0 0-2.571-2.571m2.571 2.571-2.571 2.572M10.857 23.714v-5.142m0 0 2.571 2.57m-2.571-2.57-2.572 2.57",
    })],
  })
}
function l() {
...
function d() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      fill: "#DA9DFF",
      stroke: "#A259FF",
      d: "m14.45 21.758.976 2.277a.625.625 0 0 0 1.148 0l.976-2.277A1.25 1.25 0 0 1 18.7 21h4.175c.69 0 1.25-.56 1.25-1.25V9.125c0-.69-.56-1.25-1.25-1.25H9.125c-.69 0-1.25.56-1.25 1.25V19.75c0 .69.56 1.25 1.25 1.25H13.3c.5 0 .952.298 1.15.758Z",
    }), jsx("path", {
      fill: "#A259FF",
      d: "M13.5 12.25a2.5 2.5 0 1 0 5 0 2.5 2.5 0 0 0-5 0Z",
    }), jsx("path", {
      stroke: "#000",
      strokeLinecap: "round",
      d: "M12.25 17.25h7.5",
...
function u() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      stroke: "#AFBCCF",
      strokeLinecap: "round",
      d: "M6 16h1.25c.69 0 1.25-.56 1.25-1.25v-2.5c0-.69.56-1.25 1.25-1.25H11M6 16h1.25c.69 0 1.25.56 1.25 1.25v2.5c0 .69.56 1.25 1.25 1.25H11",
    }), jsx("rect", {
      width: "12.75",
      height: "6.5",
      x: "11.5",
...
function p() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      ...
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M17.875 8h-8.75C8.504 8 8 8.504 8 9.125v7.615c0 .607.641 1 1.182.723l2.295-1.171h6.398c.621 0 1.125-.504 1.125-1.125V9.125C19 8.504 18.496 8 17.875 8Z",
    }), jsx("path", {
      fill: "#fff",
      stroke: "#9CB74F",
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M14.126 14.27h8.809c.621 0 1.125.504 1.125 1.126v7.769a.813.813 0 0 1-1.186.722l-2.31-1.194h-6.438A1.125 1.125 0 0 1 13 21.569v-6.173c0-.62.503-1.124 1.125-1.124Z",
    })],
  })
}
function _() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      fill: "#fff",
      stroke: "#AFBCCF",
      d: "M7.75 12.75h16.5v9.517a1.983 1.983 0 0 1-1.983 1.983H9.733a1.983 1.983 0 0 1-1.983-1.983V12.75Z",
    }), jsx("path", {
      fill: "#DA9DFF",
      stroke: "#A259FF",
      d: "M7.75 10.983C7.75 9.888 8.638 9 9.733 9h12.534c1.095 0 1.983.888 1.983 1.983v3.267H7.75v-3.267Z",
    }), jsx("rect", {
      width: "1",
      height: "3.75",
      x: "11",
...
function h() {
  return jsxs("svg", {
    ...
    children: [jsx("mask", {
      ...
      children: jsx("path", {
        fillRule: "evenodd",
        d: "M19.75 19.125c0-.393.19-.758.48-1.024a6.25 6.25 0 1 0-8.46 0c.29.266.48.63.48 1.024v3.125a2.5 2.5 0 0 0 2.5 2.5h2.5a2.5 2.5 0 0 0 2.5-2.5v-3.125Z",
        clipRule: "evenodd",
      }),
    }), jsx("path", {
      fill: "#FFF2DF",
      ...
      strokeLinejoin: "round",
      strokeWidth: "1.111",
      d: "M16 20.375V17.25m0 0-2.5-2.5m2.5 2.5 2.5-2.5",
    }), jsx("path", {
      fill: "#fff",
      stroke: "#FFC470",
      strokeWidth: "1.111",
      d: "M12.806 20.306h6.388v1.944c0 1.074-.87 1.944-1.944 1.944h-2.5a1.944 1.944 0 0 1-1.944-1.944v-1.944Z",
    })],
  })
}
function m() {
  return jsxs("svg", {
    ...
    children: [jsx("circle", {
      ...
      fill: "#DA9DFF",
      stroke: "#A259FF",
      d: "M21.833 13.781h-.5v1.777a.75.75 0 0 1-1.27.54l-2.258-2.177-.145-.14h-3.32l-.145.14-2.258 2.177a.75.75 0 0 1-1.27-.54v-1.777H8.5a.75.75 0 0 1-.75-.75V8.5a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 .75.75v4.531a.75.75 0 0 1-.75.75h-1.667Z",
    }), jsx("circle", {
      cx: "11",
      cy: "21",
      r: "3.25",
...
function g() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      fill: "#D5EB97",
      d: "M24 16a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",
    }), jsx("path", {
      stroke: "#000",
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M16 12.25v3.906l2.5 2.344",
    }), jsx("path", {
      fill: "#9CB74F",
      fillRule: "evenodd",
      d: "M10.256 11.146A7.52 7.52 0 1 1 8.479 16a.5.5 0 0 0-1 0A8.52 8.52 0 1 0 9.5 10.49V8a.5.5 0 0 0-1 0v3.646a.5.5 0 0 0 .5.5h3.646a.5.5 0 1 0 0-1h-2.39Z",
      clipRule: "evenodd",
    })],
  })
}
function f() {
  return jsxs("svg", {
    ...
    children: [jsx("rect", {
      ...
      fill: "#D5EB97",
      stroke: "#9CB74F",
      d: "M8.5 11.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z",
    }), jsx("path", {
      stroke: "#AFBCCF",
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M10 4h4m0 0-2-2m2 2-2 2M4 14v-4m0 0 2 2m-2-2-2 2",
    })],
  })
}
function E() {
...
function y() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      fill: "#DA9DFF",
      stroke: "#A259FF",
      d: "m6.76 12.606.78 1.822a.5.5 0 0 0 .92 0l.78-1.822a1 1 0 0 1 .92-.606h3.34a1 1 0 0 0 1-1V2.5a1 1 0 0 0-1-1h-11a1 1 0 0 0-1 1V11a1 1 0 0 0 1 1h3.34a1 1 0 0 1 .92.606Z",
    }), jsx("path", {
      fill: "#A259FF",
      d: "M6 5a2 2 0 1 0 4 0 2 2 0 0 0-4 0Z",
    }), jsx("path", {
      stroke: "#000",
      strokeLinecap: "round",
      d: "M5 9h6",
...
function T() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      stroke: "#AFBCCF",
      strokeLinecap: "round",
      d: "M1 8h1a1 1 0 0 0 1-1V5a1 1 0 0 1 1-1h1M1 8h1a1 1 0 0 1 1 1v2a1 1 0 0 0 1 1h1",
    }), jsx("rect", {
      width: "10",
      height: "5",
      x: "5.5",
...
function I() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      ...
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M9.5 1.5h-7a1 1 0 0 0-1 1v6.092a.75.75 0 0 0 1.091.668l1.815-.927H9.5a1 1 0 0 0 1-1V2.5a1 1 0 0 0-1-1Z",
    }), jsx("path", {
      fill: "#fff",
      stroke: "#9CB74F",
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M6.5 6.517h7.048a1 1 0 0 1 1 1v6.215a.75.75 0 0 1-1.094.667l-1.827-.944H6.5a1 1 0 0 1-1-1V7.517a1 1 0 0 1 1-1Z",
    })],
  })
}
function S() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      fill: "#fff",
      stroke: "#AFBCCF",
      d: "M1.5 5.5h13v7.513c0 .821-.666 1.487-1.487 1.487H2.987A1.487 1.487 0 0 1 1.5 13.013V5.5Z",
    }), jsx("path", {
      fill: "#DA9DFF",
      stroke: "#A259FF",
      d: "M1.5 3.987c0-.821.666-1.487 1.487-1.487h10.026c.821 0 1.487.666 1.487 1.487V6.5h-13V3.987Z",
    }), jsx("rect", {
      width: "1",
      height: "3",
      x: "4",
...
function v() {
  return jsxs("svg", {
    ...
    children: [jsx("mask", {
      ...
      children: jsx("path", {
        fillRule: "evenodd",
        d: "M11 10.5c0-.315.152-.606.384-.819a5 5 0 1 0-6.768 0c.232.213.384.504.384.819V13a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-2.5Z",
        clipRule: "evenodd",
      }),
    }), jsx("path", {
      fill: "#FFF2DF",
      ...
      fill: "#FFC470",
      d: "m4.616 9.681-.677.736.677-.736Zm6.768 0-.677-.736.677.736ZM12 6a3.987 3.987 0 0 1-1.293 2.945l1.354 1.472A5.987 5.987 0 0 0 14 6h-2ZM8 2a4 4 0 0 1 4 4h2a6 6 0 0 0-6-6v2ZM4 6a4 4 0 0 1 4-4V0a6 6 0 0 0-6 6h2Zm1.293 2.945A3.987 3.987 0 0 1 4 6H2c0 1.748.748 3.322 1.94 4.417l1.353-1.472ZM6 13v-2.5H4V13h2Zm1 1a1 1 0 0 1-1-1H4a3 3 0 0 0 3 3v-2Zm2 0H7v2h2v-2Zm1-1a1 1 0 0 1-1 1v2a3 3 0 0 0 3-3h-2Zm0-2.5V13h2v-2.5h-2Zm-6.06-.083c.03.028.046.053.054.07.008.016.006.02.006.013h2c0-.645-.31-1.19-.707-1.555L3.94 10.417Zm6.767-1.472C10.31 9.31 10 9.855 10 10.5h2c0 .006-.002.003.006-.013a.247.247 0 0 1 .055-.07l-1.354-1.472Z",
      mask: "url(#a)",
    }), jsx("path", {
      stroke: "#000",
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M8 11.5V9m0 0L6 7m2 2 2-2",
    }), jsx("path", {
      fill: "#fff",
      stroke: "#FFC470",
      d: "M5.5 11.5h5V13A1.5 1.5 0 0 1 9 14.5H7A1.5 1.5 0 0 1 5.5 13v-1.5Z",
    })],
  })
}
function A() {
  return jsxs("svg", {
    ...
    children: [jsx("circle", {
      ...
      fill: "#DA9DFF",
      stroke: "#A259FF",
      d: "M12.667 6.125h-.5v1.522a.5.5 0 0 1-.847.36L9.514 6.264l-.146-.14H6.632l-.146.14L4.68 8.006a.5.5 0 0 1-.847-.36V6.126H2a.5.5 0 0 1-.5-.5V2a.5.5 0 0 1 .5-.5h12a.5.5 0 0 1 .5.5v3.625a.5.5 0 0 1-.5.5h-1.333Z",
    }), jsx("circle", {
      cx: "4",
      cy: "12",
      r: "2.5",
...
function x() {
  return jsxs("svg", {
    ...
    children: [jsx("path", {
      ...
      fill: "#9CB74F",
      fillRule: "evenodd",
      d: "M3.266 4.45A5.917 5.917 0 1 1 2.083 8a.5.5 0 0 0-1 0 6.917 6.917 0 1 0 1.584-4.404V2.168a.5.5 0 0 0-1 0v2.917a.5.5 0 0 0 .5.5h2.916a.5.5 0 0 0 0-1H3.114a.498.498 0 0 0 .152-.135Z",
      clipRule: "evenodd",
    })],
  })
}
var N = (e => (e.MEETING = "meeting", e.GANTT_CHART = "gantt_chart", e.BRAINSTORM = "brainstorm", e.FLOW_CHART = "flow_chart", e.ORG_CHART = "org_chart", e.PLAN = "plan", e.MIND_MAP = "mind_map", e.TIMELINE = "timeline", e))(N || {})
var $$C7 = (e => (e.WEEKLY_SYNC = "weekly_sync", e.PLAN = "plan", e.BRAINSTORM = "brainstorm", e.TEAM_RETRO = "team_retro", e.ONEONONE = "1:1", e.GANTT_CHART = "gantt_chart", e.FLOW_CHART = "flow_chart", e.ORG_CHART = "org_chart", e.MIND_MAP = "mind_map", e.TIMELINE = "timeline", e))($$C7 || {})
var $$w0 = (e => (e.IN_EDITOR = "in_editor", e.COMMUNITY = "community", e.ONBOARDING_MODAL = "onboarding_modal", e))($$w0 || {})
var $$O1 = (e => (e.GENERATE_MODE = "generate_stage", e.REFINEMENT_MODE = "refinement_stage", e))($$O1 || {})
let $$R5 = "figjam_ai_summarization"
let $$L3 = "figjam_ai_clustering"
let $$P4 = "figjam_ai_diagram"
let $$D6 = "figjam_ai_template"
export var $$k2 = (e => (e.TEMPLATE = "template", e.VISUAL = "visual", e))($$k2 || {})
export function $$M19(e) {
  return "categoryKey" in e
}
...
export function $$U14(e, t) {
  if (t)
    return $$F16(t).filter(t => !e.includes(t.prompt))
  let r = [{
  ...
  r.forEach((e) => {
    e.keywords.some(e => e.toLocaleLowerCase().startsWith(i)) && n.push(e)
  })
  return n
}
function B(e) {
  ...
  return {
    chosenUseCaseKey: r,
    suggestion: n[Math.floor(Math.random() * n.length)],
  }
}
export function $$G15(e) {
  return B(e === "template" ? V() : H()).suggestion
}
function V() {
  return {
    brainstorm: [{
...
export function $$z13(e) {
  ...
  let o = B(r)
  n.push(o.suggestion)
  delete a[o.chosenUseCaseKey]
  delete a[s.chosenUseCaseKey]
  for (let t = 0; t < e; t++) {
    let e = B(a)
    n.push(e.suggestion)
    delete a[e.chosenUseCaseKey]
  }
  return shuffle(n)
}
...
export function $$X21(e, t) {
  ...
  for (let t of Object.values($$Q11())) {
    if (e === $$ee9(t))
      return !0
  }
...
export function $$J18() {
  return !!getFeatureFlags().figjam_quick_actions_v2
}
export function $$Z8() {
  return !!getFeatureFlags().figjam_text_to_visual_mindmap
}
export function $$Q11() {
  return {
    "Mind map - Road trip": {
...
export function $$ee9(e) {
  let t = ""
  e.suggestion.forEach((e) => {
    t = t.length === 0 ? e.text : `${t} ${e.text}`
  })
  return t
}
export const fV = $$w0
