...
export function $$p3() {
  let e = l();
  let t = useDeepEqualSceneValue(e => e.getDirectlySelectedNodes().every(e => e.isCanvasGridChild));
  return e && !!t;
}
export function $$_0() {
  let e = l();
  let t = useDeepEqualSceneValue(e => e.getDirectlySelectedNodes().every(e => e.isCanvasGridChild));
  let r = useDeepEqualSceneValue(e => e.getDirectlySelectedNodes().every(e => "FRAME" === e.type || e.isInstance));
  return e && !!t && r;
}
export const Ez = $$_0;
export const a3 = $$d1;
