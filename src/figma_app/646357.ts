...
import { _x, qE } from "../905/404538";
import { C9, jf, J5, EY } from "../figma_app/141508";
import { Qh, He, je } from "../figma_app/155728";
...
export function $$ep106(e, t, r) {
  for (let r of Object.values(t)) if ("loaded" === r.status && r.data.key === e) return r.data;
  for (let t of Object.values(r)) if (t.key === e) return t;
  return null;
}
...
export function $$eg95(e) {
  let t = {};
  for (let r of Object.values(e)) for (let [e, n] of Object.entries(r)) t[_$$l(e)] = n;
  return t;
}
...
export function $$eE1(e) {
  let t = [];
  for (let r of Object.keys(e)) for (let n of Object.values(e[_$$l(r)] ?? {})) t.push(n);
  return t;
}
export function $$ey41(e, t) {
  for (let [r, n] of Object.entries(e)) for (let [e, i] of Object.entries(n)) {
    let n = _$$l(e);
...
export async function $$ev90(e) {
  ...
  if (r.forEach(e => $$eS.add(e)), getFeatureFlags().ds_file_proxy_for_style_assets) await Promise.all(r.map(e => teamLibraryCache.getCanvas({
    ...
    try {
      ...
      for (let [r, n] of Object.entries(e.data.meta.urls)) XHR.crossOriginGetAny(n, null, {
...
export function $$ej14(e, t, r, n, i, a) {
  ...
  for (let r of n) {
    let n;
    let s = i[r];
    if (s && (n = "library_key" in s ? s.library_key : "loaded" === s.status && s.data.library_key) && eF(e.defaultPublished, {
      key: t.key,
      team_id: t.teamId,
...
function eY(e, t) {
  ...
  for (let r in e) {
    ...
    for (let e in i) if (!(e in n)) return !0;
  }
...
export function $$tc66(e) {
  ...
  let {
    ...
    subscribedComponents: C9(e),
    subscribedStateGroups: jf(e),
    subscribedComponentsOnCurrentPage: J5(e),
    subscribedStateGroupsOnCurrentPage: EY(e)
  }));
  let [u, p] = "current" === e ? [subscribedComponentsOnCurrentPage, subscribedStateGroupsOnCurrentPage] : [subscribedComponents, subscribedStateGroups];
...
export function $$tZ11(e) {
  return !!(getFeatureFlags().dse_module_publish && "MODULE" === e.type);
}
export function $$tQ44(e, t) {
  return (null !== e.design || null !== e.figjam || null !== e.slides || null !== e.buzz) && (!!e.design || !!e.figjam || !!e.slides || !!e.buzz) && (!!e.design && !t.designSubscribed || !!e.figjam && !t.figjamSubscribed || !!e.slides && !t.slidesSubscribed || !!e.buzz && !t.buzzSubscribed);
}
...
export function $$t864(e) {
  return ag(e.openFile, e.currentUserOrgId);
}
...
export function $$t793(e) {
  let t = je();
  return useMemo(() => {
    if (e && "loaded" === t.status) return t.data?.find(t => t.libraryKey === e)?.id;
  }, [e, t.data, t.status]);
}
