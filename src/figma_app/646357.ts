...
import { C9, EY, J5, jf } from '../figma_app/141508';
...
export function $$ep106(e, t, r) {
  for (let r of Object.values(t)) {
    if (r.status === 'loaded' && r.data.key === e) return r.data;
  }
...
export function $$eg95(e) {
  ...
  for (let r of Object.values(e)) {
    for (let [e, n] of Object.entries(r)) t[_$$l(e)] = n;
  }
  return t;
}
...
export function $$eE1(e) {
  ...
  for (let r of Object.keys(e)) {
    for (let n of Object.values(e[_$$l(r)] ?? {})) t.push(n);
  }
  return t;
}
...
export function $$eX24(e) {
  ...
  if (eY(t.library.local.components, newLocal) && e.dispatch(I0({
    ...
    for (let r in e) {
      if (!t[r] || e[r].url !== t[r].url || e[r].content_hash !== t[r].content_hash) return !0;
    }
    return !1;
...
export function $$to85(e, t = [], r = [], n, i, a, s = !1) {
  ...
  for (let t of l) {
    ...
    if (g) {
      ...
      if (!m || o[m] || r.isState && !s || i === null) continue;
      o[m] = {
        type: PrimaryWorkflowEnum.COMPONENT,
        name: r.name,
        library_key: r.sourceLibraryKey,
...
export function $$tU13({
  ...
  let l = r === 0 && n > 0 ? getI18nString('design_systems.libraries_modal.plural.variable_collections', {
    numVariableCollections: n
  }) : null;
...
export function $$t793(e) {
  let t = je();
  return useMemo(() => {
    if (e && t.status === 'loaded') return t.data?.find(t => t.libraryKey === e)?.id;
  }, [e, t.data, t.status]);
}
