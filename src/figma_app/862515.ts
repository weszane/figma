...
export function getSiteEmbedConfig() {
  return filterEnabledFeatures().length > 0
    ? {
        name: getI18nString('design_systems.assets_panel.site_embeds'),
        libraryKey: (SITE_KIT_EMBEDS_LIBRARY_KEY),
...
export const V = getSiteEmbedConfig
export const u = filterEnabledFeatures
