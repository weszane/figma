...
let $$I0 = atom(null, async (e, t, r, i) => {
...
let $$w1 = createRemovableAtomFamily(e => atom(async () => await dT(e)), (e, t) => e.fileKey === t.fileKey && e.fileVersion === t.fileVersion && _$$t(e.template, t.template));
export const ME = $$I0;
export const Re = $$w1;
export const Yq = $$x2;
export const bj = $$S3;
