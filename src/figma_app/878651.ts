...
import { Component, memo, PureComponent, useCallback, useMemo, useRef, useState } from "react";
...
import { _7, _ as _$$_, H as _$$H2, my as _$$my, w as _$$w, wA as _$$wA, y as _$$y, __, _F, a_, Ah, Ai, Ak, Az, bI, bs, Bz, CD, cR, cT, dB, DU, eB, FK, Gf, gx, h1, hA, HC, HG, hz, i1, IC, IM, iR, jG, JM, jq, Jt, k1, K9, kj, kl, kP, Ll, Ls, mH, MN, NB, O3, o_, oQ, pt, Pw, q2, qP, r9, Rw, Ry, s3, sj, sn, t5, t9, TD, Tk, tr, u0, U$, uB, uu, uy, vG, vz, Vz, W8, Wf, wr, x7, XC, Ys, Yt, Z2, zb, ZR, ZX } from "../905/417669";
...
import { IconMetricComments } from "../905/988303";
...
import { generateCommunityPluginUrl, generateHubFileUrl, generateCommunityWidgetUrl } from "../figma_app/870683";
...
export function $$eb5({
  ...
  let S = useCallback(t => {
    if (t?.stopPropagation(), t?.preventDefault(), _) {
      m && (f(s1({
        id: e.id,
...
(e => {
  function t(e) {
    return jsxs("div", {
      ...
      children: [e.dropdownContent && e.dropdownRef?.current && jsx(ConnectedPointingDropdown, {
  ...
  function r(e) {
    ...
    let o = ({
      ...
      return jsxs("div", {
        className: NB,
        children: [e.length === 1 && renderI18nText("community.by_publisher", {
          publisher: i
    ...
    return u.length === 1 ? e.showAuthorAndOthersTextLabel ? jsxs(Fragment, {
      children: [a({
        profile: u[0],
        ref: n[0]
      }), o({
    ...
    constructor() {
      ...
      this.onClick = e => {
        if (isCommandOrShift(e)) {
          customHistory.redirect(generateCommunityPluginUrl(this.props.plugin?.id), "_blank");
          return;
        }
        this.props.onClick();
      };
...
export class $$ev7 extends Component {
  render() {
    ...
    return jsx(Fragment, {
      children: numResources < maxResources ? new Array(maxResources - numResources).fill(null).map((e, t) => jsx("div", {
        className
      }, t)) : null
    });
  }
      ...
      return jsx("div", {
        ...
        children: jsx("div", {
          ...
          children: jsx("a", {
            ...
            href: generateHubFileUrl(this.props.hubFile.id),
            children: jsx("div", {
              className: tr,
              children: jsx("div", {
                className: Ll,
      ...
      return jsx("div", {
        ...
        children: jsx("div", {
          ...
          children: jsxs("a", {
            ...
            href: t ? generateCommunityWidgetUrl(this.props.resource.id) : generateCommunityPluginUrl(this.props.resource.id),
            children: [jsx(PluginImage, {
              className: pt,
              plugin: e,
              loading: "lazy",
  ...
  class t extends Component {
    ...
    render() {
      ...
      return jsxs("div", {
        ...
        }), this.props.resources.length === 0 && jsx("div", {
          className: t9,
