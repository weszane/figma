...
((e) => {
  ...
  function r(e) {
    ...
    return u.length === 1
      ? e.showAuthorAndOthersTextLabel
        ? jsxs(Fragment, {
            children: [a({
              profile: u[0],
              ref: n[0],
...
export class $$ev7 extends Component {
  render() {
    ...
    return jsx(Fragment, {
      children: numResources < maxResources
        ? new Array(maxResources - numResources).fill(null).map((e, t) => jsx("div", {
            className,
          }, t))
        : null,
    })
