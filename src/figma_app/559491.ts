...
async function Z(e, t, r) {
  if (e.current_plugin_version_id === null || !e.id) throw new Error(getI18nString('community.actions.resource_is_invalid'));
  let i = 0;
  ...
  let D = data.meta;
  let k = D.plugin;
  if (k.id !== e.id) throw new Error(getI18nString('community.actions.the_published_resource_i_ds_do_not_match'));
...
async function Q(e, t, r, i, a, o, l, u, h, g, f) {
  let E;
  if (!e) throw new Error(getI18nString('community.actions.plugin_id_is_invalid'));
  ...
  let V = Promise.resolve(!1);
  let H = r.iconBlob;
  H != null && (V = _$$c(H).then(e => Ac(iconUploadUrl, H, e)).then(() => !0).catch(e => {
    reportError(_$$e.COMMUNITY, e);
  ...
  let W = r.coverBlob;
  W != null && (z = _$$c(W).then(e => Ac(coverImageUploadUrl, W, e)).then(() => !0).catch(e => {
    reportError(_$$e.COMMUNITY, e);
    let t = $$e_25(e) ?? resolveMessage(e, getI18nString('community.actions.could_not_connect_to_the_server'));
  ...
  let Y = Promise.resolve(!1);
  snapshotBlob != null && snapshotUploadUrl && (Y = _$$c(snapshotBlob).then(e => Ac(snapshotUploadUrl, snapshotBlob, e)).then(() => !0).catch(e => {
    reportError(_$$e.COMMUNITY, e);
    return new Error(getI18nString('community.actions.error_uploading_widget_snapshot_image_error', {
  ...
  let et = data.meta;
  let er = et.plugin;
  if (er.id !== e) throw new Error(getI18nString('community.actions.the_published_resource_i_ds_do_not_match'));
...
let $$ea2 = createOptimistThunk(async (e, t) => {
  ...
  try {
    ...
    r instanceof UploadError ? MZ(e.dispatch, getI18nString('check_network_compatibility.error_bell.video_upload.message')) : r.message.includes('invalid word') || e.dispatch(VisualBellActions.enqueue({
      message: t,
      error: !0
    }));
...
let $$es11 = createOptimistThunk(async (e, t) => {
  ...
  try {
    ...
    r instanceof UploadError ? MZ(e.dispatch, getI18nString('check_network_compatibility.error_bell.video_upload.message')) : e.dispatch(VisualBellActions.enqueue({
      message: t,
      error: !0
    }));
    e.dispatch(updateStatus({
...
export function $$e_25(e) {
  ...
  if (r && r[0] && r[0].textContent === 'EntityTooLarge') return getI18nString('community.actions.file_too_large');
}
