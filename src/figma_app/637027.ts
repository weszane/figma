 ...
 */
export function ButtonBaseReversedContainer(e: {
  reversed?: boolean;
  className?: string;
...
export class ButtonBase extends RecordingComponent<ButtonBaseProps> {
  ...
  render() {
    ...
    const t: Omit<ButtonBaseProps, 'defaultClass' | 'recordingKey' | 'dataTestId'> = {
      ...restProps
    };
 ...
 */
export class BigButtonInverse extends Component<{
  fullWidth?: boolean;
}> {
