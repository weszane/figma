...
export function $$f0(e, t = 1, r = 1) {
  let n = e.keyCode;
  let i = Fo(e);
  if (n === Uz.TAB && sC(e, xH.SHIFT)) ;else if (wQ(e.keyCode)) ;else if (BrowserInfo.mac && e.ctrlKey && (n === Uz.A || n === Uz.B || n === Uz.D || n === Uz.E || n === Uz.F || n === Uz.H || n === Uz.K || n === Uz.L || n === Uz.N || n === Uz.O || n === Uz.P || n === Uz.T || n === Uz.V)) ;else if (n === Uz.DELETE || n === Uz.BACKSPACE || n === Uz.NUMPAD_DELETE || n === Uz.SPACE || n === Uz.ENTER || n === Uz.HOME || n === Uz.END || n === Uz.PAGE_UP || n === Uz.PAGE_DOWN || n === Uz.A && 1 === r) ;else if (i && n === Uz.Z && 1 === t) ;else if (i || e.ctrlKey) return !1;else if (n === Uz.F6) return !1;
  return !0;
}
