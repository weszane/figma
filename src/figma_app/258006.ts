...
import { Jk, Kf } from '../figma_app/99826'
import { buildUploadUrl } from '../figma_app/169182'
import { FB, Gw } from '../vendor/149334'
...
export function $$g1({
  ...
  if (useEffect(() => {
    t.status === 'loaded' && t.data && s(URL.createObjectURL(new Blob([new Uint8Array(t.data)], {
      type: 'image/png',
    })))
  }, [t.data, t.status]), e && Gw(e) === 'github') {
    return jsx($$E0, {
      width: 16,
      height: 16,
    })
  ...
  let u = e && FB(e)
  return u?.toLowerCase() === 'jira.com' || u?.toLowerCase() === 'atlassian.net'
    ? jsx('img', {
