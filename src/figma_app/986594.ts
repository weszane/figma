...
export function $$m6(e) {
  return UN().getDirectlySelectedNodes().every((t) => (!e || !!e.includes(t.type)) && null !== t.getNearestDakotaCollectionId());
}
export function $$g9() {
  return UN().getDirectlySelectedNodes().some((e) => e.isPrimaryInstance || e.isInstanceSublayer);
}
export function $$f0(e = UN().getDirectlySelectedNodes(), t) {
...
export function $$b4() {
  return UN().getDirectlySelectedNodes().some((e) => e.isInDakotaRepeater);
}
