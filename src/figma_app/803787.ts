...
let $$te25 = Mz([selectOpenFile, selectTeams], (e, t) => !!(getFeatureFlags().cmty_lib_admin_publish && e?.publishedHubFile) || !jd(e?.project) && !!(e && hasTeamPaidAccess(e.teamId ? t[e.teamId] : null)));
let $$tt3 = e0;
