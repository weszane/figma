...
import { eU as _$$eU, Iz } from "../figma_app/27355";
...
import { XR, Wn } from "../figma_app/396464";
import { jd } from "../figma_app/528509";
import { Mk } from "../figma_app/31188";
import { XJ, sS, tB, yV } from "../figma_app/516028";
import { bt } from "../905/270322";
import { rC, w8, i_, LB, pD, Q_, E2, ad, CG, HF, lg, Hb, gA, Lk, zE, RQ, MA } from "../figma_app/646357";
import { w5 } from "../figma_app/345997";
import { qV, ZA, c5 } from "../figma_app/645694";
import { O as _$$O } from "../905/566074";
import { dv, tj } from "../905/210500";
import { o as _$$o, PW, E8 } from "../figma_app/633080";
import { t as _$$t } from "../905/340158";
import { n as _$$n } from "../905/347702";
import { Xt } from "../figma_app/889655";
import { P as _$$P2 } from "../905/338617";
var u = c;
var _ = p;
var m = h;
var f = g;
...
let $$Y15 = Mz([$$G13, H, z, W, $$V14], (e, t, r, n, a) => !Im(e) || !Im(t) || !Im(r) || !Im(n) || !Im(a));
...
let $$ee5 = Mz([$, J, Z, Q], (e, t, r, n) => !Im(t) || !Im(e) || !Im(r) || !Im(n));
...
let $$el11 = Mz([ei, ea, es, eo, im], (e, t, r, n, i) => {
  ...
  let s = (e, t) => {
    ...
    } else if (t?.content_hash !== e.content_hash) return !0;
...
let $$ec33 = P8([e => {
  ...
  for (let [t, r] of Object.entries(l)) e.hasOwnProperty(t) || (s[t] = {
    ...r,
...
let $$ep20 = P8([e => {
  ...
  for (let t of Object.values(e)) {
    ...
    let n = function (e, t, r) {
      ...
      for (let e of r) if (e.status !== E8.CURRENT && e.status !== E8.NOT_STAGED) return E8.CHANGED;
      return E8.CURRENT;
    }(t, e, r[t.node_id] ?? []);
...
let $$ew0 = _$$eU(e => {
  if (e(eC)) return !0;
  for (let t of Object.keys(Mk)) if (_$$O(t) && Mk[t].local) {
    for (let r of Object.values(e(Mk[t].local))) if (!r.isSoftDeleted) return !0;
  }
  return !1;
});
let eO = _$$n(Mz([$$eb6, $$eE37], (e, t) => Object.keys(e).length > 0 || Object.keys(t).length > 0));
let $$eR17 = bt(eO);
let eL = (e, t) => null != e.status && (!!lg(e.status) || !!Hb(e.status) && (t ? t.has(e.node_id) : !!e.old_key));
let eP = (e, t) => eL(e, t) && HF(e.status);
let eD = bt(e => e.userStateLoaded);
let $$ek30 = _$$eU(e => e(eD) && e(yV)?.canEdit && (e($$tj32) || e($$ew0)));
...
function ej(e, t, r, n) {
  ...
  let a = new Set(n ? Object.keys(n).filter(e => "FORCED_COPY" !== n[e].publishType) : Object.values(i).filter(e => !!e.old_key).map(e => e.node_id));
...
function eK(e, t) {
  return null == t ? eX(e) : e$(e, t);
}
let $$eY38 = Iz(e => {
  let t = e ? bt(t => eK(t, e)) : bt(eX);
  let r = e ? bt(t => $$eM23(t, e)) : _$$eU(new Set());
  return _$$eU(e => {
    let n = e(t);
    let i = e(r);
...
function eq(e, t, r, n, i, a, s, o, l) {
  let d = (e, t) => {
    ...
    let r = l[e.node_id];
    let n = l[t.node_id];
    return r && n ? "FORCED_COPY" === r.publishType && "FORCED_COPY" !== n.publishType ? 1 : "FORCED_COPY" !== r.publishType && "FORCED_COPY" === n.publishType ? -1 : 0 : 0;
  };
...
let $$te25 = Mz([tB, _$$P2], (e, t) => !!(getFeatureFlags().cmty_lib_admin_publish && e?.publishedHubFile) || !jd(e?.project) && !!(e && w5(e.teamId ? t[e.teamId] : null)));
let $$tt3 = e0;
let tr = Mz([$$tt3], e => e.length > 0);
let tn = Iz(e => bt(t => tr(t, e)));
...
let tc = Iz(e => bt(t => td(t, e)));
let tu = Mz([e4, $$te25], (e, t) => t ? e : []);
let tp = Mz([tu], e => e.length > 0);
let t_ = Iz(e => bt(t => tp(t, e)));
let th = Mz([e8], e => e);
let tm = Mz([th], e => e.length > 0);
let tg = Iz(e => bt(t => tm(t, e)));
let tf = Mz([e6], e => e);
let tE = Mz([tf], e => e.length > 0);
let ty = Iz(e => bt(t => tE(t, e)));
let tb = Mz([e7, $$te25], (e, t) => t ? e : []);
let tT = Mz([tb], e => e.length > 0);
let tI = Iz(e => bt(t => tT(t, e)));
let tS = Mz([e9], e => e.length > 0);
let tv = Iz(e => bt(t => tS(t, e)));
let tA = Iz(e => _$$eU(t => {
  for (let r of Object.values(t($$eY38(e)).libraryAssets)) if (r.modified.wellFormed.length > 0 && _$$O(r.modified.wellFormed[0].type)) return !0;
  return !1;
}));
let tx = Iz(e => _$$eU(t => {
  for (let r of Object.values(t($$eY38(e)).libraryAssets)) if (r.modified.wellFormed.length > 0 && _$$O(r.modified.wellFormed[0].type) && r.modified.wellFormed.some(e => HF(e.status))) return !0;
  return !1;
}));
let $$tN36 = Iz(e => {
  let t = bt(t => $$tt3(t, e));
...
let $$tC9 = Iz(e => _$$eU(t => t(tn(e)) || t(tc(e)) || t(tg(e)) || t(tI(e)) || t(tA(e))));
let $$tw19 = Iz(e => _$$eU(t => t(ta) || t(t_(e)) || t(ty(e)) || t(tv(e)) || t(tx(e))));
...
let $$tD34 = Mz([$$tP35, () => Wn()], (e, t) => e.concat(t.filter(e => "SYMBOL" !== e.type).map(e => e.guid)));
let $$tk29 = Mz([$$el11, () => XR()], (e, t) => f()(e, e => t.includes(e.node_id)));
let tM = _$$eU(e => Object.values(e(_$$t).data ?? {}).some(e => HF(e.status)));
let tF = bt($$ee5);
let $$tj32 = _$$eU(e => e(tF) || e(tM));
