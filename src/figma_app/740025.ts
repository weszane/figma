...
export function $$eg59(e) {
  return "search" === e.view && ("url:community" === e.entryPoint || "community" === e.entryPoint || "community:header" === e.entryPoint);
}
export function $$ef53(e) {
  return "communityHub" === e.view && "monetizationRedirectView" === e.subView;
}
export function $$eE47(e) {
  return "communityHub" === e.view && "hubFileEmbed" === e.subView;
}
export function $$ey2(e) {
  return "communityHub" === e.view && "handle" === e.subView;
}
