...
export let $$A0 = new k([new $T(), new _$$f(), new YY(), new _$$y(), new _$$a(), new _$$m(), new B(), new G(), new _$$_(), new N(), new _$$u(), new _$$i(), new _$$T(), new _$$v()]);
...
let w = RegExp(`^/files/([0-9]+)/(?:${C.join("|")})(.*)$`);
let O = RegExp("^/files/([0-9]+)/?$");
let R = RegExp(`^/files/team/([0-9]+)/(?:${C.join("|")})(.*)$`);
let L = (e, t, r) => {
  let n = e.split("/");
  n[1] && "files" === n[1] && (6 !== n.length || "files" !== n[1] || "team" !== n[2] || "restore" !== n[5]) && (e.match(w) ? n.splice(2, 1) : e.match(R) ? n.splice(2, 2) : (n.length >= 3 && t && n[2] === t && n.splice(2, 1), n.length >= 3 && r && n[3] === r && n.splice(2, 2)));
  return n;
};
let P = (e, t) => {
  let r = e.split("/");
  r[1] && "files" === r[1] && (e.match(w) ? r.splice(2, 1) : r.length >= 3 && t && r[2] === t && r.splice(2, 1));
  return r;
};
...
export function $$F13(e, t, r, n, i = {
  ...
  let a = [];
  "" === (a = L(t, e.currentUserOrgId, e.currentTeamId))[a.length - 1] && a.splice(a.length - 1, 1);
...
export function $$B2(e) {
  let t = e.modalShown;
  for (; t;) {
    if ("ACCOUNT_SETTINGS_MODAL" === t.type) return !0;
    t = t.prevModal;
  }
  return !1;
}
...
export function $$V16(e) {
  return "fullscreen" === e.view && e.workshopModeInfoLoaded && e.workshopModeInfo && e.editorType === nT.Whiteboard && new Date() < e.workshopModeInfo.until || !1;
}
export function $$H11(e) {
  return !!("fullscreen" === e.view && e.tryPluginId && e.tryPluginName && e.tryPluginVersionId);
}
export function $$z12(e) {
  return "fullscreen" === e.view && e.nodeId || null;
}
...
export function $$$$K4(e) {
  return "recentsAndSharing" === e.view && (void 0 === e.tab || e.tab === _$$G.RECENTLY_VIEWED);
}
export function $$Y5(e) {
  return "resourceHub" === e.view || V(e);
}
export const $Z = $$A0;
export const CR = $$G1;
export const IE = $$B2;
