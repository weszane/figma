...
let $$h3 = atom(0);
let m = atom(null, (e, t, i) => {
  t($$h3, i);
});
export function $$f0(e) {
  atomStoreManager.set(m, e);
}
export function $$g1() {
  let [e, t] = useAtomValueAndSetter($$h3);
  let i = useRef(null);
  let p = function () {
    let {
    ...
    return r => {
      switch (r) {
        case 0:
          logWarning("AI Actions", 'Unexpected AI action "none" requested');
          break;
        case 1:
          summarizeCanvasSelection();
          break;
        ...
        case 6:
          {
            ...
            if (!e) {
              logWarning("AI Actions", "Unexpected AI action requested", {
                action: r
              });
              return;
            }
