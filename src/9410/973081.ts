...
import { rd as _$$rd, As, GP, v7 } from '../figma_app/475303'
...
class O {
  static getCanvasColorSpace(e = {}) {
    ...
    if (i === 'srgb')
    ;else if (i === 'display-p3')
      return e.returnString ? ColorSpaceEnum[ColorSpaceEnum.DISPLAY_P3] : ColorSpaceEnum.DISPLAY_P3
  ...
  static getDocumentColorProfile(e = {}) {
    if (void 0 === colorManagementStateJs)
      throw new Error('ColorManagementStateJs is not defined')
...
function J() {
  ...
  useEffect(() => {
    if (getFeatureFlags().assets_tab_sprig_tracking && !c.current) {
      t === AssetTabType.ASSETS && loaded && (i
          ...
          children: e.sort((e, t) => e.shortcut - t.shortcut).map((e, t) => {
            ...
            return jsxs('div', {
              ...
              children: [jsx('div', {
                ...
                children: i.shortcutText.length > 0
                  ? jsx('div', {
...
function ej({
  ...
  let g = useCallback((e) => {
    let t = u(e)
    let i = s.get(t)
    return void 0 !== i && t !== defaultSessionLocalIDString
      ? getI18nString('comments.asset_number', {
          orderNum: i + 1,
        })
      : e.pageName
  }, [u, s])
...
function ez({
  ...
  let i = useMemo(() => {
    if (window.FigmaMobile) {
      return t === FEditorType.Whiteboard
        ? function ({
          children: e,
        }) {
          return jsx(_$$a.Provider, {
  ...
  constructor(e = {}) {
    this.tick = () => {
      if (!this.isTickScheduled)
        throw new Error('wat, how did tick() get called if we\'re not ticking?')
      let e = 0
      let t = 0
...
function tS() {
  ...
  return getFeatureFlags().ce_tv_fpl_export_picker
    ? jsx(bL, {
        onClose: p,
        draggable: 'header',
        defaultPosition: h,
...
class tk extends PureComponent {
  constructor() {
    ...
    this.onExport = (e) => {
      if (this.props.isCopyExportRestricted || (trackEventAnalytics('Export Picker Exported'), this.state.downloadStarted || this.state.exportingStarted || this.isExporting() || e.length === 0))
        return
    ...
    this.renderRenameLayersButton = (e) => {
      ...
      return jsx(ButtonLargeWide, {
        ...
        onClick: a,
        disabled: s,
        children: this.state.renamingLayersRunning
          ? renderI18nText('fullscreen.export.cancel')
          : jsxs('div', {
...
function tW({
  ...
  return e && VariableAndStyleCreateModalRoot
    ? jsx(VariableAndStyleCreateModalRoot, {
        disableStyleModal: s,
...
function ia({
  ...
  if (!desktopAPIInstance || !desktopAPIInstance.isFloatingWindowAvailable())
    throw new Error('DesktopFloatingWindow: rendered with unsupported desktop app version')
  ...
  return (useEffect(() => {
    ...
    ? createPortal(e, l.document.body)
    : null
}
function is(e) {
  return jsx(ir, {
...
function ib({
  ...
  F
    ...
    : B
      ? (z = P ? xv(B, k.id) ?? B.name : B.name, i = jsx(_$$J3, {
          className: iy,
          color: D,
          hideBorderShadow: !0,
      ...
      : U && C
        ? (e.dropperData.creationFlow === IVariableStyles.STYLES ? (z = getI18nString('eyedropper.create_style'), i = jsx(_$$J2, {}), s = 'eyedropper-v2-style-creation') : e.dropperData.creationFlow === IVariableStyles.VARIABLES && (z = getI18nString('eyedropper.create_variable'), i = jsx(_$$J2, {}), s = 'eyedropper-v2-variable-creation'), V = [{
            key: 'modifier-1',
            label: 'shift',
          }, {
            key: 'modifier-2',
...
function iq(e) {
  ...
  if (!useSelector(e => getFileKeyFromSelectedView(e.selectedView)))
    return null
  let {
    thread,
  } = e
  ...
  let u = []
  l || (isCommentStateActive(thread.sidebarItemType)
    ? u.push({
        name: 'resolve',
        callback: () => {
          t(hx({
...
class ni extends PureComponent {
  items() {
    ...
    let y = !BrowserInfo.safari || a?.readClipboardData
      ? [x, d
          ? {
              separator: !0,
            }
    ...
    let T = this.props.canPublishOrgTemplate && E
      ? we({
    ...
    let S = [{
      ...
      : {
        ...
        }, !this.props.userCanViewPlugins || u && !getFeatureFlags().sites_plugin_api || h && !getFeatureFlags().buzz_plugins || p
      ? null
      : qz({
          ...this.props,
...
let ns = class e extends PureComponent {
  constructor(e) {
    ...
    this.getPageListForMoveToMenu = () => {
      ...
      if (!this.props.userCanEditFile || e == null || e.length < 2)
        return []
      let t = []
      for (let i of e) {
        i.nodeId !== this.props.appModel.currentPage && (i.isDivider
          ? t.push({
              separator: !0,
            })
          : t.push({
  ...
  getRelatedComponentMenu(e) {
    let t
    if (e !== StateHierarchy.NONE && e !== StateHierarchy.STATE_INSTANCE)
      return null
    let i = {
  ...
  getCopyLinkMenu() {
    ...
    return {
      ...
      displayText: this.isFigjam() && this.state.nodeTypeForCopyLinkText
        ? (function (e) {
            switch (e) {
  ...
  getImageToProfilePicture() {
    if (!this.props.user || !this.props.fillPaints || isInvalidValue(this.props.fillPaints))
      return null
  ...
  getMaybeEmbedOrLinkPreviewWidgetMenu() {
    if (!this.selectedEmbedOrLinkPreviewHasValidUrl())
      return null
  ...
  getExportVideo() {
    if (!this.props.fillPaints || isInvalidValue(this.props.fillPaints))
      return null
  ...
  getFigJamRemovePluginActionsMenu() {
    if (this.props.selectedView.editorType === FEditorType.Design)
      return null
  ...
  getMainComponentActionsMenu() {
    if (this.props.isLimitedDevMode)
      return null
    ...
    switch (this.props.selectedView.editorType) {
      ...
      case FEditorType.DevHandoff:
        e = [navigator.clipboard && navigator.clipboard.write
          ...
          : null, this.props.isLimitedDevMode
          ? null
          : {
              action: 'copy-text',
            }, this.props.isLimitedDevMode
          ? null
          : {
              action: 'copy-as-svg',
            }, this.props.isLimitedDevMode
  ...
  contextMenu() {
    ...
    let w = !a && !p
    let S = s || d && !getFeatureFlags().sites_plugin_api || c || u
      ? []
      : [w
          ? {
              separator: !0,
...
function ab({
  ...
  let U = (t) => {
    A && h && !O && t.template.id !== s && (R.current = !0, l
      ? p(showModalHandler({
          type: aa,
          data: {
            sectionId: e,
...
let si = class e extends PureComponent {
  constructor() {
    ...
    this.triggerPressed = () => {
      this.state.pressed !== 4 && this.state.pressed !== 2 && (clearTimeout(this.pressedTimeout), this.pressedTimeout = setTimeout(() => this.triggerUnpressed(), 500), this.state.pressed !== 3 && (this.state.pressed === 1
        ? this.setState({
            pressed: 3,
          })
        : this.setState({
    ...
    if (p !== e) {
      ...
      if (p) {
        ...
        if (a && !sh(s, c, b)) {
          ...
          let a = Object.values(_$$J5).includes(r)
                  ...
                  for (let e of s) {
                    for (let t of e.shortcuts) {
                      if (sr.keybindingsForShortcut(t.shortcutKey, i, r)) {
                        ...
                        if (sr.shortcutUsedCount(t.shortcutKey, a) > e)
...
function sW({
  ...
  return jsx('div', {
    className: e,
    children: o[t.activeTab]
      ? o[t.activeTab].columns.map((e, i) => createElement(sU, {
          ...t,
          key: `column-${i}`,
        }, e.map((e, n) => sc(s, e.includeInEditorType, e.hideInEditorType)
          ? jsx(sG, {
              caption: e.caption,
              ...t,
...
function sY({
  ...
  let d = _$$Zj()
  let c = sJ()
  return (i(n, e), sc(c, s.includeInEditorType, s.hideInEditorType) && su(s.featureFlags))
    ? jsx(sr, {
        shortcutKey: n,
        editorType: c,
        keyPosition: e,
...
function s$() {
  ...
  return getFeatureFlags().cursor_bot && t
    ? jsx('div', {
        'className': CR,
...
function s8({
  ...
  return (useEffect(() => {
    ...
    ? (globalPerfTimer.get('page_loading_overlay') || globalPerfTimer.start('page_loading_overlay'), jsx(s6, {
        background,
...
class ok extends RecordingPureComponent {
  ...
  render() {
    ...
    let d = null
    void 0 !== this.state.itemIsChecked
      ? d = jsx(_$$S6, {
...
function o1(e) {
  ...
  return e.editorType === FEditorType.Sites || e.editorType === FEditorType.Figmake
    ? jsx(o$, {
  ...
  useLayoutEffect(() => {
    ...
    if (a) {
      ...
      c.sessionId && !u
        ...
        : !a && c.sessionId && c.votingStage !== SessionStatus.ENDED && (t((u?.pageNodeId && getResourceDataOrFallback(u.pageNodeId)) === d
            ? H1({
...
export function $$lr0({
  ...
  return jsxs(Fragment, {
    children: [
      getFeatureFlags().ee_color_management_debug ? jsx(L, {}) : null,
      T && jsx(le, {
        fileKey: T,
      }),
      !(BrowserInfo.isIpad || BrowserInfo.isIpadNative || BrowserInfo.isMobileBrowser || BrowserInfo.isMeetDevice) && jsx(lt, {}),
      jsx('div', {
        'className': MY,
        ...
        'children': jsx(_$$l2.Provider, {
          ...
          children: jsxs(ez, {
            children: [
              getFeatureFlags().cursor_bot && A && t.hasCursorBot && jsx(s$, {}),
              !O && !B && !G && !K && jsx('div', {
                ref: ei,
                onMouseEnter: () => z(!0),
                onMouseLeave: () => z(!1),
              ...
              jsx(s7, {}),
              jsx(_$$T2, {}),
              isVsCodeEnvironment() && getFeatureFlags().dt_vscode_ready_for_dev && jsx(_$$f, {
              ...
              jsx(J, {}),
              getFeatureFlags().ce_al_experiments_on && j && I.size > 0 && jsx(eu, {}),
              e,
              t.hyperlinkLocation && jsx(o1, {
                hyperlinkLocation: t.hyperlinkLocation,
                editorType: t.selectedView.editorType,
                recordingKey: 'hyperlinkEditor',
              }),
              jsx(_$$y, {}),
              t.progressBarState.mode !== UIVisibilitySetting.OFF && jsx(z2, {
              ...
              t.pickerShown?.id === C9 && jsx(tS, {}),
              t.pickerShown?.id === _$$O4 && jsx(_$$S5, {
      ...
      jsx(et, {}),
      t.showKeyboardShortcuts && jsx(sq, {
