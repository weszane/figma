...
export function $$h0(e) {
  ...
  return jsx(fu, {
    ...
    children: jsxs(d_, {
      title: _$$t("file_browser.draft_to_project.title.plan_spaces"),
      titleClassName: wN,
      className: KP,
      size: 320,
      popStack: !0,
      ...
      children: [jsx(Jn, {
        ...
        children: [tx("file_browser.draft_to_project.body.plan_spaces"), jsx("br", {})]
      }), jsxs("div", {
        className: n()(v0, hF),
        children: [jsx("a", {
          target: "_blank",
          ...
          children: tx("file_browser.draft_to_project.move")
        })]
      })]
    })
  });
