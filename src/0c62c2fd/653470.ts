...
export function PdfConfirmationModal({
  ...
  const sourceOptions = useMemo<PdfSourceOption[]>(() => {
    ...
    options.sort((a, b) => {
      ...
      if (a.key === WhiteboardIntegrationType.UNKNOWN) return 1;
      if (b.key === WhiteboardIntegrationType.UNKNOWN) return -1;
        ...
        children: jsxs("div", {
          ...
          children: [jsx("div", {
            ...
            children: jsx(RadioInputRoot, {
              ...
              children: sourceOptions.map(option => jsx(RadioInputOption, {
                value: option.value,
                label: jsx(Label, {
                  className: cssBuilderInstance.textBodyMedium.$,
                  children: option.label
                }),
                children: option.key === WhiteboardIntegrationType.UNKNOWN && renderI18nText("file_browser.file_import_view.select_pdf_source_input_unknown_disclaimer")
              }, option.key))
            })
          })]
        })
