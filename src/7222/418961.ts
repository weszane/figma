...
export function $$l6(e) {
  trackEventAnalytics("resource_hub_breadcrumb_clicked", e);
}
export function $$n14(e) {
  trackEventAnalytics("resource_hub_category_dropdown_item_clicked", {
    route: e
  });
}
export function $$c17(e, t) {
  trackEventAnalytics("resource_hub_category_link_pill_clicked", {
    from_route: e,
    to_route: t
  });
}
export function $$i8() {
  trackEventAnalytics("resource_hub_saves_pill_clicked");
}
export function $$a13(e) {
  trackEventAnalytics("resource_hub_internal_resource_type_pill_clicked", {
    resource_type: e
  });
}
export function $$s16(e, t) {
  trackEventAnalytics("resource_hub_featured_category_clicked", {
    user_job_title: e,
    route: t
  });
}
export function $$o4(e, t, r, u, l, n) {
  trackEventAnalytics("resource_hub_resource_clicked", {
    resource_id: e,
    resource_type: t,
    type: r,
    search_session_id: l,
...
export function $$E0(e) {
  trackEventAnalytics("resource_hub_section_link_clicked", {
    route: e
  });
}
export function $$f9(e) {
  trackEventAnalytics("resource_hub_tab_clicked", {
    tab: e
  });
}
export function $$m10(e, t) {
  trackEventAnalytics("resource_hub_lightbox_rdp_closed", {
    resource_id: e,
    resource_type: t
  });
}
export function $$b12() {
  trackEventAnalytics("community_moved_to_resource_hub_banner_clicked");
}
...
export function $$h15() {
  trackEventAnalytics("community_home_shelf_see_more_clicked");
}
...
export function $$L2(e, t, r) {
  trackEventAnalytics("resource_hub_search_in_community_link_clicked", {
    search_session_id: e,
    search_query_id: t,
