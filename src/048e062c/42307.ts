...
function z(e) {
  ...
  if (!data.length || !keys.length || !scales || !dimensions || !getX0Value)
    return null
  let {
    x0Scale,
    x1Scale,
...
function j(e) {
  ...
  if (!data.length || !keys.length || !scales || !getX0Value)
    return null
  let {
    x0Scale,
    yScale,
...
function D({
  ...
  let o = (function ({
    ...
    return useMemo(() => {
      ...
      let g = chartType === _$$N.BAR_GROUPED
        ? _$$A6({
  ...
  return e.chartType === _$$N.BAR_STACKED
    ? jsx(j, {
        ...o,
        width: t,
        height: r,
      })
    : e.chartType === _$$N.BAR_GROUPED
      ? jsx(z, {
          ...o,
          width: t,
          height: r,
