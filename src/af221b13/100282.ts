...
let h = Ju(function (e) {
  return jsxs(d_, {
    title: jsx("div", {
      ...
      children: tx("community.collections.this_feature_isnt_available")
    }),
    ...
    children: [jsx(s_, {
      ...
      children: [tx("community.collections.this_feature_isnt_available_body"), " ", jsx("a", {
        ...
        children: tx("community.collections.learn_more")
      })]
    }), jsx("div", {
    ...
    children: jsxs("div", {
      ...
      children: [s ? jsx("div", {
        ...
        children: [jsx("div", {
          ...
          onClick: a,
          children: tx("community.collections.generate")
        })]
      }), jsx(tL, {
        title: e,
        description: t
...
export function $$I0({
  ...
  return jsx(T, {
    onClick: () => {
      ...
      })) : Object.values(es).includes(d) ? E(c, d) : $D(_$$e.COMMUNITY, Error(`Invalid use case category (${d}) for figjam ai card: ${e}`));
    },
    title: e,
    description: t,
    imageUrl: i
