...
function tu({
  ...
  if (e9(e)) {
    ...
    if (i?.idp_group) {
      ...
      r = jsx(_$$J4, {
        currentWorkspaceId: Ad(e.orgUser)?.workspace_id,
        disabled: t,
        workspacesCanMoveTo: a,
...
function tv({
  ...
  let f = useCallback((e) => {
    v((t) => {
      let a = e === Od.SEARCH_SCORE ? Od.SEARCH_SCORE : Od.NAME
      return {
        columnName: a,
  ...
  let w = useCallback((e) => {
    y(e)
    e ? f(Od.SEARCH_SCORE) : e === '' && f(oU.columnName)
  }, [f, y])
  ...
  return jsxs(Fragment, {
    children: [jsxs('div', {
      ...
      children: [jsx(TextWithTruncation, {
        children: t?.id
          ? renderI18nText('add_unassigned_members_modal.billing_group_description', {
          ...
          l && G(uo({
            ...
            successCallback: () => {
              G(VisualBellActions.enqueue({
                message: s.length <= _$$O
                  ? getI18nString('add_unassigned_members_modal.workspaces_success_message.instant', {
                      numUsers: s.length,
                    })
        ...
        let r = () => {
          ...
          a && G(uo({
            ...
            successCallback: () => {
              G(VisualBellActions.enqueue({
                message: s.length <= _$$O
                  ? getI18nString('add_unassigned_members_modal.billing_groups_success_message.instant', {
                      numUsers: s.length,
                    })
...
function tk(e) {
  ...
  if (i.status !== 'loaded' || !['loaded', 'disabled'].includes(r.status) || !d)
    return null
  let _ = hX(o)
  let u = NV(e.licenseGroup, o)
  let m = 'default'
  u
    ? (m = 'warn', t = getI18nString('license_group_admin.billing_dashboard.billing_banner.review_and_confirm'), a = getI18nString('license_group_admin.billing_banner.review.subtitle.seat_rename'))
    : (_
        ? (m = 'success', t = getI18nString('license_group_admin.billing_banner.completed_at_date_new', {
...
function tE(e) {
  ...
  let s = a?.key
  return s?.parentId && s?.type === FOrganizationLevelType.ORG && t
    ? jsx(tk, {
        orgId: s.parentId,
        licenseGroup: t,
        queueOrgUsersRefetch: e.queueOrgUsersRefetch,
  ...
  let t = (function (e) {
    ...
    return useMemo(() => {
      ...
      return ['loading', 'errors'].includes(a.status) || l.status !== 'loaded'
        ...
        : {
            plan: t,
            workspaces: a.transform(e => e.org?.workspaces?.length
              ? (sortByPropertyWithOptions(e.org.workspaces, 'name'), e.org.workspaces.concat({
                  id: UNASSIGNED,
  ...
  let h = useCallback(() => {
    ...
    m(uo({
      ...
      params: {
        ...
        paid_statuses: seatType === ViewAccessTypeEnum.VIEW
          ? N_.dict(() => FPlanAccessType.STARTER)
          : {
...
let aZ = kp((e) => {
  ...
  return jsxs(AutoLayout, {
    ...
    children: [jsx(aV, {
      ...
      className: aJ,
      children: i
        ? renderI18nText('members_tab.member_modal.guest_access.can_also_view_public_links_label', {
            name: e.user.handle,
          })
...
let a1 = registerModal((e) => {
  ...
  return T8(jsx(ModalRootComponent, {
    width: 'lg',
    height: 'dynamic',
    manager: t,
    children: jsxs(vo, {
...
function nn(e) {
  ...
  let h = useMemo(() => {
    ...
    e.filters.permissionFilter !== WH.IDP && t.push(VU)
    return t
  ...
  let ep = (t, a, s) => {
    let i = a ? em(a, e => Ad(e)?.workspace_id) : new Set()
    let r = {
      type: uw.NONE,
    }
    if (i.size === 1) {
  ...
  let ev = useCallback((e) => {
    onFilter({
      [_$$e2.seatTypeFilter]: e[t8.SEAT_TYPE]?.current ?? null,
      [_$$e2.workspaceFilter]: e[t8.WORKSPACES]?.current ?? null,
      [_$$e2.licenseGroupFilter]: e[t8.BILLING_GROUPS]?.current ?? null,
      [_$$e2.permissionFilter]: e[t8.USER_TYPE]?.current ?? null,
      [_$$e2.lastEditFilter]: e[t8.LAST_EDIT]?.current ?? null,
      [_$$e2.newEditorFilter]: !!e[t8.CHARGED]?.current,
      [_$$e2.idpGroupFilter]: e[t8.IDP_GROUPS]?.current ?? null,
    })
  }, [onFilter])
            ...
            children: [jsx('div', {
              ...
              children: [jsx(ar, {
                ...
                currentFilters: (t = e.filters, {
                  ...t7,
                  [t8.BILLING_GROUPS]: t[_$$e2.licenseGroupFilter],
                  [t8.WORKSPACES]: t[_$$e2.workspaceFilter],
                  [t8.CHARGED]: t[_$$e2.newEditorFilter] ? 'new' : null,
                  [t8.LAST_EDIT]: t[_$$e2.lastEditFilter],
                  [t8.SEAT_TYPE]: t[_$$e2.seatTypeFilter],
                  [t8.USER_TYPE]: t[_$$e2.permissionFilter],
                  [t8.IDP_GROUPS]: t[_$$e2.idpGroupFilter],
                }),
                filterCounts: {
      ...
      : (ay.withOverrides({
          ...
          children: jsxs('div', {
            ...
            children: [jsx(y2, {
              ...
              'values': [FUserRoleType.ADMIN, FUserRoleType.MEMBER, FUserRoleType.GUEST, WH.IDP, WH.UNVERIFIED],
            ...
            }), (e.invoices?.length || 0) > 0 && RC(e.selectedView.view) && !e.isELA && jsx(jm, {
              className: $u,
              onClick: () => e.onFilter({
  ...
  let eI = jsx(Me, {
    ...
    'onClick': () => {
      ...
      })), (e.selectedView.view !== 'orgAdminSettings'
        ? e.selectedView.view === 'licenseGroup'
          ? eg.getMemberCSVExport({
  ...
  let eR = jsxs(AutoLayout, {
    ...
    }), e.selectedView.view !== 'orgAdminSettings' || getFeatureFlags().user_groups
      ? jsx(_$$V, {
          'icon': 'plus-32',
          'variant': 'primary',
          'onClick': () => {
  ...
  let eO = null
  eO = getFeatureFlags().user_groups && e.selectedView.view === 'orgAdminSettings'
    ? null
    : eS
      ? jsx(_$$m2, {
          selectedSecondaryTab: m2.MEMBERS,
          rightActions: eR,
        })
      : jsx(_$$K2, {
    ...
    children: [eO, G && jsx(tT, {
      ...
      : jsxs(Fragment, {
          children: [ef && ey(), jsx(Cj, {
            ...
            itemTypeContext: {
              itemType: 'user',
              getSelectedCountString: e => j && !totalSelectable
                ? ''
                : getI18nString('multi_select_list.selected_count_user', {
                    numSelected: e,
                  }),
            },
            items: e.sortedItems,
  ...
  return jsxs(Fragment, {
    children: [eM, jsx(_$$E2.Root, {
      ...
      children: highlightedItem && jsx(_$$E2.Contents, {
        ...
        badge: _$$t2(highlightedItem.orgUser, {
          showMember: !0,
        }),
        currency: e.currency,
...
export function $$nc0(e) {
  ...
  let Y = useCallback(e => (function (e, t) {
    ...
    let i = t[_$$e2.lastEditFilter]
    let r = t[_$$e2.newEditorFilter]
    if (s === WH.IDP && wQ(e) || s === WH.UNVERIFIED && (!wQ(e) || !1 !== e.is_email_validated) || s && s !== WH.IDP && s !== WH.UNVERIFIED && (wQ(e) && !1 === e.is_email_validated || (wQ(e) ? e.permission : null) !== s))
      return !1
    if (i) {
      let t
      if (wQ(e) && (t = e.last_edit), !t)
        return !1
      let a = null
      if (i === '3mo' ? a = _$$A().subtract(3, 'month') : i === '6mo' ? a = _$$A().subtract(6, 'month') : i === '1yr' && (a = _$$A().subtract(1, 'year')), _$$A(t).isAfter(a))
        return !1
    }
    if (r && !wQ(e))
      return !1
  ...
  let e_ = useCallback(e => wQ(e) ? no(M, dropdownShown, Z, org, et, ee, queueFilterCountsRefetch)(e) : nd(M, dropdownShown, org)(e), [M, dropdownShown, Z, org, et, ee, queueFilterCountsRefetch])
  let eu = useMemo(() => K.map(e_), [K, e_])
  let em = useMemo(() => J.map(e_), [J, e_])
  let ep = new Set([...K, ...J].filter(e => !wQ(e)).map(e => e.email))
  let eg = {
  ...
  let eh = (function (e, t, a, s, i, r, l, o, d, c) {
    ...
    if (_.push({
      ...
      getSortValue: (e) => {
        if (e9(e))
          return e.orgUser?.active_seat_upgrade_date
      },
      sortReversed: !0,
      ...
      name: _$$aM(Od.UPGRADE_REASON, e.featured_scim_metadata),
      sorting_key: Od.UPGRADE_REASON,
      className: xw,
      getSortValue: (e) => {
        if (e9(e))
          return e.orgUser?.active_seat_upgrade_method?.upgrade_method?.toString()
      },
      sortReversed: !0,
      ...
      _.push({
        name: _$$aM(Od.WORKSPACE, e.featured_scim_metadata),
        sorting_key: Od.WORKSPACE,
        className: Uj,
        getSortValue: (e) => {
          if (e9(e)) {
            let a = Ad(e.orgUser)
        ...
        getSecondarySortValue: (e) => {
          if (e9(e))
            return Ad(e.orgUser)?.assigned_at ?? void 0
        },
    ...
    t && PR(o) && _.push({
      name: _$$aM(Od.LICENSE_GROUP, e.featured_scim_metadata),
      sorting_key: Od.LICENSE_GROUP,
      className: VG,
      ...
      getSecondarySortValue: (e) => {
        if (e9(e) && e.orgUser.license_group_member)
          return e.orgUser.license_group_member.assigned_at
      },
      sortSecondaryReversed: !0,
    ...
    e.featured_scim_metadata && _.push({
      ...
      sorting_key: Od.SCIM_DATA,
      className: b8,
      getSortValue: e => tn(e) ? `a${tn(e)}` : 'z',
      cellComponent: e => tn(e)
        ? jsx('span', {
            children: tn(e),
          })
        : jsx(te, {}),
    ...
    _.push({
      name: _$$aM(Od.LAST_ACTIVE, e.featured_scim_metadata),
      sorting_key: Od.LAST_ACTIVE,
      className: cJ,
  ...
  let ej = useCallback((e) => {
    let a = !1
    e === Od.SEARCH_SCORE ? a = !1 : sort.columnName === e && (a = !sort.isReversed)
    let n = {
      isReversed: a,
      columnName: e,
    }
    ...
    let s = e === Od.SEARCH_SCORE ? Od.SEARCH_SCORE : _$$aM(e, org.featured_scim_metadata)
    ex(e => ({
      columnName: s,
  ...
  let ey = useCallback((e) => {
    ...
    setSearchQuery(e)
    Q(a7.SEARCH)
    e ? ej(Od.SEARCH_SCORE) : e === '' && ej(oU.columnName)
