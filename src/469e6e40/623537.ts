...
export function $$nc0(e) {
  ...
  let Y = useCallback(e => function (e, t) {
    ...
    if (s === WH.IDP && wQ(e) || s === WH.UNVERIFIED && (!wQ(e) || !1 !== e.is_email_validated) || s && s !== WH.IDP && s !== WH.UNVERIFIED && (wQ(e) && !1 === e.is_email_validated || (wQ(e) ? e.permission : null) !== s)) return !1;
    if (i) {
      let t;
      if (wQ(e) && (t = e.last_edit), !t) return !1;
      let a = null;
    ...
    if (_.push({
      ...
      _.push({
        ...
        getSecondarySortValue: e => {
          if (e9(e)) return Ad(e.orgUser)?.assigned_at ?? void 0;
        },
