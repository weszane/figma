...
export function $$nc0(e) {
  ...
  let Y = useCallback(e => (function (e, t) {
    ...
    if (s === SpecialUserTypes.IDP && isUserObject(e) || s === SpecialUserTypes.UNVERIFIED && (!isUserObject(e) || !1 !== e.is_email_validated) || s && s !== SpecialUserTypes.IDP && s !== SpecialUserTypes.UNVERIFIED && (isUserObject(e) && !1 === e.is_email_validated || (isUserObject(e) ? e.permission : null) !== s))
      return !1
    if (i) {
      let t
      if (isUserObject(e) && (t = e.last_edit), !t)
        return !1
      let a = null
    ...
    if (_.push({
      ...
      _.push({
        ...
        getSecondarySortValue: (e) => {
          if (e9(e))
            return findMainWorkspaceUser(e.orgUser)?.assigned_at ?? void 0
        },
