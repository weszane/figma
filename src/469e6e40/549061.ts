...
function U({
  ...
  return e ? jsx(Wi, {
    ...
    children: [jsx(ER, {
      dispatch: a,
      entityType: t?.key.type === _$$OL.ORG ? ck.ORG : ck.TEAM,
      entity: {
        ...t,
...
function e_({
  ...
  } else "number" == typeof a && (r = a.toLocaleString());
  return jsxs("div", {
...
function t_({
  ...
  return jsxs(Fragment, {
    children: [jsx($z, {
      variant: "secondary",
      onClick: () => {
        "team" === e.key.type || s ? td(r, "team" === e.key.type ? _$$O.TEAM : _$$O.ORG, e.key.parentId ?? "") : tc(r);
      },
      htmlAttributes: {
...
function tu({
  ...
  let eN = "loaded" === ed.status;
  let eI = eN && !!ed.data?.adminDashboardRequests?.isLoadingNextPage;
  let eT = eN && !!ed.data?.adminDashboardRequests?.hasNextPage();
  let eA = et && "loaded" === eS.status && eS.data?.org?.bigmaEnabledAt && !!t;
  let eR = et && "loaded" === eS.status ? eS.data?.org?.orgSharedSetting?.configuredUpgradeRequestSetting : void 0;
  let eO = ZY({
    isIntendedAudience: et && "loaded" === eS.status && eS.data?.org?.bigmaEnabledAt !== null && !1 === t
  });
  _$$u2(et, t);
  let eQ = _$$d({
    reportErrorsToTeam: _$$e.SCALE
  });
  let e2 = !eN || d.loading || null === eC;
  let e4 = e_?.length ?? 0;
  let e5 = eu?.length ?? 0;
  let e3 = [X, Q].toString();
  let e8 = M[e3];
  ...
  let e9 = useMemo(() => {
    ...
    let t = ed.data?.adminDashboardRequests.reduce((t, a) => {
      ...
      let i = a.user;
      let r = a.userId;
      if (s.status !== tT.Loaded || i.status !== tT.Loaded) return t;
      let l = s.data;
      let o = i.data;
      if (!l || !o) {
        e.has(n) || e.add(n);
  ...
  let ti = useMemo(() => new Set(e9?.filter(e => [ud.DEVELOPER, ud.EXPERT].includes(e.billableProductKey) && e.message?.includes("Dev Mode")).map(e => e.id)), [e9]);
  _$$R2(() => {
  ...
  useEffect(() => {
    ...
    c(a => ({
      ...
      requestId: e,
      loading: !!e,
      costShownInEmail: "true" === t || "false" !== t && void 0
    }));
  ...
  _$$R2(() => {
    ...
    let n = a_(a) && seatAvailability[a] > 0;
    if (_ && !n && !t) {
      ...
      children: [jsxs("div", {
        ...
        children: [jsxs("div", {
          ...
          children: [jsxs("div", {
            ...
            let t = {
              [ud.COLLABORATOR]: e.upgradeApprovalSettingsCollaborator,
              [ud.DEVELOPER]: e.upgradeApprovalSettingsDeveloper,
              [ud.EXPERT]: e.upgradeApprovalSettingsExpert,
              [ud.CONTENT]: e.upgradeApprovalSettingsContent
            };
            let a = e => {
              switch (t[e]) {
                ...
                case "manual_approval":
                  return !1;
                default:
                  throw Error("Not a valid approval setting");
              }
            };
