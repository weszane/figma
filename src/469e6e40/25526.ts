...
import { isOverdue, getLatestPayableInvoice, InvoiceState } from "../figma_app/934005";
...
class tZ extends PureComponent {
  ...
  onRequestCSV = () => {
    ...
    sendWithRetry.post("/api/activity_logs/export", {
  ...
  render() {
    return jsxs(Fragment, {
      children: [this.state.emails.tokens.length > 0 && jsx(t1, {}), !this.props.hideHeader && jsx(_$$K2, {
        title: getOrgAdminTabMessage(DashboardSection.ACTIVITY),
  ...
  return jsx(TrackingProvider, {
    ...
    children: jsx(ModalRootComponent, {
      ...
      children: jsxs(ModalFormContents, {
        onSubmit: _ ? n => {
          n.preventDefault();
          sendWithRetry.del(`/api/orgs/${o}/license_groups`, {
            license_group_ids: d
          }).then(({
            data: n
          }) => {
...
let aS = registerModal(function (e) {
  ...
  return jsx(aC, {
    ...
    onSubmit: () => {
      ...
      u ? sendWithRetry.put(`/api/license_group/${e.licenseGroup.id}`, {
        name: x,
        admin_user_ids: p.tokens.map(e => e.content.user.id),
        showing_billing_groups: !0
      }).then(a).catch(n) : sendWithRetry.post(`/api/orgs/${l}/license_groups`, {
        name: x,
        admin_user_ids: p.tokens.map(e => e.content.user.id),
        showing_billing_groups: !0
      }).then(a).catch(n);
...
function no(e) {
  let t = _$$R2();
  let [a, n] = useMemo(() => {
    let a = e.openInvoices.filter(e => isOverdue(e, t));
    let n = getLatestPayableInvoice(a);
    return n ? [n, !0] : [getLatestPayableInvoice(e.openInvoices), !1];
  }, [t, e.openInvoices]);
  return a ? n ? jsx(nr, {
    orgId: e.orgId,
...
function nd(e) {
  let t = useMemo(() => e.invoices.filter(e => e.state === InvoiceState.OPEN), [e.invoices]);
...
function n_(e) {
  return jsxs(Fragment, {
    children: [jsx("div", {
      ...
      title: getOrgAdminTabMessage(DashboardSection.BILLING),
...
let nk = registerModal(function (e) {
  ...
  let C = () => {
    ...
    let a = p ? sendWithRetry.put : sendWithRetry.post;
    let n = p ? d : _;
...
function sB(e) {
  ...
  eY = e.selectedTab === DashboardSection.DASHBOARD || e.selectedTab === DashboardSection.CONTENT ? jsx(LoadingOverlay, {}) : e.selectedTab === DashboardSection.RESOURCES ? jsx(_$$p2, {
    ...
    className: kL,
    children: [jsx(_$$K2, {
      title: getOrgAdminTabMessage(e.selectedTab, e.selectedSecondaryTab)
    }), jsx(LoadingOverlay, {})]
  });
