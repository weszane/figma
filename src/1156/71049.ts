...
import { Fullscreen, SceneGraphTsApi } from "../figma_app/763686";
...
export function $$x0(e, t, n, r) {
  return permissionScopeHandler.ai("code-chat", () => {
    ...
    let x = !1;
    if (!kv(d)) {
      let e = Fullscreen?.createNewCodeFile(l, r, null, !1);
...
export function $$m3(e) {
  0 !== e.length && permissionScopeHandler.ai("remove-code-files", () => {
    e.forEach(e => {
...
export function $$h2(e, t) {
  ...
  if (e.isLayerLikeCodeNode) {
    let e = SceneGraphTsApi?.getPrimaryCodeInstanceFromLayerLikeCodeFile(n.scene, t);
    if (e) {
      let t = n.get(e);
      if (t) return t;
    }
  } else {
    let e = SceneGraphTsApi?.getCodeComponentsExportedFromFile(n.scene, t);
    if (e?.length === 1) {
      let t = n.get(e[0]);
      if (t) return t;
    }
