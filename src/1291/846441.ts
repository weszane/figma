...
import { fQ, G0, j6, l7, m_, vh } from '../9410/335206';
...
let i;
let k = new SimpleFuseSearch([], {
  keys: ['name']
});
let L = new SimpleFuseSearch([], FUSE_CONFIG_PROFILE);
let A = new SimpleFuseSearch([], FUSE_CONFIG_PROFILE);
let B = new SimpleFuseSearch([], {
  threshold: 0.1,
  matchAllTokens: !0,
  tokenize: !1,
  distance: 300,
...
export function $$z0() {
  ...
  let F = useLocalPluginsExcludingWidgets();
  let z = useLocalPluginsExcludingWidgets();
  let {
  ...
  } = usePluginServerSideSearch(_$$k.Editors.FIGJAM);
  let {
