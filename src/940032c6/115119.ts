...
function s4() {
  ...
  return jsxs('div', {
    ...
    children: [e ? jsx(Fragment, {
      children: jsx(s8, {})
    }) : null, getFeatureFlags().switch_canvas_mode ? jsx(IconButton, {
      'onClick': t,
        ...
        children: [g && jsxs('div', {
          ...
          children: [jsxs('div', {
            ...
            children: [jsx(BigTextInputForwardRef, {
              ...
              children: y.length > 0 && jsx(IconButton, {
...
function bw({
  ...
  let t = useRef(null);
  let i = getHubFileVersionOrDefault(e.content.hub_file);
...
function yi({
  ...
  let s = useStyleInfo(e, t, StyleType.TEXT);
  return jsx(Fragment, {
    children: jsx('div', {
