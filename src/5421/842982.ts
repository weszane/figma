...
let $$c2 = forwardRef(function ({
  ...
  return jsxs(ButtonPrimitive, {
    ...
    className: d()("menu_button--iconButton--KPBE2 menu_button--baseIconButton--cJj85", "menu_button--ghost--PZTUp", {
      ...
      "menu_button--active--AekuE": i
    }),
    htmlAttributes: {
      "data-tooltip": p["aria-disabled"] || p.disabled ? void 0 : l,
      "data-tooltip-type": s,
...
let p = forwardRef(function ({
  ...
  return jsx(ButtonPrimitive, {
    ref: s,
    ...c,
    ...stylex.props(m.container, i, a["aria-expanded"] ? m.container_active : null, a.noBorder ? m.container_noBorder : null, t ? null : m.containerLeftPaddingWithoutIconPrefix, n ? null : m.containerRightPaddingWithoutIconSuffix),
    children: jsxs("div", {
...
let $$u1 = forwardRef(function (e, t) {
  return jsx(p, {
    ref: t,
    ...e,
    styleXStyles: x.dialogTriggerButton
  });
});
let $$h0 = forwardRef(function (e, t) {
  return jsx(p, {
    ref: t,
    ...e,
