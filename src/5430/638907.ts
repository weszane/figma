...
export function $$f0(e) {
  ...
  let E = filterState.resourceType === ResourceTypes.BrowseResourceTypes.PLUGINS && (resourcesLoading || (totalResources ?? []).every(e => ws(e) ? e.resource_type === vt.PLUGIN : isPlugin(e)));
  let S = [];
