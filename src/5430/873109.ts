...
function ev({
  ...
  let {
    ...
    let i = isOrgOrTeam(s);
    let o = getCommunityHubLikeStatus(resource.id, getResourceType(resource), !hasContent(resource));
    let a = getCommunityHubLikeStatusByResourceId(resource.id, hasContent(resource));
