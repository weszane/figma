...
export let $$u0 = registerModal(function (e) {
  ...
  e.editorType === FileTypeEnum.SLIDES && (t = getI18nString("rcs.redirect_from_mobile_to_desktop.head_to_slides_on_desktop"), r = getI18nString("community.collections.head_to_desktop_slides"), c = buildUploadUrl("d5fbdadc97f3d94063357e9819c314ade9055df3"));
