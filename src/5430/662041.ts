...
export function $$m0(e) {
  ...
  let h = getCommunityHubLikeStatus(resource.id, getResourceType(resource), !hasContent(resource));
  let x = getCommunityHubLikeStatusByResourceId(resource.id, hasContent(resource));
