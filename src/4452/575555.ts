...
import { pG, cD } from "../figma_app/598018";
...
import { getPermissionsState, canAdminTeam } from "../figma_app/642025";
import { A8, zQ } from "../figma_app/465071";
...
var y = b;
let F = _$$ex("restricted_edu_tooltip", function (e) {
  let {
    text,
    title
  } = e;
...
function ea(e) {
  ...
  let o = useMemo(() => e.teamLgResult.transform(({
    ...
    canEditTeamMemberRole: _$$OL(e.teamRole, !!t?.canAdmin, !!t?.canEdit)
  ...
  return jsxs("div", {
    ...
    children: [e.isModal && jsx("div", {
      ...
      children: [(() => {
        if (e.isEduRestrictedLg) return jsx(_$$B, {
        ...
        if (e.teamRole.user_id !== a.id || o?.isCurrentUserTeamOwner) {
          if (!o?.canEditTeamMemberRole) return jsx("span", {
            className: "members_list_row--nonDropdownPadding--a8tyP",
            children: QN(e.teamRole.level)
          });
          o?.isCurrentUserTeamOwner && !e.teamRole.pending && n.push(_$$e.OWNER);
          o?.canMakeTeamMemberAdmin && n.push(_$$e.ADMIN);
          n.push(_$$e.EDITOR);
          n.push(_$$e.VIEWER);
          r = e.teamRole.pending;
        } else n.push(e.teamRole.level);
...
function ed(e) {
  ...
  let o = e => {
    ...
    let s = lgData[t];
    return !!s.isStudentTeam && s.level !== _$$e.VIEWER && !e.pending && !s.level && !(s.isStudent || lgData[t].hasValidEduGracePeriod);
  };
  let d = e => {
    if (!lgDataLoaded || !lgData) return null;
    let t = ec(e);
  ...
  let b = !v.some(e => e.level === _$$e.OWNER || e.level === _$$e.ADMIN);
  let y = "loading" === l.status;
  return (Vy({
    isReady: "loaded" === l.status,
...
function tf(e) {
  ...
  let [m] = mI(u);
  let p = useMemo(() => {
    if ("loaded" !== m.status || !m.data.team) return null;
    let t = m.data.team;
    return {
      teamId: e.teamId,
      orgId: t?.orgId,
  ...
  let f = u8({
    oldValue: d,
    newValue: p,
    label: A5.TeamSettingsView.teamInfo,
  ...
  let v = useMemo(() => {
    if ("loaded" !== m.status || !m.data.team || !m.data.team.currentPlanUser) return null;
    ...
    return {
      ...
      canAdminOrg: !!e && A8(e, FMemberRoleType.ADMIN),
  ...
  let V = e => e.sharing_audience_control ? e.sharing_audience_control : e.org_access ? e.org_access === FAccessLevelType.PUBLIC && "edit" === e.default_permission ? FPermissionLevelType.ORG_EDIT : e.org_access === FAccessLevelType.PUBLIC ? FPermissionLevelType.ORG_VIEW : void 0 : FPermissionLevelType.INVITE_ONLY;
  return jsxs("div", {
    children: [jsxs("div", {
      children: [jsxs("div", {
        className: to,
...
function tI(e) {
  ...
  let d = l ? [jsx("div", {
    ...
    if ("SETTINGS" === t && e.canEditTeam || "MEMBERS" === t) return jsx(tb, {
      tab: t,
      mobileNavTabTitle: a,
