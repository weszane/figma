import n, { hK } from "../905/450589";
import { Cg } from "../figma_app/916560";
import { ol, w2 } from "../905/165465";
import { m as _$$m } from "../905/194327";
import { DV } from "../figma_app/703447";
import { SW } from "../figma_app/109413";
import { buildUploadUrl } from "../figma_app/169182";
function r({
  figma: e,
  iconSvgSrc: t,
  backgroundColor: i = "#EBEBFF"
}) {
  let {
    widget
  } = e;
  ...
  let s = widget.useWidgetNodeId();
  let o = e.getNodeById(s);
  let l = o?.width;
  let d = o?.height;
  let c = e.widget.h(SVG, {
    src: t,
    x: {
      type: "center",
      offset: 0
...
let o = {
  configType: ol.GOOGLE_FORMS,
  urlPatterns: [/^(?:https?:)?\/\/(www\.)?docs\.google\.com\/forms\/.*/, /^(?:https?:)?\/\/forms\.gle\/.*/],
  allowedEmbedTypes: [w2.URL],
  specialParameters: []
};
let c = {
  configType: ol.LOTTIEFILES,
  urlPatterns: [DV],
  allowedEmbedTypes: [w2.URL],
  specialParameters: []
};
let $$u = {
  configType: ol.TYPEFORM,
  urlPatterns: [/^(?:https?:)?\/\/(www\.)?typeform\.com\/.*/, /^(?:https?:)?\/\/form\.typeform\.com\/.*/],
  allowedEmbedTypes: [w2.URL],
  specialParameters: []
};
let p = {
...
function b(e) {
  let t = null;
  try {
    if (!(t = new URL(e).searchParams.get("v") || null)) {
...
export function $$w0({
  ...
  widget.register(function () {
    let [t] = useSyncedState("widgetType", null);
    switch (t) {
      case hK.MAILCHIMP:
        return function ({
          figma: e
          ...
          let [r] = useSyncedState("inputPlaceholder", null);
          let [a] = useSyncedState("submitButtonLabel", null);
          return e.widget.h(AutoLayout, {
      ...
      case hK.YOUTUBE:
        return function ({
          ...
          let [n] = useSyncedState("videoURL", null);
          let r = n ? b(n) : null;
          return n && r ? x({
            figma: e,
            videoId: r
      ...
      case hK.GENERIC:
        return function ({
          ...
          let [n] = useSyncedState("embedCodeType", "url");
          let [s] = useSyncedState("embedURL", "");
          let [d] = useSyncedState("embedIframeHtml", "");
          let g = "url" === n ? s : Cg(d);
          return SW.some(e => e.test(g)) ? function ({
            figma: e
          }) {
            let {
              widget
            ...
            let [n] = useSyncedState("embedURL", null);
            let r = n ? b(n) : null;
            return n && r && 0 !== r.length ? x({
              figma: e,
              videoId: r
            }) : E({
              figma: e
            ...
            figma: e
          }) : _$$m.urlPatterns.some(e => e.test(g)) ? function ({
            figma: e
          }) {
            return r({
              figma: e,
            ...
            figma: e
          }) : $$u.urlPatterns.some(e => e.test(g)) ? function ({
            figma: e
          }) {
            return r({
              figma: e,
            ...
            figma: e
          }) : c.urlPatterns.some(e => e.test(g)) ? function ({
            figma: e
          }) {
            return r({
              figma: e,
            ...
            figma: e
          }) : o.urlPatterns.some(e => e.test(g)) ? function ({
            figma: e
          }) {
            return r({
              figma: e,
            ...
            figma: e
          }) : p.urlPatterns.some(e => e.test(g)) ? function ({
            figma: e
          }) {
            return r({
              figma: e,
