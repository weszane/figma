...
import { createColorDataUri, getRGBAFromColor } from "../905/248569"
...
import { getStyleThumbnail, isStyleType } from "../905/405710"
...
import { blendGradientColors, borderDark, borderLight, borderTranslucent, whiteColor } from "../figma_app/191804"
...
export function $$ei4(e) {
  return e === "inheritFillStyleKeyForStroke"
}
...
export function $$er3(e, t) {
  if (e && t && e.type === "EFFECT" && e.effects?.length > 0 && e.effects.find(e => e.type === "GLASS"))
    return getI18nString("properties_panel.effects.glass.style.non_frame_warning")
}
export function $$ea1({
  dsStyle: e,
  size: t = "Standard",
...
function es(e, t) {
  ...
  if (!e)
    return null
  if (!t && i) {
    if (i === borderTranslucent)
      return n === "dark" ? "white" : "black"
    if (i === borderDark)
      return "black"
    if (i === borderLight)
      return "white"
...
export function $$em0(e) {
  let t = Ep()
  return getFeatureFlags().ee_color_management_circle_p3 && t === ColorSpaceEnum.DISPLAY_P3 && e.filled
    ? jsx(ef, {
        ...e,
      })
    : jsx(e_, {
