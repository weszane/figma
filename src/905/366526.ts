...
import { delFigFilePublishedAsHubFile, hubFileDelAll, hubFilePutAll, hubFilePutHubFileRemix, optimisticDuplicateHubFileAction, processHubFilesThunk, hubFilePublishActionCreators, putFigFileDuplicateFromHubFile, putFigFilePublishedAsHubFile } from '../figma_app/49598';
...
import { logFileSaveAs, clearCursorActivityLogsAction, getActivityLogsAction, setActivityLogsAction } from '../figma_app/401069';
...
import { deleteAllPlugins, putAllWidgets, updateFetchedCanvasWidgetVersionsAction, updatePublishedCanvasWidgetVersionsAction, deleteAllWidgets, publishActionCreators, replaceFeaturedPluginAction, mergePublishedPluginThunk, putAllPlugins } from '../figma_app/559491';
...
import { resetCanvasSearch, toggleCanvasSearchCategoryFilter, clearCanvasSearchCategoryFilters, setCanvasSearchMode, setCanvasSearchQuery, setCanvasSearchScope, switchCanvasSearchCategoryFilterExclusive } from '../figma_app/712525';
...
import { putStyleSet, hideStylePreview, showStylePreview, showCreateStylePreview } from '../figma_app/914957';
...
import { updateFaceStamps, putDefaultFigjamInsertItems } from '../figma_app/968813';
import { setDelightfulToolbarOverflowMenuActionCreator, setQuickAccessToolActionCreator, setIsMakeSomethingV2ActiveActionCreator, setImageDialogActionCreator } from '../figma_app/972736';
            ...
            case 'put':
              if (i && i.id) {
                ...
                if (delete t.file_key, e.dispatch(processHubFilesThunk({
                  ...
                  let n = i.unpublished_at ? delFigFilePublishedAsHubFile({
                    fileKey: i.file_key
...
let oG = combineReducers({
  activeThread(e = null, t) {
    return resetComments.matches(t) || resetActiveCommentId.matches(t) ? null : setActiveComment.matches(t) ? containsDash(t.payload.threadId) || t.payload.threadId.startsWith('feed_post') && !isXrDebounceThresholdEnabled() ? e : {
...
function dM(e = Object.create(null), t) {
  if (!putStyleSet.matches(t)) return e;
  {
    let i = {
      ...t.payload.styleSet
    };
...
function dK(e, t) {
  if (!e || resetCanvasSearch.matches(t)) return dW;
...
let pg = {
  ...
  localPlugins(e = {}, t) {
    if (pluginInitializeLocal.matches(t)) return t.payload;
