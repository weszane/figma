...
export function $$p0({
  ...
  let g = useFavoriteResource(i, e, t, m);
  let f = _$$_({
    subscription: g,
    orgId: t,
    resourceId: i,
  ...
  return g.status !== 'loaded' ? (h = 'favorite-star-placeholder', jsx(ButtonPrimitive, {
    'disabled': !0,
    ...
    }), !!t && f.isDropdownShown && jsx(FavoriteResourceDropdown, {
