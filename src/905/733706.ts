...
export function $$s1(e, t, i, r, s, l, d) {
  ...
  for (let t of e) {
    ...
    }) : c.push(e) : (console.error(`Failed to decode: ${t}`), reportError(ServiceCategories.TEXT_AND_VECTOR, Error("Failed to decode selection paints")));
  }
...
export function $$o0(e) {
  ...
  reportError(ServiceCategories.TEXT_AND_VECTOR, Error("Failed to decode selection paint"));
}
export const K = $$o0;
export const S = $$s1;
