...
import { BellId, VisualBellType } from "../905/576487"
      ...
      : (function (e, t) {
          ...
          if (i) {
            ...
            if (t) {
              let e = (function (e) {
                switch ((e = Array.from(new Set(e))).sort(), e.length) {
                  ...
                  case 1:
                    return e[0]
                  case 2:
                    return getFeatureFlags().ce_localize_al_visual_bells
                      ? getI18nString("visual_bell.list_of_two_objects", {
                          object1: e[0],
                          object2: e[1],
                        })
                      : `${e[0]} and ${e[1]}`
                  case 3:
                    return getFeatureFlags().ce_localize_al_visual_bells
                      ? getI18nString("visual_bell.list_of_three_objects", {
                          object1: e[0],
                          object2: e[1],
                          object3: e[2],
                        })
                  ...
                  default:
                  {
                    let t = e.length - 3
                    return getFeatureFlags().ce_localize_al_visual_bells
                      ? getI18nString("visual_bell.list_of_more_than_three_objects", {
                          object1: e[0],
                          object2: e[1],
                          object3: e[2],
                          numRemaining: t,
              ...
              i = getFeatureFlags().ce_localize_al_visual_bells
                ? getI18nStringAlias(i, {
                    nodes: e,
                  })
                : i.replace("{{nodes}}", e)
            }
