...
export function $$l3(e, t) {
  ...
  let n = i[0]
  e = n && i.length === 1 ? n.charAt(0).toUpperCase() + n.slice(1) : i.map(e => e.charAt(0).toUpperCase() + e.slice(1).toLowerCase()).join('')
  return t ? `${t}${e}` : e
}
export function $$d1(e) {
  ...
  return i && t.length === 1
    ...
    : t.map((e, t) => {
        let i = e.toLowerCase()
        return t === 0 ? i : i.charAt(0).toUpperCase() + i.slice(1)
      }).join('')
}
...
export function $$u2(e) {
  ...
  for (let e of a) {
    if (!s.has(e.guid)) {
      ...
      if (e.type === 'INSTANCE' && !e.isInstanceSublayer && e.symbolId) {
