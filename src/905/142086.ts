...
import { Er, Ub, Al, rJ, Xv, rx, bV, _Z, Uo, KF, Zg, Rt, mt, eb as _$$eb, Yf, BY, qr, IS } from "../905/615608";
...
let eR = registerModal(function (e) {
  ...
  let ex = 1 === eE.size ? eE.values().next().value : "";
  ...
  let tr = useCallback(async () => {
    ...
    e5 || 1 !== e.data.meta.teams.length || eN({
  ...
  let tc = useMemo(() => e5 || "loaded" !== td.status || null === eT ? null : TF(td.data.currentUser, eT.id, ti), [e5, td, eT, ti]);
  let tu = useMemo(() => {
    if ("loaded" !== td.status) return null;
      ...
      children: jsxs(OJ, {
        ...
        children: [eS?.isConnectedProject && jsx($y, {
          ...
          children: [!eH && !eF && jsxs(Fragment, {
            ...
            }), eP === Q.SUGGESTED ? e1 : eP === Q.STARRED ? "loading" === td.status ? jsx("div", {
              className: _$$s.h300.$,
              children: jsx(qc, {})
            }) : tm && null === eT ? jsx(ev, {
              teamsList: ta,
        ...
        })(), i && (tC && t_ && !VA(t_) && files.some(e => (e.editor_type === FFileType.SITES || e.editor_type === FFileType.FIGMAKE) && e.is_published_site && !e.parent_org_id && e.team_id !== t_.teamId) ? jsx("div", {
          className: _$$s.p8.$,
          children: jsx(_$$_, {
            padding: 8,
            color: _$$S.WARNING,
