...
import { CY, ks } from '../figma_app/637027'
...
let eR = registerModal((e) => {
  ...
  let e7 = useMemo(() => status === _$$r.SUCCESS
    ? teams.map(e => ({
        id: e.id || '',
        name: e.name || '',
      }))
  ...
  let ta = e8
    ? e8.sort((e, t) => e.name.localeCompare(t.name)).map(e => ({
        id: e.id || '',
        name: e.name || '',
      }))
    : []
      ...
      children: jsxs(OJ, {
        title: jsxs('div', {
          ...
          children: [jsx('span', {
            ...
            children: eI
              ? renderI18nText('file_browser.file_move.modal_header_restore_file', {
                  fileName: tF,
                })
        ...
        children: [eS?.isConnectedProject && jsx($y, {
          ...
          switch (tC) {
            ...
            case LU.REQUEST:
              ...
              let c = () => {
                destinationPlanUser?.id && destinationPlan.key && destinationPlan.key.type === FOrganizationLevelType.ORG
                  ? shouldShowCurf
                    ? fm({
                        licenseType,
                        dispatch: t,
        ...
        })(), i && (tC && t_ && !VA(t_) && files.some(e => (e.editor_type === FFileType.SITES || e.editor_type === FFileType.FIGMAKE) && e.is_published_site && !e.parent_org_id && e.team_id !== t_.teamId)
          ? jsx('div', {
              className: _$$s.p8.$,
              children: jsx(_$$_, {
                padding: 8,
...
let eU = registerModal((e) => {
  ...
  let l = e.inDrafts
    ? getI18nString('file_browser.file_move.users_drafts', {
        userHandle: r,
      })
  ...
  return jsxs(OJ, {
    ...
    children: [jsxs('div', {
      ...
      children: [jsx('div', {
        ...
        children: e.inDrafts
          ? getI18nString('file_browser.file_move.you_cant_move_files_that_are_in_others_drafts')
          : jsxs(Fragment, {
