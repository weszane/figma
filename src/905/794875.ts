...
import { hF, pR, BB, Qc, Qw, Hi, Vb, x7, tN, AN, IK, HT, ai, kL, P2, x1, Wm, QF, hH, UY, z6, Df, IZ, BI, l8, uK, fE, H9, re, Om, CU, nJ, ZM, JB, yF, sS, w$, O as _$$O } from "../905/151685";
...
class et extends RecordingPureComponent {
  constructor(e) {
    ...
    this.hiddenInputRef = e => {
      cZ(this.props.inputRef, e);
      "always" !== this.props.preventHiddenInput && (this.hiddenInput = e, e && this.props.autoFocus && e.focus());
    };
    this.focus = () => {
    ...
    this.cacheOptionPositions = e => {
      ...
      Children.forEach(e.children, n => {
        ...
        if ("Option" === n.type.__CLASS_NAME__) {
          let r = n.props.value ?? null;
          let a = n.props.formattedValue ?? (null == r ? "" : e.formatter.format(r));
    ...
    this.resizeDropdown = () => {
      let e;
      if (this.hiddenInput && null == this.props.preventHiddenInput && this.hiddenInput.focus(), this.container && (this.containerRect = this.container.getBoundingClientRect()), !this.containerRect) return;
      ...
      if (this.props.neverConstrain || BrowserInfo.windows) {
        ...
        if (this.props.targetDomNode && this.props.targetDomNode !== document.body) throw Error("If you are parenting your <Select /> into a node that is NOT document.body via the targetDomNode prop, please ensure neverConstrain is also set to true. There are known issues with scrolling positioning with a specified targetDomNode.");
        if (this.shouldConstrainTop = this.containerRect.top + i < d, this.shouldConstrainTop) {
          ...
          for (let t = s.length - 2; t >= 0; t--) {
            ...
            if (8 >= Math.abs(r)) {
              if ("SelectDivider" === s[t].type.__CLASS_NAME__ || t === this.optionIndexByFormattedValue[o]) break;
              let e = r;
        ...
        if (this.shouldConstrainBottom = l() > u, this.shouldConstrainBottom) {
          ...
          for (let i = 1; i < t.length; i++) {
            ...
            if (8 >= Math.abs(r - n)) {
              if ("SelectDivider" === t[i - 1].type.__CLASS_NAME__ || i === this.optionIndexByFormattedValue[o]) break;
              n += r - n;
    ...
    this.maxDropdownHeight = () => {
      let e = null != this.props.minTop ? this.props.minTop : this.getDropdownMarginTop();
          ...
          case KeyCodes.DOWN_ARROW:
            {
              ...
              } while (t && "SelectDivider" === t.type.__CLASS_NAME__ || t?.props?.isHeader);
              let l = this.optionValueByIndex[a];
              null != l && (this.updateFocusedValue(l, n), this.scrollValueIntoView(this.props.formatter.format(l)), this.ignoreMouseMove = !0, this.resetUserInput());
              "until_keydown" === this.props.preventHiddenInput && this.focus();
              e.stopPropagation();
              e.preventDefault();
              break;
            }
    ...
    this.addInputChar = e => {
      ...
      if (Children.forEach(this.props.children, e => {
        null != e && null === n && null != e.props.value && this.props.formatter.format(e.props.value).toLowerCase().startsWith(this.userInput) && (n = e.props.value, a = !!e.props.disabled);
      }), null !== n) {
        if (this.dropdownShown()) {
          this.updateFocusedValue(n, a);
          let e = this.props.formatter.format(n);
          this.scrollValueOverInput(e);
        } else this.submitValue(n);
      }
    };
    this.isDisabled = () => this.props.disabled || 0 === Children.count(this.props.children);
    this.cloneChildForRender = (e, t, i) => {
      let n = (e, t) => null != e && null != t && this.props.formatter.isEqual ? this.props.formatter.isEqual(e, t) : e == t;
      if (null == e) return null;
      if (null == e.props.value) {
  ...
  componentDidUpdate(e, t) {
    if (super.componentDidUpdate(this.props, this.state), this.props.triggerDropdown && (this.showDropdown(), this.setState({
      allowSelection: !0
    }), this.props.setTriggerDropdown && this.props.setTriggerDropdown(!1)), this.hiddenInput && null == this.props.preventHiddenInput && (this.dropdownShown() && !this.state.currentDropdownAccepted ? this.hiddenInput.focus() : this.props.blurOnChange && this.hiddenInput.blur()), this.isDropdownShown(e) && !this.dropdownShown()) {
  ...
  render() {
    ...
    let d = jsx("div", {
      ...
      style: {
        ...
        width: "function" == typeof this.props.dropdownWidth ? this.state.dropdownWidth && this.props.dropdownWidth(this.state.dropdownWidth) : null != this.props.dropdownWidth ? this.props.dropdownWidth : this.state.dropdownWidth
      },
      children: jsxs("div", {
        className: x1,
        children: [jsx(Y, {
    ...
    let c = null == this.state.focusedOptionValue ? "" : this.props.formatter.format(this.state.focusedOptionValue);
    let u = "combobox" === t ? this.dropdownShown() : void 0;
...
et.propTypes = {
  children: (e, t, i) => {
    ...
    Children.forEach(n, e => {
      null == e || e.type && e.type.__IS_VALID_SELECT_CHILD__ || (a = Error(`${i} children should be of type 'Option' or 'SelectDivider'`));
    });
    return a;
  }
};
