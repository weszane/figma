import { z } from 'zod'
import { Kj, n3, UE, XY } from '../905/43538'
...
export function $$g3() {
  return (function (e) {
    let t = {}
    for (let [i, n] of Object.entries(e)) n instanceof z.ZodOptional && n.unwrap() instanceof z.ZodBoolean && n._def.description && typeof n._def.description == 'string' && (t[i] = n._def.description)
    return t
  }($$m4.shape))
}
