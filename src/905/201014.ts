...
class N {
  constructor(e, t = 1) {
    ...
    if (e.r > 1 || e.g > 1 || e.b > 1)
      throw new Error(`Expected normalised color values (between 0 and 1) but got (${e.r}, ${e.g}, ${e.b})`)
  }
...
function D(e, t, i, n, r) {
  ...
  if (a) {
    if (a.codeSyntax && a.codeSyntax.ANDROID)
      return pO(a.codeSyntax.ANDROID, a, r)
    {
...
function L(e, t, i, n, r) {
  if (HN(e)) {
    if (e.codeSyntax && e.codeSyntax.ANDROID)
      return pO(e.codeSyntax.ANDROID, e, r)
    {
...
function H(e, t) {
  if (e instanceof _$$B || e instanceof J3)
    return []
  let i = []
...
async function q(e, t) {
  ...
  if (e.isAutoLayout()) {
    ...
    layoutMode === 'HORIZONTAL'
      ? _.push(n8('Row('), n8(`horizontalArrangement = ${(function (e, t) {
          switch (e) {
            case 'CENTER':
      ...
      : _.push(n8('Column('), n8(`verticalArrangement = ${(function (e, t) {
          switch (e) {
            case 'CENTER':
...
async function en(e, t) {
  return e instanceof _$$a
    ...
    : e instanceof _$$L
      ...
      : e instanceof _$$z
        ? ei(e, t)
        : e instanceof _$$j || e instanceof _$$B2 || e instanceof _$$F
          ? q(e, t)
          : e instanceof _$$B
            ? []
            : [{
...
class ek {
  ...
  set(e, t, i = !1) {
    let n = this.get(e)
    if (_$$t(n) && !i)
      throw new Error(`Property "${e}" has already been set, old value: "${n?.value}", new value: "${t?.value}"`)
    this.styles[e] = t
  }
...
function eU(e, t, i, n, r, a, s = _$$DX) {
  ...
  switch (e.type) {
    ...
    case 'PATTERN':
      return null
    default:
      $D(_$$e.DEVELOPER_TOOLS, new Error(`Unknown paint type: ${e.type}`))
      return null
  }
}
let eB = (e, t) => {
...
class eW {
  ...
  addAspectRatio(e) {
    ...
    let n = getFeatureFlags().ce_tv_arl_dev_mode_fractions
      ? (function (e, t, i = 50, n = 1e-4) {
          if (!isFinite(e) || !isFinite(t) || t === 0)
          ...
          return `${e.toFixed(2)}/${t.toFixed(2)}`
        }(width, height, Math.max(50, height)))
      : (function (e, t) {
...
function eY(e, t, i = _$$DX) {
  ...
  let {
    ...
    if ((n = e.fills) && n.toString() === 'Symbol(figma.mixed)') {
      $D(_$$e.DEVELOPER_TOOLS, new Error(`Mixed value in fills in node ${e.id}`))
      return {}
    }
...
function eq(e, t, {
  ...
  let {
    fallbackHints,
    fallbackStyleMap,
  } = e.nodeCache.colorProfile === RYP.DISPLAY_P3
    ? (function ({
        node: e,
    styleMap: t,
    preferences: i,
...
function tt(e, t, i, n) {
  ...
  let {
    ...
    ? J(i.fontName.style, i.fontWeight)
    : {
  ...
  if ((function (e, t) {
    ...
    Object.entries(i).forEach(([e, i]) => {
      if (e === 'KERN') {
        ...
        if (e === 'LNUM' || e === 'ONUM' || e === 'TNUM' || e === 'PNUM' || e === 'FRAC' || e === 'ORDN' || e === 'ZERO')
          return
...
function ti(e, t, i, n, r, a = _$$DX) {
  let s = (function (e, t, i = _$$DX, n, r) {
    ...
    let d = ej(l)
    if (oQ(e.fillStyle) && !d)
      return new kz(e.fillStyle.name, l, r, void 0, e.fillStyle.id)
    if (t.fillStyleId) {
      let i = fl({
        fillStyleId: t.fillStyleId,
      }, e.nodeCache.stylesResolver)
      if (oQ(i))
        return new kz(i.name, l, r, void 0, i.id)
    }
    return l
  }(e, n, a, i, r))
  if (s) {
...
function tn(e, t, i, n, r, a = _$$DX) {
  let s = (function (e, t, i = _$$DX, n, r) {
    if (!t.textDecorationColor || !t.textDecorationColor.rawValue)
      return null
...
function td(e, t, i) {
  if (void 0 === t)
    return
  if (i.unit === _$$tK.PIXEL || i?.customSettings?.onlyText === 'true' && !tl.includes(e))
    return t
...
async function tp(e, t) {
  return e instanceof _$$a
    ? eq(e, t)
    : e instanceof _$$L || e instanceof _$$B2 || e instanceof _$$F
      ? (function (e, t) {
          let {
            styleMap,
            hints,
          ...
          if (e.isAutoLayout()) {
            ...
            (function (e, t, i, n, r) {
              ...
              let u = (function (e) {
                if (e.autoLayout.counterAxisAlignContent === 'SPACE_BETWEEN')
              ...
              if (primaryAxisAlignItems !== 'SPACE_BETWEEN') {
                ...
                layoutWrap === 'NO_WRAP' || (o.equals(m) || void 0 === counterAxisSpacing) && u !== 'space-between'
                  ? t.set('gap', oy({
                      raw: o,
                      node: e,
                      field: 'itemSpacing',
...
async function tm(e, t) {
  ...
  [...jO(fallbackStyleMap?.filterDefaultValues().getStyles() ?? {}).map(e => ({
    ...
    let [n, a] = i
    if (vy(t) && c.includes(n) || KY(t) && [...d, 'color'].includes(n))
      return
...
function tb(e, t, i, n, r) {
  let a = e.variable?.value
  if (a) {
    if (a.codeSyntax && a.codeSyntax.iOS)
      return a.codeSyntax.iOS
    {
...
function tv(e, t, i, n, r) {
  if (HN(e)) {
    if (e.codeSyntax && e.codeSyntax.iOS)
      return pO(e.codeSyntax.iOS, e, r)
    {
...
class tF {
  ...
  get value() {
    ...
    return this.opacity !== 1 || (function (e) {
      ...
      ? `${e}.opacity(${+(this.opacity * a).toFixed(2)})`
      : e
  }
}
class tM {
  ...
  return e instanceof _$$a
    ...
    : e instanceof _$$L
      ...
      : e instanceof _$$z
        ...
        : e instanceof _$$j
          ? tQ(e, t)
          : e instanceof _$$B2 || e instanceof _$$F
            ? tX(e, t)
            : e instanceof _$$B
              ? []
              : [{
...
class t8 {
  ...
  getNode(e) {
    ...
    this.nodes[t] || (this.nodes[t] = (function (e, t) {
      if (e.type === 'VECTOR' || e.type === 'BOOLEAN_OPERATION' || e.isAsset && !('fills' in e ? Array.isArray(e.fills) ? e.fills.find(e => e.type === 'IMAGE' || e.type === 'VIDEO') != null : null : e.type === 'MEDIA'))
        return _$$a.from(e, t)
      switch (e.type) {
        case 'LINE':
        case 'ELLIPSE':
