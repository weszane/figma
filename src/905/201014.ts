import { Z_n, RYP, KXw, tKW, glU } from "../figma_app/763686";
...
import { jO, Iq, t2 as _$$t, HP } from "../905/8035";
import { mJ, pO, Kp, F$, hO, a3, oE, bE, jX, zr, Eu, LI, vV, oy, DX, nb, JT, ZN, nK } from "../905/246310";
import { c2 } from "../905/382883";
import { A2, bv } from "../905/49095";
import { HN, oQ, fl, V$, jg } from "../905/707098";
import { hX, nk, vy, KY, Hw, tK as _$$tK } from "../905/432392";
import { LE, O$ } from "../905/232489";
import { J3, KH, u_, BL, XQ, qn, fw } from "../905/139004";
import $ from "lodash-es/snakeCase";
import ea from "lodash-es/camelCase";
import eo from "../vendor/750620";
import { RU, LI as _$$LI, O$ as _$$O$, Qf, lS, QE } from "../905/235413";
import { u as _$$u, E as _$$E } from "../905/363827";
import { getFeatureFlags } from "../905/601108";
import { ServiceCategories as _$$e } from "../905/165054";
import { $D } from "../905/11";
import { DX as _$$DX, Q1 } from "../905/721592";
import { W4, Ey, jN, n_ } from "../905/804867";
...
class N {
  constructor(e, t = 1) {
    this.color = e;
    this.opacity = t;
    if (e.r > 1 || e.g > 1 || e.b > 1) throw Error(`Expected normalised color values (between 0 and 1) but got (${e.r}, ${e.g}, ${e.b})`);
  }
  get value() {
...
class O {
  ...
  getDefinition() {
    return `val ${pO(LE(this.name), this.boundVariable, this.preferences)}: ${this.typeName} = ${this.wrappedValue}${"Dp" === this.typeName || "Sp" === this.typeName ? `.${this.typeName.toLowerCase()}` : ""}`;
  }
}
...
function M(e, t) {
  ...
  let p = [c, o, l, d];
  if (!(!(u.every(e => e === u[0]) && 0 === u[0]) || p.some(e => HN(e)))) return {
    code: "",
    constants: i
  };
  let m = (i, n, r, a) => {
    let s = hX(i, t);
    if (HN(n)) {
      if (n.codeSyntax && n.codeSyntax.ANDROID) return {
  ...
  let g = (e, t) => "number" == typeof e && "number" == typeof t ? e === t : "number" != typeof e && "number" != typeof t && !!(HN(e) && HN(t)) && e.name === t.name;
...
function H(e, t) {
  ...
  Object.keys(e.inferredVariables).forEach(n => {
    ...
    if ("fills" === n || "strokes" === n) {
      let t = e.inferredVariables[n];
      if (!t) return;
      return t.forEach((t, a) => {
        let s = Eu(n, e, a);
        s && "SOLID" === s.type && t && 0 !== t.length && i.push({
          ids: t.map(e => e.id),
          rawValue: {
            type: Z_n.COLOR,
            value: {
...
async function q(e, t) {
  ...
  let {
    ...
    if (0 === paddingLeft && 0 === paddingTop && 0 === paddingRight && 0 === paddingBottom && !c && !p && !m && !h) return {
      properties: {},
      constants: new Set()
    };
    let g = new Set();
  ...
  if (e.isAutoLayout()) {
    ...
    "HORIZONTAL" === layoutMode ? _.push(n8("Row("), n8(`horizontalArrangement = ${function (e, t) {
      switch (e) {
        case "CENTER":
...
async function ei(e, t) {
  ...
  if (s.push(n8("Text(")), s.push(n8(`text = ${ee(e.characters)},`, 1)), oQ(e.textStyle) && (s.push(n8("", 1)), s.push(n8(`// ${e.textStyle.name}`, 1))), s.push(n8("style = TextStyle(", 1)), fontSize) {
    ...
    A = fontSize.rawValue;
    let c = "PIXELS" === _.unit ? _.value : "AUTO" !== _.unit ? _.value / 100 * A : void 0;
    if (c) {
      let i = hX(c, t, 2);
  ...
  if (e.textAlignHorizontal && "LEFT" !== e.textAlignHorizontal) switch (e.textAlignHorizontal) {
    case "RIGHT":
  ...
  if (d.textDecoration) switch (d.textDecoration) {
    case "STRIKETHROUGH":
...
class eu {
  ...
  get value() {
    return this.blendModes.some(e => "normal" !== e) ? this.blendModes.join(", ") : "normal";
  }
  equals(e) {
...
class em {
  ...
  get value() {
    return 1 === this.filterObjects.length ? this.filterObjects[0].value : this.filterObjects.map(e => e.value).join(" ");
  }
  equals(e) {
    return this.value === e.value;
  }
...
class eb {
  ...
  get value() {
    return this.shadowObjects.map(e => `${e.offsetX.value} ${e.offsetY.value} ${e.blur.value} ${e.spread.value} ${e.color.value}` + (1 === e.type ? " inset" : "")).join(", ");
  }
  equals(e) {
    return this.value === e.value;
  }
...
class ek {
  ...
  static From(e) {
    let t = new ek();
    if (e) for (let [i, n] of e) t.set(i, n);
    return t;
  }
  get size() {
  ...
  set(e, t, i = !1) {
    let n = this.get(e);
    if (_$$t(n) && !i) throw Error(`Property "${e}" has already been set, old value: "${n?.value}", new value: "${t?.value}"`);
    this.styles[e] = t;
  }
  mergeValue(e, t) {
    let i = this.get(e);
...
function eU(e, t, i, n, r, a, s = _$$DX) {
  ...
  switch (e.type) {
    ...
    case "PATTERN":
      return null;
    default:
      $D(_$$e.DEVELOPER_TOOLS, Error(`Unknown paint type: ${e.type}`));
      return null;
  }
}
let eB = (e, t) => {
...
function eH(e) {
  ...
  let n = F$(strokes);
  return 0 === n.length ? null : (n.length > 1 && (t = A2.SinglePaint), {
    paint: n[0].paint,
    index: n[0].index,
    hint: n[0].hint || t
  });
...
class eW {
  ...
  addFlexibleLayout(e) {
    let t = this.parent?.isAutoLayout() && "HORIZONTAL" === this.parent.autoLayout.layoutMode;
    let i = !t;
  ...
  addAbsolutePosition(e, t) {
    if (!this.absolutePosition) return {
      hints: t
    };
    let {
      horizontal,
    ...
    "left" === horizontal.type && 0 !== horizontal.offset && (e.set("left", new RU(horizontal.offset)), r("left"));
    "right" === horizontal.type && (e.set("right", new RU(horizontal.offset)), 0 === Object.keys(t).length && r("right"));
    "top" === vertical.type && 0 !== vertical.offset && (e.set("top", new RU(vertical.offset)), 0 === Object.keys(t).length && r("top"));
    "bottom" === vertical.type && (e.set("bottom", new RU(vertical.offset)), 0 === Object.keys(t).length && r("bottom"));
    return {
      hints: t
    };
  }
  addAspectRatio(e) {
    ...
    let n = getFeatureFlags().ce_tv_arl_dev_mode_fractions ? function (e, t, i = 50, n = 1e-4) {
      if (!isFinite(e) || !isFinite(t) || 0 === t) return `${e.toFixed(2)}/${t.toFixed(2)}`;
      let r = e / t;
      let a = function (e) {
        let t = [];
        let i = e;
      ...
      for (let e = 0; e < a.length; e++) {
        let t = a[e];
        if (l = t * o + s, (u = t * c + d) > i || 0 === u) break;
      ...
      let i = e => .001 > Math.abs(Math.round(e) - e);
  ...
  shouldAddWidth() {
    return (!(this.node instanceof _$$z) || "WIDTH_AND_HEIGHT" !== this.node.textAutoResize || !!this.transform.isRotated()) && BL(this.node) === XQ.FIXED;
  }
  shouldAddHeight() {
    return (!(this.node instanceof _$$z) || "HEIGHT" !== this.node.textAutoResize && "WIDTH_AND_HEIGHT" !== this.node.textAutoResize || !!this.transform.isRotated()) && qn(this.node) === XQ.FIXED;
  }
}
class eK {
  constructor(e) {
...
function eY(e, t, i = _$$DX) {
  ...
  let {
    ...
    var n;
    if ((n = e.fills) && "Symbol(figma.mixed)" === n.toString()) {
      $D(_$$e.DEVELOPER_TOOLS, Error(`Mixed value in fills in node ${e.id}`));
      return {};
    }
    ...
    return {
      ...
      blendModes: blendMode.some(e => "NORMAL" !== e) ? blendMode : void 0
    };
  }(e, t, i);
  if (_$$t(backgrounds)) {
  ...
  if (!function (e, t = _$$DX, i, n, r, a) {
    ...
    let {
      ...
      if (oQ(t) && !HN(e.variableValue)) return {
    ...
    let o = new em([]);
    let l = new em([]);
    e.blendMode && "PASS_THROUGH" !== e.blendMode && (i.set("mix-blend-mode", eu.fromFigmaBlendMode([e.blendMode])), "LINEAR_BURN" === e.blendMode && (n["mix-blend-mode"] = A2.PlusDarker));
    effects.filter(e => e.visible).forEach(i => {
      switch (i.type) {
        case "LAYER_BLUR":
        case "BACKGROUND_BLUR":
          {
            ...
            "LAYER_BLUR" === i.type ? o = em.concat(o, s) : l = em.concat(l, s);
        ...
        case "INNER_SHADOW":
          {
            let a = "DROP_SHADOW" === i.type && (e instanceof _$$a || e.isGroup);
            ...
            if (a) o = em.concat(o, new em([new eg({
              offsetX: h,
              offsetY: g,
              radius: f,
              color: y
              ...
              let e = new eb([{
                ...
                spread: A,
                color: y,
                type: "INNER_SHADOW" === i.type ? ey.Inset : ey.Normal
              }]);
              s = eb.concat(s, e);
            }
          }
    ...
    0 === e.layout.layoutGrow && "AUTO" !== e.gridLayout.gridChildHorizontalAlign && n.set("justify-self", new _$$O$(l(gridChildHorizontalAlign)));
    "STRETCH" !== e.layout.layoutAlign && "AUTO" !== e.gridLayout.gridChildVerticalAlign && n.set("align-self", new _$$O$(l(gridChildVerticalAlign)));
  }
  return {
    styleMap: n,
    hints: {
...
function eX(e, t, i, n, r) {
  let {
    ...
    paddingLeft,
    paddingRight
  } = "GRID" === e.autoLayout.layoutMode ? e.gridLayout : e.autoLayout;
  let d = [paddingTop, paddingRight, paddingBottom, paddingLeft].filter(e => 0 !== e).length;
...
function e9(e) {
  return 0 === e.characters.length ? [] : e.textSegments;
}
function te(e) {
  return e9(e)[0];
}
function tt(e, t, i, n) {
  ...
  if (fontWeight && t.set("font-weight", vV(new lS(fontWeight.rawValue), fontWeight, c, "font-weight", n)), t.set("font-style", new _$$O$(italic ? "italic" : "normal")), i.textDecoration && (t.set("text-decoration-line", new _$$O$(e3[i.textDecoration])), "UNDERLINE" === i.textDecoration)) {
  ...
  e.leadingTrim && "CAP_HEIGHT" === e.leadingTrim && (t.set("leading-trim", new _$$O$("both")), t.set("text-edge", new _$$O$("cap")), c["leading-trim"] = A2.LeadingTrim);
...
function ti(e, t, i, n, r, a = _$$DX) {
  ...
  if (s) {
    if (s instanceof Q1) {
      ...
      t.set("color", s);
      i.color = i.color || e;
    } else s instanceof kz && s.wrappedValue instanceof Q1 ? t.set("color", s) : (t.set("background", new eK([s])), t.set("background-clip", new _$$O$("text")), t.set("-webkit-background-clip", new _$$O$("text")), t.set("-webkit-text-fill-color", new _$$O$("transparent")));
  }
}
function tn(e, t, i, n, r, a = _$$DX) {
  ...
  if (s) {
    ...
    } else s instanceof kz && s.wrappedValue instanceof Q1 && t.set("text-decoration-color", s);
  }
}
function tr(e, t, i, n, r = _$$DX) {
  ...
  if (!(strokeWeight <= 0) && 0 !== strokes.length) {
...
function ta(e, t, i, n, r = _$$DX) {
  e.blendMode && "PASS_THROUGH" !== e.blendMode && (t.set("mix-blend-mode", eu.fromFigmaBlendMode([e.blendMode])), "LINEAR_BURN" === e.blendMode && (i["mix-blend-mode"] = A2.PlusDarker));
  let a = new ev([]);
  let s = new em([]);
  let o = new em([]);
  e.effects.forEach(t => {
    switch (t.type) {
      ...
      case "BACKGROUND_BLUR":
        ...
        "LAYER_BLUR" === t.type ? s = em.concat(s, c) : o = em.concat(o, c);
        break;
      case "DROP_SHADOW":
...
function td(e, t, i) {
  ...
  return to.includes(e) ? "padding" === e && "string" == typeof t ? t.split(" ").map(n).join(" ") : "string" == typeof t ? n(t) : hX(t, i) : t;
}
function tc([e, t], [i, n]) {
...
async function tp(e, t) {
  return e instanceof _$$a ? eq(e, t) : e instanceof _$$L || e instanceof _$$B2 || e instanceof _$$F ? function (e, t) {
    ...
    if (e.isAutoLayout()) {
      ...
      let l = !e.layout.parent?.isAutoLayout() && ("VERTICAL" === layoutMode && "AUTO" === counterAxisSizingMode || "HORIZONTAL" === layoutMode && "AUTO" === primaryAxisSizingMode);
      ...
      (function (e, t, i, n, r) {
        ...
        let u = function (e) {
          if ("SPACE_BETWEEN" === e.autoLayout.counterAxisAlignContent) return "space-between";
          if ("WRAP" === e.autoLayout.layoutWrap && !e.children.every(e => fw(e) === XQ.FILL_PARENT)) switch (e.autoLayout.counterAxisAlignItems) {
            case "MIN":
              return "flex-start";
            case "CENTER":
              return "center";
        ...
        "WRAP" === layoutWrap && t.set("flex-wrap", new _$$O$("wrap"));
        let p = e.getVariableValue("counterAxisSpacing");
        let m = DX(new RU(counterAxisSpacing), p, i, "row-gap", r);
        if ("SPACE_BETWEEN" !== primaryAxisAlignItems) {
          let a = e.getVariableValue("itemSpacing");
          let o = DX(new RU(itemSpacing), a, i, "gap", r);
          "NO_WRAP" === layoutWrap || (o.equals(m) || void 0 === counterAxisSpacing) && "space-between" !== u ? t.set("gap", oy({
            raw: o,
            node: e,
            field: "itemSpacing",
            styleField: "gap",
            suggestedVars: n,
            preferences: r
          })) : "space-between" === u ? t.set("column-gap", oy({
            raw: o,
            node: e,
            field: "itemSpacing",
        ...
        } else "WRAP" === layoutWrap && "space-between" !== u && t.set("row-gap", oy({
          raw: m,
          node: e,
          field: "counterAxisSpacing",
          styleField: "row-gap",
    ...
    if (e.isGrid()) {
      ...
      let d = "AUTO" === e.autoLayout.primaryAxisSizingMode || "AUTO" === e.autoLayout.counterAxisSizingMode;
    ...
    let n = new _$$E();
    if (e.textAlignHorizontal && i.set("text-align", new _$$O$(e5[e.textAlignHorizontal])), e.maxLines ? i.set("display", new _$$O$("-webkit-box")) : e.textAlignVertical && "TOP" !== e.textAlignVertical && qn(e) !== XQ.HUG_CONTENTS && (i.set("display", new _$$O$("flex")), i.set("flex-direction", new _$$O$("column")), i.set("justify-content", new _$$O$(e4[e.textAlignVertical]))), "TRUNCATE" === e.textAutoResize && (i.set("text-overflow", new _$$O$("ellipsis")), i.set("overflow", new _$$O$("hidden")), i.set("white-space", new _$$O$("nowrap"))), e.layout.parent?.isGrid()) {
      let {
        gridRowSpan,
        gridColumnSpan,
        gridColumnAnchorIndex,
      ...
      0 === e.layout.layoutGrow && "AUTO" !== e.gridLayout.gridChildHorizontalAlign && i.set("justify-self", new _$$O$(gridChildHorizontalAlign));
      "STRETCH" !== e.layout.layoutAlign && "AUTO" !== e.gridLayout.gridChildVerticalAlign && i.set("align-self", new _$$O$(gridChildVerticalAlign));
    }
    let {
      styleMap,
      hints,
    ...
    let c = function (e, t = !1, i = !1) {
      ...
      i && (r = r.filter(e => 0 !== e.filter(e => "" !== e.characters.replace(s, "")).length));
      return r;
    }(e9(e));
    let u = [];
    for (let [n, r] of c.entries()) if (1 !== r.length || "" !== r[0].characters) for (let [n, a] of r.entries()) {
...
async function tm(e, t) {
  ...
  }), e instanceof _$$a && !t.isExportRestricted) try {
...
async function tA(e, t, i) {
  ...
  for (;;) {
    ...
    if (jO(styleMap.filterDefaultValues().getStyles()).sort(tc).map(([e, i]) => {
      ...
      guid: e.id,
      cssProperties: o
    }, r++, u_(e) && Array.isArray(e.children) && e.children.length > 0) for (let t of e.children) a.push(t);
  }
  return n;
}
class ty {
...
function tT(e, t) {
  ...
  if (e.isAutoLayout()) return function (e, t) {
    let {
      layout
    } = e;
    let {
    ...
    let _ = BL(e);
    let A = qn(e);
    let y = "HORIZONTAL" === layoutMode ? tx[primaryAxisAlignItems][counterAxisAlignItems] : tS[primaryAxisAlignItems][counterAxisAlignItems];
    let {
      properties,
      constants
    } = function (e, t) {
  ...
  var o;
  var l = new Set();
  var d = hX(width, t).toString();
  var c = hX(height, t).toString();
  let {
    variable,
    hint
  } = zr(e, "width", d);
...
class tF {
  ...
  get value() {
    ...
    e = 1e-5 > Math.abs(_r2) && 1e-5 > Math.abs(g) && 1e-5 > Math.abs(b) ? ".black" : 1e-5 > Math.abs(1 - _r2) && 1e-5 > Math.abs(1 - g) && 1e-5 > Math.abs(1 - b) ? ".white" : `Color(red: ${+this.color.r.toFixed(2)}, green: ${+this.color.g.toFixed(2)}, blue: ${+this.color.b.toFixed(2)})`;
    return 1 !== this.opacity || function (e) {
      let t = e.a;
      return b.t2(t) && 1 !== t;
...
class tU {
  ...
  get value() {
    ...
    1 === this.colorStops.length ? e.push(n8(`stops: [${this.colorStops[0].value}],`, 1)) : (e.push(n8("stops: [", 1)), e.push(...this.colorStops.map(e => n8(`${e.value},`, 2))), e.push(n8("],", 1)));
...
class tG {
  ...
  get value() {
    ...
    this.imagePaint.opacity && 1 !== this.imagePaint.opacity && e.push(n8(`.opacity(${+this.imagePaint.opacity.toFixed(2)})`, 1));
    return e;
  }
}
class tz {
      ...
      switch (layoutMode) {
        case "HORIZONTAL":
          return function (e, t) {
            ...
            if ("SPACE_BETWEEN" === primaryAxisAlignItems) return {
              sectionName: "HStack",
              properties: {
...
async function t1(e, t) {
  ...
  let {
    ...
    if (presentedValue && (n.foregroundColor = [n8(`.foregroundColor(${presentedValue})`, 0, hint, matchingVars)]), i.textDecoration) switch (i.textDecoration) {
      case "STRIKETHROUGH":
        n.strikethrough = [n8(".strikethrough()")];
        break;
      case "UNDERLINE":
        let l = function (e) {
          if (e.textDecorationStyle) switch (e.textDecorationStyle) {
            case "SOLID":
              return ".solid";
            case "DOTTED":
              return ".dot";
        ...
        let {
          ...
          if (t.textDecorationColor) {
            ...
            return "AUTO" === r ? {} : t0("textDecorationColor", [r], e, i, n);
          }
          return {};
        }(e, i, t, r);
  ...
  let {
    ...
    } else c && s.push(n8(`Font.system(size: ${c})`, 0, void 0, p?.matchingVars));
    if (s.length && style) {
      let {
        fontWeight,
        italic = !1
      ...
      let d = l ?? a;
      ("regular" !== fontWeight || l) && s.push(n8(`.weight(${d})`, 1));
...
class t3 {
  ...
  resolveColor(e) {
    ...
    if (!t) {
      ...
      i && "PAINT" === i.type && (t = t4(i), this.colors.push(t));
    }
    return t;
  }
  resolveEffect(e) {
    ...
    if (!t) {
      let i = this.getStyleById(e);
      i && "EFFECT" === i.type && (t = t4(i), this.effects.push(t));
    }
    return t;
  }
  resolveTextStyle(e) {
    ...
    if (!t) {
      let i = this.getStyleById(e);
      i && "TEXT" === i.type && (t = t4(i), this.textStyles.push(t));
    }
    return t;
  }
}
...
class t8 {
  ...
  getNode(e) {
    ...
    this.nodes[t] || (this.nodes[t] = function (e, t) {
      if ("VECTOR" === e.type || "BOOLEAN_OPERATION" === e.type || e.isAsset && !("fills" in e ? e.fills instanceof Array ? null != e.fills.find(e => "IMAGE" === e.type || "VIDEO" === e.type) : null : "MEDIA" === e.type)) return _$$a.from(e, t);
      switch (e.type) {
        case "LINE":
        case "ELLIPSE":
        case "RECTANGLE":
...
class ic {
  ...
  async getCSSPropertiesOfSubTree({
    ...
    if (!Pq(i)) return {
      propertiesByLayer: {},
      error: Error("Codegen is not allowed")
    };
