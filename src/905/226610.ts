...
function y() {
  return debugState || (logDebug('Labs', 'No global redux store set, so creating a mock store with empty userFlags'), createStore(() => ({
    userFlags: {},
    isStarterUser: !1,
  })))
}
...
let E = getInitialOptions().cluster_name !== 'prod'
