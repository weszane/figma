...
export function $$ek0(e) {
  ...
  let e7 = (e) => {
    if (t0 !== _$$q.UPGRADE_NOT_NEEDED && getUpgradePathway(e) !== _$$J.AUTO_PATHWAY)
      return hasPendingRequest(e) ? getI18nString('upgrades.request_sent') : getI18nString('upgrades.request')
  }
  ...
  let ib = ((t, n) => {
    ...
    return {
      ...
      [eC.DELETE]: (e, i, n) => {
        ...
        return {
          displayText: r
            ? getI18nString('tile.dropdown.move_file_and_branches_to_trash')
            : t === 1
              ? getI18nString('tile.dropdown.trash_single_tile')
              : getI18nString('tile.dropdown.trash_file', {
                  objText: i,
                }),
          callback: to,
          disabled: n,
      ...
      [eC.DUPLICATE]: (e, i) => ({
        displayText: t === 1
          ? getI18nString('tile.dropdown.duplicate_single_tile')
          : getI18nString('tile.dropdown.duplicate', {
              objText: e,
            }),
        callback: ta,
        disabled: i,
      ...
      [eC.DUPLICATE_TO_DRAFTS]: (e, t) => ({
        displayText: n === 1
          ? getI18nString('tile.dropdown.duplicate_to_draft_single_file_or_repo')
          : getI18nString('tile.dropdown.duplicate_to_draft', {
              objText: e,
            }),
        callback: tu,
        disabled: t,
      ...
      [eC.MOVE_FILE]: (e, t, i) => ({
        displayText: e === 1
          ? getI18nString('tile.dropdown.move_file')
          : getI18nString('tile.dropdown.move_object', {
              objText: t,
            }),
        callback: () => tA(tH, tW, e),
      ...
      [eC.FAVORITE_REPO]: (t, i, n) => {
        ...
        return r && n != null
          ? tf(t, n, favoriteSidebarSection, (e) => {
  ...
  let iv = (() => {
    ...
    return {
      ...
      [eC.FAVORITE_FILE]: () => {
        if (selectedView.view === 'deletedFiles')
          return !1
      ...
      [eC.FAVORITE_PROTOTYPE]: () => {
        if (selectedView.view === 'deletedFiles' || selectedView.view === 'team')
          return !1
