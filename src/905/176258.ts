...
import { bi, hg } from '../figma_app/425489'

let d = new EventEmitter('variableEventEmitter')
let c = new class {
  constructor() {
    if (this.variableModeToDebugValue = new StatePublisher({}), this.isInitialized = new StatePublisher(!1), !getFeatureFlags().prototype_variable_debug_view)
      return
