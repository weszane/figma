...
export let $$_0 = Ju(function (e) {
  ...
  if (0 === e.externalUsersWithoutAccess.length || l.length > 0) {
    ...
    let i = _$$t("comments.cant_view_this_comment", {
      numUsers: t.length,
      userHandle: t[0].handle
    });
    return jsxs(yX, {
      confirmationTitle: i,
      confirmText: 0 === l.length ? _$$t("comments.post_share") : _$$t("comments.post_anyway"),
      cancelText: _$$t("comments.cancel_post_and_share"),
      size: "small",
      hideClose: !0,
      ...e,
      children: [jsx("div", {
        className: jE,
        children: tx("comments.wont_be_able_to_view_your_comments_because_they_dont_have_access_to_this_file", {
          mentionedUsers: jsx(f, {
            users: t
          })
        })
      }), jsx(h, {
        header: _$$t("comments.you"),
  ...
  let _ = jsx("a", {
    ...
    children: tx("comments.learn_more")
  });
  let A = g ? tx("comments.please_note_that_is_external_to_your_organization", {
    numUsers: s.length,
    userNames: Yx(s),
    learnMore: _
  }) : tx("comments.please_note_that_some_of_these_users_are_external_to_your_organization", {
    numUsers: s.length,
    learnMore: _
  });
  return jsx(yX, {
    confirmationTitle: _$$t("comments.post_comment_and_share_file"),
    confirmText: _$$t("comments.post_share"),
    cancelText: _$$t("comments.discard"),
    size: "small",
    hideClose: !0,
    ...e,
    children: jsxs("div", {
      ...
      children: [jsxs(Fragment, {
        children: [jsx("div", {
          children: tx("comments.mention_confirm_warning", {
          ...
          children: t ? tx("comments.mfa_required_warning_without_link", {
            numUsers: s.length
          }) : A
        })]
      }), jsx(h, {
