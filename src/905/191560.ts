...
function k(e) {
  ...
  return jsx('button', {
    ...
    children: jsxs('span', {
      ...
      children: [e.use === 'hollow' || !loading && e.disabled ? null : loading ? jsx(SvgComponent, {
        svg: _$$A3,
        width: '24px',
        height: '24px',
        className: S
...
function P({
  ...
  return jsx(N, {
    ...
    svg: _$$A2,
    trackingProperties: {
      trackingDescriptor: UpgradeAction.CONTINUE_WITH_GOOGLE
    }
  });
}
function M() {
    ...
    onSubmit: () => {
      ...
      if (n) {
        ...
        samlAuthenticationService.twoFactor(d || '').then(e => {
          ...
          i.reason === 'invalid_session' ? customHistory.redirect('/') : t(AUTH_SHOW_ERROR({
            message: n,
    ...
    if (S()) {
      ...
      try {
        ...
        i === 'google' ? (b(!0), E()) : i === 'saml' ? t(AUTH_SEND_EMAIL_SAML_START({
          formId: e.id
        })) : i === 'sign_in' ? (l(!0), t(changeAuthFormState({
          formState: AuthFlowStep.SIGN_IN
        }))) : (l(!0), _(!1));
      } catch (e) {
        t(AUTH_SHOW_ERROR({
...
function te() {
  ...
  return jsxs('div', {
    ...
    children: [jsx('div', {
      ...
      children: jsx(N, {
        trackingProperties: {
          trackingDescriptor: UpgradeAction.OPEN_GMAIL
        },
        svg: _$$A2,
      ...
      children: jsx(N, {
        trackingProperties: {
          trackingDescriptor: UpgradeAction.OPEN_OUTLOOK
        },
        svg: _$$A5,
