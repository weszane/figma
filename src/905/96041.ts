...
import { Kv, n0 } from '../figma_app/686647'
import { G1 } from '../figma_app/691470'
import { H as _$$H, pp as _$$pp, tl as _$$tl, bv, jR, k8, KU, L6, Qp, r6, TM, XM } from '../figma_app/705029'
...
_$$z.object({
  ...
  selectionJsx: defineJSXSchema.pick({
    jsxStr: !0,
    assetsByName: !0,
...
function i1(e) {
  return isSerializedCortexErrorV2(e) ? deserializeCortexErrorV2(e) : e !== null && typeof e == 'object' && e.cortex_error ? new G1(e.cortex_error.type, e.cortex_error.data, void 0, void 0, e.cortex_error.trace) : null
}
