...
export function CurrencySwitcherDropdown(props: CurrencySwitcherDropdownProps) {
  ...
  const availableCurrencies = Object.keys(currencyOptions).filter(
    currency => props.supportedCurrencies.includes(currency),
  )
  ...
  return jsxs('div', {
    ...
    children: [
      jsx('span', {
        ...
        children: props.shortFormDisplay
          ? currentCurrencyOption.headerShort
          : currentCurrencyOption.headerLong,
      }),
      jsx('div', {
        ...
        children: jsx(SvgComponent, {
          ...
          className: classNames(
            'currency_switcher--caret--hshB4',
            isDropdownVisible ? 'currency_switcher--caretDown--ISJvk' : '',
          ),
        }),
      }),
      isDropdownVisible && jsx(Cf, {
 ...
 */
export const sortedCurrencyKeys = Object.keys(currencyOptions).sort(
  (a, b) => a === 'usd' ? 1 : b === 'usd' ? -1 : a.localeCompare(b),
)
 ...
 */
export const CurrencyDropdownOption = withTrackedClick(
  (props: CurrencyDropdownOptionProps) => {
    ...
    return jsx(c$, {
      ...
      children: jsxs('div', {
        ...
        children: [
          jsx('div', { children: option.optionLeft }),
          jsx('div', { children: option.optionRight }),
        ],
      }),
    })
  },
