...
interface ReactionItem {
  ...
  position: number
  i18nName: () => string
  action?: (e: any, t: any) => void
}

// Extract the chat action function for better readability
// Original inline action for "r-chat"
function handleChatAction(position: any, dispatch: any) {
...
// Refactored array: original $$s0
export const reactionWheelItems: ReactionItem[] = [
  {
    type: "REACTION",
    name: "r-fire",
...
// Maintain original export alias: original n
export const n = reactionWheelItems
