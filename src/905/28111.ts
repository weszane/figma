...
import { memo, useCallback, useContext, createContext, useMemo, useEffect } from "react";
...
import { bm, Zf, mb } from "../905/107436";
  ...
  return jsxs("div", {
    ...
    children: [jsxs("svg", {
      ...
      style: {
        ...
        background: z5.format(autoCorrectCandidate),
...
export function $$ei4({
  ...
  let s = contrastRowRef?.current ? cn(contrastRowRef.current, 176) : void 0;
  let o = useCallback(() => {
    ...
    children: [jsxs("div", {
      ...
      children: [jsx("div", {
        ...
        children: [jsx(_$$J, {
          ...
          children: TI.format(backgroundPaint.color)
        })]
      })]
    })]
  });
