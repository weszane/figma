  ...
  return jsxs(Fragment, {
    children: [jsxs(ButtonPrimitive, {
      ...
      'children': [p, jsx('div', {
        ...
        children: jsxs('div', {
          className: jq,
          children: [e.audienceAccessRow && e.sharingAudienceControl
            ? jsx('div', {
            ...
            : (() => {
                let e = team
                  ? team.name
                  : getI18nString('folder_permissions_modal.project_name_s_team', {
...
function ez(e) {
  let t = useMemo(() => e.teamRoles.sort((e, t) => {
    if (e.pending === t.pending && !e.pending)
      return e.user && t.user ? e.user.handle.toLowerCase() < t.user.handle.toLowerCase() ? -1 : 1 : -1
    if (e.pending === t.pending && e.pending) {
  ...
  return jsxs(Fragment, {
    children: [jsx('div', {
      ...
      'children': e.teamAccess === FTeamAccessPermissionType.TEAM_ACCESS_EDIT
        ? renderI18nText('folder_share_settings.the_following_people_have_access_team', {
            teamName: e.teamName,
          })
...
export let $$eK0 = registerModal((e) => {
  ...
  useLayoutEffect(() => {
    em.status === 'loaded' && em.data.project === null && ep(hideModal())
  }, [em, ep])
  let {
    Sprig,
  } = useSprigWithSampling()
  useWebLoggerTimerEffect(em.status === 'loaded', (e) => {
  ...
  let eB = (e) => {
    if (org && org.domain_capture && ek && ek.domains.length > 0) {
      ...
      if (org.invite_whitelist_guest_invite_setting == null && t.length > 0) {
        ep(showModalHandler({
          type: _$$F,
          data: {
            emails: t,
  ...
  let tt = () => {
    if (e0) {
      if (planPublicInfo?.tier === FPlanNameType.STARTER) {
        ...
        e0 === FTeamAccessPermissionType.TEAM_ACCESS_VIEW
          ? ep(showModalHandler({
              type: Ni,
              data: {
                team,
  ...
  let tn = (e, t) => {
    let i = t?.goBackAction
      ? jsx(DialogBackButton, {
