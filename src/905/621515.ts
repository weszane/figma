...
import { Ng } from "../figma_app/416935";
...
let E = new _$$m("DenyForSyntheticTestUser", "Don't show to synthetic test users (in E2E tests)", e => !Ng(e.userData?.email) || !!QL("allow_synthetic_tester_overlays"));
