...
export class $$v2 {
  pathToSelectedView(e, t, i, n) {
    ...
    let o = t[1];
    if (("design" === o || "file" === o) && ("1" === r["ready-for-dev"] || ("dev" === r.mode || "dev" === r.m) && "auto" !== r.m)) {
      let i = "branch" === t[3] && t[4] ? t[4] : t[2];
      let s = {
        view: "fullscreen",
        editorType: e?.user ? nT.DevHandoff : nT.Design,
        fileKey: i
      };
      d8(n, s);
      qi(r, s);
      ...
      r["cc-filter-status"] && (r["cc-version-id"] || r["cc-activity-id"]) && (r["node-id"] || r["cc-node-id"]) && !r.vars && o && (s.filterStatusVersions = "1" === r["cc-filter-status"]);
      ...
      } else if (l && "1" === r["ready-for-dev"]) s.showOverview = !0;else if (l && "1" === r["component-browser"]) {
        s.showDevModeComponentBrowser = !0;
        s.componentKey = r["component-key"] || void 0;
        let e = e6.NONE;
        "repo" === r["gh-settings"] ? e = e6.REPO_SELECTOR : "dirs" === r["gh-settings"] ? e = e6.DIRECTORY_SELECTOR : "1" === r["gh-repo-selector"] && (e = e6.REPO_SELECTOR);
        s.githubRepositorySelectorMode = e;
      }
      s.showDevModeVariablesTable || zl.set($, null);
      $$y0(s) && ("dev" === r.mode || "dev" === r.m) && (s.mode = "dev", !l || !r["focus-id"] || s.showOverview || r.vars || (s.devModeFocusId = r["focus-id"], r["node-id"] || (s.nodeId = r["focus-id"])));
      return s;
    }
    return null;
  }
  ...
  selectedViewToPath(e, t) {
    if ($$y0(e) || "fullscreen" === e.view && !0 === e.showOverview) {
      let i;
