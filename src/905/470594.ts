...
export const CheckNetworkCompatibilityModal = registerModal((props) => {
  ...
  const descriptionContent = jsxs(Fragment, {
    children: [
      jsx('span', { children: getI18nString('check_network_compatibility.description') }),
      jsx('br', {}),
      jsx('br', {}),
      jsx('span', { children: getI18nString('check_network_compatibility.description_cta') }),
      '\xA0',
      jsx(Link, {
    ...
    children: [
      jsxs('div', {
        ...
        children: [
          ...
          jsx('div', {
            children: error === NetworkErrorType.NONE
              ? jsx('div', {
      ...
      error === NetworkErrorType.NON_S3_RESPONSE
        ? jsxs('div', {
            ...
            children: [
              jsx('span', { style: sx.mr8.$, children: url }),
              jsx(SvgComponent, {
                svg: SVG2,
...
export function showNetworkSettingsModal(dispatch) {
  ...
  networkCompatibilityService.getCheckPresignedPostNetworkCompatibility().then(async ({
    ...
    if (results.some(({ error }) => error !== NetworkErrorType.NONE)) {
