...
export let $$d0 = memo(({
  ...
  let p = u.lastIndexOf("/")
  let m = u.lastIndexOf(" ")
  c = p > 0 ? p : m > 0 ? m : Math.round(0.75 * u.length)
  ...
  return jsxs("div", {
    ...
    "children": [h.length > 0 && jsx("div", {
      ref: f,
      className: s()({
        "segmented_truncated_text--firstTruncateStart--GYFkA segmented_truncated_text--_first--T44MY": d === "start",
        "segmented_truncated_text--firstTruncateEnd--NIilH segmented_truncated_text--_first--T44MY": d === "end",
      }),
