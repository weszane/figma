import { n as _$$n2 } from '../905/26360';
import { D as _$$D } from '../905/107177';
import { createAnnotationsMixin, createArcDataMixin, createBorderCornerMixin, createCanvasGridMixin, createCooperFrameMixin, createCountMixin, createDecorativeImageMixin, createDraftMixin, createEmptyMixin, createEmptyMixin2, createEmptyMixin3, createEmptyMixin4, createEmptyMixin5, createEmptyMixin6, createEmptyMixin7, createEmptyMixin8, createEmptyMixin9, createEmptyMixin10, createEmptyMixin11, createEmptyMixin12, createEmptyMixin13, createEmptyMixin14, createEmptyMixin16, createEmptyMixin17, createEmptyMixin18, createEmptyMixin19, createEmptyMixin20, createEmptyMixin21, createEmptyMixin22, createEmptyMixin23, createEmptyMixin24, createEmptyMixin25, createEmptyMixin26, createEmptyMixin27, createEmptyMixin28, createEmptyMixin30, createLayoutMixin, createModuleMixin, createOverlayMixin, createPageMixin, createResponsiveMixin, createStateGroupMixin, createTextMixin, createVisualStylingMixin, createWidgetMixin } from '../905/112832';
import { ServiceCategories as _$$e } from '../905/165054';
import { v as _$$v2 } from '../905/219968';
import { _0 } from '../905/229717';
import { F as _$$F } from '../905/266460';
import { kiwiParserCodec as _$$w } from '../905/294864';
import { w as _$$w3, G } from '../905/311324';
import { Mm } from '../905/382883';
import { B as _$$B, v as _$$v3 } from '../905/383429';
...
import { w as _$$w2 } from '../905/739338';
import { k as _$$k } from '../905/749197';
import { F7, IA, n3, Rf, sg } from '../905/859698';
import { H4, yw } from '../905/864609';
import { AD } from '../905/871411';
import { I as _$$I } from '../905/912236';
...
import { BuildStatus, CompiledVectorData_Internal, ComponentPropType, FacetType, ImageFillMode, InteractiveSlideElementFacetTsApiGenerated, MutableCollaborativePlainText, MutableSceneGraph, PrototypeInteractions_Internal, TextData_Internal, TextFacetTsApiGenerated } from '../figma_app/175377';
import { gr } from '../figma_app/243058';
import { $P } from '../figma_app/276332';
import { EV } from '../figma_app/404307';
import { CUU as _$$CUU, Fk7 } from '../figma_app/763686';
function b(e) {
  switch (e) {
    case 'FILL':
...
function L() {
  ...
  let eT = Yp;
  e = eT;
  t = eT = class extends createDecorativeImageMixin(e) {};
  i = eT = class extends createAnnotationsMixin(t) {
  ...
  o = eT = class extends createEmptyMixin(i) {
    get assetKey() {
  ...
  l = eT = class extends createEmptyMixin2(o) {
    get brushType() {
      this.setGlobalNodeID();
      return this.bindings.NodeTsApi.getBrushType(this.sceneGraph.nodeContext);
    }
  };
  c = eT = class extends createEmptyMixin3(l) {
    get strokeBrushGuid() {
      this.setGlobalNodeID();
  ...
  m = eT = class extends createCooperFrameMixin(c) {
    ...
    getBuzzTextFields() {
      ...
      let a = i[t]?.defs ? Object.values(i[t].defs) : [];
  ...
  h = eT = class extends createPageMixin(m) {
    getEditModeNode() {
      this.setGlobalNodeID();
  ...
  f = eT = class extends createCanvasGridMixin(h) {};
  _ = eT = class extends createEmptyMixin3(f) {};
  b = eT = class extends createEmptyMixin21(_) {};
  v = eT = class extends createEmptyMixin5(b) {};
  I = eT = class extends createEmptyMixin6(v) {};
  E = eT = class extends createEmptyMixin22(I) {};
  L = eT = class extends createEmptyMixin19(E) {};
  F = eT = class extends createStateGroupMixin(L) {
    get isComponentish() {
      this.setGlobalNodeID();
  ...
  eT = class extends createEmptyMixin7(F) {
    componentPropertyReferences() {
      return (this.setGlobalNodeID(), SceneNodeCpp) ? SceneNodeCpp.componentPropertyReferences() : {};
    }
    setComponentPropertyReferences(e) {
      if (this.setGlobalNodeID(), SceneNodeCpp) return SceneNodeCpp.setComponentPropertyReferences(e);
    }
    get propRefs() {
      this.setGlobalNodeID();
  ...
  M = eT = _$$w2(eT);
  j = eT = class extends createEmptyMixin9(M) {
  ...
  U = eT = class extends createEmptyMixin8(j) {};
  B = eT = class extends createEmptyMixin10(U) {
    get isDiagramNode() {
      this.setGlobalNodeID();
  ...
  V = eT = class extends createEmptyMixin12(B) {};
  G = eT = class extends createDraftMixin(V) {
    get firstDraftData() {
      this.setGlobalNodeID();
  ...
  z = eT = class extends createEmptyMixin17(G) {
    isTopLevelFrame() {
      this.setGlobalNodeID();
  ...
  H = eT = class extends createEmptyMixin13(z) {};
  W = eT = class extends createEmptyMixin11(H) {};
  K = eT = class extends createEmptyMixin16(W) {
    get guides() {
      this.setGlobalNodeID();
  ...
  Y = eT = class extends createEmptyMixin18(K) {};
  q = eT = class extends createEmptyMixin14(Y) {
    get isInstance() {
  ...
  $ = eT = class extends createEmptyMixin4(q) {
  ...
  Z = eT = class extends createEmptyMixin26($) {
    get jsxProps() {
      this.setGlobalNodeID();
  ...
  X = eT = class extends createEmptyMixin2(Z) {
    get locked() {
      this.setGlobalNodeID();
  ...
  Q = eT = class extends createEmptyMixin18(X) {};
  J = eT = class extends createEmptyMixin28(Q) {};
  ee = eT = class extends createModuleMixin(J) {
    get containingModuleId() {
      this.setGlobalNodeID();
      return this.bindings.NodeTsApi.getContainingModuleId(this.sceneGraph.nodeContext) ?? null;
    }
  };
  et = eT = class extends createEmptyMixin20(ee) {
  ...
  er = eT = class extends createCountMixin(en) {};
  ea = eT = class extends createOverlayMixin(er) {
    ...
    get effectivePrototypeStartNodeId() {
      this.setGlobalNodeID();
      return _$$CUU?.getEffectivePrototypeStartNodeId(this.sceneGraph.nodeContext) ?? null;
    }
    get flowStartingPoints() {
      this.setGlobalNodeID();
      return _$$CUU.getFlowStartingPoints(this.sceneGraph.nodeContext);
    }
    set flowStartingPoints(e) {
      this.setGlobalNodeID();
      let t = _$$CUU.setFlowStartingPoints(e, this.sceneGraph.nodeContext);
      if (t) throw new Error(t);
    }
  ...
  eT = class extends createResponsiveMixin(ea) {
  ...
  es = eT = _$$n2(eT);
  eo = eT = class extends createEmptyMixin23(es) {
    get backgroundColor() {
      this.setGlobalNodeID();
  ...
  el = eT = class extends createVisualStylingMixin(eo) {
  ...
  ed = eT = class extends createBorderCornerMixin(el) {
  ...
  ec = eT = class extends createEmptyMixin24(ed) {
  ...
  eT = class extends createLayoutMixin(ec) {
    get stackMode() {
      this.setGlobalNodeID();
  ...
  eu = eT = _$$I(eT);
  ep = eT = class extends createEmptyMixin25(eu) {};
  em = eT = class extends createEmptyMixin(ep) {};
  eh = eT = class extends createEmptyMixin27(em) {
  ...
  eT = class extends createEmptyMixin4(eh) {
    get stateGroupPropertyValueOrder() {
      this.setGlobalNodeID();
      return this.bindings.NodeTsApi.getStateGroupPropertyValueOrder(this.sceneGraph.nodeContext);
    }
    get statePropertyValues() {
      this.setGlobalNodeID();
      return this.bindings.NodeTsApi.getStatePropertyValues(this.sceneGraph.nodeContext);
    }
    get defaultVariant() {
      if (!this.isStateGroup) throw new Error('Can only get default variant of a state group');
      this.setGlobalNodeID();
      let e = this.bindings.NodeTsApi.getDefaultState(this.sceneGraph.nodeContext);
      return e && e !== AD ? this.sceneGraph.get(e) : null;
    }
    variantGroupProperties() {
      if (!this.isStateGroup) throw new Error('Can only get variant properties of a state group');
      this.setGlobalNodeID();
      return SceneNodeCpp.variantGroupProperties();
    }
    addVariantComponentPropertyDefinition(e, t) {
      if (!this.isStateGroup) throw new Error('Can only add variant property to a component set');
      this.setGlobalNodeID();
      return SceneNodeCpp.addVariantComponentPropertyDefinition(e, t);
    }
  };
  eT = _$$w3(eT);
  eg = eT = _$$D(eT);
  ef = eT = class extends createEmptyMixin30(eg) {
    get tableNumRows() {
      this.setGlobalNodeID();
  ...
  e_ = eT = class extends createTextMixin(ef) {
    get fontSize() {
  ...
  eA = eT = class extends createEmptyMixin(e_) {};
  eT = class extends createEmptyMixin(eA) {};
  ey = eT = _$$B(eT);
  eb = eT = class extends createEmptyMixin(ey) {
    get valuesByMode() {
      this.setGlobalNodeID();
      let {
        errorMsg,
  ...
  ev = eT = class extends createEmptyMixin(eb) {};
  eI = eT = class extends createEmptyMixin(ev) {};
  eE = eT = class extends createEmptyMixin(eI) {
  ...
  ex = eT = class extends createArcDataMixin(eE) {
    get handleMirroring() {
      this.setGlobalNodeID();
  ...
  eS = eT = class extends createEmptyMixin(ex) {
  ...
  ew = eT = class extends createEmptyMixin(eS) {};
  eC = eT = class extends createWidgetMixin(ew) {
    get isInWidget() {
      this.setGlobalNodeID();
  ...
  return eT = class extends eC {
    get mask() {
      this.setGlobalNodeID();
      return Fk7.getIsMask(this.sceneGraph.nodeContext);
    }
    set mask(e) {
      this.setGlobalNodeID();
      let t = Fk7.setIsMask(e, this.sceneGraph.nodeContext);
      if (t) throw new Error(t);
    }
    get size() {
      this.setGlobalNodeID();
      return Fk7.getSize(this.sceneGraph.nodeContext);
    }
    set size(e) {
      this.setGlobalNodeID();
      let t = Fk7.setSize(e, this.sceneGraph.nodeContext);
      if (t) throw new Error(t);
    }
    get shapeWithTextType() {
      this.setGlobalNodeID();
      let e = Fk7.getShapeWithTextType(this.sceneGraph.nodeContext);
    ...
    set shapeWithTextType(e) {
      ...
      if (typeof t == 'number') {
        this.setGlobalNodeID();
        let e = Fk7.setShapeWithTextType(t, this.sceneGraph.nodeContext);
        if (e) throw new Error(e);
      } else {
    ...
    get slotBackingLayerId() {
      this.setGlobalNodeID();
      return Fk7.getSlotBackingLayerId(this.sceneGraph.nodeContext);
    }
    get visualGroupHash() {
      this.setGlobalNodeID();
      return Fk7.getVisualGroupHash(this.sceneGraph.nodeContext);
    }
    get isReactFiber() {
      this.setGlobalNodeID();
      return Fk7.getIsReactFiber(this.sceneGraph.nodeContext);
    }
    get isGrid() {
      this.setGlobalNodeID();
      return Fk7.getIsGrid(this.sceneGraph.nodeContext);
    }
    get isLayoutContainer() {
      this.setGlobalNodeID();
      return Fk7.getIsLayoutContainer(this.sceneGraph.nodeContext);
    }
    get isLayoutChild() {
      this.setGlobalNodeID();
      return Fk7.getIsLayoutChild(this.sceneGraph.nodeContext);
    }
    get isLayoutPositioned() {
      this.setGlobalNodeID();
      return Fk7.getIsLayoutPositioned(this.sceneGraph.nodeContext);
    }
    get isGridChild() {
      this.setGlobalNodeID();
      return Fk7.getIsGridChild(this.sceneGraph.nodeContext);
    }
    get gridRowCount() {
      this.setGlobalNodeID();
      return Fk7.getGridRowCount(this.sceneGraph.nodeContext);
    }
    get gridColumnCount() {
      this.setGlobalNodeID();
      return Fk7.getGridColumnCount(this.sceneGraph.nodeContext);
    }
    get gridColumnAnchorIndex() {
      this.setGlobalNodeID();
      return Fk7.getGridColumnAnchorIndex(this.sceneGraph.nodeContext);
    }
    get gridRowAnchorIndex() {
      this.setGlobalNodeID();
      return Fk7.getGridRowAnchorIndex(this.sceneGraph.nodeContext);
    }
    get gridRowSizesInOrder() {
      this.setGlobalNodeID();
      return Fk7.getGridRowSizesInOrder(this.sceneGraph.nodeContext);
    }
    get gridColumnSizesInOrder() {
      this.setGlobalNodeID();
      return Fk7.getGridColumnSizesInOrder(this.sceneGraph.nodeContext);
    }
    get hasCodeInstanceDescendant() {
      this.setGlobalNodeID();
      return Fk7.getHasCodeInstanceDescendant(this.sceneGraph.nodeContext);
    }
    get isVectorLike() {
      this.setGlobalNodeID();
      return Fk7.getIsVectorLike(this.sceneGraph.nodeContext);
    }
    get isEmbeddedPrototype() {
      this.setGlobalNodeID();
      return Fk7.getIsEmbeddedPrototype(this.sceneGraph.nodeContext);
    }
    get isSlotReactive() {
      this.setGlobalNodeID();
      return Fk7.getIsSlotReactive(this.sceneGraph.nodeContext);
    }
  };
}
let F = null;
...
export class $$j0 extends L() {
  ...
  get isStackOrFixedSizeContainer() {
    return _$$F(this.type) && !this.isGroup;
  }
  get isSection() {
    this.setGlobalNodeID();
  ...
  get id() {
    return _$$v3(this) ? this.variableID : _$$v2(this) ? this.ownVariableCollectionId : G(this) ? this.styleAssetId : super.id;
  }
  ...
  export(e) {
    if (this.setGlobalNodeID(), !e) return SceneNodeCpp.exportAsImage('', this.sceneGraph.nodeContext);
    {
  ...
  getStyledTextSegments(e, t = -1, i = -1) {
    this.setGlobalNodeID();
    let n = SceneNodeCpp.getStyledTextSegments(e, t, i, this.sceneGraph.nodeContext).map(e => {
      let {
        fills,
        textDecorationFills,
        ...n
      ...
      'fills' in e && (r.fills = fills ? assertNotNullish(dG('fillPaints', fills), 'Figma Internal Error: fillPaints not found') : fills);
      'textDecorationFills' in e && (r.textDecorationFills = textDecorationFills ? assertNotNullish(dG('textDecorationFillPaints', textDecorationFills), 'Figma Internal Error: textDecorationFillPaints not found') : textDecorationFills);
      return r;
    });
    if (t !== -1 && i !== -1 && n.length > 0) {
      let e = n[0];
      let r = n[n.length - 1];
      (e.start < t || r.end > i) && (e === r ? e.characters = e.characters.substring(t - e.start, e.characters.length - (r.end - i)) : (e.characters = e.characters.substring(t - e.start), r.characters = r.characters.substring(0, r.characters.length - (r.end - i))), e.start = t, r.end = i);
    }
    return n;
  }
  ...
  getSitesJSON(e) {
    if (this.setGlobalNodeID(), !SitesBindingsCpp) throw new Error('SitesBindingsCpp is not available in getSitesJSON');
  ...
  get childrenDisplayOrder() {
    return _$$F(this.type) && this.isStack ? _$$k.DOM : _$$k.DESIGN;
  }
  get documentColorProfile() {
    let e = void 0 !== H4 && H4.documentColorProfile().getCopy() != null ? H4.documentColorProfile().getCopy() : yw.LEGACY;
    return yw[e];
  }
  ...
  setDakotaItemDatas(e, t, i) {
    ...
    n && N7(_$$e.CMS, new Error('Error: failed setDakotaItemDatas'), {
      extra: {
        error: n,
        nodeId: t,
        collectionId: i
  ...
  setGridTrackSize(e, t, i) {
    this.setGlobalNodeID();
    let n = this.bindings.NodeTsApi.setGridTrackSize(this.sceneGraph.nodeContext, e === 'row' ? _0.Y : _0.X, t, i ?? 1);
    if (n) throw new Error(`Cannot set grid track size: ${n}`);
  }
  setGridTrackType(e, t, i) {
    this.setGlobalNodeID();
    let n = this.bindings.NodeTsApi.setGridTrackType(this.sceneGraph.nodeContext, e === 'row' ? _0.Y : _0.X, t, i);
  ...
  get childrenNodes() {
    return EV(super.childrenNodes);
  }
  get reversedChildrenNodes() {
    return EV(super.reversedChildrenNodes);
  }
  createInstance() {
