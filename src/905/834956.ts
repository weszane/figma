...
class H extends z {
  ...
  render() {
    ...
    o || !this.props.leftIconOffset || header || ("search" === t.iconType ? e = jsx("div", {
      className: U,
      children: jsx(_$$h, {
        className: B
      })
    }) : "plus" === t.iconType ? e = jsx("div", {
      className: U,
      children: jsx(_$$e, {
        className: B
      })
    }) : "info" === t.iconType ? e = jsx("div", {
...
let er = class e extends RecordingPureComponent {
  constructor(t) {
    ...
    this.getActiveItemAtDepth = e => {
      if (0 === e) {
        ...
        return null == this.state.activeItem ? null : e[this.state.activeItem.index];
      }
      return null != this.state.activeItem && this.state.activeItemSubmenuShown && this.childMenu ? this.childMenu.getActiveItemAtDepth(e - 1) : null;
    };
    ...
    this.showSubmenu = (e = !1) => {
      let t = this.currentVisibleItems();
      let i = null !== this.state.activeItem && t[this.state.activeItem.index];
    ...
    this.addInputChar = e => {
      ...
      r.forEach(e => {
        null != e && null === n && e.displayText && e.displayText.toLowerCase().startsWith(this.userInput) && (n = e);
      });
      null !== n && this.setActiveOption(n, r.indexOf(n), !1, !0);
    };
      ...
      if (!this.state.activeItemSubmenuShown) {
        ...
        switch (e.keyCode) {
          ...
          case Uz.UP_ARROW:
            ...
            break;
          default:
            (!document.activeElement || "INPUT" != document.activeElement.tagName || document.activeElement.classList.contains("focus-target")) && this.addInputChar(e.keyCode);
        }
      }
    });
    ...
    this.onMouseLeaveItem = e => t => {
      if (this.state.activeItemSubmenuShown) {
        ...
        if (e) {
          ...
          if (i && J.length > 0) {
            let e = 1 === this.state.submenuPosition ? i.right : i.left;
    ...
    this.filterHiddenItems = e => {
      let t = [...e];
      for (let e = 0; e < t.length;) null == t[e] || t[e].hidden || t[e].children && !this.filterHiddenItems(t[e].children).length ? t.splice(e, 1) : ++e;
    ...
    this.getDropdownMaxHeight = e => e - (0 === this.props.depth && null != this.props.children ? this.rootMenuChildContentBottom : 64) - this.props.toolbarHeightAndMargin - 8;
    ...
    this.renderAsSubmenu = () => {
      let e = {};
      1 === this.state.submenuPosition ? e.right = document.body.clientWidth - this.props.parentRect.left : 0 === this.state.submenuPosition ? e.left = this.props.parentRect.right : e.right = 8;
      let t = 1 === this.state.submenuPosition;
    ...
    this.renderAsRootMenu = () => {
      let e = 1 === this.state.submenuPosition;
      let t = this.currentVisibleItems();
      return jsxs(Fragment, {
        children: [jsxs(Cf, {
          ...
          ...UV(this.props),
          children: [null != this.props.children && jsx("div", {
            onClick: this.onClickMenu,
    ...
    0 === this.props.depth ? this.rootMenuTop = this.props.parentRect ? this.props.parentRect.top + this.props.parentRect.height : 0 : null != this.props.rootMenuTop && (this.rootMenuTop = this.props.rootMenuTop);
  }
  componentDidMount() {
    super.componentDidMount();
    ...
    if (this.props.onMount && this.props.onMount(), this.props.focusOnMount && this.contentEl?.focus(), this.props.activatePathOnMount) {
      ...
      let i = this.findVisibleItemIndexByName(t);
      -1 !== i && this.setActiveOption(e[i], i, !0);
    } else this.props.depth > 0 && this.props.shouldAutofocusSubmenu ? this.submenuDropdownEl && this.submenuDropdownEl.focus() : 0 === this.props.depth && this.contentEl?.focus();
  }
  ...
  componentWillUnmount() {
    ...
    0 === this.props.depth && (J.length = 0, Q = !1);
  }
  render() {
    let e = null;
    if (this.props.showLoadingSpinner) e = jsx(Cf, {
      targetRect: this.props.parentRect,
      showPoint: this.props.showPoint,
      onFocus: this.props.onFocus,
      textAlign: "center",
...
export let $$ea0 = forwardRef((e, t) => {
  let i = Pg();
  return 0 === e.items.length || e.items.every(e => e.separator) ? null : jsx(er, {
    ...e,
