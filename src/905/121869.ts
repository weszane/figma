...
export function $$x0(e) {
  ...
  let x = (E?.data?.invoices ?? []).find(e => e.status === 'open' && dayjs(e.past_due_at) < dayjs().subtract(21, 'day') && dayjs(e.past_due_at) > dayjs().subtract(90, 'day'));
  ...
  return e.overdueInvoice ? jsxs(Fragment, {
    children: [jsx(TextWithTruncation, {
      ...
      children: renderI18nText('payments_modal.your_files_are_safe_but_youll_need_to_pay', {
        dueDate: dayjs(e.overdueInvoice.due_at).format('MMM D'),
