...
import { Kk as _$$Kk, gb, hf, kx, KY, lY, nf, qf, yp } from '../905/71683';
...
import { AUTO_MARKER, isAutoMarker, isInvalidValue, isMixedArray, isValidValue, MIXED_MARKER, toArray, valueOrFallback } from '../905/216495';
import { A as _$$A2 } from '../905/251970';
import { Label } from '../905/270045';
import { Checkbox } from '../905/274480';
import { useSelectedStyleOrSelectionPropertyValue, useSelectionPropertyValue, useSelectedStyleOrSelectionPropertyValues, useSelectedStylePropertyValue, useSelectionPropertyValues } from '../905/275640';
...
import { H as _$$H, bd, EI, Fc } from '../905/468313';
...
import { B9, h$, i4, LM, MK, mw, PK, vK } from '../905/566585';
...
import { ColorInput, ExpressionInput, LengthInput, PixelInput } from '../figma_app/178475';
...
import { DJ, XL } from '../figma_app/519250';
import { Pi } from '../figma_app/580959';
import { fI, JU, UZ, zi, Zk } from '../figma_app/626177';
...
import { FontHelpers, Fullscreen, LayoutTabType, NodePropertyCategory, TextAlignmentOptions, TextPathStartHelpers, TypographySettings, VariableResolvedDataType, VisibilityCondition } from '../figma_app/763686';
...
class eY extends PureComponent {
  constructor() {
    ...
    this.onListStyleChange = e => {
      e === 'PLAIN' ? fullscreenValue.triggerActionInUserEditScope('text-clear-list-formatting', {
        source: this.props.eventSource
      }) : e === 'UNORDERED_LIST' && this.props.textLineType !== 'UNORDERED_LIST' ? fullscreenValue.triggerActionInUserEditScope('text-toggle-unordered-list', {
        source: this.props.eventSource
      }) : e === 'ORDERED_LIST' && this.props.textLineType !== 'ORDERED_LIST' && fullscreenValue.triggerActionInUserEditScope('text-toggle-ordered-list', {
        source: this.props.eventSource
      });
    };
  }
...
let tI = e => {
  ...
  e !== 'UNDERLINE' && fullscreenValue.updateSelectionProperties({
...
class tC {
  ...
  parse(e, t) {
    if ((e = e.trim().toLowerCase()) === '' || t == null || e === '%' || e === 'px' || 'auto%'.startsWith(e)) return this.defaultValue;
    let i = e.includes('%') ? 'PERCENT' : e.includes('px') ? 'PIXELS' : void 0;
    e = e.replace(new RegExp('%|px', 'g'), '');
    let n = O4(e, NaN);
    if (n.error) return t;
    let r = n.value;
    void 0 === i && (i = t.units === 'RAW' ? 'PERCENT' : 'PIXELS');
    return {
      value: r,
      units: i
    };
  ...
  incrementBy(e, t) {
    (e.units === 'RAW' || isInvalidValue(e.value)) && (e = this.defaultValue);
    t /= e.units === 'PERCENT' || e.units === 'RAW' ? 2 : 10;
    return {
      value: e.value + t,
      units: e.units
    };
  ...
  format(e) {
    ...
    if (e.units === 'RAW') return 'Auto';
    let t = parseFloat(e.value.toFixed(2));
    return e.units === 'PERCENT' ? `${t}%` : `${t}px`;
  }
}
let tN = memo(e => {
  let [t, i] = useState(!1);
...
(n || (n = {})).ConnectedTextDecorationFillPanel = connect(e => ({
  ...
  let {
    ...
    textDecorationFillPaints,
    styleIdForText
  } = (e.shouldUseSelectedStyleProperties ? useSelectedStyleOrSelectionPropertyValues : useSelectionPropertyValues)('exportBackgroundDisabled', 'exportSettings', 'inheritFillStyleKey', 'styleIdForText', 'textDecorationFillPaints');
  let l = useSelectedStyleOrSelectionPropertyValue('fillPaints');
  let d = _$$m();
  let c = useSelectedStylePropertyValue('textDecorationFillPaints');
  return jsx(tN, {
    colorFormat: t,
...
function tO(e) {
  ...
  return jsxs(Fragment, {
    children: [jsx(fI, {
      ...
      children: e.textDecoration !== 'NONE' && e.textDecoration !== 'STRIKETHROUGH' && jsx(tP, {
        isEditingStyle: e.isEditingStyle,
        recordingKey: e.recordingKey,
...
function tj({
  ...
  useEffect(() => {
    if (e === TypographySettings.EMPTY || s === null) {
      d({
        placeholder: getI18nString('type_settings.preview.preview')
      });
      return;
    ...
    if ('placeholder' in n && n.placeholder === 'No preview available') {
...
function tQ({
  ...
  let y = 10;
  let b = e.max - e.min;
  b <= 3 ? (A = 0.01, y = 0.25) : b <= 6 && (A = 0.1, y = 1);
  b >= 500 && (y = 25);
  let v = useMemo(() => {
    ...
    let i = function (e, t) {
      ...
      for (let n = 0; n < e.length; n++) {
        if (!i.has(n)) {
          for (let r = n + 1; r < e.length && !(e[r] - e[n] > t); r++) i.add(n);
        }
      }
...
function t2({
  ...
  let p = H0(e.filter(e => !u(e) && e.tag !== 'ital'));
...
function t3(e) {
  ...
  let n = useSelectionPropertyValue('textAutoResize');
  let o = useSelectionPropertyValue('textTruncation');
  let l = useSelectionPropertyValue('maxLines');
  let {
    smallNudgeAmount,
    bigNudgeAmount
  } = getNudgeAmounts();
  let u = n !== 'NONE' && o === 'ENDING';
  return jsxs(Fragment, {
    children: [jsxs(fI, {
      children: [jsx(JU, {
        className: ti,
        ...
        children: jsxs(bL, {
          ...
          onChange: e => {
            ...
            e === 'ENDING' && i.current ? t.maxLines = i.current : e === 'DISABLED' && l && isValidValue(l) && l > 0 && (i.current = l);
...
function t6(e) {
  ...
  let [_, A] = useState(!1);
  let b = useSelectionPropertyValue('selectedTextContainsUnderline') ?? !1;
  let v = e.textDecoration === 'UNDERLINE' || b;
  ...
  let eK = () => {
    let t = e.fontVariantNumericSpacing === 'NORMAL';
    let i = e.fontVariantNumericFigure === 'NORMAL';
    if (!(isValidValue(e.fontVariantNumericSpacing) && isValidValue(e.fontVariantNumericFigure))) return 'MIXED';
    if (t && i) return 'ORIGINAL';
    if (t || e.fontVariantNumericSpacing === 'PROPORTIONAL') {
      if (i || e.fontVariantNumericFigure === 'LINING') return 'UPPER_PROPORTIONAL';
      if (e.fontVariantNumericFigure === 'OLDSTYLE') return 'LOWER_PROPORTIONAL';
    } else if (e.fontVariantNumericSpacing === 'TABULAR') {
      if (i || e.fontVariantNumericFigure === 'LINING') return 'UPPER_MONOSPACE';
      if (e.fontVariantNumericFigure === 'OLDSTYLE') return 'LOWER_MONOSPACE';
    }
    return 'MIXED';
  };
  let eZ = () => valueOrFallback(e.fontVariantNumericFraction, 'MIXED') === 'MIXED' ? 'MIXED' : e.fontVariantNumericFraction === 'STACKED' ? 'ON' : 'OFF';
  let eX = t => t === 'DLIG' ? e.fontVariantDiscretionaryLigatures === MIXED_MARKER ? 'MIXED' : valueOrFallback(e.fontVariantDiscretionaryLigatures, !1) ? 'ON' : 'OFF' : t === 'HLIG' ? e.fontVariantHistoricalLigatures === MIXED_MARKER ? 'MIXED' : valueOrFallback(e.fontVariantHistoricalLigatures, !1) ? 'ON' : 'OFF' : w.mixed.includes(t) ? 'MIXED' : _$$G.OpenTypeFeatureDefaultOn.includes(t) ? tx === 'Style' ? x?.includes(t) ? 'OFF' : 'ON' : w.off.includes(t) ? 'OFF' : 'ON' : tx === 'Style' ? I?.includes(t) ? 'ON' : 'OFF' : w.on.includes(t) ? 'ON' : 'OFF';
  let e5 = () => {
    fullscreenValue.updateSelectionProperties({
  ...
  let e7 = () => e.textUserLayoutVersion === 0 || toArray(e.textUserLayoutVersion).includes(0) ? 'upgrade' : e.textUserLayoutVersion === 1 && 'downgrade';
  ...
  let ty = () => tx !== 'Style' && (e.textExplicitLayoutVersion !== 1 || toArray(e.textExplicitLayoutVersion).includes(0));
  let tv = () => e7() === 'upgrade' ? jsxs(fI, {
    className: tm,
    onMouseDown: e => {
      e.stopPropagation();
    },
  ...
  let tw = tx === 'NodeNotStyleConsumer' || tx === 'Style';
  let tT = tx === 'NodeNotStyleConsumer' || tx === 'NodeStyleConsumer';
  let tk = () => {
    let t = (e, t) => {
      Y(t);
      t === 'ENTER' && (d(e === 'LEFT' ? TypographySettings.ALIGNMENT_LEFT : e === 'CENTER' ? TypographySettings.ALIGNMENT_CENTER : e === 'RIGHT' ? TypographySettings.ALIGNMENT_RIGHT : e === 'JUSTIFIED' ? TypographySettings.ALIGNMENT_JUSTIFIED : TypographySettings.EMPTY), u(null), m(!1));
    };
    let i = tT && !t0;
    return jsx(Fragment, {
    ...
    if (tT) {
      return jsx(t3, {
        textTruncationHoverHandler: (e, t) => {
          Y(t);
          t === 'ENTER' && (m(!0), d(e === 'DISABLED' ? TypographySettings.TRUNCATION_DISABLED : TypographySettings.TRUNCATION_ENABLED));
        },
        disabled: k,
        recordingKey: e.recordingKey
      });
  ...
  let tN = (e, t) => {
    Y(t);
    t === 'ENTER' && (d(e === 'NONE' ? TypographySettings.DECORATION_NONE : e === 'STRIKETHROUGH' ? TypographySettings.DECORATION_STRIKETHROUGH : e === 'UNDERLINE' ? TypographySettings.DECORATION_UNDERLINE : TypographySettings.EMPTY), u(null), m(!1));
  };
  let tP = () => {
    let t = tT || tw;
    return jsx(Fragment, {
        ...
        children: [jsx(JU, {
          ...
          onUnderlineDoubleClick: () => {
            ...
            analyticsEventManager.trackDefinedEvent('text_and_vector.text_decoration_menu_opened', {
              source: tx === 'Style' ? 'text_style' : 'type_settings',
  ...
  let tL = () => {
    if (tw) {
      return jsx(t7, {
        ...
        input: jsx(FormattedInputWithWrapper, {
  ...
  let tF = () => {
    ...
    let i = tw && e.wholeNodeTextLineType !== 'PLAIN';
    return jsxs(Fragment, {
      children: [t && jsxs(fI, {
        children: [jsx(JU, {
          className: tt,
  ...
  let tU = () => {
    let t = (e, t) => {
      Y(t);
      t === 'ENTER' && (d(e === 'CAP_HEIGHT' ? TypographySettings.LEADING_TRIM_CAP_HEIGHT : e === 'NONE' ? TypographySettings.LEADING_TRIM_NONE : TypographySettings.EMPTY), u(null), m(!0));
    };
    return jsx(Fragment, {
      children: tw && jsxs(fI, {
        children: [jsx(JU, {
  ...
  let tB = () => jsx(Fragment, {
    children: tw && jsx(_$$k4, {
      ...
      onHover: (e, t) => {
        Y(t);
        t === 'ENTER' && (d(!0 === e ? TypographySettings.HANGING_PUNCTUATION_ON : !1 === e ? TypographySettings.HANGING_PUNCTUATION_OFF : TypographySettings.EMPTY), u(null), m(!1));
      }
    })
  });
  let tV = () => {
    let t = e.wholeNodeTextLineType !== 'PLAIN';
    return jsx(Fragment, {
      children: tw && jsx(_$$k4, {
        segmentedControlClassName: tr,
        ...
        onHover: (e, t) => {
          Y(t);
          t === 'ENTER' && (d(!0 === e ? TypographySettings.HANGING_LISTS_ON : !1 === e ? TypographySettings.HANGING_LISTS_OFF : TypographySettings.EMPTY), u(null), m(!1));
        }
      })
    });
  };
  ...
  let tz = () => {
    ...
    let s = new tC(a);
    let o = !e.textUnderlineOffset || isValidValue(e.textUnderlineOffset) && e.textUnderlineOffset.value === 0 && e.textUnderlineOffset.units === 'RAW' ? {
      value: parseFloat((100 * FontHelpers.getDefaultUnderlineOffset()).toFixed(2)),
      units: 'RAW'
    } : e.textUnderlineOffset;
    let l = {
      min: 0,
      max: isInvalidValue(o) || o.units !== 'PIXELS' ? 25 : 0.25 * valueOrFallback(e.fontSize, 12)
    };
    let c = {
    ...
    let p = new tC(c);
    let h = !e.textDecorationThickness || isValidValue(e.textDecorationThickness) && e.textDecorationThickness.value === 0 && e.textDecorationThickness.units === 'RAW' ? {
      value: parseFloat((100 * FontHelpers.getDefaultUnderlineThickness()).toFixed(2)),
      units: 'RAW'
    } : e.textDecorationThickness;
    let g = {
      min: 0.5,
      max: isInvalidValue(h) || h.units !== 'PIXELS' ? 20 : 0.2 * valueOrFallback(e.fontSize, 12)
    };
    let _ = !v || k;
    return jsxs(Zk, {
      children: [jsxs(fI, {
        ...
        children: [jsx(JU, {
          ...
          decorationHoverHandler: (e, t) => {
            Y(t);
            t === 'ENTER' && (e === 'DOTTED' ? d(TypographySettings.DECORATION_STYLE_DOTTED) : e === 'WAVY' ? d(TypographySettings.DECORATION_STYLE_WAVY) : e === 'SOLID' && d(TypographySettings.DECORATION_STYLE_SOLID), u(null), m(!1));
          },
          disabled: _,
          recordingKey: generateRecordingKey(e, 'textUnderlineDrillInMenu'),
        ...
        children: [jsx(JU, {
          ...
          'shouldClearOnFocus': !isInvalidValue(h) && h.units === 'RAW',
          smallNudgeAmount,
          'value': _ ? {
            value: 0,
            units: 'PERCENT'
        ...
        children: jsx(_$$A3, {
          ...
          'min': g.min,
          'max': g.max,
          'step': isValidValue(h) && h.units === 'PERCENT' ? 0.5 : 0.1,
          'bigStep': isValidValue(h) && h.units === 'PERCENT' ? 5 : 0.5,
          'disabled': _,
        ...
        children: [jsx(JU, {
          ...
          'shouldClearOnFocus': !isInvalidValue(o) && o.units === 'RAW',
          smallNudgeAmount,
          'value': _ ? {
            value: 0,
            units: 'PERCENT'
        ...
        children: jsx(_$$A3, {
          ...
          'min': l.min,
          'max': l.max,
          'step': isValidValue(o) && o.units === 'PERCENT' ? 0.5 : 0.1,
          'bigStep': isValidValue(o) && o.units === 'PERCENT' ? 5 : 0.5,
          'disabled': _,
        ...
        children: [jsx(JU, {
          ...
          decorationHoverHandler: (e, t) => {
            Y(t);
            t === 'ENTER' && (d(!0 === e ? TypographySettings.DECORATION_SKIP_INK_ON : TypographySettings.DECORATION_SKIP_INK_OFF), u(null), m(!1));
          },
          recordingKey: generateRecordingKey(e, 'textUnderlineDrillInMenu'),
  ...
  let tK = () => {
    ...
    return jsx(t2, {
      ...
      previewHoverHandler: (e, t) => {
        Y(t);
        t === 'ENTER' && (d(TypographySettings.FONT_VARIATIONS), u(null), g(e), m(!1));
      },
  ...
  let tq = t => {
    ...
    let n = (e, i) => {
      Y(i);
      i === 'ENTER' && (t === 'FRAC' ? (d(e === 'ON' ? TypographySettings.FRACTIONS_ON : TypographySettings.FRACTIONS_OFF), u(null)) : (d(e === 'ON' ? TypographySettings.OPENTYPE_FEATURE_ON : TypographySettings.OPENTYPE_FEATURE_OFF), u(t)), m(!1));
    };
    let a = w.supported;
    let s = w.applicable;
    let o = t === 'FRAC' ? getI18nString('type_settings.fractions') : (i ? s : a)[t] || _$$G.OpenTypeFeatureNames[t];
    let l = `toggleOpenTypeFeature${t === 'FRAC' ? 'Fractions' : t}`;
    let c = typeof o == 'string' && o.length > 25;
    return jsxs(fI, {
      ...
      children: [i ? jsx(JU, {
        ...
        className: tr,
        children: jsxs(bL, {
          value: t === 'FRAC' ? eZ() : eX(t),
          onChange: e => {
            if (t === 'FRAC') {
              fullscreenValue.updateSelectionProperties({
                fontVariantNumericFraction: e === 'ON' ? 'STACKED' : 'NORMAL'
              });
              return;
            }
            switch (t) {
              case 'DLIG':
                fullscreenValue.updateSelectionProperties({
                  fontVariantDiscretionaryLigatures: e === 'ON'
                });
                break;
              case 'HLIG':
                fullscreenValue.updateSelectionProperties({
                  fontVariantHistoricalLigatures: e === 'ON'
                });
                break;
              default:
                e === 'ON' && eW(t, e);
  ...
  let t$ = () => {
    let t = (e, t) => {
      Y(t);
      t === 'ENTER' && (d(e === 'NORMAL' ? TypographySettings.NUMERIC_POSITION_NORMAL : e === 'SUB' ? TypographySettings.NUMERIC_POSITION_SUB : e === 'SUPER' ? TypographySettings.NUMERIC_POSITION_SUPER : TypographySettings.EMPTY), u(null), m(!1));
    };
    return jsxs(fI, {
      children: [jsx(JU, {
        className: tt,
  ...
  let tZ = () => {
    ...
    let l = e => e === 'ORIGINAL' ? {
      ...
      fontVariantNumericFigure: e === 'UPPER_PROPORTIONAL' || e === 'UPPER_MONOSPACE' ? 'LINING' : 'OLDSTYLE',
      fontVariantNumericSpacing: e === 'UPPER_PROPORTIONAL' || e === 'LOWER_PROPORTIONAL' ? 'PROPORTIONAL' : 'TABULAR'
    };
    let c = (e, t) => {
      let i;
      switch (Y(t), e) {
    ...
    return jsxs(Zk, {
      children: [jsx(fI, {
        ...
        children: [o ? jsx(JU, {
          ...
          className: t.length === 2 ? tr : t.length === 3 ? ta : t.length === 4 ? ts : to,
          children: jsx(bL, {
  ...
  let tJ = t => {
    ...
    return _ ? jsx(conditionalWrapper, {
      wrapper: i,
  ...
  let ie = e.fontVariantCaps === 'SMALL' ? 'SMALL_CAPS' : e.fontVariantCaps === 'ALL_SMALL' ? 'SMALL_CAPS_FORCED' : e.textCase;
  ...
  return getFeatureFlags().ce_tv_fpl_type_settings ? jsx(_$$bL, {
    onClose: e => {
      e.source === 'escape' && B || e.source === 'outside' || j();
    },
    htmlAttributes: {
...
class ip extends PureComponent {
  constructor() {
    super(...arguments);
    this.onClick = () => {
      isInvalidValue(this.props.directionality) || this.props.directionality === 'RTL' ? fullscreenValue.triggerActionInUserEditScope('text-set-directionality-ltr') : fullscreenValue.triggerActionInUserEditScope('text-set-directionality-rtl');
    };
  }
  render() {
    let e;
    e = isInvalidValue(this.props.directionality) ? jsx(io, {}) : this.props.directionality === 'LTR' ? jsx(il, {}) : jsx(id, {});
    return jsx('span', {
      className: gb,
      children: jsx(K0, {
...
class iS extends PureComponent {
  constructor(e) {
    ...
    this.maybeUnsetVariableTab = () => {
      ...
      e?.variationAxes || this.state.activeTab !== 'Variable' || this.setActiveTab('Basics');
    };
    ...
    this.shouldRenderListSpacing = () => !this.isInStyleModal() && isValidValue(this.props.textLineType) && this.props.textLineType !== 'PLAIN';
    ...
    this.renderIconButtons = ({
      ...
      if (e) {
        ...
        if (this.props.hasHadRTLText && i.push(jsx(ip, {
          ...
          i.push(jsx(AutoInteractableWrapper, {
    ...
    this.renderTextPathFlipButton = () => jsx(AutoInteractableWrapper, {
  ...
  componentDidMount() {
    ...
    if (this.showFontAgentCTA && (this.props.localFontAgentVersion || 0) < 14) {
          ...
          'children': jsxs(bo, {
            children: [jsx('div', {
              ...
              children: jsx(_D, {
                ...
                isEmpty: !1,
                openStylePickerToLeft: this.props.version === 'ui3',
                recordingKey: this.props.recordingKey,
                ...
                title: this.props.version === 'ui3' ? getI18nString('fullscreen.type_panel.typography') : getI18nString('fullscreen.type_panel.text'),
                children: jsx(iw, {
...
function iw(e) {
  ...
  let _ = g ? jsx(_$$H, {
    ...
    children: jsx(zz, {
      ...
      showMissingIcon: e.version !== 'ui3',
      versionsForStyles: e.versionsForStyles
    })
  });
  let A = jsx(AutoInteractableWrapper, {
    name: 'font_size',
    children: jsx(_$$Z2, {
  ...
  let E = jsx(AutoInteractableWrapper, {
    name: 'list_spacing',
