...
import { CodeFileIdHandler, CodeLibraryIdHandler } from '../figma_app/243058'
 ...
 */
export function getLocalCodeComponentAsset(asset: any) {
 ...
 */
export function getSubscribedCodeComponentAsset(asset: any) {
