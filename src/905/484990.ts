...
interface DevicePreset {
  ...
  framePresetSize: { x: number, y: number }
  archived?: boolean
  inlinePreviewInfo?: {
...
// MacBook Air M2 device configuration
const MACBOOK_AIR_M2: DevicePreset = {
  scaleFactor: 2,
  imageSize: {
    x: 3208,
    y: 1944,
  ...
  getI18nDeviceName: () => getI18nString("presets.mac_book_air_m2"),
  framePresetSize: {
    x: 1280,
    y: 832,
  },
...
// MacBook Pro 14" device configuration
const MACBOOK_PRO_14_IN: DevicePreset = {
  scaleFactor: 2,
  imageSize: {
    x: 3792,
    y: 2304,
  ...
  getI18nDeviceName: () => getI18nString("presets.mac_book_pro_14"),
  framePresetSize: {
    x: 1512,
    y: 982,
  },
...
// MacBook Pro 16" device configuration
const MACBOOK_PRO_16_IN: DevicePreset = {
  scaleFactor: 2,
  imageSize: {
    x: 4220,
    y: 2574,
  ...
  getI18nDeviceName: () => getI18nString("presets.mac_book_pro_16"),
  framePresetSize: {
    x: 1728,
    y: 1117,
  },
...
const TV_DEVICE: DevicePreset = {
  ...
  deviceName: "TV",
  getI18nDeviceName: () => getI18nString("presets.tv"),
  framePresetSize: {
    x: 1280,
    y: 720,
  },
...
// Macintosh 128k device configuration
const MACINTOSH_128K: DevicePreset = {
  scaleFactor: 1,
  imageSize: {
    x: 706,
    y: 976,
  ...
  getI18nDeviceName: () => getI18nString("presets.mac_128k"),
  archived: true,
  inlinePreviewInfo: {
...
// Complete preset list with device and style information
export const APPLE_PRESET_LIST: (DevicePreset & StylePreset)[] = [
  // MacBook Air M2 presets
  {
    ...
    styleName: "Silver",
    getI18nStyleName: () => getI18nString("presets.styles.mac_book_air_silver"),
    ...MACBOOK_AIR_M2,
  },
  {
    ...
    getI18nStyleName: () => getI18nString("presets.styles.mac_book_air_space_grey"),
    ...MACBOOK_AIR_M2,
  },
  {
    ...
    styleName: "Starlight",
    getI18nStyleName: () => getI18nString("presets.styles.mac_book_air_starlight"),
    ...MACBOOK_AIR_M2,
  },
  {
    ...
    styleName: "Midnight",
    getI18nStyleName: () => getI18nString("presets.styles.mac_book_air_midnight"),
    ...MACBOOK_AIR_M2,
  },

  // MacBook Pro 14" presets
  {
    ...
    styleName: "Silver",
    getI18nStyleName: () => getI18nString("presets.styles.mac_book_pro_silver"),
    ...MACBOOK_PRO_14_IN,
  },
  {
    ...
    styleName: "Space Grey",
    getI18nStyleName: () => getI18nString("presets.styles.mac_book_pro_space_grey"),
    ...MACBOOK_PRO_14_IN,
  },

  // MacBook Pro 16" presets
  {
...
export const E = APPLE_PRESET_LIST
