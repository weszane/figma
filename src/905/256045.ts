...
function $$g({
  ...
  let x = E != null ? decodeURIComponent(E) : null
  let [S] = widget.useSyncedState('srcUrl', null)
  let w = S != null ? decodeURIComponent(S) : null
  ...
  return ((...t) => e.widget.h(AutoLayout, {
    ...
    width: Number(width),
    height: Number(height),
  }, A === 'autoplayable_video' || A === 'autoplayable_audio'
    ? e.widget.h(SVG, {
        name: 'play-button',
        src: Rr,
        onClick: () => {
    ...
    switch (t) {
      ...
      case jU.EMBED_VERSION_ID_V1:
        return (function ({
          ...
          let C = w != null ? decodeURIComponent(w) : null
          let [T] = _widget.useSyncedState('srcUrl', null)
          let k = T != null ? decodeURIComponent(T) : null
          ...
          return ((...t) => e.widget.h(_AutoLayout, {
            ...
            width: Number(width),
            height: Number(height),
          }, y === 'autoplayable_video' || y === 'autoplayable_audio'
            ? e.widget.h(SVG, {
                name: 'play-button',
                src: Rr,
                onClick: () => {
            ...
            : e.widget.h(_AutoLayout, {
                ...
                onClick: () => {
                  let e = C || k || null
                  y === 'figma' && e && debugState.dispatch(RK({
                    rawInput: e,
                  }))
                  z(LinkMetadataEvent.EMBED_CLICK)
                  Fullscreen?.setActiveEmbed(A)
            ...
            : V(G(U)), ((...t) => e.widget.h(_AutoLayout, {
            name: 'provider-container',
            direction: 'horizontal',
            horizontalAlignItems: 'start',
            verticalAlignItems: 'center',
