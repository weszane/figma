...
export function $$s7(e) {
  return {
    compilerOptions: {
      ...
      lib: ["es2016"],
      strict: !0,
      typeRoots: e ? ["../node_modules/@types", "../node_modules/@figma"] : ["./node_modules/@types", "./node_modules/@figma"]
    }
  };
}
export let $$o1 = "1.0.0";
...
let $$d4 = `Below are the steps to get your widget running. You can also find instructions at:
...
`;
let $$c2 = `Below are the steps to get your widget running. You can also find instructions at:
...
`,
  SIMPLE: `// This is a counter widget with buttons to increment and decrement the number.
...
widget.register(Widget)
`,
  IFRAME: `// This widget will open an Iframe window with buttons to show a toast message and close the window.
...
let $$p6 = {
  IFRAME: `<button id="showToastButton">Say hello</button>
