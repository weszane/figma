import { z } from 'zod'
import { ChatSummarySchema, ToolCallResultSchema } from '../figma_app/232209'
import { ToolCallUnionSchema } from '../figma_app/419232'
...
export let figMakeRequestMessageSchema = z.union([v, I, o, l, m, h, g, E, ToolCallUnionSchema, d, c, u, _, A, y, s, b, x, z.object({
...
export const EK = figMakeRequestMessageSchema
