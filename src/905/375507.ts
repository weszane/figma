...
function H(e) {
  ...
  let f = (() => {
    ...
    e.push({
      ...
      cellComponent: e => e.fontInfo.version
        ? jsx(Fragment, {
    ...
    children: [!getFeatureFlags().ff_a11y_page_tab_fix && jsxs(Fragment, {
      ...
      : jsx(Cj, {
          ...
          emptyContent: jsx(_$$p, {
            children: query
              ? renderI18nText('resources_tab.shared_fonts_table.no_fonts_match_your_search_query', {
...
let eo = (e, t, i) => t.variation_instances
  ? e.existing.variation_instances
    ? e.existing.variation_instances.filter(e => i.includes(e.name)).map(e => ({
...
function el(e) {
  ...
  return jsxs('div', {
    ...
    children: [s
      ? i
        ? renderI18nText('design_systems.shared_fonts.replace_warning_new_variable_font_all_collsions_variable', {
            numCollisions: t.length,
          })
        : r
          ? renderI18nText('design_systems.shared_fonts.replace_warning_new_variable_font_all_collisions_non_variable', {
              numCollisions: t.length,
            })
      ...
      : r
        ? renderI18nText('design_systems.shared_fonts.replace_warning', {
            numCollisions: t.length,
          })
...
function eR(e) {
  ...
  let G = (() => {
    ...
    if (!fontsByResourceId[uniqueResourceId])
      return []
    if (resourceType === 'org')
      return U(uniqueResourceId, j)
    {
    ...
    children: [jsx('div', {
      ...
      children: [jsxs(TableRow, {
        ...
        : jsxs(Fragment, {
            ...
            }, 'shared-fonts-scroll-container'), fontLoadPromise
              ? null
              : jsxs(Fragment, {
                  children: [jsx('div', {
      ...
      return uploadsLaunched === 0
        ? null
        : uploadsLaunched - successfulUploads.length - unsuccessfulUploads.length > 0
          ? jsx('div', {
...
export class SharedFontsComponent extends RecordingComponent<SharedFontsComponentProps, SharedFontsComponentState> {
  ...
  private renderContent(): JSX.Element {
    return this.props.useModalViewComponent
      ? jsx(eR, {
          dispatch: this.props.dispatch,
    ...
    children: jsxs(DialogContents, {
      children: [jsx(DialogHeader, {
        ...
        children: [jsxs(TableRow, {
          ...
          children: [jsx('div', {
            className: eL,
            children: existing.version
              ? renderI18nText('design_systems.shared_fonts.family_info_with_version', {
          ...
          children: [jsx('div', {
            className: eL,
            children: collision.uploaded.version
              ? renderI18nText('design_systems.shared_fonts.family_info_with_version', {
                  fontFamily: existing.family,
                  fontStyle: existing.style,
