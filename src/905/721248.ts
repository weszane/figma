...
import { DEFAULT_BACKGROUND_COLOR, generateThumbnails, getBackgroundStyle, getEffectOrGridBackgroundStyle, getImmediateParentHierarchyNodeChange, getMergeResultImagesForChunks, getPageBackgroundColor, getParentHierarchyNodeChangeForDisplayNode, getSVGForLayoutGrid, getTextOrFillBackgroundStyle, groupDisplayChunks, hasStyleOrLibraryKey, hasSymbolStateGroup, isDisplayNodeVisible, isGridStyle, isInternalCanvas, isInternalVariableSet, isValidStyleType, partitionVariantChunks, shouldShowColor } from '../905/432493'
...
import { SelectContainer, SelectGroupLabel, SelectOptionReset, SelectSeparator } from '../905/493196'
...
import { CheckableOptionComponent, DropdownContainer } from '../figma_app/236327'
...
function e0(e) {
  ...
  return void 0 !== prevValue && void 0 !== newValue
    ? renderI18nText('collaboration.branching_chunk.property_change_edited', {
        prevValue: prevValue.toString(),
        newValue: newValue.toString(),
      })
    : void 0 !== prevValue
      ? renderI18nText('collaboration.branching_chunk.property_change_removed', {
          prevValue: prevValue.toString(),
        })
      : void 0 !== newValue
        ? renderI18nText('collaboration.branching_chunk.property_change_added', {
            newValue: newValue.toString(),
          })
        : null
}
function e1(e) {
  ...
  return [prevValue, newValue].some(e => e && typeof e == 'object')
    ? jsx(eJ, {
        prevValue,
        newValue,
      })
...
function e5(e) {
  ...
  if (changes.phase === 'REMOVED')
    return renderI18nText('collaboration.branching_chunk.property_change_node_removed')
...
class e7 extends Component {
  ...
  render() {
    return this.state.hasError
      ? renderI18nText('collaboration.branching_chunk.error')
      : jsx(e6, {
      ...
      children: [jsxs('div', {
        ...
        children: [isImageLoading
          ...
          : image
            ...
            : (() => {
                ...
                return displayNode.type === 'CANVAS'
                  ? jsx('div', {
                      className: ek,
                      children: td,
                    })
        ...
        children: [jsxs('div', {
          ...
          children: [!!e.variantCount && jsx(Fragment, {
            children: e.phase === LibraryUpdateStatus.UPDATED || e.phase === LibraryUpdateStatus.UPDATED_LIBRARY
              ? renderI18nText('collaboration.branching_chunk.tile_variants_changed', {
...
let tx = memo((e) => {
  ...
  let _ = useRef(window.IntersectionObserver
...
let tU = memo((e) => {
  ...
  return modifiedVariants.length + unmodifiedVariants.length === 0
    ? jsx('div', {
        className: Dn,
...
function iL({
  ...
  let a = useMemo(() => {
    ...
    for (let e of s) {
      ...
      o.hasOwnProperty(t)
        ? (o[t].prev = e, o[t].next?.name === e.name ? o[t].phase = LibraryUpdateStatus.UNMODIFIED : o[t].phase = LibraryUpdateStatus.UPDATED)
        : o[t] = {
          id: e.id,
          prev: e,
    ...
    children: jsxs(DialogContents, {
      children: [jsx(DialogHeader, {
        ...
        children: [jsx('form', {
          ...
          onMouseLeave,
          onMouseUp,
          placeholder: (t = e.mergeRequest.owner?.handle, i = e.mergeRequest.reviewers.length > 1, t
            ? i
              ? getI18nString('collaboration.branching_reviews.leave_a_comment_for_owner_and_other_reviewers', {
                  ownerHandle: t,
                })
...
function ng(e) {
  ...
  return jsx(nc, {
    button: e.archivedBranch
      ? void 0
      : i && (e.reviewer.approved_at || e.reviewer.changes_requested_at)
        ? jsxs(MenuRootComp, {
            manager,
            children: [jsx(IconButton, {
              ...getTriggerProps(),
...
function ny(e) {
  ...
  let v = t => e.mergeRequestPersisted && e.mergeRequestInDraft
    ? g
      ? jsx(nh, {
          user: t.user,
...
function nb(e) {
  let t = ''
  t = e.canMerge
    ? getI18nString('collaboration.branching_to_source.add_people_to_approve_or_provide_feedback_on_your_changes_they_ll_get_notified_when_you_add_them')
    : e.canEditReviewers
      ? e.suggestionsSize > 0
        ? getI18nString('collaboration.branching_to_source.no_reviewers_add_suggestions.seat_rename', {
...
function nv(e) {
  ...
  let d = useRef(null)
  if (!e.mergeRequest || !e.mergeRequest.owner || !e.mergeRequest.requested_at)
    return null
...
function nS(e) {
  ...
  let s = e.canMerge
    ...
    : e.fileMerge && e.fileMerge.mergeResultCheckpointId
      ? jsx('span', {
      ...
      : e.isBranchArchived
        ? jsx('span', {
            children: renderI18nText('collaboration.branching_to_source.branch_was_archived', {
              branchFileName: r,
              relativeTimestamp: e.branchFile.trashed_at
...
let nw = memo((e) => {
  ...
  useEffect(() => {
    if (!tP(i) || allDisplayGroups.length <= 1)
      return
    let e = (e) => {
  ...
  let eO = useMemo(() => {
    if (i.view === tN.SUMMARY || i.view === tN.AFFECTED_SUMMARY)
      return null
    let e = nx(i)
                        ...
                        children: [jsxs('div', {
                          ...
                          children: [jsx('div', {
                            ...
                            children: jsx(IconButton, {
                              ...
                              'onClick': () => {
                                i.view === tN.AFFECTED_DETAIL
                                  ? v({
                                      view: tN.AFFECTED_SUMMARY,
                                      displayGroup: i.displayGroup,
                                    })
                                  : i.view === tN.VARIANT_DETAIL
                                    ? v({
                                        view: tN.VARIANT_SUMMARY,
                                        displayGroup: i.displayGroup,
                                      })
...
let nF = memo((e) => {
  ...
  return jsxs('div', {
    ...
    children: [jsx('div', {
      ...
      children: e.didResolveConflicts
        ? jsxs(Fragment, {
            children: [jsxs(ButtonPrimitive, {
...
function rn(e) {
  ...
  let p = chunk
    ? getEffectOrGridBackgroundStyle(chunk, imageBackgroundColor)
    : {
    ...
    ? jsx('div', {
        ...
        children: jsx('span', {
          ...
          children: chunk
            ? o
              ? (() => {
                  if (chunk && chunk.displayNode.styleType && chunk.displayNode.styleType !== 'NONE')
                    return renderI18nText('collaboration.branching_from_source.this_style_was_removed')
              ...
              : renderI18nText('collaboration.branching_from_source.preview_unavailable')
            : renderI18nText('collaboration.branching_from_source.no_item'),
        }),
      })
    : jsxs('div', {
        className: n8,
...
function r_(e) {
  ...
  return numUniqueItems > 1
    ? renderI18nText('collaboration.branching_from_source.num_unique_items_related_items', {
        numUniqueItems,
      })
    : jsx(rf, {
...
let rR = memo((e) => {
  ...
  let x = useMemo(() => (function (e, t, i, n, r, a) {
    ...
    e.forEach((e) => {
      let t = (function (e, t, i, n, r) {
        ...
        let l = null
        for (let e of o) {
          if (isInternalCanvas(e) && e.displayNode.styleType)
            return 'Styles'
          if (isInternalVariableSet(e))
            return 'Variables'
    ...
    useEffect(() => {
      ...
      let e = setTimeout(() => {
        try {
          ...
          e instanceof DiffManager.InvalidStateTransitionError
            ? s.status === 'loading' && s.timer && clearTimeout(s.timer)
            : o({
                status: 'error',
                error: e,
              })
  ...
  return jsxs('div', {
    ...
    children: [jsx(rb, {
      ...
      children: pickedAllFromBranch && !hasNonConflictDisplayGroups
        ? jsx(ButtonWide, {
            onClick(i) {
              if (!D) {
                L(!0)
  ...
  let u = useMemo(() => {
    switch (e) {
      ...
      case SourceDirection.FROM_SOURCE:
        if (t != null)
          return renderI18nText('collaboration.branching_merge_modal.title_merge_from_source_version')
...
function rM(e) {
  ...
  let ei = useSetAtom(isActiveAtom)
  ...
  useEffect(() => {
    ...
    c.navigationKey && c.navigationKey !== I
      ? i(selectViewAction({
          view: 'fullscreen',
  ...
  let eg = useSelector((e) => {
    ...
    if (t)
      return t in e.repos ? e.repos[t] : void 0
  })
  ...
  return jsxs(rO, {
    ...
    children: [ev && jsx(TrackingProvider, {
      ...
      children: jsx(tK, {
        isLoading: ep,
        text: eI,
        button: l === SourceDirection.TO_SOURCE
          ? (t = renderI18nText('collaboration.branching_merge_modal.button_review_conflicts'), jsx('div', {
              className: tV,
              children: jsx(Button, {
                onClick: e_,
                children: t,
