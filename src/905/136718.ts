...
export class ComponentNodeProperties {
  ...
  get autoLayout() {
    return this.readValue("autoLayout", e => new AutoLayoutPropertyReader(e))
  }
  ...
  get properties() {
    return this.readValue("properties", (e) => {
      ...
      if (e.parent?.type === "COMPONENT_SET") {
        ...
        t = normalizeObjectKeys(e.componentPropertyDefinitions)
      }
      return t
    })
  }
  ...
  static from(e: Node, t: NodeCache) {
    return new ComponentNodeProperties(e, t)
  }
...
export const F = ComponentNodeProperties
