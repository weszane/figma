...
import { startSearchSessionAction, updateRecentSearchesThunk } from "../905/977218";
...
function T({
  ...
  let N = useCallback(() => {
    SearchAnalytics.Recents.trackRecentsClick(g, i, null, SearchAnalytics.RecentType.SEARCH);
  }, [i, g]);
  let P = jsx("button", {
