...
function eH(e) {
  ...
  return jsx(kq.Consumer, {
    children: t => jsx(_$$m, {
      searchResults: !0,
      folderList: s,
      onContextMenuOverride: e.viewMode === ViewMode.GRID
        ? void 0
        : (i, n, r) => {
      ...
      children: [jsx('div', {
        ...
        children: [jsx(H8, {
          ...
          children: [t && jsxs('div', {
            ...
            ? renderI18nText('search.user_view.last_active', {
...
export function $$tt0(e) {
  ...
  let d = vt(o)
  let c = jn()
  let p = useMemo(() => e.searchModelType === PublicModelType.TEAMS
    ? t.map(e => ({
        teamId: e.model.id,
      }))
    : [], [e.searchModelType, t])
  ...
  let f = o
    ...
    : void 0
  return e.searchModelType === PublicModelType.FILES
    ? jsx(eM, {
        results: t,
        viewMode: e.viewMode,
        checksForViewOnlyLabels: f,
      })
    : e.searchModelType === PublicModelType.PROJECTS
      ? jsx(eH, {
          results: t,
          checksForViewOnlyLabels: f,
          viewMode: e.viewMode,
        })
      : e.viewMode === ViewMode.GRID && e.searchModelType === PublicModelType.TEAMS
        ? jsx(eK, {
            results: t,
          })
        : e.viewMode === ViewMode.GRID && e.searchModelType === PublicModelType.USERS
          ? jsx(e7, {
              results: t,
            })
          : e.searchModelType === PublicModelType.PUBLIC_PLUGINS || e.searchModelType === PublicModelType.PRIVATE_PLUGINS
            ? jsx(eU, {
                results: t,
              })
            : e.searchModelType === PublicModelType.PUBLIC_WIDGETS || e.searchModelType === PublicModelType.PRIVATE_WIDGETS
              ? jsx(e9, {
                  results: t,
                })
              : jsx(Fragment, {
