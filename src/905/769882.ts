...
let d = ({
  ...
  if (i === FEditorType.Whiteboard) ;else if (t === ColorSpaceType.DISPLAY_P3 && isColorSpaceStatusSupported(e)) return ColorSpaceEnum.DISPLAY_P3;
  return ColorSpaceEnum.SRGB;
};
export function $$c0(e) {
  let t = getColorSpaceSupportStatus();
  let i = useUserColorProfileSubscription();
