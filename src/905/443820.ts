...
let h = "loading-spinner__sm__zIhMd"
let g = "loading-spinner__md__Es0gp"
let f = "loading-spinner__lg__0eM5K"
let _ = "loading-spinner__root__r3CAO"
let A = "loading-spinner__rotate__fG7El"
let y = "loading-spinner__spinner__-BOPO"
let n = {
  lg: f,
  md: g,
  root: _,
...
export let LoadingSpinner = forwardRef<HTMLDivElement, {
  loadingText?: string,
  size?: "sm" | "md" | "lg",
  ...
  let h = v[t]
  return jsxs(AnnouncementPrimitive, {
    className: classNames(_, n[t]),
    ref: d,
    htmlAttributes: i,
    ...a,
    children: [jsx("div", {
