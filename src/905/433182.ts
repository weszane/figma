...
import { createNewFolderThunk } from '../figma_app/199513';
interface TeamInfo {
  id: string;
  name: string;
  org_id: string;
...
export function FileMoveButton(props: FileMoveButtonProps): JSX.Element {
  ...
  return jsxs('button', {
    ...
    'data-tooltip': hasEditPermission ? undefined : getI18nString('file_browser.file_move.you_dont_have_edit_access_to_this_team'),
