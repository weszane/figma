...
(e => {
  ...
  function i(t, i, r) {
    switch (t) {
      ...
      case vL.FILE:
        return r ? getI18nString("consumption_paywalls.campfire.starter_file_limit") : getI18nString("consumption_paywalls.both_file_limits", {
          file_limit: e.getResourceLimit(vL.FILE, i)
        });
      case vL.PAGE:
        if (i === FFileType.WHITEBOARD) return getI18nString("consumption_paywalls.free_page_limit_figjam", {
      ...
      case Bi.PROTOTYPE_SHARING:
        return i === FFileType.SLIDES ? getI18nString("consumption_paywalls.presentation_sharing.no_sharing_presentation_separately") : getI18nString("consumption_paywalls.prototype_sharing.no_sharing_prototypes_separately");
  ...
  let n = (e, t) => {
    switch (e) {
      ...
      case vL.PAGE:
        if (t === FFileType.WHITEBOARD) return getI18nString("consumption_paywalls.unlimited_pages_in_figjam_files");
      ...
      case Bi.PROTOTYPE_SHARING:
        return t === FFileType.SLIDES ? getI18nString("consumption_paywalls.presentation_sharing.share_presentation_separately") : getI18nString("consumption_paywalls.prototype_sharing.share_prototypes_separately");
      case Bi.PASSWORD_PROTECTION:
  ...
  let U = (t, r, a, s) => {
    let l;
    let d = a === FFileType.WHITEBOARD ? getI18nString("consumption_paywalls.editor_type.figjam") : getI18nString("consumption_paywalls.editor_type.figma_design");
    if (0 === r) switch (t) {
      case Bi.VOTING:
      case Bi.PUBLISH_STYLES:
        l = [getI18nString("consumption_paywalls.free_editor_type_files_and_project_limit", {
          editor_type: d
        ...
        break;
      case Bi.TEAM_LIBRARY:
        l = [getI18nString("consumption_paywalls.free_design_files_and_project_limit"), getI18nString("consumption_paywalls.free_page_limit", {
          page_limit: e.getResourceLimit(vL.PAGE, a)
        })];
        break;
      case Bi.PROTOTYPING_MULTIPLE_ACTIONS:
      ...
      case Bi.DEV_MODE:
        ...
        break;
      case Bi.CONNECTED_PROJECTS:
        l = [i(t, a, s), getI18nString("consumption_paywalls.campfire.starter_file_limit"), getI18nString("consumption_paywalls.free_page_limit", {
          page_limit: e.getResourceLimit(vL.PAGE, a)
        })];
        break;
      case Bi.FIGMAKE:
        ...
        break;
      case Bi.CODE_CHAT_LIBRARY_IMPORT:
        l = [getI18nString("consumption_paywalls.code_chat_library_import.no_design_libraries"), getI18nString("consumption_paywalls.three_files_and_one_project_per_team")];
        break;
      case Bi.PUBLISH_SITE:
      case Bi.CONNECT_DOMAIN:
        l = [getFeatureFlags().ai_ga && a === FFileType.FIGMAKE ? getI18nString("consumption_paywalls.ai_ga.publish_make_community") : getI18nString("consumption_paywalls.publish_site.no_publishing"), getI18nString("consumption_paywalls.three_files_and_one_project_per_team")];
        break;
      default:
        l = [i(t, a, s), getI18nString("consumption_paywalls.free_editor_type_files_and_project_limit", {
          editor_type: d
        }), getI18nString("consumption_paywalls.free_page_limit_per_editor_type_file", {
          page_limit: e.getResourceLimit(vL.PAGE, a),
          editor_type: d
      ...
      case Bi.PUBLISH_STYLES:
        l = [getI18nString("consumption_paywalls.unlimited_files_and_projects"), getI18nString("consumption_paywalls.unlimited_pages_in_design_files"), getI18nString("consumption_paywalls.shared_team_libraries")];
        break;
      case Bi.PROTOTYPING_MULTIPLE_ACTIONS:
      case Bi.PROTOTYPING_VARIABLES:
      case Bi.PROTOTYPING_CONDITIONAL_ACTIONS:
        l = [getI18nString("consumption_paywalls.multiple_action_prototypes"), getI18nString("consumption_paywalls.variables_in_prototypes"), getI18nString("consumption_paywalls.conditional_prototypes")];
        break;
      case Bi.CONNECTED_PROJECTS:
        l = [n(t, a), getI18nString("consumption_paywalls.unlimited_files"), getI18nString("consumption_paywalls.unlimited_pages_in_design_files")];
        break;
      case Bi.FIGMAKE:
        l = [n(t, a)];
        break;
      case Bi.PUBLISH_SITE:
        ...
        break;
      case Bi.CODE_CHAT_LIBRARY_IMPORT:
        l = [getI18nString("consumption_paywalls.code_chat_library_import.bring_styling_context"), getFeatureFlags().ai_ga ? getI18nString("plan_comparison.feature.ai_credits", {
          aiCredits: EK
        }) : getI18nString("consumption_paywalls.publish_site.higher_credit_limits"), getI18nString("consumption_paywalls.unlimited_files_and_projects")];
        break;
      default:
        l = [n(t, a), getI18nString("consumption_paywalls.unlimited_files_and_projects"), getI18nString("consumption_paywalls.unlimited_pages_in_editor_type_files", {
          editor_type: d
        })];
    }
    return l.map(e => ({
  ...
  e.getModalTitle = function (e, t, i, n) {
    switch (e) {
      ...
      case Bi.PROTOTYPE_SHARING:
        return n === FFileType.SLIDES ? getI18nString("consumption_paywalls.presentation_sharing.title") : getI18nString("consumption_paywalls.prototype_sharing.title");
      case Bi.PASSWORD_PROTECTION:
  ...
  e.getModalSubtitle = function (t, i, n, r) {
    switch (t) {
      ...
      case vL.PAGE:
        if (r === FFileType.WHITEBOARD) return getI18nString("consumption_paywalls.upgrade_your_plan_to_get_unlimited_pages_in_all_your_figjam_files");
      ...
      case Bi.PROTOTYPE_SHARING:
        return r === FFileType.SLIDES ? getI18nString("consumption_paywalls.presentation_sharing.subtitle") : getI18nString("consumption_paywalls.prototype_sharing.subtitle");
      case Bi.PASSWORD_PROTECTION:
      ...
      case Bi.PUBLISH_SITE:
        return getFeatureFlags().ai_ga && r === FFileType.FIGMAKE ? getI18nString("consumption_paywalls.publish_site.ai_ga.subtitle") : getI18nString("consumption_paywalls.publish_site.subtitle");
      case Bi.CONNECT_DOMAIN:
