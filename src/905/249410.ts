...
registerModal((e) => {
  ...
  let g = e.team
  g.subscription
    ? (t = renderI18nText('payments_modal.your_team_is_locked'), i = renderI18nText('payments_modal.your_professional_team_plan_is_no_longer_active_please', {
        teamName: g.name,
      }))
