...
export function $$J0(e, t, i) {
  ...
  switch (i.type) {
    ...
    {
      if (O)
        return PluginManager.instance.handleUpgrade(PluginAction.RUN_PLUGIN)
      if (!$(e)) {
    ...
    case 'run-installed-plugin':
    {
      ...
      let r = (function (e, t) {
        ...
        if (allSavedPlugins[e])
          return allSavedPlugins[e]
        if (orgSavedPlugins && orgSavedPlugins[e])
          return orgSavedPlugins[e]
    ...
    case 'manage-widgets':
      ...
      _$$s({
        initialX: 0,
        initialY: 0,
        initialTab: w === 'figjam' ? _$$p.WIDGETS : void 0,
        initialFdResourceTab: w === 'figma' ? _$$s2.WIDGET : void 0,
    ...
    case 'manage-plugins':
    {
      ...
      _$$s({
        initialX: 0,
        initialY: 0,
        initialTab: w === 'figjam' ? _$$p.PLUGINS : void 0,
    ...
    case 'browse-plugins':
      ...
      _$$s({
        ...
        initialY: 0,
        initialTab: w === 'figjam' ? _$$p.PLUGINS : void 0,
        initialFdResourceTab: w === 'figma' ? _$$s2.PLUGIN : void 0,
