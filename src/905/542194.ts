 ...
 */
window.FIGMA_start_react_profile = () => fZb?.startProfile('react', 1)

/**
 * Stop React profiling via fZb.
 * Original window.FIGMA_stop_react_profile
 */
window.FIGMA_stop_react_profile = () => fZb?.stopProfile('react', 1)

/**
 * Set of timer event names for analytics.
 * Original variable: $$d0
 */
export const timerEventNames = new Set([
  'react-render',
  'frame',
  'trigger-action',
  'symbol-updater',
  'style-updater',
  'synthesize-all-pending-changes',
  'scene-render',
