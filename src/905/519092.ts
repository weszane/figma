...
export interface HeaderModalProps {
  ...
  title?: string | React.ReactNode | ((closeButton: React.ReactNode, props: {
    titleId: string;
  }) => React.ReactNode);
...
export class HeaderModal extends Component<HeaderModalProps> {
  ...
  componentDidMount(): void {
    ...
    if (this.backgroundRef.current && !this.backgroundRef.current.contains(document.activeElement) && (this.props.closeOnEsc || this.props.focus)) {
  ...
  handleKeyDown = (event: React.KeyboardEvent): void => {
    event.stopPropagation();
    if (event.keyCode === KeyCodes.ESCAPE && (!this.props.disableClickOutsideToHide || this.props.closeOnEsc) && this.props.onClose) {
      this.props.onClose(event);
    }
    if (event.keyCode === KeyCodes.ENTER && this.props.closeOnEnter && this.props.onClose) {
      this.props.onClose(event);
    }
  };
  render() {
    const modalClasses = classNames(K1, jsFullscreenPreventEventCapture, {
    ...
    return jsx('div', {
      ...
      children: jsx('div', {
        ...
        'children': (() => {
          ...
          return hasBottomSection ? jsxs(Fragment, {
            children: [jsx('div', {
              className: SM,
...
export function ConfirmationModal(props: ConfirmationModalProps) {
  ...
  const buttons = jsxs(Fragment, {
    children: [!props.hideCancel && jsx(ButtonSecondaryTracked, {
  ...
  return jsx(HeaderModal, {
    ...
    children: props.useRedesign ? jsxs('div', {
  ...
  render() {
    ...
    return jsxs('div', {
      ...
      'children': [jsxs('div', {
        ...
        }), typeof this.props.title === 'function' ? this.props.title(closeButton, {
          titleId: this.props.titleId
        }) : jsxs(Fragment, {
          children: [typeof this.props.title === 'string' ? jsx(TitleElement, {
            title: this.props.title,
            titleId: this.props.titleId,
            truncateTitleText: this.props.truncateTitleText
          }) : this.props.title, jsxs('div', {
            className: hS,
            children: [this.props.customButton, !this.props.isCloseHidden && closeButton]
          })]
        })]
      }), this.props.children]
    });
