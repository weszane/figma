...
export function $$h0(e, t) {
  getFeatureFlags().anticipation_trigger_shadow && (analyticsEventManager.trackDefinedEvent("auto_suggest.trigger_shadowing", g({
    insertedLocation: e,
    insertedNodeGuid: t,
    isDelayed: !1
  })), setTimeout(() => {
    analyticsEventManager.trackDefinedEvent("auto_suggest.trigger_shadowing", g({
      insertedLocation: e,
      insertedNodeGuid: t,
      isDelayed: !0
    }));
