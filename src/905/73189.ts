  ...
  return jsxs("div", {
    ...
    children: [`APPLE INC.
      ...
      children: [jsx("li", {
        ...
        `, $$a1(`A. Limited License. Subject to the terms of this License and your compliance with Apple\u2019s Human Interface Guidelines, you are granted a limited, non-transferable, non-exclusive license to use the Apple Design Resources solely for creating mock-ups of user interfaces designed for use in software products that run only on Apple\u2019s macOS, iOS, watchOS, tvOS, and/or visionOS operating system software (\u201CMock-Ups\u201D). The foregoing right includes the right to show the Apple Design Resources in screen shots, images or other depictions of such Mock-Ups.
