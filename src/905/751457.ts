 ...
 */
export function attachReactStackToError(error: Error, info?: {
 ...
 */
export function RootErrorBoundaryFallback(props: {
  sentryId?: string;
  isGoogleTranslateError?: boolean;
}) {
    ...
    children: jsx('div', {
      ...
      children: jsxs('div', {
        ...
        children: [jsx('h1', {
          ...
          children: showGoogleTranslate ? hasI18n ? renderI18nText('general.root_error_boundary_google_translate_description') : errorBoundaryText.googleTranslateDescription : hasI18n ? renderI18nText('general.root_error_boundary_description', {
            ...
            children: [jsx('span', {
              children: errorBoundaryText.descriptionP1
            }), jsx(Link, {
              trusted: true,
              href: 'https://status.figma.com',
              children: errorBoundaryText.statusPage
            }), jsx('span', {
              children: errorBoundaryText.descriptionP2
            })]
          })
        }), jsx('div', {
 ...
 */
let errorBoundaryContextInstance: React.Context<{
  error?: Error;
}> | undefined;
function getErrorBoundaryContext() {
  return errorBoundaryContextInstance ??= createContext<{
    error?: Error;
  }>({});
}
 ...
 */
export function ErrorBoundaryContextProvider(props: {
  error?: Error;
  children?: React.ReactNode;
}) {
