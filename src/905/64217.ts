...
export class TabLoop extends Component<TabLoopProps> {
  ...
  onFrontGuardFocus = (e: React.FocusEvent<HTMLDivElement>): void => {
    ...
    const target = this.containerRef.current?.contains(e.relatedTarget as Node) ? this.lastTabbableEl : this.firstTabbableEl;
  ...
  render() {
    ...
    const classes = classNames(className, {
      [cssBuilderInstance.hFull.$]: displayAs === TabLoopDisplayAs.DeprecatedFullHeightBlock,
