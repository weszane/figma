...
import { abandonAndReattachMultiplayer, detachMultiplayer, reattachAndSyncMultiplayer } from '../905/346794'
import { p as _$$p3 } from '../905/347427'
import { Z as _$$Z } from '../905/357899'
import { IOS as _$$p4, ANDROID, ANDROID_XML, IOS_UIKIT, SupportedPlatforms, WEB } from '../905/359509'
...
import { IntegrationUtils, isZoomIntegration } from '../figma_app/469876'
  ...
  for (let t of n.detections) {
    ...
    let s = (e) => {
      ...
      i && (function (e, t) {
        ...
        ? n.push(e)
        : 'children' in e && e.children && e.children.forEach(s)
    }
    s(i)
...
function t1(e) {
  ...
  return a?.key === 'b2XUNRa1b1UPr0ZqkqiOOu' && tQ[e.name]
    ? Promise.resolve({
...
let iK = registerModal((e) => {
  return getFeatureFlags().anticipation && getFeatureFlags().anticipation_eval
    ? jsx(iY, {
        ...e,
      })
    : null
      ...
      try {
        ...
        let t = (function (e) {
          ...
          n?.forEach((i, n) => {
            ...
            if (!a || !s || a.childrenNodes.length === 0)
              return
...
${t}: ${i.join(', ')}`
  ...
  getDetailedResults(e = !1) {
    let t = Object.fromEntries([...Object.entries(deepClone(this.testResults))].sort(([e], [t]) => e.localeCompare(t)).map(([t, i]) => [t, e
      ? i
      : {
          ...i,
          debugInfo: void 0,
...
export function $$nN0(e) {
  ...
  }, 
  {
    ...
    ? nT(function (e) {
        {
          if (!e || !e.userCanViewPlugins)
            return []
          let t = qz(e, 'filemenu')
          return t ? [t] : []
        }
      }(pluginAndWidgetMenuArgs))
    : []), ...(pluginAndWidgetMenuArgs ? nT(pluginAndWidgetMenuArgs && !pluginAndWidgetMenuArgs.isReadOnly ? [Vd(pluginAndWidgetMenuArgs, 'filemenu')] : []) : []), ...(function () {
    ...
    children: [{
      ...
      children: nT(function (e) {
        ...
        return t.type !== 'first-party'
          ? []
          : [tB('dev-handoff-code-settings-unit-pixel', 'dev-handoff-code-settings-unit-pixel-quick-command', MeasurementUnit.PIXEL, e), tB('dev-handoff-code-settings-unit-scaled', 'dev-handoff-code-settings-unit-scaled-quick-command', MeasurementUnit.SCALED, e, {
      ...
      ? [{
          ...
          children: [...(getFeatureFlags().dt_my_cool_plugin_internal || getFeatureFlags().dt_my_cool_plugin_xml
            ...
            if (!desktopAPIInstance?.hasFeature('addMcpImageSupport') || atomStoreManager.get(Kx) === 'xml')
              return []
            let e = [{
              name: 'dev-mode-mcp-server-settings',
    ...
    children: [{
      ...
      callback: (e, t, i) => {
        IntegrationUtils.isGoogleClassroomIntegration()
          ? sendMessageToParent({
              action: 'logOut',
            })
          : i(S5())
