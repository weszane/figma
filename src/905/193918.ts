...
function q({
  ...
  return t
    ? Uv(e.monetized_resource_metadata)
      ? t.duration === -1
        ? renderI18nText('community.buyer.sub_percent_off__forever', {
...
function Z({
  ...
  if (!e || !('third_party_m10n_status' in e) || e.third_party_m10n_status !== PN.MIGRATING)
    return null
  let f = (() => {
...
function J(e) {
  ...
  let I = void 0 !== priceInCents
    ? up(priceInCents, !0)
    : jsx('div', {
        className: nv,
        children: getI18nString('community.buyer.tbd'),
      })
  let E = void 0 !== newTotalAmount
    ? up(newTotalAmount, !0)
    : jsx('div', {
        className: nv,
        children: getI18nString('community.buyer.tbd'),
      })
  isSubscription && priceInCents && (t = subscriptionInterval === fN.MONTHLY
    ? renderI18nText('community.buyer.price_x_month', {
  ...
  return jsxs('div', {
    ...
    children: [jsx(ee, {
      ...
      price: taxCalculationError
        ? jsx('span', {
            className: u7,
            children: taxCalculationError,
          })
        : hasCalculatedTax
          ? up(taxAmountInCents, !0)
          : jsx('span', {
              className: nv,
...
function eS({
  ...
  if (m3(e)) {
    if (e.monetized_resource_metadata.is_subscription) {
      ...
      l = i > 0 && !a
        ? renderI18nText(n ? 'community.buyer.free_trial_then_price_month' : 'community.buyer.free_trial_then_price_year', {
            freeTrialDays: i,
            priceString: r,
          })
...
export let $$eN0 = registerModal((e) => {
  ...
  let ez = useCallback(() => {
    eT
      ...
      : (B(_$$F.clearAll()), B(hideModal()), onCancel?.(), new URLSearchParams(Ay.location.search).has(Tb) && B(sf({
          ...eF,
  ...
  let eq = F?.annual_discount_active_at && F?.annual_discount_percentage
    ? jsx(ef, {
      ...
      children: jsx(OJ, {
        title: jsxs('div', {
          children: [(function (e, t) {
            ...
            return i !== 'undefined' && e && F && F.is_subscription
              ? renderI18nText('community.buyer.subscribe_to_resource_name', {
                  resourceName: i,
                })
