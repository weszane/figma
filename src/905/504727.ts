...
class b extends PureComponent {
  constructor(e) {
    ...
    this.onKeyDownFromFullscreen = (e) => {
      e.event.key === 'Escape' && this.props.dispatch && (e.accept(), this.props.dispatch(hideDropdownAction()))
    }
  ...
  renderDropdownOptions() {
    ...
    return !this.props.disableDropdownScrollContainer && this.dropdownOptionsContainer
      ? jsx($$E0, {
  ...
  render() {
    ...
    let d = this.props.propagateCloseClick
      ? jsxs(ms, {
...
export class $$E0 extends Component {
  ...
  componentDidUpdate(e, t) {
    (t.windowHeight !== this.state.windowHeight || e.dropdownChildrenHeight !== this.props.dropdownChildrenHeight) && (this.props.dropdownChildrenHeight > this.props.maxDropdownHeight(this.state.windowHeight)
      ? this.updateScrollIndicatorVisibility()
      : (this.state.showTopScrollIndicator || this.state.showBottomScrollIndicator) && this.setState({
          showTopScrollIndicator: !1,
