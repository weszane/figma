...
function _(e) {
  switch (e) {
    case "designer":
      return t("job-title.design");
    case "developer":
      return t("job-title.software-development");
    case "product-manager":
      return t("job-title.product-management");
    case "marketer":
      return t("job-title.marketing");
    case "researcher":
      return t("job-title.research");
    case "education":
      return t("job-title.education");
    case "ux-writer":
      return t("job-title.ux-writing");
    case "data":
      return t("job-title.data-analytics");
    case "other":
    case "unknown":
      return t("job-title.other");
  }
}
...
export function $$u2(e) {
  return "student" === e ? t("job-title.student") : "educator" === e ? t("job-title.educator") : _($$o0(e));
}
export const HB = $$o0;
export const VA = $$s1;
export const ZS = $$u2;
